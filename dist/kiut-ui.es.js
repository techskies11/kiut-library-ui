import { defineComponent as re, shallowRef as ri, h as ze, ref as ae, onMounted as Qe, onUnmounted as dt, watch as Ee, toRaw as Ya, nextTick as We, version as Pr, isProxy as li, computed as C, toRef as Me, openBlock as m, createElementBlock as _, normalizeStyle as we, createVNode as j, unref as P, createElementVNode as u, Fragment as se, renderList as he, normalizeClass as J, toDisplayString as A, createCommentVNode as V, onBeforeUnmount as ci, createStaticVNode as Ua, useSlots as ao, renderSlot as ke, Transition as ht, withCtx as R, Comment as Ir, createBlock as ee, resolveDynamicComponent as St, createTextVNode as Ae, Teleport as un, withDirectives as Ze, withModifiers as Oe, vModelText as Yt, vShow as Xt, createSlots as To, vModelSelect as di, mergeProps as mt, useAttrs as Ca, withKeys as Vn, inject as ui } from "vue";
...
function al(e) {
  ...
  if (t) {
    if (t[7] !== a) {
      const i = +t[7];
      n = t[8] ? Ln(i) : zt(i * 255, 0, 255);
    }
    return a = +t[1], o = +t[3], s = +t[5], a = 255 & (t[2] ? Ln(a) : zt(a, 0, 255)), o = 255 & (t[4] ? Ln(o) : zt(o, 0, 255)), s = 255 & (t[6] ? Ln(s) : zt(s, 0, 255)), {
      r: a,
      g: o,
      b: s,
      a: n
...
const Ba = (e) => e <= 31308e-7 ? e * 12.92 : Math.pow(e, 1 / 2.4) * 1.055 - 0.055, pn = (e) => e <= 0.04045 ? e / 12.92 : Math.pow((e + 0.055) / 1.055, 2.4);
function sl(e, t, n) {
  const a = pn(It(e.r)), o = pn(It(e.g)), s = pn(It(e.b));
  return {
    r: Ut(Ba(a + n * (pn(It(t.r)) - a))),
    g: Ut(Ba(o + n * (pn(It(t.g)) - o))),
    b: Ut(Ba(s + n * (pn(It(t.b)) - s))),
    a: e.a + n * (t.a - e.a)
  };
}
function ta(e, t, n) {
...
function dl(e, t, n) {
  if (!pi(e))
    return;
  const a = t[e], o = n[e];
  Be(a) && Be(o) ? Rn(a, o) : Object.prototype.hasOwnProperty.call(t, e) || (t[e] = ba(o));
}
const Eo = {
...
const jn = (e) => typeof e < "u", Gt = (e) => typeof e == "function", Fo = (e, t) => {
  if (e.size !== t.size)
    return !1;
  for (const n of e)
    if (!t.has(n))
...
const Re = Math.PI, Ke = 2 * Re, gl = Ke + Re, va = Number.POSITIVE_INFINITY, ml = Re / 180, Ge = Re / 2, nn = Re / 4, Oo = Re * 2 / 3, bi = Math.log10, Dt = Math.sign;
function En(e, t, n) {
...
const co = (e) => e === "start" ? "left" : e === "end" ? "right" : "center", Je = (e, t, n) => e === "start" ? t : e === "end" ? n : (t + n) / 2, Ml = (e, t, n, a) => e === (a ? "left" : "right") ? n : e === "center" ? (t + n) / 2 : t;
function Dl(e, t, n) {
  const a = t.length;
  let o = 0, s = a;
  if (e._sorted) {
...
const na = (e) => e === 0 || e === 1, jo = (e, t, n) => -(Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * Ke / n)), Ho = (e, t, n) => Math.pow(2, -10 * e) * Math.sin((e - t) * Ke / n) + 1, Fn = {
  linear: (e) => e,
  easeInQuad: (e) => e * e,
  easeOutQuad: (e) => -e * (e - 2),
  ...
  easeInSine: (e) => -Math.cos(e * Ge) + 1,
  easeOutSine: (e) => Math.sin(e * Ge),
    ...
    Object.defineProperties(s, {
      ...
      [n]: {
        ...
        get() {
          ...
          return Be(l) ? Object.assign({}, c, l) : Se(l, c);
        },
        set(l) {
          this[r] = l;
        }
...
function Ci(e, t, n, a, o) {
  ...
  if (!(isNaN(v) || v <= 0)) {
    switch (e.beginPath(), p) {
      ...
      default:
        o ? e.ellipse(n, a, o / 2, v, 0, 0, Ke) : e.arc(n, a, v, 0, Ke), e.closePath();
        break;
      case "triangle":
        ...
        break;
      case "rectRounded":
        c = v * 0.516, l = v - c, i = Math.cos(y + nn) * l, h = Math.cos(y + nn) * (o ? o / 2 - c : l), r = Math.sin(y + nn) * l, f = Math.sin(y + nn) * (o ? o / 2 - c : l), e.arc(n - h, a - r, c, y - Re, y - Ge), e.arc(n + f, a - i, c, y - Ge, y), e.arc(n + h, a + r, c, y, y + Ge), e.arc(n - f, a + i, c, y + Ge, y + Re), e.closePath();
        break;
      case "rect":
        if (!g) {
...
function ya(e, t) {
  ...
  e.arc(n + i.topLeft, a + i.topLeft, i.topLeft, 1.5 * Re, Re, !0), e.lineTo(n, a + s - i.bottomLeft), e.arc(n + i.bottomLeft, a + s - i.bottomLeft, i.bottomLeft, Re, Ge, !0), e.lineTo(n + o - i.bottomRight, a + s), e.arc(n + o - i.bottomRight, a + s - i.bottomRight, i.bottomRight, Ge, 0, !0), e.lineTo(n + o, a + i.topRight), e.arc(n + o - i.topRight, a + i.topRight, i.topRight, 0, -Ge, !0), e.lineTo(n + i.topLeft, a);
}
...
const ql = (e) => +e || 0;
function mo(e, t) {
  const n = {}, a = Be(t), o = a ? Object.keys(t) : t, s = Be(e) ? a ? (i) => Se(e[i], e[t[i]]) : (i) => e[i] : () => e;
  for (const i of o)
    n[i] = ql(s(i));
  return n;
}
...
const Gl = (e, t) => e ? e + ro(t) : t, bo = (e, t) => Be(t) && e !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function Mi(e, t, n) {
...
function Zl(e, t, n) {
  ...
  let r = a[t];
  return Gt(r) && i.isScriptable(t) && (r = Ql(t, r, e, n)), Xe(r) && r.length && (r = Jl(t, r, e, i.isIndexable)), bo(t, r) && (r = kn(r, o, s && s[t], i)), r;
}
function Ql(e, t, n, a) {
...
const sc = Number.EPSILON || 1e-14, _n = (e, t) => t < e.length && !e[t].skip && e[t], Ti = (e) => e === "x" ? "y" : "x";
function ic(e, t, n, a) {
...
function rc(e, t, n) {
  const a = e.length;
  let o, s, i, r, l, c = _n(e, 0);
  for (let d = 0; d < a - 1; ++d)
    if (l = c, c = _n(e, d + 1), !(!l || !c)) {
      if (En(t[d], 0, sc)) {
        n[d] = n[d + 1] = 0;
        continue;
      }
...
class Ii {
  ...
  configure(t) {
    if (!Be(t))
      return;
    const n = Object.keys(Ue.animation), a = this._properties;
...
function Vc(e) {
  let t, n, a, o;
  return Be(e) ? (t = e.top, n = e.right, a = e.bottom, o = e.left) : t = n = a = o = e, {
    top: t,
    right: n,
    bottom: a,
    left: o,
...
class Sa {
  ...
  parse(t, n) {
    ...
    if (this._parsing === !1)
      ...
      Xe(o[t]) ? f = this.parseArrayData(a, o, t, n) : Be(o[t]) ? f = this.parseObjectData(a, o, t, n) : f = this.parsePrimitiveData(a, o, t, n);
  ...
  _resolveElementOptions(t, n = "default", a) {
    ...
    const c = this.chart.config, d = c.datasetElementScopeKeys(this._type, t), h = o ? [
      ...
      t,
      ""
    ], f = c.getOptionScopes(this.getDataset(), d), p = Object.keys(Ue.elements[t]), g = () => this.getContext(a, o, n), v = c.resolveNamedOptions(f, p, g, h);
...
function Ei(e, t, n, a) {
  return Xe(e) ? Zc(e, t, n, a) : t[n.axis] = n.parse(e, a), t;
}
function rs(e, t, n, a) {
...
function od(e, t, n) {
  let a = 1, o = 1, s = 0, i = 0;
  if (t < Ke) {
    const r = e, l = r + t, c = Math.cos(r), d = Math.sin(r), h = Math.cos(l), f = Math.sin(l), p = (k, w, $) => Wn(k, r, l, !0) ? 1 : Math.max(w, w * n, $, $ * n), g = (k, w, $) => Wn(k, r, l, !0) ? -1 : Math.min(w, w * n, $, $ * n), v = p(0, c, h), y = p(Ge, d, f), b = g(Re, c, h), x = g(Re + Ge, d, f);
...
class sd extends Sa {
  ...
  _circumference(t, n) {
    ...
    return n && a.animation.animateRotate || !this.chart.getDataVisibility(t) || o._parsed[t] === null || o.data[t].hidden ? 0 : this.calculateCircumference(o._parsed[t] * s / Ke);
  }
  updateElements(t, n, a, o) {
  ...
  calculateCircumference(t) {
    ...
    return n > 0 && !isNaN(t) ? Ke * (Math.abs(t) / n) : 0;
  }
  getLabelAndValue(t) {
...
function Sd(e, t) {
  const n = _d[e.type] || e.type, { x: a, y: o } = rn(e, t);
  return {
    type: n,
    chart: t,
    native: e,
...
function ys(e, t) {
  if (!e.display)
    return 0;
  const n = nt(e.font, t), a = vt(e.padding);
  return (Xe(e.text) ? e.text.length : 1) * n.lineHeight + a.height;
}
function Wd(e, t) {
  return gn(e, {
    scale: t,
...
class wn extends Ft {
  ...
  calculateLabelRotation() {
    ...
    const d = this._getLabelSizes(), h = d.widest.width, f = d.highest.height, p = tt(this.chart.width - h, 0, this.maxWidth);
    r = t.offset ? this.maxWidth / a : p / (a - 1), h + 6 > r && (r = p / (a - (t.offset ? 0.5 : 1)), l = this.maxHeight - Mn(t.grid) - n.padding - ys(t.title, this.chart.options.font), c = Math.sqrt(h * h + f * f), i = xl(Math.min(Math.asin(tt((d.highest.height + 6) / r, -1, 1)), Math.asin(tt(l / c, -1, 1)) - Math.asin(tt(f / c, -1, 1)))), i = Math.max(o, Math.min(s, i))), this.labelRotation = i;
  }
  ...
  _computeLabelSizes(t, n, a) {
    ...
    for (h = 0; h < n; h += l) {
      if (g = t[h].label, v = this._resolveTickFontOptions(h), o.font = y = v.string, b = s[y] = s[y] || {
        data: {},
        gc: []
      }, x = v.lineHeight, k = w = 0, !Pe(g) && !Xe(g))
        k = Yo(o, b.data, b.gc, k, g), w = x;
      else if (Xe(g))
        for (f = 0, p = g.length; f < p; ++f)
          $ = g[f], !Pe($) && !Xe($) && (k = Yo(o, b.data, b.gc, k, $), w += x);
  ...
  getPixelForDecimal(t) {
    ...
    return _l(this._alignToPixels ? an(this.chart, n, 0) : n);
  }
  ...
  _computeGridLineItems(t) {
    ...
    for (k = 0; k < h; k += H) {
      const Q = this.getContext(k), ne = s.setContext(Q), le = r.setContext(Q), ge = ne.lineWidth, X = ne.color, L = le.dash || [], W = le.dashOffset, K = ne.tickWidth, ie = ne.tickColor, pe = ne.tickBorderDash || [], Ce = ne.tickBorderDashOffset;
      w = jd(this, k, l), w !== void 0 && ($ = an(a, w, ge), c ? M = I = O = B = $ : S = z = D = T = $, p.push({
        tx1: M,
        ty1: S,
        tx2: I,
        ty2: z,
  ...
  _computeLabelItems(t) {
    ...
    for (b = 0, x = r.length; b < x; ++b) {
      ...
      I = this.getPixelForTick(b) + s.labelOffset, z = this._resolveTickFontOptions(b), O = z.lineHeight, D = Xe(w) ? w.length : 1;
      const Q = D / 2, ne = H.color, le = H.textStrokeColor, ge = H.textStrokeWidth;
      let X = S;
      i ? ($ = I, S === "inner" && (b === x - 1 ? X = this.options.reverse ? "left" : "right" : b === 0 ? X = this.options.reverse ? "right" : "left" : X = "center"), o === "top" ? c === "near" || v !== 0 ? B = -D * O + O / 2 : c === "center" ? B = -N.highest.height / 2 - Q * O + O : B = -N.highest.height + O / 2 : c === "near" || v !== 0 ? B = O / 2 : c === "center" ? B = N.highest.height / 2 - Q * O : B = N.highest.height - D * O, h && (B *= -1), v !== 0 && !H.showLabelBackdrop && ($ += O / 2 * Math.sin(v))) : (M = I, B = (1 - D) * O / 2);
      let L;
      if (H.showLabelBackdrop) {
        const W = vt(H.backdropPadding), K = N.heights[b], ie = N.widths[b];
        let pe = B - W.top, Ce = 0 - W.left;
        switch (T) {
          case "middle":
            pe -= K / 2;
            break;
  ...
  drawTitle() {
    ...
    if (!a.display)
      return;
    const s = nt(a.font), i = vt(a.padding), r = a.align;
    let l = s.lineHeight / 2;
    n === "bottom" || n === "center" || Be(n) ? (l += i.bottom, Xe(a.text) && (l += s.lineHeight * (a.text.length - 1))) : l += i.top;
...
class la {
  ...
  register(t) {
    ...
    return s in o || (o[s] = t, qd(t, i, a), this.override && Ue.override(t.id, t.overrides)), i;
  }
  get(t) {
    return this.items[t];
  }
  unregister(t) {
    ...
    a in n && delete n[a], o && a in Ue[o] && (delete Ue[o][a], this.override && delete fn[a]);
  }
}
function qd(e, t, n) {
  ...
  Ue.set(t, a), e.defaultRoutes && Xd(t, e.defaultRoutes), e.descriptors && Ue.describe(t, e.descriptors);
}
function Xd(e, t) {
...
class Zd {
  constructor() {
    this.controllers = new la(Sa, "datasets", !0), this.elements = new la(Ft, "elements"), this.plugins = new la(Object, "plugins"), this.scales = new la(wn, "scales"), this._typedRegistries = [
      this.controllers,
      this.scales,
      this.elements
    ];
...
function ru(e, t) {
  ...
  return Object.keys(a).forEach((i) => {
    ...
    const l = Ja(i, r, iu(i, e), Ue.scales[r.type]), c = ou(l, o), d = n.scales || {};
...
class cu {
  ...
  getOptionScopes(t, n, a) {
    ...
    n.forEach((d) => {
      t && (l.add(t), d.forEach((h) => Dn(l, t, h))), d.forEach((h) => Dn(l, o, h)), d.forEach((h) => Dn(l, fn[s] || {}, h)), d.forEach((h) => Dn(l, Ue, h)), d.forEach((h) => Dn(l, Ga, h));
    });
...
const du = (e) => Be(e) && Object.getOwnPropertyNames(e).some((t) => Gt(e[t]));
function uu(e, t) {
  const { isScriptable: n, isIndexable: a } = Si(e);
  for (const o of t) {
    const s = n(o), i = a(o), r = (i || s) && e[o];
    if (s && (Gt(r) || du(r)) || i && Xe(r))
      return !0;
  }
  return !1;
}
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), a = 0, o = n.length; a < o; a++) {
      ...
      if (i.type && i.type !== r && (this._destroyDatasetMeta(a), i = this.getDatasetMeta(a)), i.type = r, i.indexAxis = s.indexAxis || Qa(r, this.options), i.order = s.order || 0, i.index = a, i.label = "" + s.label, i.visible = this.isDatasetVisible(a), i.controller)
        ...
        const l = $t.getController(r), { datasetElementType: c, dataElementType: d } = Ue.datasets[r];
        Object.assign(l, {
...
function vu(e, t, n) {
  ...
  let c = o / r;
  e.beginPath(), e.arc(s, i, r, a - c, n + c), l > o ? (c = o / l, e.arc(s, i, l, n + c, a - c, !0)) : e.arc(s, i, o, n + Ge, a - Ge), e.closePath(), e.clip();
}
function yu(e) {
  return mo(e, [
    "outerStart",
...
function xu(e, t, n, a) {
  const o = yu(e.options.borderRadius), s = (n - t) / 2, i = Math.min(s, a * t / 2), r = (l) => {
    ...
    return tt(l, 0, Math.min(s, c));
  };
  return {
    outerStart: r(o.outerStart),
    outerEnd: r(o.outerEnd),
    innerStart: tt(o.innerStart, 0, i),
    innerEnd: tt(o.innerEnd, 0, i)
  };
}
function bn(e, t, n, a) {
  return {
...
class wu extends Ft {
  ...
  inRange(t, n, a) {
    const o = this.getProps([
      ...
      "outerRadius",
      "circumference"
    ], a), f = (this.options.spacing + this.options.borderWidth) / 2, p = Se(h, l - r), g = Wn(s, r, l) && r !== l, v = p >= Ke || g, y = Nt(i, c + f, d + f);
    return v && y;
  }
  getCenterPoint(t) {
  ...
  draw(t) {
    ...
    if (this.pixelMargin = n.borderAlign === "inner" ? 0.33 : 0, this.fullCircles = a > Ke ? Math.floor(a / Ke) : 0, a === 0 || this.innerRadius < 0 || this.outerRadius < 0)
      return;
    t.save();
...
function Eu(e, t, n) {
  const { enableBorderRadius: a } = e.getProps([
    "enableBorderRadius"
  ]), o = e.options.borderRadius, s = yn(o), i = Math.min(t, n), r = e.borderSkipped, l = a || Be(o);
  return {
...
class Bs extends Ft {
  ...
  fit() {
    ...
    const a = t.labels, o = nt(a.font), s = o.size, i = this._computeTitleHeight(), { boxWidth: r, itemHeight: l } = Ts(a, s);
    let c, d;
  ...
  adjustHitBoxes() {
    ...
    if (this.isHorizontal()) {
      let r = 0, l = Je(a, this.left + o, this.right - this.lineWidths[r]);
      for (const c of n)
        r !== c.row && (r = c.row, l = Je(a, this.left + o, this.right - this.lineWidths[r])), c.top += this.top + t + o, c.left = i.leftForLtr(i.x(l), c.width), l += c.width + o;
    } else {
      let r = 0, l = Je(a, this.top + t + o, this.bottom - this.columnSizes[r].height);
      for (const c of n)
        c.col !== r && (r = c.col, l = Je(a, this.top + t + o, this.bottom - this.columnSizes[r].height)), c.top = l, c.left += this.left + o, c.left = i.leftForLtr(i.x(c.left), c.width), l += c.height + o;
    }
  }
  isHorizontal() {
  ...
  _draw() {
    const { options: t, columnSizes: n, lineWidths: a, ctx: o } = this, { align: s, labels: i } = t, r = Ue.color, l = xn(t.rtl, this.left, this.width), c = nt(i.font), { padding: d } = i, h = c.size, f = h / 2;
    let p;
    ...
    const { boxWidth: g, boxHeight: v, itemHeight: y } = Ts(i, h), b = function(M, S, I) {
      ...
      if (o.fillStyle = Se(I.fillStyle, r), o.lineCap = Se(I.lineCap, "butt"), o.lineDashOffset = Se(I.lineDashOffset, 0), o.lineJoin = Se(I.lineJoin, "miter"), o.lineWidth = z, o.strokeStyle = Se(I.strokeStyle, r), o.setLineDash(Se(I.lineDash, [])), i.usePointStyle) {
        ...
        const O = S + Math.max((h - v) / 2, 0), D = l.leftForLtr(M, g), B = yn(I.borderRadius);
    ...
    k ? p = {
      x: Je(s, this.left + d, this.right - a[0]),
      y: this.top + d + w,
      line: 0
    } : p = {
      x: this.left + d,
      y: Je(s, this.top + w + d, this.bottom - n[0].height),
      line: 0
    ...
    this.legendItems.forEach((M, S) => {
      ...
      let D = p.x, B = p.y;
      l.setWidth(this.width), k ? S > 0 && D + O + d > this.right && (B = p.y += $, p.line++, D = p.x = Je(s, this.left + d, this.right - a[p.line])) : S > 0 && B + $ > this.bottom && (D = p.x = D + n[p.line].width + d, p.line++, B = p.y = Je(s, this.top + w + d, this.bottom - n[p.line].height));
      const T = l.x(D);
  ...
  drawTitle() {
    const t = this.options, n = t.title, a = nt(n.font), o = vt(n.padding);
    if (!n.display)
      return;
    const s = xn(t.rtl, this.left, this.width), i = this.ctx, r = n.position, l = a.size / 2, c = o.top + l;
    let d, h = this.left, f = this.width;
    if (this.isHorizontal())
      f = Math.max(...this.lineWidths), d = this.top + c, h = Je(t.align, h, this.right - f);
    else {
      const g = this.columnSizes.reduce((v, y) => Math.max(v, y.height), 0);
      d = c + Je(t.align, this.top, this.bottom - g - t.labels.padding - this._computeTitleHeight());
    }
    const p = Je(r, h, h + f);
  ...
  _computeTitleHeight() {
    const t = this.options.title, n = nt(t.font), a = vt(t.padding);
...
class Gi extends Ft {
  ...
  update(t, n) {
    ...
    const o = Xe(a.text) ? a.text.length : 1;
    this._padding = vt(a.padding);
    const s = o * nt(a.font).lineHeight + this._padding.height;
  ...
  _drawArgs(t) {
    ...
    let l = 0, c, d, h;
    return this.isHorizontal() ? (d = Je(r, a, s), h = n + t, c = s - a) : (i.position === "left" ? (d = a + t, h = Je(r, o, n), l = Re * -0.5) : (d = s - t, h = Je(r, n, o), l = Re * 0.5), c = o - n), {
      titleX: d,
      titleY: h,
      maxWidth: c,
      rotation: l
  ...
  draw() {
    ...
    if (!n.display)
      return;
    const a = nt(n.font), s = a.lineHeight / 2 + this._padding.top, { titleX: i, titleY: r, maxWidth: l, rotation: c } = this._drawArgs(s);
    Yn(t, n.text, 0, 0, a, {
      color: n.color,
      maxWidth: l,
      rotation: c,
...
function Ct(e, t) {
  return t && (Xe(t) ? Array.prototype.push.apply(e, t) : e.push(t)), e;
}
function Pt(e) {
...
function Ls(e, t) {
  const n = e.chart.ctx, { body: a, footer: o, title: s } = e, { boxWidth: i, boxHeight: r } = t, l = nt(t.bodyFont), c = nt(t.titleFont), d = nt(t.footerFont), h = s.length, f = o.length, p = a.length, g = vt(t.padding);
...
function Is(e, t, n, a) {
  ...
  return l === "center" ? r === "left" ? g += c : r === "right" && (g -= c) : r === "left" ? g -= Math.max(d, f) + o : r === "right" && (g += Math.max(h, p) + o), {
    x: tt(g, 0, a.width - t.width),
    y: tt(v, 0, a.height - t.height)
  };
}
function da(e, t, n) {
...
class Fs extends Ft {
  ...
  getCaretPosition(t, n, a) {
    const { xAlign: o, yAlign: s } = this, { caretSize: i, cornerRadius: r } = a, { topLeft: l, topRight: c, bottomLeft: d, bottomRight: h } = yn(r), { x: f, y: p } = t, { width: g, height: v } = n;
    let y, b, x, k, w, $;
  ...
  drawTitle(t, n, a) {
    ...
    if (s) {
      ...
      for (t.x = da(this, a.titleAlign, a), n.textAlign = c.textAlign(a.titleAlign), n.textBaseline = "middle", i = nt(a.titleFont), r = a.titleSpacing, n.fillStyle = a.titleColor, n.font = i.string, l = 0; l < s; ++l)
        n.fillText(o[l], c.x(t.x), t.y + i.lineHeight / 2), t.y += i.lineHeight + r, l + 1 === s && (t.y += a.titleMarginBottom - r);
    }
  }
  _drawColorBox(t, n, a, o, s) {
    const i = this.labelColors[a], r = this.labelPointStyles[a], { boxHeight: l, boxWidth: c } = s, d = nt(s.bodyFont), h = da(this, "left", s), f = o.x(h), p = l < d.lineHeight ? (d.lineHeight - l) / 2 : 0, g = n.y + p;
    if (s.usePointStyle) {
      const v = {
      ...
      const v = o.leftForLtr(f, c), y = o.leftForLtr(o.xPlus(f, 1), c - 2), b = yn(i.borderRadius);
  ...
  drawBody(t, n, a) {
    const { body: o } = this, { bodySpacing: s, bodyAlign: i, displayColors: r, boxHeight: l, boxWidth: c, boxPadding: d } = a, h = nt(a.bodyFont);
    let f = h.lineHeight, p = 0;
    const g = xn(a.rtl, this.x, this.width), v = function(I) {
  ...
  drawFooter(t, n, a) {
    ...
    if (s) {
      ...
      for (t.x = da(this, a.footerAlign, a), t.y += a.footerMarginTop, n.textAlign = l.textAlign(a.footerAlign), n.textBaseline = "middle", i = nt(a.footerFont), n.fillStyle = a.footerColor, n.font = i.string, r = 0; r < s; ++r)
...
const nh = (e, t) => e === null ? null : tt(Math.round(e), 0, t);
function Os(e) {
...
function Ns(e, t) {
  ...
  let i = t;
  return typeof a == "function" && (i = a(i)), bt(i) || (i = typeof a == "string" ? n.parse(i, a) : n.parse(i)), i === null ? null : (o && (i = o === "week" && (Hn(s) || s === !0) ? n.startOf(i, "isoWeek", s) : n.startOf(i, o)), +i);
}
function js(e, t, n, a) {
  const o = ct.length;
...
class Ks extends wn {
  ...
  initOffsets(t = []) {
    ...
    n = tt(n, 0, i), a = tt(a, 0, i), this._offsets = {
      start: n,
      end: a,
      factor: 1 / (n + 1 + a)
    };
...
const gh = re({
  ...
  setup(e, t) {
    ...
    return Qe(i), dt(r), Ee([
      ...
      if (f) {
        const b = vn(f.labels), x = vn(g.labels), k = vn(f.datasets), w = vn(g.datasets);
...
const qs = 10, _h = /* @__PURE__ */ re({
  ...
  setup(e, { expose: t }) {
    const n = e;
    Zt.register(Ji, er, zu, Zi, wo, _o), Zt.defaults.font.family = rt;
  ...
  for (const [a, o] of t)
    n[a] = o;
  return n;
}, _t = /* @__PURE__ */ ve(_h, [["__scopeId", "data-v-1d64fb88"]]), wh = { class: "chart-line-root flex h-full min-h-[230px] w-full shrink-0 flex-col bg-transparent font-[family-name:Inter,ui-sans-serif,system-ui,sans-serif] min-w-0" }, Ch = { class: "chart-line-canvas-host relative min-h-0 w-full flex-1" }, $h = {
  key: 0,
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: o }), (y, b) => (m(), _("div", wh, [
      ...
      h.value.length > 0 ? (m(), _("ul", $h, [
        (m(!0), _(se, null, he(h.value, (x, k) => (m(), _("li", {
          key: x.key,
          role: "listitem"
        }, [
          u("button", {
...
}), yt = /* @__PURE__ */ ve(Dh, [["__scopeId", "data-v-426e23d5"]]), Ah = { class: "chart-container" }, Th = "'Inter', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", Bh = /* @__PURE__ */ re({
  __name: "PieChart",
  props: {
    data: {},
    options: {},
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: a }), (f, p) => (m(), _("div", Lh, [
      (m(), _("svg", {
        ...
        (m(!0), _(se, null, he(h.value, (g, v) => (m(), _(se, { key: v }, [
          u("line", {
            x1: e.chartMargin - 6,
            y1: g.y,
            x2: e.chartMargin,
        ...
        (m(!0), _(se, null, he(e.boxplotData, (g, v) => (m(), _(se, { key: v }, [
          u("g", {
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: a }), (x, k) => (m(), _("div", Df, [
      (m(), _("svg", {
        ...
        (m(!0), _(se, null, he(b.value, (w, $) => (m(), _("line", {
          key: `grid-${$}`,
          x1: e.chartMargin,
          y1: w.y,
          x2: e.chartWidth - e.chartMargin,
        ...
        (m(!0), _(se, null, he(b.value, (w, $) => (m(), _(se, { key: $ }, [
          u("line", {
            x1: e.chartMargin - 6,
            y1: w.y,
            x2: e.chartMargin,
        ...
        (m(!0), _(se, null, he(e.candlestickData, (w, $) => (m(), _(se, { key: $ }, [
          u("g", {
  ...
  setup(e, { expose: t }) {
    ...
    function r(q, G, te) {
      const de = te ? 0.6 : 0.535;
      return Math.ceil(Math.max(q, 1) * G * de);
    }
    function l(q, G) {
      return Math.max(
        r(q.length, Wa, !0),
    ...
    function c(q, G, te, de) {
      const me = te / 2, F = 6, Z = Math.min(
        Math.max(q, me + F),
        n.chartWidth - me - F
      ), oe = F + de + 10, fe = n.chartHeight - F + 10, xe = Math.min(Math.max(G, oe), fe);
      return { x: Z, y: xe };
    }
    const d = C(() => ({
      // Axis
    ...
    function x(q) {
      ...
      const G = v.value / 10;
      return p.value + (q - 0.5) * G;
    }
    const k = C(
      () => Array.from({ length: 10 }, (q, G) => {
        const te = G + 1, de = x(te);
        return de === null ? null : { score: te, x: de };
      }).filter((q) => q !== null)
    ), w = C(() => {
      if (!n.histogram || n.histogram.length === 0) return 1;
      const q = Math.max(...n.histogram.map((te) => te.count || 0), 1), G = Math.max(1, Math.ceil(q * 0.2));
      return q + G;
    }), $ = C(() => {
      if (!n.histogram || n.histogram.length === 0) return 1;
      ...
      if (te === 0) return 0;
      const de = 1 / (te * Math.sqrt(2 * Math.PI)), me = -0.5 * Math.pow((q - G) / te, 2);
      return de * Math.exp(me);
    }, S = C(() => {
      if (!n.histogram || n.histogram.length === 0 || n.averageScore === 0 && $.value === 0) return null;
      const q = n.averageScore, G = $.value, te = 100, me = Math.max(...n.histogram.map((fe) => fe.count || 0), 1) / w.value * y.value;
      if (me <= 0) return null;
      let F = 0;
      for (let fe = 0; fe <= te; fe++) {
        const xe = 1 + 9 * (fe / te), Te = M(xe, q, G);
        Te > F && (F = Te);
      }
      if (F <= 0) return null;
      const Z = me / F, oe = [];
      for (let fe = 0; fe <= te; fe++) {
        const xe = 1 + 9 * (fe / te), Te = M(xe, q, G) * Z, _e = x(xe);
        if (_e !== null) {
          const je = n.chartHeight - n.chartBottomMargin - Te;
          oe.push(`${fe === 0 ? "M" : "L"} ${_e} ${je}`);
        }
      }
      return oe.join(" ");
    }), I = C(() => {
      ...
      const q = v.value / 10;
      return n.histogram.map((G) => {
        const te = Number(G.score);
        if (!Number.isFinite(te) || te < 1 || te > 10)
          return null;
        const de = p.value + (te - 0.5) * q, me = G.count > 0 ? G.count / w.value * y.value : 0, F = n.chartHeight - n.chartBottomMargin - me;
        return {
          score: te,
          count: G.count,
          x: de,
    ...
    }), z = C(() => x(n.minScore)), O = C(() => x(n.maxScore)), D = C(() => x(n.q1Score)), B = C(() => x(n.medianScore)), T = C(() => x(n.q3Score)), N = C(() => x(n.averageScore)), H = C(() => n.minScore), Q = C(() => n.maxScore), ne = C(() => n.q1Score), le = C(() => n.medianScore), ge = C(() => n.q3Score), X = C(() => n.averageScore), L = C(() => {
      const q = [], G = n.chartMargin - 8, te = 18;
      D.value !== null && q.push({
        x: D.value,
        y: G,
        value: n.q1Score,
      ...
      q.forEach((F) => {
        ...
        for (let oe = 0; oe < de.length; oe++) {
          let fe = !1;
          for (const xe of de[oe]) {
            if (xe.x === null) continue;
            const Te = Math.abs(F.x - xe.x), _e = (F.width + xe.width) / 2 + 10;
            if (Te < _e) {
              fe = !0;
              break;
            }
        ...
        Z === -1 && (Z = de.length - 1), F.y = G - Z * te, de[Z].push(F);
      });
      const me = 15;
      return q.forEach((F) => {
        F.y < me && (F.y = me);
      }), q;
    }), W = (q) => L.value.find((te) => te.id === q)?.y || n.chartMargin - 10, K = C(() => {
      const q = [];
      for (let te = 0; te <= 5; te++) {
        const de = Math.round(w.value / 5 * te), me = n.chartHeight - n.chartBottomMargin - te / 5 * y.value;
        q.push({ value: de, y: me });
      }
      return q;
    });
    function ie(q, G, te) {
      ...
      if (!me) {
        ...
        return { x: G - Z.left, y: te - Z.top };
      }
      const F = de.matrixTransform(me.inverse());
      return { x: F.x, y: F.y };
    }
    const pe = (q, G) => {
      n.interactive && E(q, G);
      ...
      if (!te) return;
      const { x: de, y: me } = ie(te, q.clientX, q.clientY), F = `Score: ${G.score}`, Z = `Count: ${Number(G.count ?? 0).toLocaleString()}`, oe = l(F, Z), fe = s, xe = typeof G?.x == "number" ? G.x : de;
      let Te = me - 20;
      const _e = c(xe, Te, oe, fe);
      h.value = {
        visible: !0,
        x: _e.x,
        y: _e.y,
      ...
      if (n.interactive && h.value.visible) {
        const G = q.currentTarget, { x: te, y: de } = ie(G, q.clientX, q.clientY), me = h.value.anchorX, F = me != null && Number.isFinite(me) ? me : te;
        let Z = de - 20;
    ...
    return t({ isDark: a }), (q, G) => (m(), _("div", {
      ...
      (m(), _("svg", {
        ...
        (m(!0), _(se, null, he(K.value, (te, de) => (m(), _("line", {
          key: `grid-${de}`,
          x1: p.value,
          y1: te.y,
          x2: g.value,
        ...
        (m(!0), _(se, null, he(K.value, (te, de) => (m(), _(se, {
          key: `y-tick-${de}`
        }, [
          u("line", {
            x1: e.chartMargin - 6,
        ...
        (m(!0), _(se, null, he(k.value, (te) => (m(), _(se, {
          key: `tick-${te.score}`
        }, [
          u("line", {
            x1: te.x,
        ...
        (m(!0), _(se, null, he(I.value, (te, de) => (m(), _("rect", {
          key: `bar-${de}`,
          x: te.x - b.value / 2,
          y: te.y,
          width: b.value,
        ...
        e.showStatLabels && N.value ? (m(), _("text", {
          ...
          "font-weight": "700",
          "font-family": "'DM Sans', sans-serif"
        }, " Avg: " + A(X.value.toFixed(1)), 9, Eg)) : V("", !0),
...
const dm = { class: "chart-container" }, um = {
  ...
  setup(e, { expose: t }) {
    ...
    const h = {
      ...
      const Y = E.replace(/_/g, " ").replace(/\s+/g, " ").trim(), U = Y.match(/^Failed:\s*(.+)$/i);
      return U ? `Failed:
${U[1].trim()}` : Y;
    }, x = (E, Y) => {
      const U = E.trim();
      ...
      let q = 0;
      for (; q < U.length; ) {
        const G = Math.min(q + Y, U.length);
        if (G >= U.length) {
          const me = U.slice(q).trim();
          me && ue.push(me);
          break;
        }
        const te = U.slice(q, G), de = te.lastIndexOf(" ");
        if (de > 0)
          for (ue.push(U.slice(q, q + de).trim()), q += de; q < U.length && U[q] === " "; ) q += 1;
        else
          ue.push(te), q = G;
      }
      return ue.join(`
`);
      ...
      const U = E.trim();
      return !U || Y < 1 ? E : U.split(`
`).map((ue) => x(ue.trim(), Y)).filter(Boolean).join(`
`);
    }, w = (E) => E.status ? E.status : g.test(E.name) ? "abandon" : v.test(E.name) ? "error" : "success", $ = (E) => E.originalValue ?? E.value, M = (E, Y) => {
      const U = new Set(Y.map((q) => q.target)), ue = E.filter((q) => !U.has(q.name));
      for (const q of ue) {
        if (typeof q.value == "number" && q.value > 0) return q.value;
        const G = Y.filter((te) => te.source === q.name);
        if (G.length > 0)
          return G.reduce((te, de) => te + $(de), 0);
      }
      return Y.reduce((q, G) => Math.max(q, $(G)), 0);
    }, S = (E) => {
      const Y = /* @__PURE__ */ new Map();
      for (const U of E) {
        const ue = String(U.source);
        Y.set(ue, (Y.get(ue) ?? 0) + $(U));
      }
      return Y;
    }, I = (E, Y) => {
      const U = /* @__PURE__ */ new Map(), ue = new Set(Y.map((G) => G.target)), q = E.filter((G) => !ue.has(G.name)).map((G) => ({ name: G.name, depth: 0 }));
      for (; q.length > 0; ) {
        const { name: G, depth: te } = q.shift(), de = U.get(G);
        if (!(de !== void 0 && de >= te)) {
          U.set(G, te);
          for (const me of Y)
            me.source === G && q.push({ name: me.target, depth: te + 1 });
        }
      }
      for (const G of E)
        U.has(G.name) || U.set(G.name, 0);
      return U;
    }, z = (E, Y) => {
      const U = /* @__PURE__ */ new Map(), ue = new Set(Y.map((de) => de.target)), q = E.filter((de) => !ue.has(de.name));
      let G = 0;
      const te = (de) => {
        let me = de;
        for (; me && !U.has(me); )
          U.set(me, G), G += 1, me = Y.filter(
            (Z) => Z.source === me && w({ name: Z.target }) === "success"
          ).sort((Z, oe) => $(oe) - $(Z))[0]?.target;
      };
      return q.forEach((de) => te(de.name)), U;
    }, O = (E, Y, U) => {
      const ue = w(E);
      if (ue === "success" && U.has(E.name))
        return U.get(E.name);
      if (ue === "success") {
        const q = Y.filter((te) => te.target === E.name);
      ...
      const U = I(E, Y), ue = z(E, Y);
      return [...E].sort((q, G) => {
        const te = U.get(q.name) ?? 0, de = U.get(G.name) ?? 0;
        if (te !== de) return te - de;
        const me = p[w(q)], F = p[w(G)];
        if (me !== F) return me - F;
        const Z = O(q, Y, ue), oe = O(G, Y, ue);
        return Z !== oe ? Z - oe : q.name.localeCompare(G.name);
      });
    }, B = (E, Y, U, ue) => {
      const G = k(E, ue).split(`
`), te = Y * 0.58, me = Math.max(...G.map((Z) => Z.length), 1) * te, F = G.length * U;
      return {
        lines: G,
        width: me,
        height: F,
    ...
    }, T = (E, Y) => Y ? `${(E / Y * 100).toFixed(1)}%` : "0.0%", N = (E, Y) => typeof E.label == "string" && E.label ? k(b(E.label), Y) : k(b(E.name), Y), H = (E, Y = 0) => {
      if (Y > 0) return Y;
      ...
      if (!Y.length || !E.length || q <= 0) return E;
      const G = E.map((xe) => ({ ...xe })), te = U.labelLineHeight || Math.round(U.labelFontSize * 1.25), de = Math.max(4, U.labelCharsPerLine), me = Math.max(ue * 0.88, 260), F = I(Y, G), Z = /* @__PURE__ */ new Map();
      Y.forEach((xe) => {
        const Te = F.get(xe.name) ?? 0;
        Z.set(Te, (Z.get(Te) ?? 0) + 1);
      });
      const oe = (xe) => {
        const _e = Y.find((tn) => tn.name === xe)?.displayLabel || xe, ft = B(_e, U.labelFontSize, te, de).height + sn * 2, en = F.get(xe) ?? 0, Ot = Z.get(en) ?? 1, Qn = (Math.max(Ot, 1) - 1) * U.nodeGap / Math.max(Ot, 1), Ta = Math.max(me - Qn, ft);
        return Math.max(1, ft / Ta * q);
      }, fe = (xe) => {
        const Te = G.filter((_e) => _e.target === xe);
        return Te.length > 0 ? Te.reduce((_e, je) => _e + je.value, 0) : G.filter((_e) => _e.source === xe).reduce((_e, je) => _e + je.value, 0);
      };
      for (let xe = 0; xe < 16; xe += 1) {
        let Te = !1;
        for (const _e of Y) {
          const je = oe(_e.name), ft = fe(_e.name);
          if (ft >= je) continue;
          const en = G.filter((tn) => tn.target === _e.name), Ot = G.filter((tn) => tn.source === _e.name), Qn = en.length > 0 ? en : Ot;
          if (Qn.length === 0) continue;
          const Ta = je / Math.max(ft, 1e-6);
          Qn.forEach((tn) => {
            tn.value *= Ta;
          }), Te = !0;
        }
      ...
      const ue = M(E, Y), q = D(E, Y), G = U.labelLineHeight || Math.round(U.labelFontSize * 1.25), te = Math.max(4, U.labelCharsPerLine);
      let de = U.nodeWidth;
      const me = [], F = q.map((oe, fe) => {
        const xe = w(oe), Te = N(oe, te);
        me.push(Te);
        const _e = B(Te, U.labelFontSize, G, te);
        U.orient === "vertical" ? de = Math.max(de, _e.height + sn * 2) : de = Math.max(de, _e.nodeWidth);
        const je = n.nodeColors[oe.name] || f[xe] || le[fe % le.length], ft = Math.max(Math.ceil(_e.nodeWidth - sn * 2), 48);
        return {
          ...oe,
          displayLabel: Te,
          label: {
      ...
      if (U.orient === "vertical") {
        const oe = Math.max(
          ...me.map(
            (xe) => B(xe, U.labelFontSize, G, te).width
          ),
          0
        ), fe = typeof Z.right == "number" ? Z.right : 10;
        Z = {
          ...Z,
          right: Math.max(fe, oe + sn + U.labelDistance)
        };
      }
      return { nodes: F, maxNodeWidth: de, contentMargins: Z, originTotal: ue };
    }, le = [
      "#C67DFF",
      // Primary light
      "#8b5cf6",
      ...
      ), Y = Math.max(...E.map((q) => q.value), 1), U = Math.max(1, Y * 0.01), ue = E.map((q) => ({
        ...q,
        originalValue: q.value,
        value: q.value < Y * 0.01 ? U : q.value
      }));
      return {
      ...
      const ue = U.dataType === "node", q = o.value.tooltipText, G = a.value ? "#d1d5db" : "#e2e8f0";
      if (ue) {
        const fe = E.filter((_e) => _e.target === U.name), xe = E.filter((_e) => _e.source === U.name), Te = fe.length > 0 ? fe.reduce((_e, je) => _e + (je.originalValue || je.value), 0) : xe.reduce((_e, je) => _e + (je.originalValue || je.value), 0);
        return `<div style="font-weight: 600; margin-bottom: 4px; color: ${q};">${U.name}</div><div style="color: ${G}; font-size: 12px;">Count: ${Te.toLocaleString()}</div>`;
      }
      const te = U.data?.source || U.source || "Unknown", de = U.data?.target || U.target || "Unknown", me = Number(U.data?.originalValue ?? U.data?.value ?? U.value ?? 0), F = Y.get(String(te)) ?? 0, Z = T(me, F), oe = `${me.toLocaleString()} (${Z})`;
      return `<div style="font-weight: 600; margin-bottom: 4px; color: ${q};">${te} → ${de}</div><div style="color: ${G}; font-size: 12px;">Flow: ${oe}</div>`;
    }, L = () => {
      if (!c || !n.data.nodes?.length || !n.data.links?.length) return;
      const E = y.value, Y = a.value ? "rgba(110, 110, 120, 0.35)" : "rgba(148, 163, 184, 0.45)", U = a.value ? "rgba(130, 130, 140, 0.5)" : "rgba(100, 116, 139, 0.55)", ue = a.value ? "rgba(203, 213, 225, 0.92)" : "#64748b", q = E.labelPosition === "inside" ? "#ffffff" : a.value ? o.value.textPrimary : "#334155";
      try {
        const { nodes: G, links: te } = ge(), { nodes: de, maxNodeWidth: me, contentMargins: F, originTotal: Z } = ne(
          G,
          te,
          E
        ), oe = H(n.height, i.value?.clientHeight ?? 0), fe = Q(
          te,
          de,
          {
          ...
          series: [
            {
              ...
              edgeLabel: E.edgeLabelShow ? {
                ...
                fontFamily: "'Inter', 'DM Sans', sans-serif",
                formatter: (_e) => {
                  const je = Number(_e.data?.originalValue ?? _e.value ?? 0), ft = String(_e.data?.source ?? ""), en = xe.get(ft) ?? 0, Ot = T(je, en);
                  return `${je.toLocaleString()} (${Ot})`;
                }
              } : { show: !1 },
      ...
      await new Promise((E) => {
        ...
        d = new ResizeObserver(() => {
          K() && (d?.disconnect(), d = null, W().then(E));
        }), d.observe(Y);
      });
    }, pe = () => c?.resize(), Ce = () => {
      window.removeEventListener("resize", pe), d?.disconnect(), d = null, c && (c.dispose(), c = null);
    };
    return Qe(() => ie()), ci(Ce), Ee(() => n.data, L, { deep: !0 }), Ee(a, L), Ee(s, L), t({ isDark: a }), (E, Y) => (m(), _("div", dm, [
      l.value ? (m(), _("div", {
        key: 0,
        class: "error-state",
        style: we({ height: e.height })
      }, [...Y[0] || (Y[0] = [
        Ua('<div class="error-content" data-v-a95c5e56><svg class="error-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a95c5e56><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-a95c5e56></path></svg><p class="error-title" data-v-a95c5e56>Chart could not be loaded</p><p class="error-description" data-v-a95c5e56>Please check the data format.</p></div>', 1)
      ])], 4)) : (m(), _("div", {
        key: 1,
        class: "chart-wrapper",
        style: we({ height: e.height })
        ...
        r.value ? (m(), _("div", um, [...Y[1] || (Y[1] = [
          Ua('<div class="loading-container" data-v-a95c5e56><div class="sankey-loader" data-v-a95c5e56><div class="flow flow-1" data-v-a95c5e56></div><div class="flow flow-2" data-v-a95c5e56></div><div class="flow flow-3" data-v-a95c5e56></div><div class="flow flow-4" data-v-a95c5e56></div></div><p class="loading-text" data-v-a95c5e56>Loading Sankey diagram...</p></div>', 1)
        ])])) : V("", !0)
      ], 4))
    ]));
  }
}), Jt = /* @__PURE__ */ ve(hm, [["__scopeId", "data-v-a95c5e56"]]), fm = ["open"], gm = { class: "card-header metric-collapsible__summary" }, mm = { class: "header-content metric-header-content" }, pm = { class: "metric-header-content__main" }, bm = { class: "metric-header-content__text" }, vm = { class: "metric-header-content__loaded" }, ym = {
  key: 0,
  class: "card-title"
}, xm = {
  key: 0,
...
}), $e = /* @__PURE__ */ ve(Vm, [["__scopeId", "data-v-46090b42"]]);
function zm(e, t) {
  return m(), _("svg", {
...
}), hp = /* @__PURE__ */ ve(up, [["__scopeId", "data-v-f8d0ec91"]]), mn = (e, t) => t ? `${(e / t * 100).toFixed(1)}%` : "0.0%", be = (e, t) => `${e.toLocaleString()} (${mn(e, t)})`, fp = { class: "flex w-full min-w-0 justify-center" }, gp = { class: "flex max-w-full min-w-0 items-center gap-2" }, mp = { class: "min-w-0 truncate text-[12px] leading-normal capitalize" }, pp = { class: "text-[14px] font-bold leading-tight text-[color:var(--kiut-text-primary,#1e293b)]" }, bp = {
  key: 0,
...
}), ye = /* @__PURE__ */ ve(vp, [["__scopeId", "data-v-0d546967"]]), dr = "inline-flex w-min max-w-full min-h-[22px] items-center justify-center whitespace-nowrap rounded-full px-3 py-1 text-center text-xs font-['Inter',system-ui,sans-serif] font-semibold leading-snug tracking-tight";
function ur(e, t) {
  switch (e) {
    case "purple":
...
const yp = {
    ...
    return (w, $) => (m(), _("div", xp, [
      u("div", kp, [
        u("table", _p, [
          u("thead", null, [
            u("tr", null, [
              (m(!0), _(se, null, he(e.columns, (M) => (m(), _("th", {
                key: M.key,
                scope: "col",
          ...
          u("tbody", null, [
            (m(!0), _(se, null, he(x.value, (M, S) => (m(), _("tr", {
              key: h(M, S)
            }, [
              (m(!0), _(se, null, he(e.columns, (I) => (m(), _("td", {
                key: `${S}-${I.key}`,
              ...
              i.value.length > 0 ? (m(), _("section", Rp, [
                ...
                u("div", Ep, [
                  j(ut, {
                    ...
                    "cell-date": R(({ row: k }) => [
                      u("span", Fp, A(P(Ye)(String(k.date)).format("MMM DD")), 1)
                    ]),
  ...
  setup(e, { emit: t }) {
    const n = t, a = (w) => {
      ...
      const w = [], $ = [], M = /* @__PURE__ */ new Set(), S = (q, G = {}) => {
        M.has(q) || (w.push({ name: q, ...G }), M.add(q));
      };
      ...
      T ? (H > 0 && (S("Abandoned (Init)", { status: "abandon" }), $.push({
        ...
        value: N,
        label: be(N, I)
      }))) : Y > 0 && (S("Abandoned (Init)", { status: "abandon" }), $.push({
        source: "Checkin Init",
        target: "Abandoned (Init)",
        value: Y,
        label: be(Y, I)
        ...
        value: ge,
        label: be(ge, I)
      })), X > 0 && (S("Abandoned (Started)", { status: "abandon" }), $.push({
        source: "Booking retrive",
        ...
        value: ie,
        label: be(ie, I)
      }), Ce.length > 0 && E > 0 && (S("Unrecovered", { status: "error" }), $.push({
        source: "Number of Passengers",
        target: "Unrecovered",
        value: E,
        label: be(E, I)
      }), Ce.forEach((q) => {
        const te = q.step_name.replace(/_/g, " ").split(" ").map((de) => de.charAt(0).toUpperCase() + de.slice(1)).join(" ");
        S(te, { status: "error" }), $.push({
          source: "Unrecovered",
          target: te,
          value: q.count,
          label: be(q.count, I)
      ...
      const ue = ie - pe;
      return ue > 0 && (S("BP Error", { status: "error" }), $.push({
        source: "Completed",
        target: "BP Error",
        value: ue,
        label: be(ue, I)
          ...
          r.value && r.value.length > 0 ? (m(), _("section", Xp, [
            u("div", Gp, [
              j(ut, {
                ...
                "cell-date": R(({ row: M }) => [
                  u("span", Zp, A(P(Ye)(String(M.date)).format("MMM DD")), 1)
                ]),
                ...
                "cell-reasons": R(({ row: M }) => [
                  M.failed_steps && M.failed_steps.length > 0 ? (m(), _("div", e0, [
                    (m(!0), _(se, null, he(M.failed_steps, (S) => (m(), _("div", {
                      key: S.step_name,
                      class: "reason-item"
                    }, [
  ...
  setup(e, { expose: t, emit: n }) {
    const a = e, o = n, s = (x) => {
      ...
      return Ye([k, w - 1, $]).format("MMM DD");
    }, c = (x) => x.replace(/_/g, " ").replace(/\b\w/g, (k) => k.toUpperCase()), d = (x, k) => mn(x, k), h = (x, k) => {
      ...
      const x = [], k = [], w = /* @__PURE__ */ new Set(), $ = (Y, U = {}) => {
        w.has(Y) || (x.push({ name: Y, ...U }), w.add(Y));
      };
              ...
              j(ut, {
                ...
                "cell-reasons": R(({ row: w }) => [
                  Array.isArray(w.failed_steps) && w.failed_steps.length > 0 ? (m(), _("div", f0, [
                    (m(!0), _(se, null, he(w.failed_steps, ($) => (m(), _("div", {
                      key: $.step_name,
                      class: "reason-item"
                    }, [
  ...
  setup(e, { emit: t }) {
    ...
    }), h = (y, b) => mn(y, b), f = (y) => Le(y), p = (y) => (y ?? []).reduce((b, x) => b + (x.count ?? 0), 0), g = (y) => typeof y.sell_success_count == "number" ? y.sell_success_count : p(y.payment_success_total), v = C(() => {
          ...
          i.value && i.value.length > 0 ? (m(), _("section", N0, [
            ...
            u("div", j0, [
              j(ut, {
                ...
                "cell-date": R(({ row: x }) => [
                  u("span", H0, A(P(Ye)(String(x.date)).format("MMM DD")), 1)
                ]),
                ...
                "cell-voluntary": R(({ row: x }) => [
                  u("div", X0, [
                    (m(!0), _(se, null, he([x], (k, w) => (m(), _(se, { key: w }, [
                      j(qe, {
                        color: "neutral",
                        outlined: !0
                      }, {
                      ...
                      (m(!0), _(se, null, he(k.payment_success_total || [], ($) => (m(), ee(qe, {
                        key: `${k.date}-${$.currency}`,
                        color: "neutral"
                      }, {
                        default: R(() => [
        ...
        u("div", eb, [
          u("div", tb, [
            c.value.labels && c.value.labels.length ? (m(), _("section", nb, [
              ...
              u("div", ob, [
                (m(!0), _(se, null, he(h.value, (v) => (m(), ee(ye, {
                  key: v.name,
                  class: "min-w-0",
                  color: v.color,
                  title: v.label,
  ...
  setup(e, { expose: t, emit: n }) {
    const a = {
      ...
      return {
        labels: g.map((x) => Ye(x).format("MMM DD")),
        datasets: b
      };
    }), d = C(() => {
  ...
  setup(e, { expose: t, emit: n }) {
    const a = e, o = n, s = (y) => {
      ...
      const y = [], b = [], x = /* @__PURE__ */ new Set(), k = (K) => {
          ...
          r.value && r.value.length > 0 ? (m(), _("section", kb, [
            u("div", _b, [
              j(ut, {
                ...
                "cell-date": R(({ row: x }) => [
                  u("span", wb, A(P(Ye)(String(x.date)).format("MMM DD")), 1)
                ]),
  ...
  setup(e, { expose: t, emit: n }) {
    ...
    const p = C(() => {
      ...
      const v = g.map((b) => Ye(b.date).format("MMM-DD")), y = c.value.map((b, x) => ({
        label: b,
      ...
      default: R(() => [
        u("div", Eb, [
          ...
          e.channelComparison.length > 0 ? (m(), _("section", Vb, [
            u("div", zb, [
              (m(!0), _(se, null, he(e.channelComparison, (y, b) => (m(), ee(P(ye), {
                key: y.channel,
                color: d(y.channel, b),
                title: h(y.channel),
...
${w(D)}`, M = C(() => {
      ...
      const ie = ge.reduce(
        (E, Y) => (Y.reasons && Array.isArray(Y.reasons) && Y.reasons.forEach((U) => {
          const ue = U.reason, q = U.failed_count;
          E[ue] = (E[ue] || 0) + q;
        }), E),
        {}
      );
      ...
      if (Ce > 0 && (L.push({
        ...
        Object.entries(ie).filter(([, U]) => U > 0).sort(([, U], [, ue]) => ue - U).forEach(([U, ue]) => {
          const q = `Failed: ${U}`;
          L.push({
            name: q,
            value: ue,
...
Without Reason`
      ...
      return `${T} (${N})`;
    }, z = (D) => D == null ? 0 : typeof D == "number" ? D : Array.isArray(D) ? D.reduce((B, T) => B + (T.total_value || 0), 0) : 0, O = (D) => Vt(z(D));
    return t({ isDark: r }), (D, B) => (m(), ee($e, {
          ...
          l.value && l.value.length > 0 ? (m(), _("section", Ub, [
            u("div", qb, [
              j(ut, {
                ...
                "cell-date": R(({ row: T }) => [
                  u("span", Xb, A(P(Ye)(String(T.date)).format("MMM DD")), 1)
                ]),
                ...
                "cell-btValue": R(({ row: T }) => [
                  u("span", tv, [
                    Array.isArray(
                      ...
                      (m(!0), _(se, null, he(T.daily_value_sell_success_bank_transfer, (N) => (m(), _("span", {
                ...
                "cell-coValue": R(({ row: T }) => [
                  u("span", iv, [
                    Array.isArray(
                      ...
                      (m(!0), _(se, null, he(T.daily_value_sell_success_cash, (N) => (m(), _("span", {
                ...
                "cell-totalSalesValue": R(({ row: T }) => [
                  u("span", uv, [
                    Array.isArray(T.daily_value_sell_success) && T.daily_value_sell_success.length > 0 ? (m(), _("div", hv, [
                      (m(!0), _(se, null, he(T.daily_value_sell_success, (N) => (m(), _("span", {
                ...
                "cell-failed": R(({ row: T }) => [
                  (T.reasons || []).length > 0 ? (m(), _("div", gv, [
                    (m(!0), _(se, null, he(T.reasons || [], (N) => (m(), _("div", {
                      key: N.reason,
  ...
  setup(e, { expose: t, emit: n }) {
    ...
    }), l = C(() => r.value.payment_method_breakdown && r.value.payment_method_breakdown.length > 0), c = C(() => r.value.payment_method_by_day && r.value.payment_method_by_day.length > 0), d = C(() => !r.value.payment_method_by_day || r.value.payment_method_by_day.length === 0 ? [] : [...r.value.payment_method_by_day].sort((S, I) => Ye(S.date).valueOf() - Ye(I.date).valueOf())), h = [
    ...
    }, k = (S) => S ? Ye(S).format("MMM DD") : "-", w = (S) => S == null || Number.isNaN(Number(S)) ? 0 : Number(S), $ = (S) => {
      o("export", S);
    };
    function M() {
      const S = a.data;
      ...
      default: R(() => [
        u("div", Av, [
          l.value ? (m(), _("section", Tv, [
            ...
            u("div", Bv, [
              (m(!0), _(se, null, he(r.value.payment_method_breakdown, (z, O) => (m(), ee(ye, {
            ...
            u("div", Ev, [
              j(ut, {
                ...
                "cell-totalAmount": R(({ row: z }) => [
                  u("span", Vv, [
                    Array.isArray(z.total_amount_by_currency) && z.total_amount_by_currency.length > 0 ? (m(), _("div", zv, [
                      (m(!0), _(se, null, he(z.total_amount_by_currency, (O) => (m(), _("span", {
                ...
                "cell-paymentMethods": R(({ row: z }) => [
                  u("div", Nv, [
                    (m(!0), _(se, null, he(Array.isArray(z.payment_methods) ? z.payment_methods : [], (O) => (m(), _("div", {
...
const st = "mb-1.5 block text-sm font-medium text-[color:var(--kiut-text-primary)] dark:text-slate-100", at = "min-h-[2.75rem] w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm font-sans text-[color:var(--kiut-text-primary)] shadow-sm outline-none transition placeholder:text-[color:var(--kiut-text-muted)] focus:border-[color:var(--kiut-primary)] focus:ring-2 focus:ring-[color:var(--kiut-primary)]/25 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:border-[color:var(--kiut-border-light)] dark:bg-[color:var(--kiut-bg-secondary)] dark:text-slate-100 dark:placeholder:text-slate-500", uy = "min-h-[5.5rem] w-full resize-y rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm font-sans leading-normal text-[color:var(--kiut-text-primary)] shadow-sm outline-none transition placeholder:text-[color:var(--kiut-text-muted)] focus:border-[color:var(--kiut-primary)] focus:ring-2 focus:ring-[color:var(--kiut-primary)]/25 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:border-[color:var(--kiut-border-light)] dark:bg-[color:var(--kiut-bg-secondary)] dark:text-slate-100 dark:placeholder:text-slate-500", At = "border-red-500 focus:border-red-500 focus:ring-red-500/25 dark:border-red-400", Tt = "mt-1 text-xs font-medium text-red-600 dark:text-red-400", hy = ["disabled", "aria-expanded", "aria-labelledby", "aria-label"], fy = {
  ...
  setup(e, { emit: t }) {
    ...
    const x = C(() => n.options.filter((X) => !X.disabled)), k = C(() => {
      ...
      return X ? x.value.filter((L) => L.label.toLowerCase().includes(X)) : x.value;
    }), w = C(
    ...
    function I(X, L) {
      ...
      return [
        ...
        !W && K ? "bg-slate-100 dark:bg-white/5" : ""
      ];
    }
    function z() {
      g.value = Math.max(
    ...
    function H(X) {
      X.stopPropagation(), !n.disabled && N();
    }
    function Q(X) {
      if (!p.value) return;
      const L = X.target, W = l.value, K = d.value;
      W && !W.contains(L) && (!K || !K.contains(L)) && B();
    }
    function ne(X) {
      n.disabled || (X.key === "ArrowDown" || X.key === "Enter" || X.key === " ") && (X.preventDefault(), p.value || (p.value = !0, D()));
    }
    function le(X) {
      const L = k.value;
      if (X.key === "Escape") {
      ...
      (m(), ee(un, { to: "body" }, [
        Ze(u("div", {
          ...
          u("ul", {
            ...
            (m(!0), _(se, null, he(k.value, (W, K) => (m(), _("li", {
              key: M(W),
              role: "option",
              "aria-selected": S(W),
              class: J(I(W, K)),
              onClick: Oe((ie) => T(W), ["stop"]),
              onMouseenter: (ie) => g.value = K
            }, [
  ...
  setup(e, { expose: t, emit: n }) {
    ...
    function l(E) {
      const Y = E?.trim() ?? "";
      return Y.length > 0 && !r.has(Y);
    }
    function c(E) {
      if (!l(E.agent_email)) return !1;
      const Y = E.assigned_count ?? 0, U = E.closed_count ?? 0;
      return Y > 0 || U > 0;
    }
    function d(E) {
    ...
    function k(E, Y) {
      return Y == null ? null : Y === 0 ? E > 0 ? 100 : 0 : (E - Y) / Y * 100;
    }
    function w(E) {
      const Y = E.toFixed(1);
      return E > 0 ? `+${Y}%` : `${Y}%`;
    ...
    function S(E) {
      ...
      if (!Y) return null;
      if (Y.includes(":")) {
        const ue = Y.split(":").map(Number);
        return ue.length !== 3 || ue.some(isNaN) ? null : ue[0] * 3600 + ue[1] * 60 + ue[2];
      }
      const U = Number(Y);
      return Number.isFinite(U) ? U : null;
    }
    function I(E) {
      const Y = Math.round(E), U = Math.floor(Y / 3600), ue = Math.floor(Y % 3600 / 60), q = Y % 60;
      return `${String(U).padStart(2, "0")}:${String(ue).padStart(2, "0")}:${String(q).padStart(2, "0")}`;
    }
    function z(E) {
      const Y = S(E);
      return Y === null ? "—" : typeof E == "string" && E.includes(":") ? E.trim() : I(Y);
    }
    ...
    function le(E) {
      ...
      for (const U of E) {
        ...
        const q = Y.get(ue), G = U.assigned_count ?? 0, te = U.closed_count ?? 0;
        q.handled += d(U), U.agent_name?.trim() && (q.agent_name = U.agent_name.trim());
        const de = S(U.avg_time_to_assign_seconds);
        de !== null && G > 0 && (q.assignSum += de * G, q.assignWeight += G);
        const me = S(U.avg_conversation_duration_seconds);
        me !== null && te > 0 && (q.resolutionSum += me * te, q.resolutionWeight += te);
      }
      return Array.from(Y.values()).map((U, ue) => {
        const q = U.assignWeight > 0 ? U.assignSum / U.assignWeight : null, G = U.resolutionWeight > 0 ? U.resolutionSum / U.resolutionWeight : null;
        return {
          id: `agg-${U.agent_email}-${ue}`,
          ...
          avg_resolution_display: G !== null ? I(G) : "—"
        };
      });
    }
    const ge = C(() => {
    ...
    function X(E, Y, U, ue) {
      ...
      switch (U) {
        case "date":
          G = (E.dateSort ?? 0) - (Y.dateSort ?? 0);
          break;
        case "name":
          G = (E.agent_name || "").localeCompare(Y.agent_name || "", void 0, {
            sensitivity: "base"
          });
          break;
        case "email":
          G = E.agent_email.localeCompare(Y.agent_email, void 0, {
            sensitivity: "base"
          });
          break;
        case "handled":
          G = E.handled - Y.handled;
          break;
        case "avgAssignation":
          G = (E.avg_assignation_seconds ?? Number.NEGATIVE_INFINITY) - (Y.avg_assignation_seconds ?? Number.NEGATIVE_INFINITY);
          break;
        case "avgResolution":
          G = (E.avg_resolution_seconds ?? Number.NEGATIVE_INFINITY) - (Y.avg_resolution_seconds ?? Number.NEGATIVE_INFINITY);
          break;
      }
      if (G !== 0) return G * q;
      if (v.value === "by_date" && U !== "date") {
        const te = (Y.dateSort ?? 0) - (E.dateSort ?? 0);
        if (te !== 0) return te;
      }
      return (E.agent_name || "").localeCompare(Y.agent_name || "", void 0, {
        sensitivity: "base"
      });
    }
    const L = C(() => {
      const E = [...ge.value];
      return E.sort((Y, U) => X(Y, U, b.value, x.value)), E;
    }), W = C(
      () => L.value
    ), K = C(() => {
      const E = [];
    ...
    function ie(E) {
      ...
      b.value = Y, Y === "date" ? x.value = "desc" : Y === "name" || Y === "email" ? x.value = "asc" : x.value = "desc";
    }
    const pe = (E) => E == null ? "0" : ce(E), Ce = (E) => new Date(E).toLocaleDateString("en-US", {
      month: "short",
      day: "numeric"
    });
    return t({ isDark: i }), (E, Y) => (m(), ee($e, {
      class: "agent-human-conv-root h-full min-h-0",
      title: "Agent Human Conversations",
      subtitle: "Human conversation assignments and closures by agent",
      loading: e.loading,
      "lazy-mount": "",
      onOpen: Y[1] || (Y[1] = (U) => o("open"))
    }, {
      headerExport: R(() => [
        e.enableExport && !e.loading ? (m(), ee(P(Ve), {
          key: 0,
          ...
          p.value ? (m(), ee($e, {
            ...
            headerAside: R(() => [
              u("div", wy, [
                j(Do, {
                  modelValue: v.value,
                  "onUpdate:modelValue": Y[0] || (Y[0] = (U) => v.value = U),
                  options: y,
            ...
            _: 1
          })) : g.value ? V("", !0) : (m(), _("div", By, [...Y[6] || (Y[6] = [
            u("div", { class: "empty-state-content" }, [
              u("div", { class: "empty-icon-wrapper" }, [
                u("svg", {
                  class: "empty-icon",
          ...
          u("div", Ey, [
            c.value.labels && c.value.labels.length ? (m(), _("section", Fy, [
              ...
              f.value.length ? (m(), _("div", {
                ...
                (m(!0), _(se, null, he(f.value, (b) => (m(), ee(ye, {
                  key: b.name,
                  class: "min-w-0",
                  color: b.color,
                  title: b.label,
            ...
            p.value.length > 0 ? (m(), _("section", h1, [
              u("div", f1, [
                j(ut, {
                  ...
                  "cell-date": R(({ row: x }) => [
                    u("span", g1, A(P(Ye)(String(x.date)).format("MMM DD")), 1)
                  ]),
                  "cell-count": R(({ row: x }) => [
                  ...
                  "cell-types": R(({ row: x }) => [
                    u("div", p1, [
                      (m(!0), _(se, null, he(x.types, (k) => (m(), _("span", {
                        key: k.type,
  ...
  setup(e, { expose: t, emit: n }) {
    const a = e, o = n, s = ($) => {
      ...
      ].sort(), z = I.map((B) => Ye(B).format("MMM DD")), O = I.map((B) => {
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: s, changePercent: i }), (r, l) => (m(), ee(Mt, {
  ...
  setup(e, { emit: t }) {
    const n = t, a = (c) => {
      ...
      labels: s.value.map((c) => Ye(c.date).format("DD-MM-YYYY")),
      datasets: [
        {
          label: "CSAT P95",
  ...
  setup(e, { expose: t, emit: n }) {
    const a = e, o = n, s = Me(a, "theme"), { isDark: i, colors: r } = De(s), l = ae(a.breakdownBy), c = ae("local"), d = C(() => a.data?.currency ?? "USD"), h = C(
      ...
      const H = [...T].sort((X, L) => X.date.localeCompare(L.date)), Q = H.map((X) => Ye(X.date).format("MMM DD")), ne = c.value === "usd" ? "ai_revenue_usd" : "ai_revenue";
      if (l.value === "all") {
        x.value = {
          labels: Q,
          datasets: [
      ...
      const ge = N.slice(0, 7).map((X) => X.key).map((X, L) => {
        const W = v(L), K = H.map((ie) => {
          const pe = (ie.breakdown ?? {})[X];
      ...
      x.value = { labels: Q, datasets: ge }, k.value = N.slice(0, 5).map((X, L) => {
        const W = c.value === "usd" ? X.total_usd : X.total;
        return {
          key: X.key,
          label: b(X.key),
          amount: `${h.value} ${y(W)}`,
      ...
      headerAside: R(() => [
        u("div", yx, [
          ...
          d.value !== "USD" ? (m(), _("div", xx, [
            (m(!0), _(se, null, he(f.value, (N) => (m(), _("button", {
              key: N.value,
              class: J([
              ...
              a.loading ? (m(), _("div", _x, [...T[2] || (T[2] = [
                ...
                x.value.labels && x.value.labels.length && x.value.datasets.length ? (m(), _("section", Cx, [
                  ...
                  k.value.length ? (m(), _("div", {
                    ...
                    (m(!0), _(se, null, he(k.value, (N) => (m(), ee(ye, {
                      key: `card-${N.key}`,
                      class: "min-w-0",
                      color: N.color,
                      title: N.label,
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: o, changePercent: c }), (f, p) => (m(), ee(Mt, {
      label: "Cost",
      value: r.value,
      prefix: "USD",
      loading: e.loading,
  ...
  setup(e, { expose: t, emit: n }) {
    const a = e, o = n, s = (w) => {
      ...
      if (l.value === "all") {
        ...
        d.value = {
          labels: B.map((T) => Ye(T.date).format("MMM DD")),
          datasets: [
            {
              label: "All",
              data: B.map(
      ...
      ), I = M.slice(0, 5).map((D) => D.key), z = S.map((D) => Ye(D.date).format("MMM DD")), O = I.map((D, B) => {
          ...
          u("div", Px, [
            d.value.labels && d.value.labels.length && d.value.datasets.length ? (m(), _("section", Ix, [
              ...
              h.value.length ? (m(), _("div", {
                ...
                (m(!0), _(se, null, he(h.value, (M) => (m(), ee(ye, {
                  key: `card-${M.key}`,
                  class: "min-w-0",
                  color: M.color,
                  title: M.label,
  ...
  setup(e, { emit: t }) {
    ...
    function h(g, v) {
      a("tab-click", { value: g.value, originalEvent: v }), !g.disabled && (d(g.value, n.modelValue), We(() => {
    ...
    async function p(g, v) {
      ...
      const x = n.items[b];
      !x || x.disabled || (d(x.value, n.modelValue), await We(), o.value[b]?.focus());
    }
    return (g, v) => (m(), _("div", e_, [
      u("div", {
        ...
        (m(!0), _(se, null, he(e.items, (y, b) => (m(), _("button", {
          id: i(y.value),
          key: y.value,
          ref_for: !0,
          ref_key: "tabRefs",
...
const R_ = { class: "kiut-table-wrap overflow-hidden rounded-xl border border-[#e5e7eb] bg-[color:var(--kiut-bg-secondary)] shadow-sm dark:border-[color:var(--kiut-border-light)]" }, E_ = { class: "w-full overflow-x-auto overflow-y-auto md:overflow-y-hidden" }, F_ = { class: "h-12 border-b border-[#e5e7eb] bg-[#eaeaec80] dark:border-[color:var(--kiut-border-light)] dark:bg-[#23232f80]" }, O_ = {
  ...
  setup(e, { emit: t }) {
    const n = e, a = t, o = ae(null), s = ae([...n.defaultExpandedKeys]), i = C({
      ...
      const { sortKey: L, sortDirection: W, sortCompare: K, rows: ie } = n;
      return !L || !W || !K ? ie : n.expandable ? xr(ie, {
        childrenKey: n.childrenKey,
        sortKey: L,
        sortDirection: W,
        compare: K
      }) : [...ie].sort((pe, Ce) => K(pe, Ce, L, W));
    ...
    const D = C(() => {
      ...
      })).filter(({ row: W, context: K }) => M(W, K)).map(({ key: W }) => W);
    });
    function B(L) {
      const W = String(L);
      return n.selectedKeys.some((K) => String(K) === W);
    }
    const T = C(() => !n.selectable || D.value.length === 0 ? !1 : D.value.every(
      ...
      const L = D.value.filter(
        (W) => n.selectedKeys.some((K) => String(K) === String(W))
      );
    ...
    function Q(L) {
      ...
      const W = String(L), K = h.value.find((pe) => String(pe.key) === W);
      if (K && !S(K) || !K && !D.value.some((pe) => String(pe) === W))
        return;
        ...
        u("table", {
          ...
          u("thead", null, [
            u("tr", F_, [
              ...
              (m(!0), _(se, null, he(e.columns, (K) => (m(), _("th", {
                key: K.key,
                scope: "col",
                class: J([
          ...
          u("tbody", null, [
            (m(!0), _(se, null, he(h.value, (K) => (m(), _("tr", {
              key: K.key,
              class: J([
              ...
              (m(!0), _(se, null, he(e.columns, (ie) => (m(), _("td", {
                key: ie.key,
                class: J([
                ...
                b(ie.key) ? (m(), _("div", {
                  ...
                  ke(L.$slots, "row-expand", {
                    ...
                    z(K) ? (m(), _("button", {
                      ...
                      "aria-expanded": K.isExpanded,
                      "aria-label": K.isExpanded ? e.ariaLabelCollapseRow : e.ariaLabelExpandRow,
                      onClick: Oe((pe) => w(K), ["stop"])
                    }, [
                      j(P(Qt), {
                        class: J(["h-5 w-5 text-[color:var(--kiut-text-muted)] transition-transform duration-200", { "-rotate-90": !K.isExpanded }]),
                        "aria-hidden": "true"
                      }, null, 8, ["class"])
                    ], 8, U_)) : O(K) ? (m(), _("span", q_)) : V("", !0)
                  ], !0),
                  u("div", X_, [
                    ke(L.$slots, f(ie.key), mt({ ref_for: !0 }, k(K, ie)), () => [
                      Ae(A(y(v(K.row, ie.key))), 1)
                    ], !0)
                  ])
                ], 4)) : ke(L.$slots, f(ie.key), mt({
                  key: 1,
                  ref_for: !0
                }, k(K, ie)), () => [
                  Ae(A(y(v(K.row, ie.key))), 1)
  ...
  setup(e, { emit: t }) {
    const n = e, a = t, o = Ca(), s = C(
      ...
      const { class: L, type: W, "aria-label": K, ...ie } = o;
      return ie;
    ...
    function D() {
      const L = w.value;
      if (!L) return;
      const W = L.getBoundingClientRect(), K = {
        top: `${W.bottom - 3}px`,
        minWidth: `max(${W.width}px, ${n.menuMinWidth})`
      };
      n.menuAlign === "right" ? (K.right = `${window.innerWidth - W.right}px`, K.left = "auto") : (K.left = `${W.left}px`, K.right = "auto"), I.value = K;
    }
    function B(L) {
      return [
    ...
    function le(L) {
      if (!M.value) return;
      const W = L.target, K = k.value, ie = $.value;
      K && !K.contains(W) && (!ie || !ie.contains(W)) && T();
    }
    function ge(L) {
    ...
    return Qe(() => {
      ...
      (m(), ee(un, { to: "body" }, [
        Ze(u("div", {
          ...
          (m(!0), _(se, null, he(z.value, (K, ie) => (m(), _("button", {
            key: O(K),
            type: "button",
            role: "menuitem",
            disabled: K.disabled,
            class: J(B(ie)),
            onClick: Oe((pe) => Q(K), ["stop"]),
            onMouseenter: (pe) => S.value = ie
          }, [
            K.icon ? (m(), _("span", n2, [
              (m(), ee(St(K.icon), { class: "h-5 w-5" }))
            ])) : (m(), _("span", a2)),
            u("span", o2, [
              u("span", s2, A(K.label), 1),
              K.description ? (m(), _("span", i2, A(K.description), 1)) : V("", !0)
            ])
          ], 42, t2))), 128))
        ], 36), [
          [Xt, M.value]
      ...
      (m(), ee(un, { to: "body" }, [
        Ze(u("div", {
          ...
          (m(!0), _(se, null, he(z.value, (K, ie) => (m(), _("button", {
            ...
            u("span", h2, [
              u("span", f2, A(K.label), 1),
              K.description ? (m(), _("span", g2, A(K.description), 1)) : V("", !0)
            ])
          ], 42, c2))), 128))
        ], 36), [
          [Xt, M.value]
    ...
    return (D, B) => (m(), _("div", $2, [
      u("div", S2, [
        u("table", M2, [
          u("thead", null, [
            u("tr", D2, [
              (m(!0), _(se, null, he(e.columns, (T) => (m(), _("th", {
                key: T.key,
                scope: "col",
                class: J([
          ...
          u("tbody", null, [
            (m(!0), _(se, null, he(e.rows, (T, N) => (m(), _(se, {
              key: g(T, N)
            }, [
              u("tr", A2, [
                (m(!0), _(se, null, he(e.columns, (H) => (m(), _("td", {
                  key: H.key,
                  class: J([
                  ...
                  ke(D.$slots, c(H.key), mt({ ref_for: !0 }, d(T, H, N)), () => [
                    p(H.key) ? (m(), _("div", T2, [
                      u("button", {
                        type: "button",
              ...
              v(T, N) ? (m(), _("tr", P2, [
                u("td", {
                  ...
                  y(T) ? (m(), _("div", {
                    ...
                    (m(!0), _(se, null, he(e.historySkeletonCount, (H) => (m(), _("div", {
                      key: H,
                    ...
                    (m(!0), _(se, null, he(T.versions, (H) => (m(), _("div", {
                      key: H.id,
                      class: "flex flex-wrap items-center gap-3 rounded-lg border border-[#e5e7eb] bg-[color:var(--kiut-bg-secondary)] px-4 py-3 dark:border-[color:var(--kiut-border-light)]"
                    }, [
...
const U2 = ["aria-label"], q2 = { class: "flex flex-wrap items-center gap-x-2 gap-y-1.5" }, X2 = { class: "shrink-0 font-medium text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, G2 = { class: "flex min-w-0 flex-1 flex-wrap items-center gap-1.5" }, Z2 = ["aria-label", "aria-expanded", "aria-controls", "onClick"], Q2 = { class: "truncate" }, J2 = {
  ...
  setup(e, { emit: t }) {
    ...
    function O(F) {
      ...
      if (F.type === "select") {
        const je = $(Z).map((ft) => F.options.find((Ot) => Ot.value === ft)?.label ?? ft);
        return `${oe}: ${je.join(", ")}`;
      }
      const fe = Z, xe = B(fe.start), Te = B(fe.end);
      return `${oe}: ${xe} – ${Te}`;
    }
    function D(F) {
    ...
    function N(F) {
      return M(F, w(F.id)) ? q(F) : `Editar filtro ${F.label.replace(/^\+\s*/, "")}`;
    }
    function H(F) {
      const Z = w(F.id);
      if (F.type === "text") {
    ...
    function ne(F) {
      ...
      Z >= 0 ? g.value = g.value.filter((oe, fe) => fe !== Z) : g.value = [...g.value, F], Q();
    }
    function le(F) {
      if (!F) return;
      f.value = F;
      ...
      let fe = Z.left;
      const xe = window.innerWidth - oe - 12;
    ...
    function ge(F, Z) {
      ...
      d.value && c.value !== F.id && ie(), c.value = F.id, d.value = !0, H(F), We().then(async () => {
        le(Z.currentTarget), await We(), L();
      });
    }
    function X(F, Z) {
      if (c.value === F.id && d.value) {
    ...
    function K(F) {
      ...
      if (Z.type === "select") {
        g.value = Array.isArray(F) ? F.filter((fe) => typeof fe == "string") : $(F);
        return;
      }
      const oe = F;
      v.value = oe?.start?.trim() ?? "", y.value = oe?.end?.trim() ?? "";
    ...
    function ie() {
      ...
      if (!F) return;
      if (F.type === "text") {
        const xe = p.value.trim(), Te = { ...n.modelValue };
        xe === "" ? delete Te[F.id] : Te[F.id] = xe, a("update:modelValue", Te), a("change", Te), W();
        return;
      }
      if (F.type === "select") {
        Q(), W();
      ...
      const Z = v.value.trim(), oe = y.value.trim(), fe = { ...n.modelValue };
      !Z || !oe || Z > oe ? delete fe[F.id] : fe[F.id] = { start: Z, end: oe }, a("update:modelValue", fe), a("change", fe), W();
    }
    function pe(F) {
      const Z = { ...n.modelValue };
    ...
    function Ce(F) {
      ...
      const Z = { ...n.modelValue }, fe = $(Z[F.def.id]).filter((xe) => xe !== F.optionValue);
      fe.length === 0 ? delete Z[F.def.id] : Z[F.def.id] = fe, a("update:modelValue", Z), a("change", Z), c.value === F.def.id && H(F.def);
    }
    function E() {
      const F = {};
    ...
    function U(F) {
      ...
      return F.kind === "select" ? `Quitar ${F.def.options.find((xe) => xe.value === F.optionValue)?.label ?? F.optionValue} del filtro ${Z}` : `Quitar filtro ${Z}`;
    }
    function ue(F) {
      const Z = F.def.label.replace(/^\+\s*/, "");
      if (F.kind === "select") {
        const fe = F.def.options.find((xe) => xe.value === F.optionValue)?.label ?? F.optionValue;
    ...
    return Qe(() => {
      document.addEventListener("mousedown", te, !0), window.addEventListener("keydown", de, !0), window.addEventListener("resize", me);
    }), ci(() => {
      document.removeEventListener("mousedown", te, !0), window.removeEventListener("keydown", de, !0), window.removeEventListener("resize", me);
    }), Ee(
      () => n.modelValue,
      () => {
        const F = b.value;
      ...
      u("div", q2, [
        ...
        u("div", G2, [
          (m(!0), _(se, null, he(e.filterDefinitions, (oe) => (m(), _("button", {
            key: `pill-${oe.id}`,
            ref_for: !0,
            ref: (fe) => k(oe.id, fe),
            type: "button",
      ...
      S.value ? (m(), _("div", ew, [
        u("div", tw, [
          (m(!0), _(se, null, he(I.value, (oe) => (m(), _("div", {
            key: oe.key,
            ...
            F.$slots.panel ? ke(F.$slots, "panel", {
              ...
              b.value.type === "text" ? (m(), _(se, { key: 0 }, [
                ...
                u("ul", {
                  ...
                  (m(!0), _(se, null, he(b.value.options, (oe) => (m(), _("li", {
                    key: oe.value
                  }, [
                    u("label", uw, [
                      u("input", {
    ...
    return (S, I) => (m(), _("div", jw, [
      ...
      e.multiple ? (m(), _("div", qw, [
        ...
        c.value.length > 0 ? (m(), _("ul", Jw, [
          (m(!0), _(se, null, he(c.value, (z) => (m(), _("li", {
            key: z.id,
  ...
  setup(e, { emit: t }) {
    ...
    return (g, v) => (m(), _("div", mt({ class: "font-sans flex w-full flex-col gap-2" }, g.$attrs), [
      e.label ? (m(), _("label", {
        key: 0,
        for: r.value,
        class: J(P(st))
...
const sC = ["disabled", "aria-expanded", "aria-label"], iC = {
    ...
    return Qe(() => {
      ...
      (m(), ee(un, { to: "body" }, [
        Ze(u("div", {
          ...
          u("div", uC, [
            b.value.length > 0 ? (m(!0), _(se, { key: 0 }, he(b.value, (H) => (m(), _("section", {
              key: H.id
            }, [
              u("h3", hC, A(H.label), 1),
              u("div", fC, [
                (m(!0), _(se, null, he(H.emojis, (Q) => (m(), _("button", {
                  key: `${H.id}-${Q}`,
                  type: "button",
                  disabled: e.disabled,
  ...
  setup(e, { emit: t }) {
    ...
    return Qe(() => {
      ...
      u("button", {
        ...
        u("div", xC, [
          g.value.length === 0 ? (m(), _("span", kC, A(e.placeholder), 1)) : (m(), _("div", _C, [
            (m(!0), _(se, null, he(g.value, (B) => (m(), _("span", {
              key: y(B),
      ...
      Ze(u("ul", {
        ...
        (m(!0), _(se, null, he(f.value, (B, T) => (m(), _("li", {
          key: y(B),
          role: "option",
          "aria-selected": b(B),
          class: J(x(B, T)),
  ...
  setup(e, { emit: t }) {
    ...
    return (l, c) => (m(), _("div", {
      ...
      u("div", FC, [
        (m(!0), _(se, null, he(e.items, (d) => (m(), _("button", {
          key: d.value,
          type: "button",
          class: J(i(d)),
          "aria-checked": s(d),
  ...
  setup(e, { emit: t }) {
    ...
    return (v, y) => (m(), _("div", {
      ...
      (m(!0), _(se, null, he(e.items, (b, x) => (m(), _("button", {
        id: s(b.value),
        key: b.value,
        ref_for: !0,
        ref: (k) => r(k, x),
...
const a$ = ["aria-expanded", "aria-labelledby", "aria-label"], o$ = ["onKeydown"], s$ = { class: "min-w-0 flex-1 overflow-x-hidden p-3" }, i$ = { class: "mb-4 flex items-center justify-between gap-2" }, r$ = { class: "flex min-w-0 flex-1 justify-center text-center text-[#61616b] dark:text-[#e3e3e8]" }, l$ = { class: "min-w-0 truncate px-1 text-sm font-medium sm:hidden" }, c$ = { class: "hidden min-w-0 flex-1 justify-center gap-4 sm:flex" }, d$ = { class: "w-[252px] min-w-0 truncate text-sm font-medium" }, u$ = { class: "w-[252px] min-w-0 truncate text-sm font-medium" }, h$ = { class: "flex flex-col items-center gap-4 sm:flex-row sm:items-start" }, f$ = { class: "mb-2 grid grid-cols-7 text-center text-xs font-medium tracking-wide text-[#61616b] font-normal text-[0.8rem]" }, g$ = { class: "grid grid-cols-7 gap-y-2 mt-2" }, m$ = ["disabled", "onClick"], p$ = "rounded-lg text-[#61616b]", b$ = "rounded-lg text-[#17171C] hover:bg-[#895af6] hover:text-white dark:text-[#e3e3e8] dark:hover:bg-[#895af6] dark:hover:text-white", v$ = "opacity-30", y$ = "bg-[#6b35e9] font-medium text-white", x$ = "bg-[#895af6] font-semibold text-white", k$ = /* @__PURE__ */ re({
  ...
  setup(e, { emit: t }) {
    const n = e, a = t, s = `${`kiut-drp-${Ne()}`}-lbl`, i = ae(null), r = ae(null), l = ae(!1), c = ae(null), d = ae(Et(/* @__PURE__ */ new Date())), h = C(() => !!(n.modelValue.start && n.modelValue.end)), f = C(() => {
      ...
      const D = et(n.modelValue.start), B = et(n.modelValue.end);
      return `${wa(D)} – ${wa(B)}`;
    });
    function x(D, B) {
    ...
    function k(D) {
      const B = He(D);
      if (n.minDate) {
        const T = He(et(n.minDate));
        if (qt(B, T)) return !0;
      }
      if (n.maxDate) {
        const T = He(et(n.maxDate));
        if (qt(T, B)) return !0;
      }
      return !1;
    }
    ...
    function $(D, B) {
      const T = x(B, D), N = k(B), H = n.modelValue.start ? He(et(n.modelValue.start)) : null, Q = n.modelValue.end ? He(et(n.modelValue.end)) : null, ne = He(B);
      if (N)
        return p$;
      let le = b$;
      if (H && Q && Tr(ne, H) && Br(ne, Q)) {
        const X = Wt(ne, H), L = Wt(ne, Q);
        le = `${w(ne, H, Q)} ${X || L ? x$ : y$}`;
      }
      return T || (le = `${le} ${v$}`), le;
    }
    ...
    function z(D) {
      if (D?.stopPropagation(), !l.value) {
        if (l.value = !0, c.value = null, n.modelValue.start)
          try {
            d.value = Et(et(n.modelValue.start));
          } catch {
          }
        We(() => r.value?.focus());
      }
    ...
    return Ee(l, (D) => {
      ...
      Ze(u("div", {
        ...
        u("div", s$, [
          ...
          u("div", h$, [
            (m(!0), _(se, null, he(f.value, (T) => (m(), _("div", {
              key: `${T.getFullYear()}-${T.getMonth()}`,
              class: "w-full max-w-[252px] shrink-0"
            }, [
              u("div", f$, [
                (m(), _(se, null, he(y, (N) => u("span", { key: N }, A(N), 1)), 64))
              ]),
              u("div", g$, [
                (m(!0), _(se, null, he(P(Lr)(T), (N) => (m(), _("button", {
                  key: P(lt)(N),
                  type: "button",
                  disabled: k(N),
  ...
  setup(e, { emit: t }) {
    const n = e, a = t, s = `${`kiut-dpp-${Ne()}`}-lbl`, i = ae(null), r = ae(null), l = ae(!1), c = ae(null), d = ae(Et(/* @__PURE__ */ new Date())), h = C(() => !!(n.modelValue.start && n.modelValue.end)), f = C(() => {
      ...
      const X = et(n.modelValue.start), L = et(n.modelValue.end);
    ...
    function O(X) {
      const L = He(X);
      if (n.minDate) {
        const W = He(et(n.minDate));
        if (qt(L, W)) return !0;
      }
      if (n.maxDate) {
        const W = He(et(n.maxDate));
        if (qt(W, L)) return !0;
      }
      return !1;
    }
    function D(X, L, W) {
      const K = Wt(X, L), ie = Wt(X, W);
      if (K && ie) return "rounded-lg";
      const pe = K || X.getDay() === 0, Ce = ie || X.getDay() === 6;
      return pe && Ce ? "rounded-lg" : pe ? "rounded-l-lg" : Ce ? "rounded-r-lg" : "rounded-none";
    }
    function B(X) {
      const L = n$(
        n.modelValue,
    ...
    function T(X, L) {
      const W = z(L, X), K = O(L), ie = n.modelValue.start ? He(et(n.modelValue.start)) : null, pe = n.modelValue.end ? He(et(n.modelValue.end)) : null, Ce = He(L);
      if (K)
        return j$;
      let E = H$;
      if (ie && pe && Tr(Ce, ie) && Br(Ce, pe)) {
        const U = Wt(Ce, ie), ue = Wt(Ce, pe);
        E = `${D(Ce, ie, pe)} ${U || ue ? Y$ : K$}`;
      }
      return W || (E = `${E} ${W$}`), E;
    }
    function N(X) {
      const L = Ar(Dr(X), n.minDate, n.maxDate);
      a("update:modelValue", {
        start: lt(L.start),
        end: lt(L.end)
    ...
    function H(X) {
      ...
      let K = He(c.value), ie = new Date(L);
      qt(ie, K) && ([K, ie] = [ie, K]), a("update:modelValue", { start: lt(K), end: lt(ie) }), c.value = null, l.value = !1;
    }
    function Q(X) {
      d.value = Xn(d.value, X);
    }
    function ne() {
      l.value = !1;
    }
      ...
      Ze(u("div", {
        ...
        u("div", C$, [
          u("aside", {
            ...
            u("p", S$, A(y.value), 1),
            u("ul", M$, [
              (m(!0), _(se, null, he(v.value, (W) => (m(), _("li", {
                key: W.id
              }, [
                u("button", {
                  type: "button",
          ...
          u("div", A$, [
            ...
            u("div", O$, [
              (m(!0), _(se, null, he(f.value, (W) => (m(), _("div", {
                key: `${W.getFullYear()}-${W.getMonth()}`,
                class: "w-full max-w-[252px] shrink-0"
              }, [
                u("div", V$, [
                  (m(!0), _(se, null, he(b.value, (K) => (m(), _("span", { key: K }, A(K), 1))), 128))
                ]),
                u("div", z$, [
                  (m(!0), _(se, null, he(P(Lr)(W), (K) => (m(), _("button", {
                    key: P(lt)(K),
                    type: "button",
                    disabled: O(K),
                    class: J(["relative flex h-[36px] w-[36px] items-center justify-center text-xs outline-none transition focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/40 disabled:cursor-not-allowed disabled:opacity-100", T(W, K)]),
                    onClick: (ie) => H(K)
                  }, A(K.getDate()), 11, N$))), 128))
                ])
              ]))), 128))
            ])
          ])
      ...
      (m(), ee(un, { to: "body" }, [
        Ze(u("div", {
          ...
          u("ul", {
            ...
            (m(!0), _(se, null, he(p.value, (le, ge) => (m(), _("li", {
              key: w(le),
              role: "option",
              "aria-selected": $(le),
              class: J(M(le, ge)),
              onClick: Oe((X) => O(le), ["stop"]),
  ...
  setup(e, { emit: t }) {
    ...
    return (b, x) => l.value ? (m(), _("div", mt({
      ...
      j(ht, { name: "ksn-sheet" }, {
        default: R(() => [
          d.value ? (m(), _("div", {
            ...
            u("nav", MS, [
              (m(!0), _(se, null, he(d.value.items, (k) => (m(), _("button", {
                key: k.id,
                type: "button",
                "data-nav-id": k.id,
      ...
      u("nav", {
        ...
        (m(!0), _(se, null, he(e.sections, (k) => (m(), _("button", {
          key: k.id,
          type: "button",
