import { defineComponent as ce, shallowRef as yi, h as je, ref as ne, onMounted as Je, onUnmounted as it, watch as Be, toRaw as Qn, nextTick as He, version as Yr, isProxy as xi, computed as $, toRef as $e, openBlock as g, createElementBlock as x, normalizeStyle as we, createVNode as N, unref as B, createElementVNode as d, Fragment as le, renderList as be, normalizeClass as G, toDisplayString as A, createCommentVNode as O, onBeforeUnmount as ki, createStaticVNode as Jn, useSlots as uo, renderSlot as ke, Transition as pt, withCtx as V, Comment as Ur, createBlock as ae, resolveDynamicComponent as mt, createTextVNode as Ae, Teleport as Qt, withDirectives as Qe, withModifiers as Ie, vModelText as Nt, vShow as Ht, createSlots as Oo, vModelSelect as qr, mergeProps as yt, useAttrs as Ja, withKeys as Ca, inject as _i } from "vue";
...
function Oc(e, t, a) {
  ...
  for (let P = u, E = u; P <= h; ++P)
    k = t[P % i], !k.skip && (v = c(k[n]), v !== w && (p = l(v, o, s), y === null && M() && (y = r(v, o) === 0 ? P : E), y !== null && S() && (f.push(is({
      start: y,
      end: P,
      loop: m,
      count: i,
...
class bd extends Rn {
  ...
  _calculateBarValuePixels(t) {
    ...
    if (this.chart.getDataVisibility(t) ? f = a.getPixelForValue(m + b) : f = v, p = f - v, Math.abs(p) < i) {
      ...
      v = Math.max(Math.min(v, C), _), f = v + p, n && !u && (l._stacks[a.axis]._visualValues[o] = a.getValueForPixel(f) - a.getValueForPixel(v));
    }
...
function vd(e, t, a) {
  let n = 1, o = 1, s = 0, i = 0;
  if (t < Ye) {
    const r = e, l = r + t, c = Math.cos(r), u = Math.sin(r), h = Math.cos(l), m = Math.sin(l), b = (w, _, C) => qa(w, r, l, !0) ? 1 : Math.max(_, _ * a, C, C * a), f = (w, _, C) => qa(w, r, l, !0) ? -1 : Math.min(_, _ * a, C, C * a), p = b(0, c, h), y = b(Ze, u, m), v = f(Oe, c, h), k = f(Oe + Ze, u, m);
...
class xd extends Rn {
  ...
  updateElements(t, a, n, o) {
    ...
    for (let C = 0; C < w; ++C) {
      ...
      const P = this.getParsed(C), E = Ee(P[b]), F = S[m] = i.getPixelForValue(P[m], C), D = S[b] = s || E ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, P, l) : P[b], C);
      S.skip = isNaN(F) || isNaN(D) || E, S.stop = C > 0 && Math.abs(P[m] - _[m]) > y, p && (S.parsed = P, S.raw = c.data[C]), h && (S.options = u || this.resolveDataElementOptions(C, M.active ? "active" : o)), v || this.updateElement(M, C, S, o), _ = P;
    }
  }
  getMaxOverflow() {
...
class Da extends Wt {
  ...
  _computeLabelSizes(t, a, n) {
    ...
    let c = 0, u = 0, h, m, b, f, p, y, v, k, w, _, C;
    for (h = 0; h < a; h += l) {
      if (f = t[h].label, p = this._resolveTickFontOptions(h), o.font = y = p.string, v = s[y] = s[y] || {
        ...
        for (m = 0, b = f.length; m < b; ++m)
          C = f[m], !Ee(C) && !Ge(C) && (w = es(o, v.data, v.gc, w, C), _ += k);
      i.push(w), r.push(_), c = Math.max(w, c), u = Math.max(_, u);
    }
    nu(s, a);
    const M = i.indexOf(c), S = r.indexOf(u), P = (E) => ({
      width: i[E] || 0,
      height: r[E] || 0
    });
    return {
  ...
  _computeGridLineItems(t) {
    const a = this.axis, n = this.chart, o = this.options, { grid: s, position: i, border: r } = o, l = s.offset, c = this.isHorizontal(), h = this.ticks.length + (l ? 1 : 0), m = La(s), b = [], f = r.setContext(this.getContext()), p = f.display ? f.width : 0, y = p / 2, v = function(Q) {
      return ia(n, Q, p);
    };
    let k, w, _, C, M, S, P, E, F, D, L, T;
    if (i === "top")
      k = v(this.bottom), S = this.bottom - m, E = k - y, D = v(t.top) + y, T = t.bottom;
    else if (i === "bottom")
      k = v(this.top), D = t.top, T = v(t.bottom) - y, S = k + y, E = this.top + m;
    else if (i === "left")
      k = v(this.right), M = this.right - m, P = k - y, F = v(t.left) + y, L = t.right;
    else if (i === "right")
      k = v(this.left), F = t.left, L = v(t.right) - y, M = k + y, P = this.left + m;
    else if (a === "x") {
      if (i === "center")
        k = v((t.top + t.bottom) / 2 + 0.5);
      else if (Te(i)) {
        const Q = Object.keys(i)[0], ie = i[Q];
        k = v(this.chart.scales[Q].getPixelForValue(ie));
      }
      D = t.top, T = t.bottom, S = k + y, E = S + m;
    } else if (a === "y") {
      if (i === "center")
      ...
      M = k - y, P = M - m, F = t.left, L = t.right;
    }
    const j = De(o.ticks.maxTicksLimit, h), W = Math.max(1, Math.ceil(h / j));
    for (w = 0; w < h; w += W) {
      const Q = this.getContext(w), ie = s.setContext(Q), ue = r.setContext(Q), X = ie.lineWidth, oe = ie.color, R = ue.dash || [], U = ue.dashOffset, Y = ie.tickWidth, q = ie.tickColor, de = ie.tickBorderDash || [], ge = ie.tickBorderDashOffset;
      _ = au(this, w, l), _ !== void 0 && (C = ia(n, _, X), c ? M = P = F = L = C : S = E = D = T = C, b.push({
        tx1: M,
        ty1: S,
        tx2: P,
        ty2: E,
  ...
  _computeLabelItems(t) {
    ...
    let v, k, w, _, C, M, S, P, E, F, D, L, T = "middle";
    if (o === "top")
      ...
      if (o === "center")
        ...
        M = this.chart.scales[W].getPixelForValue(Q) + b;
      }
    ...
    for (v = 0, k = r.length; v < k; ++v) {
      ...
      P = this.getPixelForTick(v) + s.labelOffset, E = this._resolveTickFontOptions(v), F = E.lineHeight, D = Ge(_) ? _.length : 1;
      const Q = D / 2, ie = W.color, ue = W.textStrokeColor, X = W.textStrokeWidth;
      let oe = S;
      i ? (C = P, S === "inner" && (v === k - 1 ? oe = this.options.reverse ? "left" : "right" : v === 0 ? oe = this.options.reverse ? "right" : "left" : oe = "center"), o === "top" ? c === "near" || p !== 0 ? L = -D * F + F / 2 : c === "center" ? L = -j.highest.height / 2 - Q * F + F : L = -j.highest.height + F / 2 : c === "near" || p !== 0 ? L = F / 2 : c === "center" ? L = j.highest.height / 2 - Q * F : L = j.highest.height - D * F, h && (L *= -1), p !== 0 && !W.showLabelBackdrop && (C += F / 2 * Math.sin(p))) : (M = P, L = (1 - D) * F / 2);
      let R;
      if (W.showLabelBackdrop) {
        const U = wt(W.backdropPadding), Y = j.heights[v], q = j.widths[v];
        let de = L - U.top, ge = 0 - U.left;
        switch (T) {
          case "middle":
            de -= Y / 2;
            break;
...
function Tn(e, t, a, n, o, s) {
  ...
  const f = o - l;
  if (n) {
    const W = u > 0 ? u - n : 0, Q = h > 0 ? h - n : 0, ie = (W + Q) / 2, ue = ie !== 0 ? f * ie / (ie + n) : f;
    b = (f - ue) / 2;
  }
  const p = Math.max(1e-3, f * h - a / Oe) / h, y = (f - p) / 2, v = l + y + b, k = o - y - b, { outerStart: w, outerEnd: _, innerStart: C, innerEnd: M } = Pu(t, m, h, k - v), S = h - w, P = h - _, E = v + w / S, F = k - _ / P, D = m + C, L = m + M, T = v + C / D, j = k - M / L;
  if (e.beginPath(), s) {
    const W = (E + F) / 2;
    if (e.arc(i, r, h, E, W), e.arc(i, r, h, W, F), _ > 0) {
      const X = va(P, F, i, r);
      e.arc(X.x, X.y, _, F, k + Ze);
    }
    const Q = va(L, k, i, r);
    if (e.lineTo(Q.x, Q.y), M > 0) {
      const X = va(L, j, i, r);
      e.arc(X.x, X.y, M, k + Ze, j + Math.PI);
    }
    ...
    if (e.lineTo(ue.x, ue.y), w > 0) {
      const X = va(S, E, i, r);
      e.arc(X.x, X.y, w, v - Ze, E);
    }
  } else {
    e.moveTo(i, r);
    const W = Math.cos(E) * h + i, Q = Math.sin(E) * h + r;
    e.lineTo(W, Q);
    const ie = Math.cos(F) * h + i, ue = Math.sin(F) * h + r;
    e.lineTo(ie, ue);
  }
  e.closePath();
}
...
function Nu(e, t, a, n) {
  ...
  for (l && (b = o[k(0)], e.moveTo(b.x, b.y)), m = 0; m <= r; ++m) {
    ...
    M === f ? (C < p ? p = C : C > y && (y = C), u = (h * u + _) / ++h) : (w(), e.lineTo(_, C), f = M, h = 0, p = y = C), v = C;
  }
  w();
}
function io(e) {
...
class Vs extends Wt {
  ...
  _draw() {
    ...
    const { boxWidth: f, boxHeight: p, itemHeight: y } = Os(i, h), v = function(M, S, P) {
      ...
      if (o.fillStyle = De(P.fillStyle, r), o.lineCap = De(P.lineCap, "butt"), o.lineDashOffset = De(P.lineDashOffset, 0), o.lineJoin = De(P.lineJoin, "miter"), o.lineWidth = E, o.strokeStyle = De(P.strokeStyle, r), o.setLineDash(De(P.lineDash, [])), i.usePointStyle) {
        ...
        Ii(o, F, D, L, i.pointStyleWidth && f);
      } else {
        const F = S + Math.max((h - p) / 2, 0), D = l.leftForLtr(M, f), L = _a(P.borderRadius);
    ...
    this.legendItems.forEach((M, S) => {
      ...
      const P = o.measureText(M.text).width, E = l.textAlign(M.textAlign || (M.textAlign = i.textAlign)), F = f + m + P;
      let D = b.x, L = b.y;
      l.setWidth(this.width), w ? S > 0 && D + F + u > this.right && (L = b.y += C, b.line++, D = b.x = tt(s, this.left + u, this.right - n[b.line])) : S > 0 && L + C > this.bottom && (D = b.x = D + a[b.line].width + u, b.line++, L = b.y = tt(s, this.top + _ + u, this.bottom - a[b.line].height));
      const T = l.x(D);
      if (v(T, L, M), D = Nl(E, D + f + m, w ? D + F : this.right, t.rtl), k(l.x(D), L, M), w)
        b.x += F + u;
...
class Ks extends Wt {
  ...
  getCaretPosition(t, a, n) {
    ...
    let y, v, k, w, _, C;
    return s === "center" ? (_ = b + p / 2, o === "left" ? (y = m, v = y - i, w = _ + i, C = _ - i) : (y = m + f, v = y + i, w = _ - i, C = _ + i), k = y) : (o === "left" ? v = m + Math.max(l, u) + i : o === "right" ? v = m + f - Math.max(c, h) - i : v = this.caretX, s === "top" ? (w = b, _ = w - i, y = v - i, k = v + i) : (w = b + p, _ = w + i, y = v + i, k = v - i), C = w), {
      x1: y,
      x2: v,
      x3: k,
      y1: w,
  ...
  drawBody(t, a, n) {
    ...
    const f = wa(n.rtl, this.x, this.width), p = function(P) {
      a.fillText(P, f.x(t.x + b), t.y + m / 2), t.y += m + s;
    }, y = f.textAlign(i);
    let v, k, w, _, C, M, S;
    for (a.textAlign = i, a.textBaseline = "middle", a.font = h.string, t.x = pn(this, y, n), a.fillStyle = n.bodyColor, Fe(this.beforeBody, p), b = r && y !== "right" ? i === "center" ? c / 2 + u : c + 2 + u : 0, _ = 0, M = o.length; _ < M; ++_) {
      for (v = o[_], k = this.labelTextColors[_], a.fillStyle = k, Fe(v.before, p), w = v.lines, r && w.length && (this._drawColorBox(a, t, _, f, n), m = Math.max(h.lineHeight, l)), C = 0, S = w.length; C < S; ++C)
...
function bh(e, t) {
  ...
  E = Math.ceil(y / C) - Math.floor(p / C), E > f && (C = Uo(E * C / f / b) * b), Ee(l) || (M = Math.pow(10, l), C = Math.ceil(C * M) / M), o === "ticks" ? (S = Math.floor(p / C) * C, P = Math.ceil(y / C) * C) : (S = p, P = y), v && k && s && Ll((r - i) / s, C / 1e3) ? (E = Math.round(Math.min((r - i) / C, u)), C = (r - i) / E, S = i, P = r) : w ? (S = v ? i : S, P = k ? r : P, E = c - 1, C = (P - S) / E) : (E = (P - S) / C, Na(E, Math.round(E), C / 1e3) ? E = Math.round(E) : E = Math.ceil(E));
  const F = Math.max(qo(C), qo(S));
  M = Math.pow(10, Ee(l) ? F : l), S = Math.round(S * M) / M, P = Math.round(P * M) / M;
  let D = 0;
  for (v && (m && S !== i ? (a.push({
    value: i
  }), S < i && D++, Na(Math.round((S + D * C) * M) / M, i, Us(i, _, e)) && D++) : S < i && D++); D < E; ++D) {
  ...
  return k && m && P !== r ? a.length && Na(a[a.length - 1].value, r, Us(r, _, e)) ? a[a.length - 1].value = r : a.push({
    value: r
  }) : (!k || P === r) && a.push({
    value: P
  }), a;
...
function Me(e) {
  const t = ne("light");
  let a = null;
  const n = () => typeof document > "u" ? "light" : document.documentElement.classList.contains("dark") ? "dark" : "light", o = $(() => e?.value ? e.value : t.value), s = $(() => o.value === "dark"), i = $(() => s.value ? ti : ei), r = () => {
...
const ai = 10, Eh = /* @__PURE__ */ ce({
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: n, colors: o } = Me($e(a, "theme")), s = vn + Gn + ni + oi + vn, i = $(() => ({
    ...
    function c(k, w, _, C) {
      const M = _ / 2, S = 6, P = Math.min(
        Math.max(k, M + S),
        a.chartWidth - M - S
      ), E = S + C + 10, F = a.chartHeight - S + 10, D = Math.min(Math.max(w, E), F);
      return { x: P, y: D };
    }
    const u = $(() => ({
      // Axis
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: n, colors: o } = Me($e(a, "theme")), s = yn + Zn + ii + si + yn, i = $(() => ({
      bg: o.value.tooltipBg,
      border: o.value.tooltipBorder,
      text: o.value.tooltipText,
      secondary: n.value ? "#d1d5db" : "#e2e8f0"
    ...
    function r(Z, K, J) {
      ...
      return Math.ceil(Math.max(Z, 1) * K * he);
    }
    function l(Z, K) {
      return Math.max(
        r(Z.length, Zn, !0),
    ...
    function c(Z, K, J, he) {
      const me = J / 2, z = 6, ee = Math.min(
        Math.max(Z, me + z),
        a.chartWidth - me - z
      ), re = z + he + 10, pe = a.chartHeight - z + 10, Ce = Math.min(Math.max(K, re), pe);
      return { x: ee, y: Ce };
    }
    const u = $(() => ({
      // Axis
    ...
    const w = $(
      ...
      const Z = Math.max(...a.histogram.map((J) => J.count || 0), 1), K = Math.max(1, Math.ceil(Z * 0.2));
      return Z + K;
    }), C = $(() => {
      if (!a.histogram || a.histogram.length === 0) return 1;
      ...
      if (J === 0) return 0;
      const he = 1 / (J * Math.sqrt(2 * Math.PI)), me = -0.5 * Math.pow((Z - K) / J, 2);
      return he * Math.exp(me);
    }, S = $(() => {
      if (!a.histogram || a.histogram.length === 0 || a.averageScore === 0 && C.value === 0) return null;
      const Z = a.averageScore, K = C.value, J = 100, me = Math.max(...a.histogram.map((pe) => pe.count || 0), 1) / _.value * y.value;
      if (me <= 0) return null;
      let z = 0;
      for (let pe = 0; pe <= J; pe++) {
        const Ce = 1 + 9 * (pe / J), _e = M(Ce, Z, K);
        _e > z && (z = _e);
      }
      if (z <= 0) return null;
      const ee = me / z, re = [];
      for (let pe = 0; pe <= J; pe++) {
        const Ce = 1 + 9 * (pe / J), _e = M(Ce, Z, K) * ee, Le = k(Ce);
        if (Le !== null) {
          const Re = a.chartHeight - a.chartBottomMargin - _e;
          re.push(`${pe === 0 ? "M" : "L"} ${Le} ${Re}`);
        }
      }
      return re.join(" ");
    }), P = $(() => {
      ...
      return a.histogram.map((K) => {
        ...
        if (!Number.isFinite(J) || J < 1 || J > 10)
          return null;
        const he = b.value + (J - 0.5) * Z, me = K.count > 0 ? K.count / _.value * y.value : 0, z = a.chartHeight - a.chartBottomMargin - me;
        return {
          score: J,
          count: K.count,
          x: he,
    ...
    }), E = $(() => k(a.minScore)), F = $(() => k(a.maxScore)), D = $(() => k(a.q1Score)), L = $(() => k(a.medianScore)), T = $(() => k(a.q3Score)), j = $(() => k(a.averageScore)), W = $(() => a.minScore), Q = $(() => a.maxScore), ie = $(() => a.q1Score), ue = $(() => a.medianScore), X = $(() => a.q3Score), oe = $(() => a.averageScore), R = $(() => {
      const Z = [], K = a.chartMargin - 8, J = 18;
      D.value !== null && Z.push({
        x: D.value,
        y: K,
        value: a.q1Score,
      ...
      Z.forEach((z) => {
        ...
        for (let re = 0; re < he.length; re++) {
          ...
          for (const Ce of he[re]) {
            ...
            const _e = Math.abs(z.x - Ce.x), Le = (z.width + Ce.width) / 2 + 10;
            if (_e < Le) {
              pe = !0;
              break;
            }
        ...
        ee === -1 && (ee = he.length - 1), z.y = K - ee * J, he[ee].push(z);
      });
      const me = 15;
      return Z.forEach((z) => {
        z.y < me && (z.y = me);
      }), Z;
    }), U = (Z) => R.value.find((J) => J.id === Z)?.y || a.chartMargin - 10, Y = $(() => {
      const Z = [];
      for (let J = 0; J <= 5; J++) {
        const he = Math.round(_.value / 5 * J), me = a.chartHeight - a.chartBottomMargin - J / 5 * y.value;
        Z.push({ value: he, y: me });
      }
      return Z;
    });
    function q(Z, K, J) {
      const he = Z.createSVGPoint();
      he.x = K, he.y = J;
      ...
      const z = he.matrixTransform(me.inverse());
      return { x: z.x, y: z.y };
    }
    const de = (Z, K) => {
      a.interactive && te(Z, K);
    }, ge = () => {
      a.interactive && se();
    }, te = (Z, K) => {
      const J = Z.currentTarget.closest("svg");
      if (!J) return;
      const { x: he, y: me } = q(J, Z.clientX, Z.clientY), z = `Score: ${K.score}`, ee = `Count: ${Number(K.count ?? 0).toLocaleString()}`, re = l(z, ee), pe = s, Ce = typeof K?.x == "number" ? K.x : he;
      let _e = me - 20;
      const Le = c(Ce, _e, re, pe);
      h.value = {
        visible: !0,
        x: Le.x,
        y: Le.y,
      ...
      if (a.interactive && h.value.visible) {
        const K = Z.currentTarget, { x: J, y: he } = q(K, Z.clientX, Z.clientY), me = h.value.anchorX, z = me != null && Number.isFinite(me) ? me : J;
        let ee = he - 20;
        const re = c(z, ee, h.value.width, h.value.height);
    ...
    return t({ isDark: n }), (Z, K) => (g(), x("div", {
      ...
      (g(), x("svg", {
        ...
        (g(!0), x(le, null, be(Y.value, (J, he) => (g(), x("line", {
          key: `grid-${he}`,
          x1: b.value,
          y1: J.y,
          x2: f.value,
        ...
        (g(!0), x(le, null, be(Y.value, (J, he) => (g(), x(le, {
          key: `y-tick-${he}`
        }, [
          d("line", {
            x1: e.chartMargin - 6,
        ...
        e.showStatLabels && D.value ? (g(), x("text", {
          ...
          "font-weight": "600",
          "font-family": "'DM Sans', sans-serif"
        }, " Q1: " + A(ie.value.toFixed(1)), 9, Yg)) : O("", !0),
        ...
        e.showStatLabels && j.value ? (g(), x("text", {
          ...
          "font-weight": "700",
          "font-family": "'DM Sans', sans-serif"
        }, " Avg: " + A(oe.value.toFixed(1)), 9, Gg)) : O("", !0),
        ...
        e.showStatLabels && T.value ? (g(), x("text", {
          ...
          "font-weight": "600",
          "font-family": "'DM Sans', sans-serif"
        }, " Q3: " + A(X.value.toFixed(1)), 9, Qg)) : O("", !0),
        e.showStatLabels && F.value ? (g(), x("line", {
          key: 11,
          x1: F.value,
          y1: e.chartMargin,
          x2: F.value,
        ...
        e.showStatLabels && F.value ? (g(), x("text", {
          key: 12,
          x: F.value,
          y: e.chartHeight - e.chartBottomMargin + 60,
          "text-anchor": "middle",
...
const Pt = (e, t) => t ? `${(e / t * 100).toFixed(1)}%` : "0.0%", ye = (e, t) => `${e.toLocaleString()} (${Pt(e, t)})`, Cm = { class: "chart-container" }, $m = {
  ...
  setup(e, { expose: t }) {
    ...
    const h = {
      ...
      const H = I.replace(/_/g, " ").replace(/\s+/g, " ").trim(), se = H.match(/^Failed:\s*(.+)$/i);
      return se ? `Failed:
${se[1].trim()}` : H;
    }, k = (I, H) => {
      const se = I.trim();
      if (!se || H < 1 || se.length <= H) return se;
      const Z = [];
      let K = 0;
      for (; K < se.length; ) {
        const J = Math.min(K + H, se.length);
        if (J >= se.length) {
          const z = se.slice(K).trim();
          z && Z.push(z);
          break;
        }
        const he = se.slice(K, J), me = he.lastIndexOf(" ");
        if (me > 0)
          for (Z.push(se.slice(K, K + me).trim()), K += me; K < se.length && se[K] === " "; ) K += 1;
        else
          Z.push(he), K = J;
      }
      return Z.join(`
`);
      ...
      const se = I.trim();
      return !se || H < 1 ? I : se.split(`
`).map((Z) => k(Z.trim(), H)).filter(Boolean).join(`
`);
    }, _ = (I) => I.status ? I.status : f.test(I.name) ? "abandon" : p.test(I.name) ? "error" : "success", C = (I) => I.originalValue ?? I.value, M = (I, H) => {
      const se = new Set(H.map((K) => K.target)), Z = I.filter((K) => !se.has(K.name));
      for (const K of Z) {
        if (typeof K.value == "number" && K.value > 0) return K.value;
        const J = H.filter((he) => he.source === K.name);
        if (J.length > 0)
          return J.reduce((he, me) => he + C(me), 0);
      }
      return H.reduce((K, J) => Math.max(K, C(J)), 0);
    }, S = (I, H) => {
      const se = /* @__PURE__ */ new Map(), Z = new Set(H.map((J) => J.target)), K = I.filter((J) => !Z.has(J.name)).map((J) => ({ name: J.name, depth: 0 }));
      for (; K.length > 0; ) {
        const { name: J, depth: he } = K.shift(), me = se.get(J);
        if (!(me !== void 0 && me >= he)) {
          se.set(J, he);
          for (const z of H)
            z.source === J && K.push({ name: z.target, depth: he + 1 });
        }
      }
      for (const J of I)
      ...
      const se = /* @__PURE__ */ new Map(), Z = new Set(H.map((me) => me.target)), K = I.filter((me) => !Z.has(me.name));
      let J = 0;
      const he = (me) => {
        let z = me;
        for (; z && !se.has(z); )
          se.set(z, J), J += 1, z = H.filter(
            (re) => re.source === z && _({ name: re.target }) === "success"
          ).sort((re, pe) => C(pe) - C(re))[0]?.target;
      };
      return K.forEach((me) => he(me.name)), se;
    }, E = (I, H, se) => {
      const Z = _(I);
      if (Z === "success" && se.has(I.name))
        return se.get(I.name);
      if (Z === "success") {
        const K = H.filter((he) => he.target === I.name);
        return 200 + (K.length ? Math.min(
          ...K.map(
            (he) => se.has(he.source) ? (se.get(he.source) ?? 0) + 0.01 : 500
          )
        ) : 500);
      }
      return Z === "abandon" ? 1e3 : 2e3;
    }, F = (I, H) => {
      const se = S(I, H), Z = P(I, H);
      return [...I].sort((K, J) => {
        const he = se.get(K.name) ?? 0, me = se.get(J.name) ?? 0;
        if (he !== me) return he - me;
        const z = b[_(K)], ee = b[_(J)];
        if (z !== ee) return z - ee;
        const re = E(K, H, Z), pe = E(J, H, Z);
        if (re !== pe) return re - pe;
      ...
      const J = w(I, Z).split(`
`), he = H * 0.58, z = Math.max(...J.map((re) => re.length), 1) * he, ee = J.length * se;
      return {
        lines: J,
        width: z,
        height: ee,
      ...
      const K = typeof I.label == "string" && I.label ? I.label : I.name, J = `${v(K)}
(${Pt(se, Z)})`;
      return w(J, H);
    }, T = (I, H) => {
      const se = H.filter((Z) => Z.target === I.name);
      return se.length > 0 ? se.reduce((Z, K) => Z + C(K), 0) : typeof I.value == "number" ? I.value : H.filter((Z) => Z.source === I.name).reduce((Z, K) => Z + C(K), 0);
    }, j = (I, H, se) => {
      const Z = H.find((K) => K.name === I);
      return Z ? T(Z, se) : se.filter((K) => K.source === I).reduce((K, J) => K + C(J), 0);
    }, W = (I, H, se, Z) => {
      const K = j(I, se, Z);
      return `${H.toLocaleString()} (${Pt(H, K)})`;
    }, Q = (I, H = 0) => {
      if (H > 0) return H;
      const se = I.match(/^(\d+(?:\.\d+)?)px$/);
      if (se) return Number(se[1]);
      const Z = I.match(/^(\d+(?:\.\d+)?)vh$/);
      return Z && typeof window < "u" ? Number(Z[1]) / 100 * window.innerHeight : 500;
    }, ie = (I, H, se, Z, K) => {
      if (!H.length || !I.length || K <= 0) return I;
      const J = I.map((_e) => ({ ..._e })), he = se.labelLineHeight || Math.round(se.labelFontSize * 1.25), me = Math.max(4, se.labelCharsPerLine), z = Math.max(Z * 0.88, 260), ee = S(H, J), re = /* @__PURE__ */ new Map();
      H.forEach((_e) => {
        const Le = ee.get(_e.name) ?? 0;
        re.set(Le, (re.get(Le) ?? 0) + 1);
      });
      const pe = (_e) => {
        const Re = H.find((oa) => oa.name === _e)?.displayLabel || _e, Kt = D(Re, se.labelFontSize, he, me).height + la * 2, pa = ee.get(_e) ?? 0, an = re.get(pa) ?? 1, nn = (Math.max(an, 1) - 1) * se.nodeGap / Math.max(an, 1), Fn = Math.max(z - nn, Kt);
      ...
      for (let _e = 0; _e < 16; _e += 1) {
        let Le = !1;
        for (const Re of H) {
          const qe = pe(Re.name), Kt = Ce(Re.name);
          if (Kt >= qe) continue;
      ...
      const Z = M(I, H), K = F(I, H), J = se.labelLineHeight || Math.round(se.labelFontSize * 1.25), he = Math.max(4, se.labelCharsPerLine);
      let me = se.nodeWidth;
      const z = [], ee = K.map((pe, Ce) => {
        const _e = _(pe), Le = L(
          pe,
          he,
          T(pe, H),
        ...
        z.push(Le);
        const Re = D(Le, se.labelFontSize, J, he);
        se.orient === "vertical" ? me = Math.max(me, Re.height + la * 2) : me = Math.max(me, Re.nodeWidth);
        const qe = a.nodeColors[pe.name] || m[_e] || X[Ce % X.length], Kt = Math.max(Math.ceil(Re.nodeWidth - la * 2), 48);
        return {
          ...pe,
          displayLabel: Le,
          label: {
      ...
      if (se.orient === "vertical") {
        const pe = Math.max(
          ...z.map(
            (_e) => D(_e, se.labelFontSize, J, he).width
          ),
          0
        ), Ce = typeof re.right == "number" ? re.right : 10;
        re = {
          ...re,
          right: Math.max(Ce, pe + la + se.labelDistance)
        };
      }
      return { nodes: ee, maxNodeWidth: me, contentMargins: re, originTotal: Z };
    }, X = [
      "#C67DFF",
      // Primary light
      "#8b5cf6",
      ...
      const I = a.data.links.filter(
        (K) => K.source && K.target && typeof K.value == "number"
      ), H = Math.max(...I.map((K) => K.value), 1), se = Math.max(1, H * 0.01), Z = I.map((K) => ({
        ...K,
        originalValue: K.value,
        value: K.value < H * 0.01 ? se : K.value
      }));
      return {
      ...
      const K = Z.dataType === "node", J = o.value.tooltipText, he = n.value ? "#d1d5db" : "#e2e8f0";
      if (K) {
        const pe = H.filter((Re) => Re.target === Z.name), Ce = H.filter((Re) => Re.source === Z.name), _e = pe.length > 0 ? pe.reduce((Re, qe) => Re + (qe.originalValue || qe.value), 0) : Ce.reduce((Re, qe) => Re + (qe.originalValue || qe.value), 0), Le = Pt(_e, se);
        return `<div style="font-weight: 600; margin-bottom: 4px; color: ${J};">${Z.name} (${Le})</div><div style="color: ${he}; font-size: 12px;">Count: ${_e.toLocaleString()}</div>`;
      }
      const me = Z.data?.source || Z.source || "Unknown", z = Z.data?.target || Z.target || "Unknown", ee = Number(Z.data?.originalValue ?? Z.data?.value ?? Z.value ?? 0), re = W(me, ee, I, H);
      return `<div style="font-weight: 600; margin-bottom: 4px; color: ${J};">${me} → ${z}</div><div style="color: ${he}; font-size: 12px;">Flow: ${re}</div>`;
    }, U = () => {
      if (!c || !a.data.nodes?.length || !a.data.links?.length) return;
      const I = y.value, H = n.value ? "rgba(110, 110, 120, 0.35)" : "rgba(148, 163, 184, 0.45)", se = n.value ? "rgba(130, 130, 140, 0.5)" : "rgba(100, 116, 139, 0.55)", Z = n.value ? "rgba(203, 213, 225, 0.92)" : "#64748b", K = I.labelPosition === "inside" ? "#ffffff" : n.value ? o.value.textPrimary : "#334155";
      try {
        const { nodes: J, links: he } = oe(), { nodes: me, maxNodeWidth: z, contentMargins: ee, originTotal: re } = ue(
          J,
          he,
          I
        ), pe = Q(a.height, i.value?.clientHeight ?? 0), Ce = ie(
          he,
          me,
          {
          ...
          series: [
            {
              ...
              label: {
                ...
                overflow: "none",
                ...I.orient === "horizontal" ? { width: Math.max(z - la * 2, 48), overflow: "none" } : I.labelWrap && I.labelTextWidth > 0 ? { width: I.labelTextWidth, overflow: "none" } : {},
      ...
      if (i.value)
        try {
          c = Vo.init(i.value), U(), window.addEventListener("resize", ge);
        } catch (I) {
      ...
      await new Promise((I) => {
        ...
        u = new ResizeObserver(() => {
          q() && (u?.disconnect(), u = null, Y().then(I));
        }), u.observe(H);
      });
    }, ge = () => c?.resize(), te = () => {
      window.removeEventListener("resize", ge), u?.disconnect(), u = null, c && (c.dispose(), c = null);
    };
    return Je(() => de()), ki(te), Be(() => a.data, U, { deep: !0 }), Be(n, U), Be(s, U), t({ isDark: n }), (I, H) => (g(), x("div", Cm, [
      l.value ? (g(), x("div", {
        key: 0,
        class: "error-state",
  ...
  setup(e, { emit: t }) {
    ...
    const u = $(() => a.collapsible ? a.lazyMount ? r.value : i.value : !0), h = $(() => a.loading && u.value), m = $(() => {
        ...
        d("div", Am, [
          d("div", Tm, [
            d("div", Bm, [
              d("div", Lm, [
                ke(f.$slots, "title", {}, () => [
                  e.title ? (g(), x("h3", Rm, A(e.title), 1)) : O("", !0)
                ], !0),
                e.subtitle ? (g(), x("p", Pm, A(e.subtitle), 1)) : O("", !0),
        ...
        d("div", jm, [
          d("div", Hm, [
            d("div", Wm, [
              d("div", Km, [
                ke(f.$slots, "title", {}, () => [
                  e.title ? (g(), x("h3", Ym, A(e.title), 1)) : O("", !0)
                ], !0),
                e.subtitle ? (g(), x("p", Um, A(e.subtitle), 1)) : O("", !0),
                ke(f.$slots, "headerAppend", {}, void 0, !0)
              ])
            ]),
            m.value ? (g(), x("div", qm, [
...
const lp = {
  ...
  setup(e, { emit: t }) {
    ...
    return (l, c) => (g(), ae(mt(o.value), {
      ...
      default: V(() => [
        e.variant === "footer" ? (g(), x("div", lp)) : O("", !0),
        d("div", {
          class: G(["export-actions", { "export-actions--inline": e.variant === "inline" }])
        }, [
          e.variant === "footer" ? (g(), x("span", cp, "Export")) : O("", !0),
          d("div", dp, [
            i("pdf") ? (g(), x("button", {
              key: 0,
              type: "button",
  ...
  setup(e) {
    return (t, a) => (g(), x("div", {
      ...
      d("p", Ap, A(e.value), 1),
      e.subvalue ? (g(), x("p", Tp, A(e.subvalue), 1)) : O("", !0)
    ], 2));
  }
...
const Lp = {
                ...
                M.sortable ? (g(), x("button", {
                  ...
                  d("span", Fp, [
                    m(M.key) ? (g(), x(le, { key: 0 }, [
                      e.sortDirection === "asc" ? (g(), x("span", Op, "↑")) : e.sortDirection === "desc" ? (g(), x("span", Vp, "↓")) : O("", !0)
                    ], 64)) : (g(), x(le, { key: 1 }, [
  ...
  setup(e, { emit: t }) {
    ...
    const p = $(() => {
      const v = n.data, k = v.total_booking_initiated || 0, w = v.total_booking_started || 0, _ = v.total_payment_initiated || 0, C = v.total_not_found || 0, M = v.total_cancelled || 0, S = v.total_no_pending_balance || 0, P = v.total_errors || 0, E = typeof v.total_payment_success == "number" ? v.total_payment_success : (v.total_payment_success_value || []).reduce(
        (Q, ie) => Q + (ie.count || 0),
        0
      ), F = v.total_payment_failed || 0, D = Math.max(0, k - w), L = Math.max(
        0,
        w - _ - C - M - S - P
      ), T = (Q, ie) => ye(Q, ie), j = [
                ...
                d("div", Xp, [
                  N(ft, {
                    ...
                    "cell-initiated": V(({ row: w }) => [
                      d("span", null, A(B(fe)(Number(w.booking_initiated_count))), 1)
                    ]),
                    ...
                    "cell-paymentInitiated": V(({ row: w }) => [
                      d("span", null, A(B(fe)(Number(w.payment_initiated_count))), 1)
                    ]),
  ...
  setup(e, { emit: t }) {
    const a = t, n = (_) => {
    ...
    }), f = (_, C) => !C || C === 0 ? "0.0%" : Pt(_, C), p = (_, C) => {
      const M = fe(_), S = f(_, C);
      return `${M} (${S})`;
    }, y = (_) => _.reduce((C, M) => C + M.failed_count, 0), v = $(() => {
      const _ = [], C = [], M = /* @__PURE__ */ new Set(), S = (Z, K = {}) => {
        M.has(Z) || (_.push({ name: Z, ...K }), M.add(Z));
      };
      ...
      const I = P - E;
      T ? (W > 0 && (S("Abandoned (Init)", { status: "abandon" }), C.push({
        source: "Checkin Init",
        target: "Abandoned (Init)",
        value: W,
        label: ye(W, P)
        ...
        value: j,
        label: ye(j, P)
      }))) : I > 0 && (S("Abandoned (Init)", { status: "abandon" }), C.push({
        source: "Checkin Init",
        target: "Abandoned (Init)",
        value: I,
        label: ye(I, P)
      })), ue ? (X > 0 && (S("Error", { status: "error" }), C.push({
        ...
        value: R,
        label: ye(R, P)
      }))) : F > 0 && (S("Abandoned (Started)", { status: "abandon" }), C.push({
        source: "Booking retrive",
        target: "Abandoned (Started)",
        value: F,
        label: ye(F, P)
        ...
        const he = Z.step_name.replace(/_/g, " ").split(" ").map((me) => me.charAt(0).toUpperCase() + me.slice(1)).join(" ");
        S(he, { status: "error", order: K + 1 }), C.push({
          source: "Unrecovered",
          target: he,
          value: Z.count,
          label: ye(Z.count, P)
      ...
      const H = Y - (q + te);
      H > 0 && (S("Abandoned (Flow)", { status: "abandon" }), C.push({
        source: "Number of Passengers",
      ...
      const se = q - de;
      return se > 0 && (S("BP Error", { status: "error", order: 0 }), C.push({
        source: "Completed",
        target: "BP Error",
        value: se,
        label: ye(se, P)
          ...
          r.value && r.value.length > 0 ? (g(), x("section", l0, [
            d("div", c0, [
              N(ft, {
                ...
                "cell-date": V(({ row: M }) => [
                  d("span", d0, A(B(We)(String(M.date)).format("MMM DD")), 1)
                ]),
                "cell-checkinInit": V(({ row: M }) => [
                  d("span", null, A(B(fe)(M.checkin_initiated_count)), 1)
                ]),
                ...
                "cell-passengers": V(({ row: M }) => [
                  d("span", null, A(B(fe)(M.checkin_started_count)), 1)
                ]),
                ...
                "cell-createPayment": V(({ row: M }) => [
                  d("span", null, A(B(fe)(M.record_locator_create_payment_count ?? 0)), 1)
                ]),
                _: 1
              }, 8, ["columns", "rows"])
            ])
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (C) => {
      ...
      return We([M, S - 1, P]).format("MMM DD");
    }, c = (C) => C.replace(/_/g, " ").replace(/\b\w/g, (M) => M.toUpperCase()), u = (C, M) => Pt(C, M), h = (C, M) => {
      const S = C || 0, P = M || 0, E = r(S), F = u(S, P);
      return `${E} (${F})`;
    }, m = $(() => {
      const C = n.checkinData?.record_locator_by_day || [], M = n.failedData?.failed_by_step_by_day || [], S = n.failedData?.unrecovered_by_day || [];
      return C.map((E) => {
        const F = M.find((L) => L.date === E.date), D = S.find(
          (L) => L.date === E.date
        );
        return {
          ...E,
        ...
        (E, F) => new Date(E.date).getTime() - new Date(F.date).getTime()
      );
    }), b = /* @__PURE__ */ new Set([
      "choose_boardingpass",
      "boarding_pass",
      ...
      for (const P of M)
        for (const E of P.steps || [])
          f(E.step_name) && (S += E.failed_count || 0);
      if (S > 0) return S;
      ...
      P("Checkin Init", { value: E }), P("Booking Retrieval"), P("Booking Retrieved"), P("Check-in Closed"), P("BP Issued");
      const F = n.checkinData.total_record_locator_init || 0, D = n.checkinData.total_record_locator_init_abandoned || 0, L = n.checkinData.total_checkin_pre_init_abandoned_error, T = n.checkinData.total_checkin_pre_init_abandoned_voluntary, j = L != null || T != null, W = j ? Math.max(Number(L) || 0, 0) : 0, Q = j ? Math.max(Number(T) || 0, 0) : 0, ie = n.checkinData.total_record_locator_init_abandoned_error, ue = n.checkinData.total_record_locator_init_abandoned_voluntary, X = ie != null || ue != null, oe = X ? Math.max(Number(ie) || 0, 0) : 0, R = X ? Math.max(Number(ue) || 0, 0) : 0, U = X ? Math.max(D - oe - R, 0) : D, Y = F - D, q = n.checkinData.total_record_locator_started || 0, de = n.checkinData.total_record_locator_completed || 0, ge = n.checkinData.total_record_locator_closed || 0, te = n.checkinData.total_record_locator_unrecovered || 0;
      F > 0 && M.push({
        source: "Checkin Init",
      ...
      const I = E - F;
      j ? (Q > 0 && (P("Abandoned (Init)"), M.push({
        source: "Checkin Init",
        target: "Abandoned (Init)",
        value: Q,
        label: ye(Q, E)
      })), W > 0 && (P("Booking not retreived"), M.push({
        source: "Checkin Init",
        target: "Booking not retreived",
        value: W,
        label: ye(W, E)
      }))) : I > 0 && (P("Abandoned (Init)"), M.push({
        source: "Checkin Init",
        target: "Abandoned (Init)",
        value: I,
        label: ye(I, E)
      }));
      const H = n.isAvianca ? "Abandoned (Booking)" : "Abandoned (Started)";
      X ? (oe > 0 && (P("Error"), M.push({
        source: "Booking Retrieval",
        target: "Error",
        value: oe,
        label: ye(oe, E)
      })), R > 0 && (P(H, { status: "abandon" }), M.push({
        source: "Booking Retrieval",
        target: H,
        value: R,
        label: ye(R, E)
      })), U > 0 && (P(H, { status: "abandon" }), M.push({
        source: "Booking Retrieval",
        target: H,
        value: U,
        label: ye(U, E)
      }))) : D > 0 && (P(H, { status: "abandon" }), M.push({
        source: "Booking Retrieval",
        target: H,
        value: D,
        label: ye(D, E)
      ...
      const se = p(n.failedData), Z = Math.min(se, Math.max(ge - de, 0));
      de > 0 && M.push({
        source: "Check-in Closed",
        target: "BP Issued",
        value: de,
        label: ye(de, E)
      }), Z > 0 && (P("BP Error", { status: "error" }), M.push({
        source: "Check-in Closed",
        target: "BP Error",
        value: Z,
        label: ye(Z, E)
      }));
      const K = Math.max(ge - de - Z, 0);
      K > 0 && (P("Abandoned after Closed", { status: "abandon" }), M.push({
        source: "Check-in Closed",
          ...
          n.data.length > 0 ? (g(), x("section", E0, [
            d("div", F0, [
              N(ft, {
                ...
                "cell-departure": V(({ row: f }) => [
                  d("span", O0, A(u(f.departure_airport)), 1)
                ]),
                "cell-connection": V(({ row: f }) => [
                  d("span", {
...
}), Cr = /* @__PURE__ */ ve(K0, [["__scopeId", "data-v-9a9d7a34"]]), Y0 = { class: "checkin-container__body" }, U0 = /* @__PURE__ */ ce({
  ...
  setup(e, { emit: t }) {
    ...
    const n = e, o = t, s = (y) => {
    ...
    }), h = (y, v) => Pt(y, v), m = (y) => Pe(y), b = (y) => (y ?? []).reduce((v, k) => v + (k.count ?? 0), 0), f = (y) => typeof y.sell_success_count == "number" ? y.sell_success_count : b(y.payment_success_total), p = $(() => {
      const y = n.data, v = y.total_disruption_conversations || 0, k = y.total_disruption_initiated || 0, w = y.total_voluntary || 0, _ = y.total_involuntary || 0, C = y.total_accepted || 0, M = y.total_confirmed || 0, S = typeof y.total_sell_success == "number" ? y.total_sell_success : b(y.total_payment_success), P = y.total_sell_failed || 0, E = Math.max(0, v - k), F = Math.max(
        0,
        k - w - _
      ), D = Math.max(0, _ - C), L = Math.max(0, w - M), T = P, j = Math.max(0, M - S - T), W = (ue, X) => ye(ue, X), Q = [
        { name: "Initiated", status: "success" },
        { name: "Started", status: "success" },
            ...
            d("div", tb, [
              N(ft, {
                ...
                "cell-initiated": V(({ row: k }) => [
                  d("span", nb, A(B(fe)(Number(k.disruption_conversations))), 1)
                ]),
...
const wb = { class: "flex flex-col gap-3 items-center" }, Cb = {
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-select-${Ke()}`, s = `${o}-label`, i = `${o}-btn`, r = `${o}-listbox`, l = `${o}-err`, c = $(() => a.invalid ?? !1), u = ne(null), h = ne(null), m = ne(null), b = ne(null), f = ne(null), p = ne(!1), y = ne(0), v = ne(""), k = ne({});
    function w() {
      const q = h.value;
      if (!q) return;
    ...
    const _ = $(() => a.options.filter((q) => !q.disabled)), C = $(() => {
    ...
    ), P = $(() => a.modelValue === null || a.modelValue === void 0 || a.modelValue === "" ? a.placeholder : S.value?.label ?? String(a.modelValue)), E = $(() => S.value?.leadingClass);
    function F(q) {
    ...
    function L(q, de) {
      const ge = D(q), te = y.value === de, I = !!a.listSectionLabel;
      return [
        "flex cursor-pointer items-center gap-2.5 text-sm outline-none transition-colors",
        I ? "border-b border-gray-200 px-3 py-2.5 last:border-b-0 dark:border-white/5" : "gap-1.5 px-2 py-2",
        ge ? I ? "bg-[color:var(--kiut-primary-section)] font-medium text-[color:var(--kiut-primary)] dark:bg-[color:var(--kiut-primary-section)]" : "mx-1 rounded-lg bg-[color:var(--kiut-primary)] font-medium text-white" : "text-[color:var(--kiut-text-primary)] dark:text-slate-100",
    ...
    function T() {
      y.value = Math.max(
        0,
        C.value.findIndex((q) => q.value === a.modelValue)
      );
    }
    function j() {
      if (a.searchable) {
    ...
    function oe(q) {
      if (!p.value) return;
      const de = q.target, ge = u.value, te = m.value;
      ge && !ge.contains(de) && (!te || !te.contains(de)) && Q();
    }
    function R(q) {
      a.disabled || (q.key === "ArrowDown" || q.key === "Enter" || q.key === " ") && (q.preventDefault(), p.value || (p.value = !0, W()));
    }
    function U(q) {
      const de = C.value;
      if (q.key === "Escape") {
    ...
    return Be(v, () => {
      ...
      d("button", {
        ...
        d("span", Sb, [
          ...
          S.value?.badge ? (g(), x("span", {
            key: 2,
            class: G(B(di)(S.value.badge.variant))
      ...
      (g(), ae(Qt, { to: "body" }, [
        Qe(d("div", {
          ...
          e.searchable ? (g(), x("div", Mb, [
            d("div", Db, [
              ...
              Qe(d("input", {
                ...
                type: "search",
                class: G([B(et), "min-h-0 py-2 pl-9 pr-3 text-sm"]),
          ...
          e.listSectionLabel ? (g(), x("p", Bb, A(e.listSectionLabel), 1)) : O("", !0),
          d("ul", {
            id: r,
            ref_key: "listRef",
            ref: b,
            ...
            C.value.length === 0 ? (g(), x("li", Lb, A(e.noResultsText), 1)) : O("", !0),
            (g(!0), x(le, null, be(C.value, (ge, te) => (g(), x("li", {
              key: F(ge),
              role: "option",
              "aria-selected": D(ge),
              class: G(L(ge, te)),
              onClick: Ie((I) => ie(ge), ["stop"]),
              onMouseenter: (I) => y.value = te
            }, [
              ge.leadingClass ? (g(), x("span", {
                key: 0,
                class: G([ge.leadingClass, "shrink-0"]),
                "aria-hidden": "true"
              }, null, 2)) : O("", !0),
              ...
              d("span", Ib, A(ge.label), 1),
              ge.badge ? (g(), x("span", {
                key: 2,
                class: G(B(di)(ge.badge.variant))
              }, A(ge.badge.label), 3)) : O("", !0)
            ], 42, Rb))), 128))
          ], 34)
        ], 4), [
          [Ht, p.value]
  ...
  setup(e, { expose: t, emit: a }) {
    const n = {
      ...
      return {
        labels: w.map((M) => We(M).format("MMM DD")),
        datasets: C
      };
    }), p = $(() => {
      ...
      default: V(() => [
        d("div", Fb, [
          d("div", Ob, [
            ...
            p.value.length ? O("", !0) : (g(), x("section", jb, [
              d("div", Hb, [
                d("div", Wb, [
                  N(B(rt), { class: "h-10 w-10 text-[var(--kiut-primary,#8b5cf6)]" })
                ]),
            ...
            d("div", Qb, [
              N(ft, {
                ...
                "cell-checkinInit": V(({ row: k }) => [
                  d("span", ev, A(B(fe)(k.checkin_initiated)), 1)
                ]),
                ...
                "cell-checkinStarted": V(({ row: k }) => [
                  d("span", av, A(B(fe)(k.record_locator_started_count)), 1)
                ]),
...
${_(D)}`, M = $(() => {
      ...
      const U = ie.reduce(
        (de, ge) => (ge.reasons && Array.isArray(ge.reasons) && ge.reasons.forEach((te) => {
          const I = te.reason, H = te.failed_count;
          de[I] = (de[I] || 0) + H;
        }), de),
        {}
      );
      ...
      if (q > 0 && (X.push({
        ...
        const de = Object.values(U).reduce(
          (te, I) => te + I,
          0
        ), ge = q - de;
        Object.entries(U).filter(([, te]) => te > 0).sort(([, te], [, I]) => I - te).forEach(([te, I]) => {
          const H = `Failed: ${te}`;
          X.push({
            name: H,
            value: I,
...
Without Reason`
      ...
      return `${T} (${j})`;
    }, E = (D) => D == null ? 0 : typeof D == "number" ? D : Array.isArray(D) ? D.reduce((L, T) => L + (T.total_value || 0), 0) : 0, F = (D) => Yt(E(D));
    return t({ isDark: r }), (D, L) => (g(), ae(Se, {
      ...
      default: V(() => [
        d("div", vv, [
          M.value.nodes.length > 0 ? (g(), x("section", yv, [
            d("div", xv, [
              N(aa, {
                data: M.value,
                height: "420px",
          ...
          l.value && l.value.length > 0 ? (g(), x("section", wv, [
            d("div", Cv, [
              N(ft, {
                ...
                "cell-sellInitiated": V(({ row: T }) => [
                  d("span", Sv, A(B(fe)(Number(T.seller_conversations) || 0)), 1)
                ]),
                "cell-sellStarted": V(({ row: T }) => [
                  d("span", Mv, A(P(
                    T.sell_started_count,
                    T.seller_conversations || T.sell_started_count
                  )), 1)
                ]),
                "cell-getQuote": V(({ row: T }) => [
                  d("span", Dv, A(P(
                    T.sell_get_quote_count,
                    T.seller_conversations || T.sell_started_count
                  )), 1)
                ]),
                "cell-bookingCreated": V(({ row: T }) => [
                  d("span", Av, A(P(
                    T.sell_booking_created_count,
                    T.seller_conversations || T.sell_started_count
                  )), 1)
                ]),
                "cell-btValue": V(({ row: T }) => [
                  d("span", Tv, [
                    Array.isArray(
                ...
                "cell-cashSuccess": V(({ row: T }) => [
                  d("span", Fv, A(B(fe)(
                    Number(T.sell_success_cash_count) || 0
                  )), 1)
                ]),
                "cell-sellSuccess": V(({ row: T }) => [
                  d("span", Ov, A(P(
                    T.sell_success_count,
                    T.seller_conversations || T.sell_started_count
                  )), 1)
                ]),
                "cell-totalSalesValue": V(({ row: T }) => [
                  d("span", Vv, [
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, { isDark: s } = Me($e(n, "theme")), i = ne(!1), r = ne({
    ...
    }), l = $(() => r.value.payment_method_breakdown && r.value.payment_method_breakdown.length > 0), c = $(() => r.value.payment_method_by_day && r.value.payment_method_by_day.length > 0), u = $(() => !r.value.payment_method_by_day || r.value.payment_method_by_day.length === 0 ? [] : [...r.value.payment_method_by_day].sort((S, P) => We(S.date).valueOf() - We(P.date).valueOf())), h = [
      ...
      ), E = (S.payment_method_by_day || []).map((F) => ({
        date: F.date || "",
      ...
      "#f43f5e",
      "#06b6d4"
    ], y = (S) => !S || S.toLowerCase() === "unknown" ? ky : S.replace(/_/g, " "), v = (S) => S == null ? "$0.00" : Pe(S), k = (S) => {
      const P = S.total_amount_by_currency;
      return P && P.length > 0 ? P.map((E) => `${E.currency} ${v(E.total_value)}`).join(" · ") : v(S.total_amount);
    }, w = (S) => S ? We(S).format("MMM DD") : "-", _ = (S) => S == null || Number.isNaN(Number(S)) ? 0 : Number(S), C = (S) => {
      o("export", S);
    };
    function M() {
      const S = n.data;
      ...
      default: V(() => [
        d("div", ny, [
          l.value ? (g(), x("section", oy, [
            ...
            d("div", sy, [
              (g(!0), x(le, null, be(r.value.payment_method_breakdown, (E, F) => (g(), ae(xe, {
          ...
          c.value ? (g(), x("section", cy, [
            ...
            d("div", dy, [
              N(ft, {
                ...
                "cell-date": V(({ row: E }) => [
                  d("span", uy, A(w(String(E.date))), 1)
                ]),
                "cell-totalSales": V(({ row: E }) => [
                  d("span", hy, A(B(fe)(E.total_count ?? 0)), 1)
                ]),
                "cell-totalAmount": V(({ row: E }) => [
                  d("span", fy, [
                    Array.isArray(E.total_amount_by_currency) && E.total_amount_by_currency.length > 0 ? (g(), x("div", gy, [
                      (g(!0), x(le, null, be(E.total_amount_by_currency, (F) => (g(), x("span", {
                ...
                "cell-paymentMethods": V(({ row: E }) => [
                  d("div", my, [
                    (g(!0), x(le, null, be(Array.isArray(E.payment_methods) ? E.payment_methods : [], (F) => (g(), x("div", {
                      key: F.payment_method,
                      class: "payment-tag"
                    }, [
                      d("span", py, A(y(F.payment_method)), 1),
                      P[4] || (P[4] = d("span", { class: "tag-separator" }, "•", -1)),
                      !F.total_amount_by_currency || F.total_amount_by_currency.length === 0 ? (g(), x("span", by, A(v(F.total_amount)), 1)) : (g(), x("span", vy, A(F.total_amount_by_currency.map(
                        (D) => `${D.currency} ${v(D.total_value)}`
                      ).join(" / ")), 1)),
                      d("span", yy, "(" + A(_(F.count)) + ")", 1)
                    ]))), 128))
                  ])
                ]),
                _: 1
        ...
        N(pt, {
          ...
          default: V(() => [
            e.loading ? (g(), x("div", Cy, [
              ...
              o.value ? (g(), x("div", $y)) : O("", !0)
            ])) : (g(), x("div", Sy, [
              d("div", My, [
                ke(c.$slots, "icon", {}, void 0, !0)
              ]),
              o.value ? (g(), x("span", Dy, A(e.label), 1)) : O("", !0)
            ]))
          ]),
          _: 3
        })
        ...
        N(pt, {
          ...
          default: V(() => [
            e.loading ? (g(), x("div", By, [
              ...
              o.value ? O("", !0) : (g(), x("div", Ly))
            ])) : (g(), x("div", Ry, [
              d("div", Py, [
                ke(c.$slots, "value", {}, () => [
                  d("div", Iy, [
                    e.prefix ? (g(), x("span", Ey, A(e.prefix), 1)) : O("", !0),
                    d("span", {
                      class: G(["metric-value", e.valueSize === "large" ? "metric-value--large" : ""])
                    }, A(e.value), 3)
                  ])
                ], !0),
                o.value ? O("", !0) : (g(), x("span", Fy, A(e.label), 1))
              ])
            ]))
          ]),
          _: 3
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    function l(te) {
      const I = te?.trim() ?? "";
      return I.length > 0 && !r.has(I);
    }
    function c(te) {
      if (!l(te.agent_email)) return !1;
      const I = te.assigned_count ?? 0, H = te.closed_count ?? 0;
      return I > 0 || H > 0;
    }
    function u(te) {
    ...
    function w(te, I) {
      return I == null ? null : I === 0 ? te > 0 ? 100 : 0 : (te - I) / I * 100;
    }
    function _(te) {
      const I = te.toFixed(1);
      return te > 0 ? `+${I}%` : `${I}%`;
    }
    function C(te, I = !1) {
      const H = I ? -te : te;
    ...
    function P(te) {
      const I = Math.round(te), H = Math.floor(I / 3600), se = Math.floor(I % 3600 / 60), Z = I % 60;
      return `${String(H).padStart(2, "0")}:${String(se).padStart(2, "0")}:${String(Z).padStart(2, "0")}`;
    }
    function E(te) {
      const I = S(te);
      return I === null ? "—" : typeof te == "string" && te.includes(":") ? te.trim() : P(I);
    }
    const F = $(() => n.data?.total_enqueued ?? 0), D = $(() => n.data?.total_closed ?? 0), L = $(
    ...
    function ie(te, I) {
      return {
        ...
        avg_assignation_display: E(te.avg_time_to_assign_seconds),
        avg_resolution_display: E(te.avg_conversation_duration_seconds)
      };
    }
    function ue(te) {
      ...
      for (const H of te) {
        ...
        const Z = I.get(se), K = H.assigned_count ?? 0, J = H.closed_count ?? 0;
        Z.handled += u(H), H.agent_name?.trim() && (Z.agent_name = H.agent_name.trim());
        const he = S(H.avg_time_to_assign_seconds);
        he !== null && K > 0 && (Z.assignSum += he * K, Z.assignWeight += K);
        const me = S(H.avg_conversation_duration_seconds);
        me !== null && J > 0 && (Z.resolutionSum += me * J, Z.resolutionWeight += J);
      }
      return Array.from(I.values()).map((H, se) => {
        const Z = H.assignWeight > 0 ? H.assignSum / H.assignWeight : null, K = H.resolutionWeight > 0 ? H.resolutionSum / H.resolutionWeight : null;
        return {
          id: `agg-${H.agent_email}-${se}`,
    ...
    function oe(te, I, H, se) {
      const Z = se === "asc" ? 1 : -1;
      let K = 0;
      switch (H) {
        case "date":
          K = (te.dateSort ?? 0) - (I.dateSort ?? 0);
          break;
        case "name":
          K = (te.agent_name || "").localeCompare(I.agent_name || "", void 0, {
            sensitivity: "base"
          });
          break;
        case "email":
          K = te.agent_email.localeCompare(I.agent_email, void 0, {
            sensitivity: "base"
          });
          break;
        case "handled":
          K = te.handled - I.handled;
          break;
        case "avgAssignation":
          K = (te.avg_assignation_seconds ?? Number.NEGATIVE_INFINITY) - (I.avg_assignation_seconds ?? Number.NEGATIVE_INFINITY);
          break;
        case "avgResolution":
          K = (te.avg_resolution_seconds ?? Number.NEGATIVE_INFINITY) - (I.avg_resolution_seconds ?? Number.NEGATIVE_INFINITY);
          break;
      }
      if (K !== 0) return K * Z;
      if (p.value === "by_date" && H !== "date") {
        const J = (I.dateSort ?? 0) - (te.dateSort ?? 0);
        if (J !== 0) return J;
      }
      return (te.agent_name || "").localeCompare(I.agent_name || "", void 0, {
        sensitivity: "base"
      });
    }
    const R = $(() => {
      const te = [...X.value];
      return te.sort((I, H) => oe(I, H, v.value, k.value)), te;
    }), U = $(
      () => R.value
    ), Y = $(() => {
      const te = [];
        ...
        d("div", Vy, [
          f.value ? (g(), x("div", {
            ...
            N(ht, {
              ...
              value: V(() => [
                d("div", zy, [
                  d("span", Ny, A(de(D.value)), 1),
                  j.value ? (g(), x("span", jy, A(j.value), 1)) : O("", !0)
                ])
              ]),
              _: 1
            }, 8, ["value", "theme", "current-value", "previous-value"]),
          ...
          b.value ? (g(), ae(Se, {
            ...
            default: V(() => [
              d("div", Wy, [
                (g(), ae(ft, {
                  ...
                  "cell-date": V(({ row: H }) => [
                    d("span", Ky, A(ge(String(H.date))), 1)
                  ]),
                  "cell-name": V(({ row: H }) => [
                    d("span", Yy, A(h(H.agent_name)), 1)
                  ]),
                  "cell-email": V(({ row: H }) => [
                    d("span", Uy, A(H.agent_email), 1)
                  ]),
                  "cell-handled": V(({ row: H }) => [
                    d("span", qy, A(de(Number(H.handled))), 1)
                  ]),
                  "cell-avgAssignation": V(({ row: H }) => [
                    d("span", Xy, A(H.avg_assignation_display), 1)
                  ]),
                  "cell-avgResolution": V(({ row: H }) => [
                    d("span", Gy, A(H.avg_resolution_display), 1)
                  ]),
                  _: 1
            ...
            _: 1
          })) : f.value ? O("", !0) : (g(), x("div", Zy, [...I[6] || (I[6] = [
            d("div", { class: "empty-state-content" }, [
              d("div", { class: "empty-icon-wrapper" }, [
                d("svg", {
                  class: "empty-icon",
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (k) => {
      ...
      const S = Array.from(C).map((P) => ({
        label: P.toUpperCase(),
        data: _.map((E) => w[E]?.[P] || 0),
        borderColor: h(P)
      }));
      m.value = {
        labels: _.map((P) => We(P).format("MMM DD")),
        datasets: S
      };
    };
    return Be(
      ...
      default: V(() => [
        d("div", a1, [
          d("div", n1, [
            ...
            f.value.length ? O("", !0) : (g(), x("section", r1, [
              d("div", l1, [
                d("div", c1, [
                  N(B(rt), { class: "h-10 w-10 text-[var(--kiut-primary,#8b5cf6)]" })
                ]),
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (w) => {
      ...
      for (const [C, M] of Object.entries(w)) {
        ...
        const P = S.filter((E) => E !== "triage").length;
    ...
    }), u = $(() => Object.keys(n.data?.combinations || {}).length > 0), h = $(() => {
      const w = c.value;
            ...
            d("div", p1, [
              N(ft, {
                ...
                "cell-b0": V(({ row: C }) => [
                  ...
                  }, A(k(Number(C.b0))) + "%", 5)) : (g(), x("span", v1, A(B(fe)(Number(C.b0))), 1))
                ]),
                "cell-b1": V(({ row: C }) => [
                  C.id === "pct" ? (g(), x("span", {
                    key: 0,
                  ...
                  }, A(k(Number(C.b1))) + "%", 5)) : (g(), x("span", y1, A(B(fe)(Number(C.b1))), 1))
                ]),
                "cell-b2": V(({ row: C }) => [
                  C.id === "pct" ? (g(), x("span", {
                    key: 0,
                  ...
                  }, A(k(Number(C.b2))) + "%", 5)) : (g(), x("span", x1, A(B(fe)(Number(C.b2))), 1))
                ]),
                "cell-b3": V(({ row: C }) => [
                  C.id === "pct" ? (g(), x("span", {
                    key: 0,
                  ...
                  }, A(k(Number(C.b3))) + "%", 5)) : (g(), x("span", k1, A(B(fe)(Number(C.b3))), 1))
                ]),
                "cell-b4p": V(({ row: C }) => [
                  C.id === "pct" ? (g(), x("span", {
                    key: 0,
                  ...
                  }, A(k(Number(C.b4p))) + "%", 5)) : (g(), x("span", _1, A(B(fe)(Number(C.b4p))), 1))
                ]),
                _: 1
              }, 8, ["rows"])
            ])
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    }, u = $(() => c("guardrail_type")), h = $(() => c("guardrail_action")), m = $(() => c("guardrail_source")), b = $(() => {
      const y = {};
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (C) => {
      ...
      const C = h.value, M = u.value.processing_success, S = Math.max(0, M - u.value.totalDqErrors), P = u.value.notification_sent, E = Math.max(0, C - M), F = u.value.totalDqErrors, D = Math.max(0, S - P), L = (W, Q) => ye(W, Q), T = [
      ...
      ].sort(), E = P.map((L) => We(L).format("MMM DD")), F = P.map((L) => {
        const T = C.find((Q) => Q.date === L), j = T?.notification_sent || 0, W = S[L] || T?.processing_started || 0;
          ...
          l.value ? (g(), x(le, { key: 0 }, [
            d("section", K1, [
              ...
              d("div", Y1, [
                k.value.nodes.length > 0 && k.value.links.length > 0 ? (g(), ae(aa, {
                  ...
                  "use-gradient": !1,
                  "node-gap": 16
                }, null, 8, ["data"])) : (g(), x("div", U1, [...M[1] || (M[1] = [
            ...
            d("div", q1, [
              ...
              N(xe, {
                ...
                value: B(fe)(u.value.notification_sent),
            ...
            p.value.length > 0 ? (g(), x("section", X1, [
              ...
              d("div", G1, [
                N(ft, {
                  ...
                  "cell-reason": V(({ row: S }) => [
                    d("span", Z1, A(S.reason), 1)
                  ]),
                  "cell-count": V(({ row: S }) => [
                    d("span", Q1, A(B(fe)(S.count)), 1)
                  ]),
                  "cell-impact": V(({ row: S }) => [
                    d("div", J1, [
                      d("div", {
                ...
                d("div", sx, [
                  d("div", ix, [
                    ...
                    N(xe, {
                      ...
                      value: B(fe)(u.value.processing_started)
                    }, null, 8, ["value"]),
                    N(xe, {
                      title: "Processing Success",
                      value: B(fe)(u.value.processing_success)
                    }, null, 8, ["value"]),
                    N(xe, {
                      title: "Notification Failed",
                      value: B(fe)(u.value.notification_failed)
                    }, null, 8, ["value"])
                  ])
                ])
              ])
            ])
          ], 64)) : (g(), x("section", rx, [...M[6] || (M[6] = [
            d("div", { class: "empty-state-content" }, [
              d("div", { class: "empty-icon-wrapper" }, [
                d("svg", {
                  class: "empty-icon",
  ...
  setup(e, { expose: t }) {
    const a = e, n = ne(null), o = $(() => fe(a.totalConversations)), s = $(() => B(n.value?.isDark) ?? !1), i = $(() => B(n.value?.changePercent) ?? 0);
  ...
  setup(e, { expose: t }) {
    const a = e, n = ne(null), o = $(() => Yt(a.totalRevenue)), s = $(() => B(n.value?.isDark) ?? !1), i = $(() => B(n.value?.changePercent) ?? 0);
    return t({ isDark: s, changePercent: i }), (r, l) => (g(), ae(ht, {
      label: "AI Revenue",
      value: o.value,
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = $e(n, "theme"), { isDark: i, colors: r } = Me(s), l = ne(n.breakdownBy), c = $(() => n.data?.currency ?? "USD"), u = [
    ...
    }, y = (D) => !D || D === "unknown" ? "Unknown" : St(D).split(/[_|]/).map((L) => L ? L.charAt(0).toUpperCase() + L.slice(1) : "").join(" "), v = ne({
      labels: [],
      datasets: []
    }), k = ne([]), w = $(() => {
      ...
      const j = [...L].sort((X, oe) => X.date.localeCompare(oe.date)), W = j.map((X) => We(X.date).format("MMM DD")), Q = "ai_revenue";
      if (l.value === "all") {
        v.value = {
          labels: W,
          datasets: [
      ...
      const ue = T.slice(0, 7).map((X) => X.key).map((X, oe) => {
        const R = f(oe), U = j.map((Y) => {
          const q = (Y.breakdown ?? {})[X];
          return q ? Number(q[Q] ?? 0) : 0;
        });
        return m.value ? {
          label: y(X),
          data: U,
      ...
      v.value = { labels: W, datasets: ue }, k.value = T.slice(0, 5).map((X, oe) => ({
        key: X.key,
        label: y(X.key),
  ...
  setup(e, { expose: t }) {
    const a = e, n = ne(null), { isDark: o } = Me($e(a, "theme")), s = $(() => a.totalConversations * hi), i = $(() => a.previousTotalConversations === null || a.previousTotalConversations === void 0 ? null : a.previousTotalConversations * hi), r = $(() => fe(s.value)), l = $(
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (_) => {
      ...
      ), P = M.slice(0, 5).map((D) => D.key), E = S.map((D) => We(D.date).format("MMM DD")), F = P.map((D, L) => {
...
const lk = { class: "flex justify-end" }, ck = { class: "w-52" }, dk = { class: "flex min-h-0 w-full shrink-0 flex-col font-[family-name:Inter,ui-sans-serif,system-ui,sans-serif]" }, uk = { class: "w-full shrink-0 flex min-h-0 flex-col" }, hk = {
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (X) => {
      ...
      agency: "#6366F1",
      loyalty: "#EAB308"
    }, y = (X) => p[X.toLowerCase()] || bk, v = (X) => {
      const [oe] = X.split("|").map((R) => R.trim());
      return y(oe || X);
    }, k = (X) => {
      if (!X) return "Unknown";
      const oe = St(X).replace(/_/g, " ").trim();
      ...
      const U = Object.keys(X).sort((q, de) => q.localeCompare(de));
      if (!U.length || !oe.length) {
        _.value = { labels: [], datasets: [] }, T.value = [];
        return;
      }
      const Y = oe.map((q) => q.key);
      T.value = Y.map((q) => U.map((de) => X[de]?.[q] ?? null)), _.value = {
        labels: U.map((q) => We(q).format("MMM DD")),
        datasets: Y.map((q, de) => {
          const ge = oe.find((te) => te.key === q);
          return {
            label: k(ge?.label || q),
      ...
      plugins: {
        tooltip: {
          callbacks: {
            label: (X) => {
              const oe = X.dataset.label || "", R = T.value[X.datasetIndex]?.[X.dataIndex];
    ...
    return Be(
      ...
      () => n.breakdownBy,
      (X) => {
        c.value = X, ie(n.data ?? null);
      }
    ), t({ isDark: l }), (X, oe) => (g(), ae(Se, {
      class: "w-full min-h-0 self-start",
      title: u.value,
          ...
          d("div", uk, [
            _.value.labels.length && _.value.datasets.length ? (g(), x("section", hk, [
              ...
              F.value.length ? (g(), x("div", {
                ...
                (g(!0), x(le, null, be(F.value, (R) => (g(), ae(xe, {
                  key: `card-${R.key}`,
                  class: "min-w-0",
                  color: R.color,
                  title: R.label,
  ...
  setup(e, { expose: t }) {
    const a = e, n = ne(null), { isDark: o } = Me($e(a, "theme")), s = $(() => co(a.aiAgentAvgResolutionTimeSeconds)), i = $(() => co(a.humanAvgResolutionTimeSeconds));
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = ne([]), s = `tabs-${Ke()}`, i = (f) => `${s}-tab-${f}`, r = $(
  ...
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, s = (w) => {
      ...
      flight_info: "#f59e0b",
      support: "#10b981"
    }, c = (w) => w.agent_type || w.agent_id || w.agent_name || "", u = (w) => w.agent_name ? St(w.agent_name) : St(c(w)).split("_").map((C) => C.charAt(0).toUpperCase() + C.slice(1)).join(" ").replace(/V\d+$/, "").trim(), h = (w) => {
      ...
      if (w.length === 0)
        return { labels: [], datasets: [] };
      const _ = w.map((S) => u(S)), C = w.map((S) => S.avg_cost_per_conversation), M = w.map((S) => h(S));
      return {
        labels: _,
        datasets: [
          {
...
const C2 = { class: "kiut-table-wrap overflow-hidden rounded-xl border border-[#e5e7eb] bg-[color:var(--kiut-bg-secondary)] shadow-sm dark:border-[color:var(--kiut-border-light)]" }, $2 = { class: "w-full overflow-x-auto overflow-y-auto md:overflow-y-hidden" }, S2 = { class: "h-12 border-b border-[#e5e7eb] bg-[#eaeaec80] dark:border-[color:var(--kiut-border-light)] dark:bg-[#23232f80]" }, M2 = {
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = ne(null), s = ne([...a.defaultExpandedKeys]), i = $({
      ...
      const { sortKey: R, sortDirection: U, sortCompare: Y, rows: q } = a;
      return !R || !U || !Y ? q : a.expandable ? Rr(q, {
        childrenKey: a.childrenKey,
        sortKey: R,
        sortDirection: U,
        compare: Y
      }) : [...q].sort((de, ge) => Y(de, ge, R, U));
    }), h = $(() => a.expandable ? Pr(u.value, c.value) : u.value.map((R, U) => ({
      row: R,
      key: f(R, U),
      depth: 0,
      hasChildren: !1,
    ...
    function F(R) {
      return E(R) ? !1 : R.depth > 0 ? !0 : a.selectable && !k(R);
    }
    const D = $(() => {
    ...
    function Q(R) {
      ...
      const U = String(R), Y = h.value.find((de) => String(de.key) === U);
      if (Y && !S(Y) || !Y && !D.value.some((de) => String(de) === U))
        return;
      a.selectedKeys.some((de) => String(de) === U) ? n(
        "update:selectedKeys",
        a.selectedKeys.filter((de) => String(de) !== U)
        ...
        d("table", {
          ...
          d("thead", null, [
            d("tr", S2, [
              ...
              (g(!0), x(le, null, be(e.columns, (Y) => (g(), x("th", {
                key: Y.key,
                scope: "col",
                class: G([
                ...
                Y.sortable ? (g(), x("button", {
                  key: 0,
                  type: "button",
                  class: G(["kiut-table-sort-btn inline-flex items-center gap-1", b(Y.align)]),
                  "aria-sort": oe(Y.key),
                  onClick: (q) => ue(Y.key)
                }, [
                  d("span", null, A(Y.label), 1),
                  d("span", T2, [
                    X(Y.key) ? (g(), x(le, { key: 0 }, [
                      e.sortDirection === "asc" ? (g(), x("span", B2, "↑")) : e.sortDirection === "desc" ? (g(), x("span", L2, "↓")) : O("", !0)
                    ], 64)) : (g(), x(le, { key: 1 }, [
          ...
          d("tbody", null, [
            (g(!0), x(le, null, be(h.value, (Y) => (g(), x("tr", {
              key: Y.key,
              class: G([
              ...
              (g(!0), x(le, null, be(e.columns, (q) => (g(), x("td", {
                key: q.key,
                class: G([
                ...
                v(q.key) ? (g(), x("div", {
                  ...
                  ke(R.$slots, "row-expand", {
                    ...
                    E(Y) ? (g(), x("button", {
                      ...
                      "aria-expanded": Y.isExpanded,
                      "aria-label": Y.isExpanded ? e.ariaLabelCollapseRow : e.ariaLabelExpandRow,
                      onClick: Ie((de) => _(Y), ["stop"])
                    }, [
                      N(B(ta), {
                        class: G(["h-5 w-5 text-[color:var(--kiut-text-muted)] transition-transform duration-200", { "-rotate-90": !Y.isExpanded }]),
                        "aria-hidden": "true"
                      }, null, 8, ["class"])
                    ], 8, E2)) : F(Y) ? (g(), x("span", F2)) : O("", !0)
                  ], !0),
                  d("div", O2, [
                    ke(R.$slots, m(q.key), yt({ ref_for: !0 }, w(Y, q)), () => [
                      Ae(A(y(p(Y.row, q.key))), 1)
                    ], !0)
                  ])
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = Ja(), s = $(
    ...
    ), i = $(() => a.variant === "dropdown"), r = $(() => a.variant === "split"), l = $(() => a.variant === "action"), c = $(() => !l.value && !r.value), u = $(() => a.disabled || a.loading), h = $(
      ...
      const { class: R, type: U, "aria-label": Y, ...q } = o;
      return q;
    ...
    ]), y = `kiut-button-menu-${Ke()}`, v = `${y}-btn`, k = `${y}-menu`, w = ne(null), _ = ne(null), C = ne(null), M = ne(!1), S = ne(0), P = ne({}), E = $(() => a.options.filter((R) => !R.disabled));
    function F(R) {
    ...
    function D() {
      ...
      a.menuAlign === "right" ? (Y.right = `${window.innerWidth - U.right}px`, Y.left = "auto") : (Y.left = `${U.left}px`, Y.right = "auto"), P.value = Y;
    }
    function L(R) {
      return [
    ...
    function ue(R) {
      if (!M.value) return;
      const U = R.target, Y = w.value, q = C.value;
      Y && !Y.contains(U) && (!q || !q.contains(U)) && T();
    }
    function X(R) {
    ...
    return Je(() => {
      ...
      (g(), ae(Qt, { to: "body" }, [
        Qe(d("div", {
          ...
          (g(!0), x(le, null, be(E.value, (Y, q) => (g(), x("button", {
            key: F(Y),
            type: "button",
            role: "menuitem",
            disabled: Y.disabled,
            class: G(L(q)),
            onClick: Ie((de) => Q(Y), ["stop"]),
            onMouseenter: (de) => S.value = q
          }, [
            Y.icon ? (g(), x("span", K2, [
              (g(), ae(mt(Y.icon), { class: "h-5 w-5" }))
            ])) : (g(), x("span", Y2)),
            d("span", U2, [
              d("span", q2, A(Y.label), 1),
              Y.description ? (g(), x("span", X2, A(Y.description), 1)) : O("", !0)
            ])
          ], 42, W2))), 128))
        ], 36), [
          [Ht, M.value]
      ...
      (g(), ae(Qt, { to: "body" }, [
        Qe(d("div", {
          ...
          (g(!0), x(le, null, be(E.value, (Y, q) => (g(), x("button", {
            ...
            d("span", tw, [
              d("span", aw, A(Y.label), 1),
              Y.description ? (g(), x("span", nw, A(Y.description), 1)) : O("", !0)
            ])
          ], 42, Q2))), 128))
        ], 36), [
          [Ht, M.value]
    ...
    function F(D, L, T) {
      switch (k(L)) {
        ...
        case "actions":
          return E(D, L);
        default:
          return je("span", {}, String(D[L.key] ?? ""));
      }
    }
    return (D, L) => (g(), x("div", gw, [
      d("div", mw, [
        d("table", pw, [
          d("thead", null, [
            d("tr", bw, [
          ...
          d("tbody", null, [
            (g(!0), x(le, null, be(e.rows, (T, j) => (g(), x(le, {
              ...
              d("tr", vw, [
                (g(!0), x(le, null, be(e.columns, (W) => (g(), x("td", {
                  key: W.key,
                  class: G([
                  ...
                  ke(D.$slots, c(W.key), yt({ ref_for: !0 }, u(T, W, j)), () => [
                    b(W.key) ? (g(), x("div", yw, [
                      d("button", {
                        type: "button",
              ...
              p(T, j) ? (g(), x("tr", _w, [
                d("td", {
                  ...
                  y(T) ? (g(), x("div", {
                    ...
                    (g(!0), x(le, null, be(e.historySkeletonCount, (W) => (g(), x("div", {
                      key: W,
                    ...
                    (g(!0), x(le, null, be(T.versions, (W) => (g(), x("div", {
                      key: W.id,
                      class: "flex flex-wrap items-center gap-3 rounded-lg border border-[#e5e7eb] bg-[color:var(--kiut-bg-secondary)] px-4 py-3 dark:border-[color:var(--kiut-border-light)]"
                    }, [
                      ke(D.$slots, "history-item", {
                        ...
                        d("span", Dw, A(W.version), 1),
                        W.method ? (g(), x("span", {
                          key: 0,
                          class: G(["inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold", w(W.method)])
                        }, A(W.method), 3)) : O("", !0),
                        W.url ? (g(), x("span", {
                          key: 1,
...
const Nw = ["aria-label"], jw = { class: "flex flex-wrap items-center gap-x-2 gap-y-1.5" }, Hw = { class: "shrink-0 font-medium text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, Ww = { class: "flex min-w-0 flex-1 flex-wrap items-center gap-1.5" }, Kw = ["aria-label", "aria-expanded", "aria-controls", "onClick"], Yw = { class: "truncate" }, Uw = {
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = uo(), i = `${`kiut-filters-${Ke()}`}-panel`, r = ne(null), l = /* @__PURE__ */ new Map(), c = ne(null), u = ne(!1), h = ne({}), m = ne(null), b = ne(""), f = ne([]), p = ne(""), y = ne(""), v = $(() => c.value ? a.filterDefinitions.find((z) => z.id === c.value) ?? null : null), k = $(() => {
      const z = v.value;
      if (z)
        return z.type === "text" ? b.value : z.type === "select" ? f.value : { start: p.value, end: y.value };
    });
    function w(z, ee) {
      ee && ee instanceof HTMLElement ? l.set(z, ee) : l.delete(z);
    }
    function _(z) {
    ...
    function C(z) {
      if (z == null) return [];
      if (Array.isArray(z))
        return z.filter((ee) => typeof ee == "string" && ee.trim() !== "");
      if (typeof z == "string") {
        const ee = z.trim();
        return ee ? [ee] : [];
      }
    ...
    function M(z, ee) {
      if (ee == null) return !0;
      if (z.type === "text") return String(ee).trim() === "";
      if (z.type === "select") return C(ee).length === 0;
      if (z.type === "dateRange") {
        const re = ee;
    ...
    const S = $(
      ...
      for (const ee of a.filterDefinitions) {
        ...
        if (!M(ee, re)) {
          if (ee.type === "text")
            z.push({ kind: "text", def: ee, key: ee.id });
          else if (ee.type === "dateRange")
            z.push({ kind: "dateRange", def: ee, key: ee.id });
          else if (ee.type === "select")
            for (const pe of C(re))
              z.push({
                kind: "select",
                def: ee,
                optionValue: pe,
    ...
    function E(z) {
      return z.type !== "select" ? 0 : C(_(z.id)).length;
    }
    function F(z) {
      const ee = _(z.id), re = z.label.replace(/^\+\s*/, "");
      if (z.type === "text") return `${re}: ${String(ee ?? "").trim()}`;
      if (z.type === "select") {
        const Re = C(ee).map((qe) => z.options.find((pa) => pa.value === qe)?.label ?? qe);
        return `${re}: ${Re.join(", ")}`;
      }
    ...
    function D(z) {
      return z.kind === "text" || z.kind === "dateRange" ? F(z.def) : z.def.options.find((re) => re.value === z.optionValue)?.label ?? z.optionValue;
    }
    function L(z) {
      if (!z) return "";
      const ee = We(z, "YYYY-MM-DD", !0);
      return ee.isValid() ? ee.format("L") : z;
    }
    function T(z) {
      const ee = c.value === z.id && u.value, re = !M(z, _(z.id));
    ...
    function j(z) {
      return M(z, _(z.id)) ? Z(z) : `Editar filtro ${z.label.replace(/^\+\s*/, "")}`;
    }
    function W(z) {
      const ee = _(z.id);
      if (z.type === "text") {
    ...
    function Q() {
      ...
      f.value.length === 0 ? delete ee[z.id] : ee[z.id] = [...f.value], n("update:modelValue", ee), n("change", ee);
    }
    function ie(z) {
      const ee = f.value.indexOf(z);
      ee >= 0 ? f.value = f.value.filter((re, pe) => pe !== ee) : f.value = [...f.value, z], Q();
    }
    function ue(z) {
      if (!z) return;
      m.value = z;
      const ee = z.getBoundingClientRect(), re = 300;
      let pe = ee.left;
    ...
    function X(z, ee) {
      ...
      u.value && c.value !== z.id && q(), c.value = z.id, u.value = !0, W(z), He().then(async () => {
    ...
    function oe(z, ee) {
      ...
      u.value && c.value !== z.id && q(), c.value = z.id, u.value = !0, W(z), He().then(async () => {
        const re = l.get(z.id) ?? ee.currentTarget;
        ue(re), await He(), R();
      });
    }
    function R() {
    ...
    function Y(z) {
      ...
      if (ee.type === "select") {
        f.value = Array.isArray(z) ? z.filter((pe) => typeof pe == "string") : C(z);
        return;
      }
      const re = z;
      p.value = re?.start?.trim() ?? "", y.value = re?.end?.trim() ?? "";
    ...
    function q() {
      ...
      if (z.type === "text") {
        ...
        Ce === "" ? delete _e[z.id] : _e[z.id] = Ce, n("update:modelValue", _e), n("change", _e), U();
        return;
      }
      if (z.type === "select") {
        Q(), U();
      ...
      const ee = p.value.trim(), re = y.value.trim(), pe = { ...a.modelValue };
      !ee || !re || ee > re ? delete pe[z.id] : pe[z.id] = { start: ee, end: re }, n("update:modelValue", pe), n("change", pe), U();
    }
    function de(z) {
      const ee = { ...a.modelValue };
      delete ee[z], n("update:modelValue", ee), n("change", ee), c.value === z && U();
    }
    function ge(z) {
      ...
      const ee = { ...a.modelValue }, pe = C(ee[z.def.id]).filter((Ce) => Ce !== z.optionValue);
      pe.length === 0 ? delete ee[z.def.id] : ee[z.def.id] = pe, n("update:modelValue", ee), n("change", ee), c.value === z.def.id && W(z.def);
    }
    function te() {
      const z = {};
      n("update:modelValue", z), n("change", z), U();
    }
    const I = $(() => {
      const z = v.value;
    ...
    function H(z) {
      const ee = z.def.label.replace(/^\+\s*/, "");
      return z.kind === "select" ? `Quitar ${z.def.options.find((Ce) => Ce.value === z.optionValue)?.label ?? z.optionValue} del filtro ${ee}` : `Quitar filtro ${ee}`;
    }
    function se(z) {
      const ee = z.def.label.replace(/^\+\s*/, "");
      if (z.kind === "select") {
    ...
    function he(z) {
      z.key === "Escape" && u.value && (z.preventDefault(), U());
    }
    function me() {
    ...
    return Je(() => {
      ...
      d("div", jw, [
        ...
        d("div", Ww, [
          (g(!0), x(le, null, be(e.filterDefinitions, (re) => (g(), x("button", {
            key: `pill-${re.id}`,
            ref_for: !0,
            ref: (pe) => w(re.id, pe),
            type: "button",
            ...
            re.type === "select" && E(re) > 0 ? (g(), x("span", Uw, A(E(re)), 1)) : O("", !0)
          ], 10, Kw))), 128))
        ])
      ]),
      S.value ? (g(), x("div", qw, [
        d("div", Xw, [
          (g(!0), x(le, null, be(P.value, (re) => (g(), x("div", {
            key: re.key,
            ...
            z.$slots.panel ? ke(z.$slots, "panel", {
              ...
              v.value.type === "text" ? (g(), x(le, { key: 0 }, [
                ...
                d("ul", {
                  ...
                  (g(!0), x(le, null, be(v.value.options, (re) => (g(), x("li", {
                    key: re.value
                  }, [
                    d("label", s5, [
                      d("input", {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = Ja(), s = _i("$pcForm", null), i = `kiut-input-text-${Ke()}`, r = $(() => a.id ?? i), l = $(() => `${r.value}-err`), c = $(() => a.name ?? o.name ?? ""), u = ne(a.modelValue ?? "");
    Be(
      () => a.modelValue,
      (v) => {
        u.value = v ?? "";
    ...
    const h = $(() => s && c.value ? s.fields?.[c.value]?.states?.value ?? u.value : u.value), m = $(() => s && c.value ? s.fields?.[c.value]?.states?.invalid ?? a.invalid ?? !1 : a.invalid ?? !1);
    function b(v) {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = Ja(), s = _i("$pcForm", null), i = `kiut-input-password-${Ke()}`, r = $(() => a.id ?? i), l = $(() => `${r.value}-err`), c = $(() => a.name ?? o.name ?? ""), u = ne(!1), h = ne(a.modelValue ?? "");
    Be(
      () => a.modelValue,
      (k) => {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-input-textarea-${Ke()}`, s = $(() => a.id ?? o), i = $(() => `${s.value}-err`), r = $({
      get: () => a.modelValue,
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-input-file-${Ke()}`, s = $(() => a.id ?? o), i = $(() => `${s.value}-err`), r = ne(null), l = $(
    ...
    function w(S) {
      const P = S.target, E = Array.from(P.files ?? []);
    ...
    function M(S, P) {
      n(
        "update:modelValue",
        c.value.map(
          (E) => E.id === S ? { ...E, description: P } : E
        )
      );
    }
    return (S, P) => (g(), x("div", F5, [
      e.label ? (g(), x("label", {
        key: 0,
        for: s.value,
        class: G(B(lt))
      ...
      e.multiple ? (g(), x("div", H5, [
        d("div", {
          ...
          e.filesCountLabel ? (g(), x("span", U5, A(e.filesCountLabel), 1)) : O("", !0)
        ], 2),
        c.value.length > 0 ? (g(), x("ul", q5, [
          (g(!0), x(le, null, be(c.value, (E) => (g(), x("li", {
            key: E.id,
            ...
            d("div", X5, [
              ...
              d("div", G5, [
                d("div", Z5, [
                  ...
                  d("span", J5, A(f(E.file.size)), 1),
                  e.disabled ? O("", !0) : (g(), x("button", {
                    key: 0,
                    type: "button",
                ...
                e.showDescriptions ? (g(), ae(Fr, {
                  ...
                  "onUpdate:modelValue": (F) => M(E.id, F)
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = ne(!1), s = ne(null), i = `kiut-image-upload-circle-${Ke()}`, r = $(() => a.id ?? i), l = $(() => `${r.value}-url`), c = $(() => a.size === "sm" ? "h-10 w-10" : a.size === "lg" ? "h-16 w-16" : "h-12 w-12"), u = $(() => a.size === "sm" ? "h-4 w-4" : a.size === "lg" ? "h-6 w-6" : "h-5 w-5"), h = $(() => !a.disabled && !a.loading);
    Be(
      () => a.modelValue,
      () => {
        o.value = !1;
...
const MC = ["name", "value"], DC = ["for"], AC = ["id", "disabled", "aria-expanded", "aria-labelledby", "aria-label", "aria-invalid", "aria-describedby"], TC = ["aria-label", "onKeydown"], BC = { class: "p-3" }, LC = { class: "mb-4 flex items-center justify-between gap-2" }, RC = ["aria-label"], PC = { class: "min-w-0 truncate px-1 text-sm font-medium text-[#61616b] dark:text-[#e3e3e8]" }, IC = ["aria-label"], EC = { class: "mb-2 grid grid-cols-7 text-center text-xs font-normal tracking-wide text-[#61616b] dark:text-[#e3e3e8]" }, FC = { class: "grid grid-cols-7 gap-y-2" }, OC = ["disabled", "onClick"], VC = { class: "border-t border-gray-200 px-3 py-3 dark:border-[color:var(--kiut-border-light)]" }, zC = { class: "relative" }, NC = ["value", "disabled", "min", "max", "step", "aria-label"], jC = /* @__PURE__ */ ce({
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-input-datetime-${Ke()}`, s = `${o}-label`, i = $(() => a.id ?? `${o}-btn`), r = `${o}-panel`, l = `${o}-err`, c = ne(null), u = ne(null), h = ne(null), m = ne(!1), b = ne(kt(/* @__PURE__ */ new Date())), f = ne(null), p = ne("00:00"), y = $(() => !!a.modelValue), v = $(() => vC(a.locale)), k = $(() => wC(b.value)), w = $(() => a.placeholder), _ = $(() => a.modelValue ? SC(a.modelValue, a.locale) : a.placeholder), C = $(() => {
      const I = "max-sm:left-1/2 max-sm:right-auto max-sm:-translate-x-1/2 sm:translate-x-0";
      return a.panelAlign === "end" ? `right-0 left-auto ${I}` : `left-0 right-auto ${I}`;
    }), M = $(
    ...
    ), F = $(() => ka(a.min)), D = $(() => ka(a.max)), L = $(() => {
      if (!(!f.value || !F.value) && gt(f.value, F.value))
        return `${String(F.value.getHours()).padStart(2, "0")}:${String(F.value.getMinutes()).padStart(2, "0")}`;
    }), T = $(() => {
      if (!(!f.value || !D.value) && gt(f.value, D.value))
        return `${String(D.value.getHours()).padStart(2, "0")}:${String(D.value.getMinutes()).padStart(2, "0")}`;
    });
    function j(I, H) {
      return I.getMonth() === H.getMonth() && I.getFullYear() === H.getFullYear();
    }
    function W(I) {
      const H = Ve(I);
      return !!(F.value && jt(H, Ve(F.value)) || D.value && wn(H, Ve(D.value)));
    }
    function Q(I) {
      const H = j(I, b.value), se = W(I), Z = f.value ? gt(I, f.value) : !1;
      if (se)
      ...
      return Z && (K = "rounded-lg bg-[#895af6] font-semibold text-white"), H || (K = `${K} opacity-30`), K;
    }
    function ie() {
      const I = ka(a.modelValue);
      if (I) {
        f.value = Ve(I), p.value = $C(a.modelValue), b.value = kt(I);
        return;
      }
    ...
    function ue(I) {
      if (!f.value) return I;
      let H = ka(`${nt(f.value)}T${I}`);
      return H ? (F.value && gt(f.value, F.value) && bi(H, F.value) && (H = F.value), D.value && gt(f.value, D.value) && vi(H, D.value) && (H = D.value), `${String(H.getHours()).padStart(2, "0")}:${String(H.getMinutes()).padStart(2, "0")}`) : I;
    }
    function X() {
      if (!f.value) {
      ...
      F.value && bi(H, F.value) || D.value && vi(H, D.value) || n("update:modelValue", se);
    }
    function oe(I) {
      W(I) || (f.value = Ve(I), p.value = ue(p.value), X());
    }
    function R(I) {
    ...
    function de(I) {
      if (I.stopPropagation(), !a.disabled) {
        if (m.value) {
          Y();
          return;
        }
    ...
    function ge(I) {
      a.disabled || (I.key === "ArrowDown" || I.key === "Enter" || I.key === " ") && (I.preventDefault(), m.value || q());
    }
    function te(I) {
      if (!m.value) return;
      const H = c.value;
      H && !H.contains(I.target) && Y();
    }
    return Be(
      () => a.modelValue,
      () => {
      ...
      d("button", {
        ...
        d("span", {
          class: G(["min-w-0 flex-1 truncate", y.value ? "" : "text-[color:var(--kiut-text-muted)] dark:text-slate-500"])
        }, A(_.value), 3)
      ], 42, AC),
      e.errorText ? (g(), x("p", {
        key: 2,
        ...
        d("div", BC, [
          d("div", LC, [
            d("button", {
              ...
              "aria-label": S.value,
              onClick: H[0] || (H[0] = Ie((se) => U(-1), ["stop"]))
            }, [
              N(B(Po), {
                class: "h-4 w-4",
                "aria-hidden": "true"
            ...
            d("button", {
              ...
              class: "inline-flex h-[28px] w-[28px] shrink-0 items-center justify-center rounded-md border border-gray-300 text-[#61616b] transition hover:bg-black/[0.04] focus-visible:outline focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/30 dark:border-[color:var(--kiut-border-light)] dark:text-[#e3e3e8] dark:hover:bg-white/[0.06]",
              "aria-label": P.value,
              onClick: H[1] || (H[1] = Ie((se) => U(1), ["stop"]))
            }, [
              N(B(Io), {
                class: "h-4 w-4",
                "aria-hidden": "true"
          ...
          d("div", EC, [
            (g(!0), x(le, null, be(v.value, (se) => (g(), x("span", { key: se }, A(se), 1))), 128))
          ]),
          d("div", FC, [
            (g(!0), x(le, null, be(k.value, (se) => (g(), x("button", {
              key: B(nt)(se),
              type: "button",
              disabled: W(se),
              class: G(["relative mx-auto flex h-[36px] w-[36px] items-center justify-center text-xs outline-none transition focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/40 disabled:cursor-not-allowed", Q(se)]),
              onClick: Ie((Z) => oe(se), ["stop"])
        ...
        d("div", VC, [
          d("div", zC, [
            ...
            d("input", {
              ...
              type: "time",
              autocomplete: "off",
              class: G([B(et), "min-h-0 py-2 pl-10 pr-3 text-sm"]),
              disabled: !f.value,
              min: L.value,
              max: T.value,
              step: e.step,
  ...
  setup(e, { emit: t }) {
    ...
    const o = e, s = t, i = `kiut-input-time-${Ke()}`, r = $(() => o.id ?? i), l = $(() => `${r.value}-err`), c = $(() => o.modelValue == null || o.modelValue === "" ? "" : a(o.modelValue) ?? "");
    function u(h) {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-input-range-${Ke()}`, s = $(() => a.id ?? o), i = $(() => `${s.value}-err`), r = $(() => {
      const b = [];
    ...
    return (b, f) => (g(), x("div", ZC, [
      ...
      d("div", {
        ...
        e.orientation === "vertical" && e.captionMax ? (g(), x("p", JC, A(e.captionMax), 1)) : O("", !0),
        d("div", {
        ...
        e.orientation === "vertical" && e.captionMin ? (g(), x("p", i$, A(e.captionMin), 1)) : O("", !0),
        e.orientation === "vertical" && e.caption ? (g(), x("p", r$, A(e.caption), 1)) : O("", !0)
      ], 2),
      e.errorText ? (g(), x("p", {
        key: 1,
        id: i.value,
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-input-number-${Ke()}`, s = $(() => a.id ?? o), i = $(() => `${s.value}-err`), r = $(() => {
      switch (a.align) {
        case "start":
          return "text-start";
        case "end":
  ...
  setup(e, { emit: t }) {
    ...
    const o = e, s = t, i = `kiut-input-color-${Ke()}`, r = $(() => o.id ?? i), l = $(() => `${r.value}-err`), c = $(() => n(o.modelValue)), u = ne(c.value), h = ne(!1);
    Be(c, (f) => {
      h.value || (u.value = f);
    });
    function m(f) {
...
const A$ = ["disabled", "aria-expanded", "aria-label"], T$ = {
  ...
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-emoji-picker-${Ke()}`, s = `${o}-btn`, i = `${o}-panel`, r = ne(null), l = ne(null), c = ne(null), u = ne(null), h = ne(!1), m = ne(""), b = ne({}), f = $(
      () => a.ariaLabelTrigger ?? a.triggerLabel ?? a.ariaLabel
    ), p = $(() => ({
      ...Wr,
      ...a.categoryLabels
    })), y = $(() => new Set(M$(a.draft))), v = $(() => {
    ...
    function k() {
      ...
      const X = Math.max(160, j.top - Q - ie);
      b.value = {
    ...
    function E(T) {
      ...
      W && !W.contains(j) && (!Q || !Q.contains(j)) && M();
    }
    function F(T) {
    ...
    return Je(() => {
      document.addEventListener("click", E), window.addEventListener("resize", L), window.addEventListener("scroll", L, !0);
    }), it(() => {
      document.removeEventListener("click", E), window.removeEventListener("resize", L), window.removeEventListener("scroll", L, !0);
    }), (T, j) => (g(), x("div", {
      ref_key: "rootRef",
      ref: r,
      class: "relative inline-flex shrink-0 font-sans"
      ...
      d("button", {
        ...
        e.triggerLabel ? (g(), x("span", B$, A(e.triggerLabel), 1)) : O("", !0),
      ...
      (g(), ae(Qt, { to: "body" }, [
        Qe(d("div", {
          ...
          d("div", I$, [
            v.value.length > 0 ? (g(!0), x(le, { key: 0 }, be(v.value, (W) => (g(), x("section", {
              key: W.id
            }, [
              d("h3", E$, A(W.label), 1),
              d("div", F$, [
                (g(!0), x(le, null, be(W.emojis, (Q) => (g(), x("button", {
                  key: `${W.id}-${Q}`,
                  type: "button",
                  disabled: e.disabled,
                  "aria-label": `Add ${Q} to input`,
                  class: G(w(Q)),
                  onClick: Ie((ie) => _(Q), ["stop"])
                }, [
                  d("span", V$, A(Q), 1)
                ], 10, O$))), 128))
              ])
  ...
  emits: ["update:modelValue"],
  setup(e, { expose: t, emit: a }) {
    const n = e, o = a, i = `${`kiut-language-picker-${Ke()}`}-listbox`, r = ne(null), l = ne(null), c = ne(""), u = ne(0), h = $(() => n.options.filter((_) => !_.disabled)), m = $(() => {
    ...
    return Be(c, () => {
      ...
      e.listSectionLabel ? (g(), x("p", q$, A(e.listSectionLabel), 1)) : O("", !0),
      d("ul", {
        id: i,
        ref_key: "listRef",
        ref: l,
        ...
        m.value.length === 0 ? (g(), x("li", G$, A(e.noResultsText), 1)) : O("", !0),
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-multiselect-${Ke()}`, s = `${o}-label`, i = `${o}-btn`, r = `${o}-listbox`, l = ne(null), c = ne(null), u = ne(!1), h = ne(0), m = $(() => a.options.filter((F) => !F.disabled)), b = $(() => new Set(a.modelValue ?? [])), f = $(
    ...
    function w(F) {
      const D = [...a.modelValue ?? []], L = D.indexOf(F.value);
      L >= 0 ? D.splice(L, 1) : D.push(F.value), n("update:modelValue", D);
    }
    function _() {
      const F = m.value;
      if (F.length === 0) {
      ...
      const D = b.value, L = F.findIndex((T) => D.has(T.value));
      h.value = L >= 0 ? L : 0;
    }
    function C() {
    ...
    function M(F) {
      F.stopPropagation(), !a.disabled && (C(), u.value && (_(), He(() => c.value?.focus())));
    }
    function S(F) {
      if (!u.value) return;
      const D = l.value;
      D && !D.contains(F.target) && (u.value = !1);
    }
    function P(F) {
      a.disabled || (F.key === "ArrowDown" || F.key === "Enter" || F.key === " ") && (F.preventDefault(), u.value || (u.value = !0, _(), He(() => c.value?.focus())));
    }
    function E(F) {
      const D = m.value;
      if (D.length !== 0) {
    ...
    return Je(() => {
      ...
      d("button", {
        ...
        N(B(ta), {
          class: G(["mt-0.5 h-5 w-5 shrink-0 text-gray-400 transition-transform dark:text-slate-500", u.value ? "rotate-180" : ""]),
          "aria-hidden": "true"
        }, null, 8, ["class"])
      ], 42, a4),
      Qe(d("ul", {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, o = `kiut-phone-${Ke()}`, s = $(() => a.id ?? `${o}-num`), i = $(() => `${s.value}-err`), r = $({
  ...
  setup(e, { emit: t }) {
    ...
    return (l, c) => (g(), x("div", {
      ...
      d("div", x4, [
        (g(!0), x(le, null, be(e.items, (u) => (g(), x("button", {
          key: u.value,
          type: "button",
          class: G(i(u)),
          "aria-checked": s(u),
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, s = `${`kiut-drp-${Ke()}`}-lbl`, i = ne(null), r = ne(null), l = ne(!1), c = ne(null), u = ne(kt(/* @__PURE__ */ new Date())), h = $(() => !!(a.modelValue.start && a.modelValue.end)), m = $(() => {
      const D = kt(u.value);
      return [D, Ma(D, 1)];
      ...
      const D = at(a.modelValue.start), L = at(a.modelValue.end);
      return `${Bn(D)} – ${Bn(L)}`;
    });
    function k(D, L) {
    ...
    function C(D, L) {
      const T = k(L, D), j = w(L), W = a.modelValue.start ? Ve(at(a.modelValue.start)) : null, Q = a.modelValue.end ? Ve(at(a.modelValue.end)) : null, ie = Ve(L);
      if (j)
        return H4;
      let ue = W4;
      if (W && Q && Nr(ie, W) && jr(ie, Q)) {
        const oe = gt(ie, W), R = gt(ie, Q);
        ue = `${_(ie, W, Q)} ${oe || R ? U4 : Y4}`;
      }
    ...
    function M(D) {
      ...
      let j = Ve(c.value), W = new Date(L);
      jt(W, j) && ([j, W] = [W, j]), n("update:modelValue", { start: nt(j), end: nt(W) }), c.value = null, l.value = !1;
    }
    function S(D) {
        ...
        d("div", L4, [
          ...
          d("div", V4, [
            (g(!0), x(le, null, be(m.value, (T) => (g(), x("div", {
              ...
              d("div", z4, [
                (g(), x(le, null, be(y, (j) => d("span", { key: j }, A(j), 1)), 64))
              ]),
              d("div", N4, [
                (g(!0), x(le, null, be(B(Hr)(T), (j) => (g(), x("button", {
                  key: B(nt)(j),
                  type: "button",
                  disabled: w(j),
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, s = `${`kiut-dpp-${Ke()}`}-lbl`, i = ne(null), r = ne(null), l = ne(!1), c = ne(null), u = ne(kt(/* @__PURE__ */ new Date())), h = $(() => !!(a.modelValue.start && a.modelValue.end)), m = $(() => {
      const oe = kt(u.value);
      return [oe, Ma(oe, 1)];
    }), b = $(
      () => a.placeholder ?? (a.locale === "es" ? "Seleccionar fechas" : "Select dates")
    ), f = $(() => a.ariaLabel ?? b.value), p = $(() => Or(a.locale)), y = $(() => yC(a.locale)), v = $(() => bC(a.locale)), k = $(
    ...
    function D(oe, R, U) {
      const Y = gt(oe, R), q = gt(oe, U);
      if (Y && q) return "rounded-lg";
      const de = Y || oe.getDay() === 0, ge = q || oe.getDay() === 6;
    ...
    function T(oe, R) {
      const U = E(R, oe), Y = F(R), q = a.modelValue.start ? Ve(at(a.modelValue.start)) : null, de = a.modelValue.end ? Ve(at(a.modelValue.end)) : null, ge = Ve(R);
      if (Y)
        return mS;
      let te = pS;
      if (q && de && Nr(ge, q) && jr(ge, de)) {
        const H = gt(ge, q), se = gt(ge, de);
        te = `${D(ge, q, de)} ${H || se ? yS : vS}`;
      }
      return U || (te = `${te} ${bS}`), te;
    }
    function j(oe) {
    ...
    function W(oe) {
      ...
      let Y = Ve(c.value), q = new Date(R);
      jt(q, Y) && ([Y, q] = [q, Y]), n("update:modelValue", { start: nt(Y), end: nt(q) }), c.value = null, l.value = !1;
    }
    function Q(oe) {
      ...
      Qe(d("div", {
        ...
        d("div", Z4, [
          d("aside", {
            ...
            d("p", J4, A(y.value), 1),
            d("ul", eS, [
              (g(!0), x(le, null, be(p.value, (U) => (g(), x("li", {
                key: U.id
              }, [
                d("button", {
                  type: "button",
                  class: G(["w-full rounded-lg px-2 py-1.5 text-left text-xs transition focus-visible:outline focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/40", L(U.id)]),
                  onClick: (Y) => j(U.id)
                }, A(U.label), 11, tS)
              ]))), 128))
            ])
          ...
          d("div", aS, [
            ...
            d("div", uS, [
              (g(!0), x(le, null, be(m.value, (U) => (g(), x("div", {
                key: `${U.getFullYear()}-${U.getMonth()}`,
                class: "w-full max-w-[252px] shrink-0"
              }, [
                d("div", hS, [
                  (g(!0), x(le, null, be(v.value, (Y) => (g(), x("span", { key: Y }, A(Y), 1))), 128))
                ]),
                d("div", fS, [
                  (g(!0), x(le, null, be(B(Hr)(U), (Y) => (g(), x("button", {
                    key: B(nt)(Y),
                    type: "button",
                    disabled: F(Y),
                    class: G(["relative flex h-[36px] w-[36px] items-center justify-center text-xs outline-none transition focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/40 disabled:cursor-not-allowed disabled:opacity-100", T(U, Y)]),
                    onClick: (q) => W(Y)
                  }, A(Y.getDate()), 11, gS))), 128))
                ])
              ]))), 128))
            ])
          ])
  ...
  setup(e) {
    ...
    function u() {
      ...
      let M = C === "top" ? p.top - y.height - xn : p.bottom + xn;
      M = Math.max(
        xa,
          ...
          d("div", kS, [
            ...
            d("div", wS, [
              (g(!0), x(le, null, be(e.items, (p) => (g(), x("span", {
                ...
                Ae(A(p.label) + " ", 1),
                p.note ? (g(), x("span", CS, " (" + A(p.note) + ") ", 1)) : O("", !0)
              ], 2))), 128))
            ])
          ])
        ], 38)) : O("", !0)
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, n = t, s = `${`kiut-tag-select-${Ke()}`}-listbox`, i = ne(null), r = ne(null), l = ne(null), c = ne(null), u = ne(!1), h = ne(0), m = ne({}), b = $(() => a.options.filter((Q) => !Q.disabled)), f = $(
      () => a.options.find((Q) => Q.value === a.modelValue) ?? null
    ...
    function T(Q) {
      if (!u.value) return;
      const ie = Q.target, ue = i.value, X = l.value;
      ue && !ue.contains(ie) && (!X || !X.contains(ie)) && E();
    }
    function j(Q) {
      ...
      (g(), ae(Qt, { to: "body" }, [
        Qe(d("div", {
          ...
          d("ul", {
            ...
            (g(!0), x(le, null, be(b.value, (ue, X) => (g(), x("li", {
              key: _(ue),
              role: "option",
              "aria-selected": C(ue),
              class: G(M(ue, X)),
              onClick: Ie((oe) => F(ue), ["stop"]),
              onMouseenter: (oe) => h.value = X
            }, [
              d("span", AS, [
                C(ue) ? (g(), ae(B(Eo), {
                  key: 0,
  ...
  setup(e, { emit: t }) {
    const a = e, n = $(() => ({ maxWidth: `${a.width}px` })), o = t, i = `${`kiut-modal-${Ke()}`}-title`, r = ne(null);
    function l() {
            ...
            d("div", {
              ...
              d("header", {
                ...
                d("div", zS, [
                  ...
                  e.subtitle ? (g(), x("p", NS, A(e.subtitle), 1)) : O("", !0)
                ]),
                N($t, {
                  variant: "action",
                  type: "button",
    ...
    return (v, k) => l.value ? (g(), x("div", yt({
      ...
      N(pt, { name: "ksn-sheet" }, {
        default: V(() => [
          u.value ? (g(), x("div", {
            ...
            d("nav", uM, [
              (g(!0), x(le, null, be(u.value.items, (w) => (g(), x("button", {
                key: w.id,
                type: "button",
                "data-nav-id": w.id,
      ...
      d("nav", {
        ...
        (g(!0), x(le, null, be(e.sections, (w) => (g(), x("button", {
          ...
          e.selectedSectionId === w.id || m(w) ? (g(), x("span", mM)) : O("", !0),
          w.icon ? (g(), ae(mt(w.icon), {
            key: 1,
            class: "shrink-0",
