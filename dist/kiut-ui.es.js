...
}), Yp = /* @__PURE__ */ nt(jp, [["__scopeId", "data-v-2db93357"]]), Up = { class: "checkin-metrics-card" }, Kp = {
  key: 0,
  class: "loading-state"
}, qp = {
  key: 1,
...
const t3 = ["disabled", "aria-expanded", "aria-labelledby", "aria-label"], e3 = ["aria-selected", "onClick", "onMouseenter"], a3 = {
  key: 0,
  class: "flex w-5 shrink-0 justify-center",
  "aria-hidden": "true"
}, s3 = { class: "min-w-0 flex-1" }, Yi = /* @__PURE__ */ tt({
  name: "Select",
  __name: "Select",
  props: {
    modelValue: {},
...
}), n3 = ["disabled", "aria-expanded", "aria-labelledby", "aria-label"], o3 = { class: "min-h-[1.25rem] min-w-0 flex-1 max-h-32 overflow-y-auto py-0.5" }, i3 = {
  key: 0,
  class: "block truncate text-[color:var(--kiut-text-muted)] dark:text-slate-500"
}, r3 = {
  key: 1,
  class: "flex flex-wrap gap-1"
}, l3 = { class: "truncate" }, c3 = ["aria-selected", "onClick", "onMouseenter"], d3 = {
  class: "flex w-5 shrink-0 justify-center",
  "aria-hidden": "true"
}, u3 = { class: "min-w-0 flex-1" }, h3 = /* @__PURE__ */ tt({
  name: "MultiSelect",
  __name: "MultiSelect",
  props: {
    modelValue: {},
  ...
  setup(e, { emit: t }) {
    ...
    return le(() => {
      ...
      c("button", {
        ...
        c("div", o3, [
          h.value.length === 0 ? (y(), x("span", i3, $(e.placeholder), 1)) : (y(), x("div", r3, [
...
}), f3 = ["id", "aria-checked", "aria-disabled", "disabled", "onKeydown"], g3 = { class: "sr-only" }, p3 = /* @__PURE__ */ tt({
  name: "Toggle",
  __name: "Toggle",
  props: {
  ...
  setup(e, { emit: t }) {
    ...
    return (o, i) => (y(), x("button", {
      ...
      c("span", g3, $(e.ariaLabel), 1)
    ], 42, f3));
  }
}), v3 = { class: "font-sans" }, b3 = ["for"], m3 = { class: "flex gap-2" }, y3 = { class: "w-[7.5rem] shrink-0" }, _3 = { class: "min-w-0 flex-1" }, x3 = ["id", "placeholder", "disabled", "aria-invalid", "aria-describedby"], k3 = ["id"], w3 = /* @__PURE__ */ tt({
  name: "InputPhone",
  __name: "InputPhone",
  props: {
    modelValue: {},
  ...
  setup(e, { emit: t }) {
    ...
    return (d, u) => (y(), x("div", v3, [
      ...
      e.errorText ? (y(), x("p", {
        ...
        class: U(T(xe)),
        role: "alert"
      }, $(e.errorText), 11, k3)) : R("", !0)
    ]));
  }
}), $3 = ["role", "aria-label"], M3 = { class: "flex flex-wrap gap-2" }, C3 = ["aria-checked", "role", "onClick"], S3 = { class: "flex h-4 w-4 shrink-0 items-center justify-center rounded-full border-2 border-[color:var(--kiut-primary)] bg-white transition dark:bg-[color:var(--kiut-bg-secondary)]" }, D3 = {
  key: 0,
  class: "h-2 w-2 rounded-full bg-[color:var(--kiut-primary)]"
}, A3 = { class: "text-sm font-medium text-[color:var(--kiut-text-primary)] dark:text-slate-100" }, T3 = /* @__PURE__ */ tt({
...
}), B3 = ["aria-label"], L3 = ["id", "aria-selected", "aria-disabled", "tabindex", "onClick", "onKeydown"], F3 = { class: "truncate px-3 py-2 text-sm font-medium" }, P3 = /* @__PURE__ */ tt({
...
function Fo(e) {
  return `${O3[e.getMonth()]} ${String(e.getDate()).padStart(2, "0")}`;
}
function Po(e) {
  return `${V3[e.getMonth()]} ${e.getFullYear()}`;
}
const z3 = ["aria-expanded", "aria-labelledby", "aria-label"], N3 = ["onKeydown"], W3 = { class: "mb-4 flex items-center justify-between gap-2" }, H3 = { class: "flex min-w-0 flex-1 justify-center gap-8 text-center text-sm font-semibold text-[color:var(--kiut-text-primary)] dark:text-slate-100" }, j3 = { class: "min-w-0 truncate" }, Y3 = { class: "min-w-0 truncate" }, U3 = { class: "flex flex-col gap-6 sm:flex-row sm:gap-8" }, K3 = { class: "mb-2 grid grid-cols-7 gap-1 text-center text-[11px] font-medium uppercase tracking-wide text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, q3 = { class: "grid grid-cols-7 gap-y-1" }, X3 = ["disabled", "onClick"], G3 = /* @__PURE__ */ tt({
  ...
  setup(e, { emit: t }) {
    ...
    function g(D, A) {
      ...
      const Y = I3(E, F) && R3(E, P), L = Lo(E, F), O = Lo(E, P);
    ...
    return Rt(l, (D) => {
      ...
      Kt(c("div", {
        ...
        c("div", W3, [
          ...
          c("div", H3, [
            c("span", j3, $(T(Po)(f.value[0])), 1),
            c("span", Y3, $(T(Po)(f.value[1])), 1)
          ]),
          c("button", {
            type: "button",
            class: "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-gray-300 text-gray-600 transition hover:bg-black/[0.04] focus-visible:outline focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/30 dark:border-[color:var(--kiut-border-light)] dark:text-slate-300 dark:hover:bg-white/[0.06]",
        ...
        c("div", U3, [
          (y(!0), x(q, null, J(f.value, (B) => (y(), x("div", {
            ...
            c("div", q3, [
              (y(!0), x(q, null, J(T(E3)(B), (F) => (y(), x("button", {
                key: T(ta)(F),
                type: "button",
                disabled: b(F),
  ...
  setup(e) {
    ...
    return (r, l) => a.value ? (y(), x("span", {
      ...
      e.statusLive === !0 ? (y(), x("span", Z3, [...l[0] || (l[0] = [
...
}, tM = ["type", "disabled", "aria-label"], eM = {
  key: 1,
...
}, sM = ["type", "disabled", "aria-label"], nM = {
  key: 1,
  class: "min-w-0 truncate"
}, Ia = /* @__PURE__ */ tt({
  name: "Button",
  ...
  setup(e) {
    ...
    return (u, f) => s.value ? (y(), x("span", J3, [
      c("button", Cs({
        type: r.value,
  ...
  "aria-hidden": "false"
}, iM = { class: "min-w-0 flex-1 space-y-1" }, rM = {
  key: 0,
  class: "text-sm leading-snug text-[color:var(--kiut-text-secondary)] dark:text-slate-400"
}, lM = { class: "min-h-0 flex-1 overflow-y-auto px-6 py-6" }, cM = { class: "flex shrink-0 justify-end gap-3 px-6 pb-6 pt-2" }, dM = /* @__PURE__ */ tt({
  name: "Modal",
  __name: "Modal",
  props: {
    modelValue: { type: Boolean },
            ...
            c("div", {
              ...
              c("header", {
                ...
                c("div", iM, [
                  ...
                  e.subtitle ? (y(), x("p", rM, $(e.subtitle), 1)) : R("", !0)
                ]),
                Q(Ia, {
                  variant: "action",
                  type: "button",
...
}), uM = /* @__PURE__ */ nt(dM, [["__scopeId", "data-v-4ed7bb14"]]), hM = { class: "flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between" }, fM = { class: "flex min-w-0 flex-1 flex-col gap-1.5" }, gM = { class: "flex min-w-0 items-center gap-2.5" }, pM = {
  key: 0,
    ...
    return (i, r) => (y(), x("section", {
      ...
      c("header", hM, [
        c("div", fM, [
          ...
          e.subtitle ? (y(), x("p", vM, $(e.subtitle), 1)) : R("", !0)
        ]),
        i.$slots.actions ? (y(), x("div", bM, [
          It(i.$slots, "actions")
        ])) : R("", !0)
      ]),
      i.$slots.default ? (y(), x("div", mM, [
        It(i.$slots, "default")
      ])) : R("", !0)
    ]));
  }
}), _M = { class: "flex flex-1 min-h-0" }, xM = {
  key: 0,
  class: "flex justify-center items-center mt-3 shrink-0"
}, kM = {
  class: "flex-1 overflow-y-auto p-1.5 flex flex-col gap-1",
  "aria-label": "Sections"
}, wM = ["aria-current", "title", "onClick"], $M = {
  key: 1,
  class: "shrink-0 border-t border-[color:var(--kiut-border-light)] bg-[color:var(--kiut-bg-secondary)]"
}, MM = { class: "px-4 pt-4 pb-2 shrink-0" }, CM = { class: "text-[12px] font-bold uppercase tracking-widest text-[color:var(--kiut-text-muted)]" }, SM = {
  class: "flex-1 overflow-y-auto px-2 pb-3 flex flex-col gap-1",
  "aria-label": "Section items"
}, DM = ["data-nav-id", "aria-current", "onClick"], AM = /* @__PURE__ */ tt({
...
export {
  ...
  _e as SankeyChart,
  yM as Section,
  P3 as SegmentedControl,
  Yi as Select,
  m_ as SelectLanguage,
  T3 as SelectablePills,
  e1 as Seller,
  x$ as Table,
  u$ as Tabs,
  Q3 as Tag,
