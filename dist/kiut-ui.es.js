import { defineComponent as tt, shallowRef as Io, h as $s, ref as at, onMounted as le, onUnmounted as He, watch as Rt, toRaw as Ms, nextTick as Ct, version as qi, isProxy as Ro, computed as C, toRef as lt, openBlock as y, createElementBlock as x, createVNode as Q, unref as T, normalizeStyle as ft, createElementVNode as c, toDisplayString as $, createCommentVNode as R, Fragment as q, renderList as J, onBeforeUnmount as Eo, createStaticVNode as st, withDirectives as Kt, vShow as la, normalizeClass as U, createBlock as dt, createTextVNode as kt, resolveDynamicComponent as ca, Transition as Is, withCtx as Ee, renderSlot as It, useSlots as Oo, Teleport as Rs, withModifiers as te, withKeys as Ra, vModelText as Oe, useAttrs as Vo, mergeProps as Cs } from "vue";
...
function Es(e) {
  ...
  let l, d, u;
  return o !== i && (u = o - i, d = r > 0.5 ? u / (2 - o - i) : u / (o + i), l = lr(a, s, n, u, o), l = l * 60 + 0.5), [l | 0, d || 0, r];
}
function Os(e, t, a, s) {
...
function Wr(e, t, a) {
  ...
  let n = 0, o = s;
  if (e._sorted) {
    const { iScale: i, vScale: r, _parsed: l } = e, d = e.dataset && e.dataset.options ? e.dataset.options.spanGaps : null, u = i.axis, { min: f, max: p, minDefined: v, maxDefined: h } = i.getUserBounds();
    if (v) {
      if (n = Math.min(
        ...
        const m = l.slice(0, n + 1).reverse().findIndex((b) => !pt(b[r.axis]));
        n -= Math.max(0, m);
      }
      n = Tt(n, 0, s - 1);
    }
    if (h) {
      let m = Math.max(
        // @ts-expect-error Need to type _parsed
        De(l, i.axis, p, !0).hi + 1,
        // @ts-expect-error Need to fix types on _lookupByKey
        a ? 0 : De(t, u, i.getPixelForValue(p), !0).hi + 1
      );
      if (d) {
        const b = l.slice(m - 1).findIndex((g) => !pt(g[r.axis]));
        m += Math.max(0, b);
      }
      o = Tt(m, n, s) - n;
    } else
...
const Xr = {
  ...
  numeric(e, t, a) {
    ...
    const i = Yo(Math.abs(o)), r = isNaN(i) ? 1 : Math.max(Math.min(-1 * Math.floor(i), 20), 0), l = {
      notation: n,
      minimumFractionDigits: r,
      maximumFractionDigits: r
    };
    return Object.assign(l, this.options.ticks.format), js(e, s, l);
  }
};
function Gr(e, t) {
    ...
    Object.defineProperties(o, {
      ...
      [a]: {
        ...
        get() {
          ...
          return ht(l) ? Object.assign({}, d, l) : it(l, d);
        },
        set(l) {
          this[r] = l;
        }
  ...
  if (!(isNaN(m) || m <= 0)) {
    switch (e.beginPath(), v) {
      ...
      default:
        ...
        break;
      case "triangle":
        u = n ? n / 2 : m, e.moveTo(a + Math.sin(b) * u, s - Math.cos(b) * m), b += un, e.lineTo(a + Math.sin(b) * u, s - Math.cos(b) * m), b += un, e.lineTo(a + Math.sin(b) * u, s - Math.cos(b) * m), e.closePath();
        break;
      case "rectRounded":
        d = m * 0.516, l = m - d, i = Math.cos(b + ke) * l, f = Math.cos(b + ke) * (n ? n / 2 - d : l), r = Math.sin(b + ke) * l, p = Math.sin(b + ke) * (n ? n / 2 - d : l), e.arc(a - f, s - r, d, b - mt, b - St), e.arc(a + p, s - i, d, b - St, b), e.arc(a + f, s + r, d, b, b + St), e.arc(a - p, s + i, d, b + St, b + mt), e.closePath();
        break;
      case "rect":
        if (!h) {
          l = Math.SQRT1_2 * m, u = n ? n / 2 : l, e.rect(a - u, s - l, 2 * u, 2 * l);
          break;
        }
        b += ke;
      /* falls through */
      case "rectRot":
        f = Math.cos(b) * (n ? n / 2 : m), i = Math.cos(b) * m, r = Math.sin(b) * m, p = Math.sin(b) * (n ? n / 2 : m), e.moveTo(a - f, s - r), e.lineTo(a + p, s - i), e.lineTo(a + f, s + r), e.lineTo(a - p, s + i), e.closePath();
        break;
      case "crossRot":
        b += ke;
      /* falls through */
      case "cross":
        f = Math.cos(b) * (n ? n / 2 : m), i = Math.cos(b) * m, r = Math.sin(b) * m, p = Math.sin(b) * (n ? n / 2 : m), e.moveTo(a - f, s - r), e.lineTo(a + f, s + r), e.moveTo(a + p, s - i), e.lineTo(a - p, s + i);
        break;
      case "star":
        f = Math.cos(b) * (n ? n / 2 : m), i = Math.cos(b) * m, r = Math.sin(b) * m, p = Math.sin(b) * (n ? n / 2 : m), e.moveTo(a - f, s - r), e.lineTo(a + f, s + r), e.moveTo(a + p, s - i), e.lineTo(a - p, s + i), b += ke, f = Math.cos(b) * (n ? n / 2 : m), i = Math.cos(b) * m, r = Math.sin(b) * m, p = Math.sin(b) * (n ? n / 2 : m), e.moveTo(a - f, s - r), e.lineTo(a + f, s + r), e.moveTo(a + p, s - i), e.lineTo(a - p, s + i);
        break;
      case "line":
        i = n ? n / 2 : Math.cos(b) * m, r = Math.sin(b) * m, e.moveTo(a - i, s - r), e.lineTo(a + i, s + r);
        break;
      case "dash":
        e.moveTo(a, s), e.lineTo(a + Math.cos(b) * (n ? n / 2 : m), s + Math.sin(b) * m);
        break;
      case !1:
        e.closePath();
        break;
...
function va(e, t, a, s, n, o = {}) {
  ...
  let l, d;
  for (e.save(), e.font = n.string, al(e, o), l = 0; l < i.length; ++l)
    d = i[l], o.backdrop && nl(e, o.backdrop), r && (o.strokeColor && (e.strokeStyle = o.strokeColor), pt(o.strokeWidth) || (e.lineWidth = o.strokeWidth), e.strokeText(d, a, s, o.maxWidth)), e.fillText(d, a, s, o.maxWidth), sl(e, a, s, d, o), s += Number(n.lineHeight);
  e.restore();
}
function za(e, t) {
...
function cl(e, t, a) {
  const { min: s, max: n } = e, o = Ho(t, (n - s) / 2), i = (r, l) => a && r === 0 ? 0 : r + l;
  return {
    min: i(s, -Math.abs(o)),
    max: i(n, o)
  };
...
const dl = (e, t) => e ? e + zs(t) : t, Ks = (e, t) => ht(t) && e !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function ei(e, t, a) {
...
function ul(e, t, a) {
  ...
  let r = s[t];
  return me(r) && i.isScriptable(t) && (r = hl(t, r, e, a)), Mt(r) && r.length && (r = fl(t, r, e, i.isIndexable)), Ks(t, r) && (r = Ne(r, n, o && o[t], i)), r;
}
function hl(e, t, a, s) {
  ...
  r.add(e);
  let l = t(o, i || s);
  return r.delete(e), Ks(e, l) && (l = qs(n._scopes, n, e, l)), l;
}
function fl(e, t, a, s) {
...
function qs(e, t, a, s) {
  ...
  r.add(s);
  let l = xn(r, i, a, o || a, s);
  return l === null || typeof o < "u" && o !== a && (l = xn(r, i, o, l, s), l === null) ? !1 : Us(Array.from(r), [
    ""
  ], n, o, () => vl(t, a, s));
}
...
function _l(e, t, a, s) {
  const n = e.skip ? t : e, o = t, i = a.skip ? t : a, r = Ds(o, n), l = Ds(i, o);
  let d = r / (r + l), u = l / (r + l);
...
function xl(e, t, a) {
  const s = e.length;
  let n, o, i, r, l, d = We(e, 0);
  for (let u = 0; u < s - 1; ++u)
    if (l = d, d = We(e, u + 1), !(!l || !d)) {
      if (oa(t[u], 0, yl)) {
        a[u] = a[u + 1] = 0;
        continue;
      }
...
function kl(e, t, a = "x") {
  ...
  let o, i, r, l = We(e, 0);
  for (let d = 0; d < n; ++d) {
    if (i = r, r = l, l = We(e, d + 1), !r)
      continue;
    const u = r[a], f = r[s];
    i && (o = (u - i[a]) / 3, r[`cp1${a}`] = u - o, r[`cp1${s}`] = f - o * t[d]), l && (o = (l[a] - u) / 3, r[`cp2${a}`] = u + o, r[`cp2${s}`] = f + o * t[d]);
  }
}
function wl(e, t = "x") {
...
function Ml(e, t, a, s, n) {
  ...
  if (t.spanGaps && (e = e.filter((d) => !d.skip)), t.cubicInterpolationMode === "monotone")
    ...
    for (o = 0, i = e.length; o < i; ++o)
      r = e[o], l = _l(d, r, e[Math.min(o + 1, i - (s ? 0 : 1)) % i], t.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, d = r;
  }
...
function Ce(e, t) {
  if ("native" in e)
    return e;
  const { canvas: a, currentDevicePixelRatio: s } = t, n = Ua(a), o = n.boxSizing === "border-box", i = Ae(n, "padding"), r = Ae(n, "border", "width"), { x: l, y: d, box: u } = Al(e, a), f = i.left + (u && r.left), p = i.top + (u && r.top);
  let { width: v, height: h } = t;
  return o && (v -= i.width + r.width, h -= i.height + r.height), {
    x: Math.round((l - f) / v * a.width / s),
...
function Tl(e, t, a) {
  ...
  if (t === void 0 || a === void 0) {
    ...
    if (!o)
      ...
      const i = o.getBoundingClientRect(), r = Ua(o), l = Ae(r, "border", "width"), d = Ae(r, "padding");
      t = i.width - d.width - l.width, a = i.height - d.height - l.height, s = Na(r.maxWidth, o, "clientWidth"), n = Na(r.maxHeight, o, "clientHeight");
    }
  }
  return {
    width: t,
...
function Bl(e, t, a, s) {
  const n = Ua(e), o = Ae(n, "margin"), i = Na(n.maxWidth, e, "clientWidth") || Va, r = Na(n.maxHeight, e, "clientHeight") || Va, l = Tl(e, t, a);
  let { width: d, height: u } = l;
  if (n.boxSizing === "content-box") {
    const p = Ae(n, "border", "width"), v = Ae(n, "padding");
    d -= v.width + p.width, u -= v.height + p.height;
  }
  return d = Math.max(0, d - o.width), u = Math.max(0, s ? d / s : u - o.height), d = pe(Math.min(d, i, l.maxWidth)), u = pe(Math.min(u, r, l.maxHeight)), d && !u && (u = pe(d / 2)), (t !== void 0 || a !== void 0) && s && l.height && u > l.height && (u = l.height, d = pe(Math.floor(u * s))), {
    width: d,
    height: u
  };
}
...
function El(e, t, a) {
  const { property: s, start: n, end: o } = a, { between: i, normalize: r } = ri(s), l = t.length;
...
function li(e, t, a) {
  ...
  const { property: s, start: n, end: o } = a, i = t.length, { compare: r, between: l, normalize: d } = ri(s), { start: u, end: f, loop: p, style: v } = El(e, t, a), h = [];
  let m = !1, b = null, g, _, k;
  const w = () => l(n, k, g) && r(n, k) !== 0, M = () => r(o, g) === 0 || l(o, k, g), S = () => m || w(), D = () => !m || M();
  for (let A = u, B = u; A <= f; ++A)
    _ = t[A % i], !_.skip && (g = d(_[s]), g !== k && (m = l(g, n, o), b === null && S() && (b = r(g, n) === 0 ? A : B), b !== null && D() && (h.push(Mn({
      start: b,
      end: A,
      loop: p,
      count: i,
  ...
  for (const h of t) {
    ...
    for (p = f + 1; p <= h.end; p++) {
      ...
      b = Sn(s.setContext(Le(n, {
        ...
        p1DataIndex: p % l,
        datasetIndex: i
      }))), Wl(b, u) && v(f, p - 1, h.loop, u), m = g, u = b;
    }
...
function Tn(e, t, a, s = {}) {
  ...
  for (i = 0, r = n.length; i < r; ++i) {
    ...
    d = e.values[l], Lt(d) && (o || t === 0 || Jt(t) === Jt(d)) && (t += d);
  }
  return !u && !s.all ? 0 : t;
}
function Zl(e, t) {
...
function Ln(e, t) {
  const { chart: a, _cachedMeta: s } = e, n = a._stacks || (a._stacks = {}), { iScale: o, vScale: i, index: r } = s, l = o.axis, d = i.axis, u = Ql(o, i, s), f = t.length;
  let p;
  for (let v = 0; v < f; ++v) {
    const h = t[v], { [l]: m, [d]: b } = h, g = h._stacks || (h._stacks = {});
    p = g[d] = tc(n, u, m), p[r] = b, p._top = Bn(p, i, !0, s.type), p._bottom = Bn(p, i, !1, s.type);
...
class Ka {
  ...
  linkScales() {
    const t = this.chart, a = this._cachedMeta, s = this.getDataset(), n = (f, p, v, h) => f === "x" ? p : f === "r" ? h : v, o = a.xAxisID = it(s.xAxisID, ns(t, "x")), i = a.yAxisID = it(s.yAxisID, ns(t, "y")), r = a.rAxisID = it(s.rAxisID, ns(t, "r")), l = a.indexAxis, d = a.iAxisID = n(l, o, i, r), u = a.vAxisID = n(l, i, o, r);
  ...
  parse(t, a) {
    ...
    let l = t === 0 && a === n.length ? !0 : s._sorted, d = t > 0 && s._parsed[t - 1], u, f, p;
    if (this._parsing === !1)
      ...
      for (u = 0; u < a; ++u)
        s._parsed[u + t] = f = p[u], l && (v() && (l = !1), d = f);
      s._sorted = l;
    }
    i && Ln(this, p);
  }
  parsePrimitiveData(t, a, s, n) {
    const { iScale: o, vScale: i } = t, r = o.axis, l = i.axis, d = o.getLabels(), u = o === i, f = new Array(n);
    let p, v, h;
    for (p = 0, v = n; p < v; ++p)
      h = p + s, f[p] = {
        [r]: u || o.parse(d[h], h),
  ...
  getMinMax(t, a) {
    const s = this._cachedMeta, n = s._parsed, o = s._sorted && t === s.iScale, i = n.length, r = this._getOtherScale(t), l = sc(a, s, this.chart), d = {
    ...
    for (p = 0; p < i && !(!h() && (this.updateRangeFromParsed(d, t, v, l), o)); ++p)
      ;
    if (o) {
      for (p = i - 1; p >= 0; --p)
        if (!h()) {
  ...
  _resolveElementOptions(t, a = "default", s) {
    const n = a === "active", o = this._cachedDataOpts, i = t + "-" + a, r = o[i], l = this.enableOptionSharing && ha(s);
    if (r)
      return Fn(r, l);
    ...
    return m.$shared && (m.$shared = l, o[i] = Object.freeze(Fn(m, l))), m;
  }
  _resolveAnimations(t, a, s) {
    ...
    const d = new ui(n, l && l.animations);
...
function Pn(e, t, a, s) {
  ...
  let d, u, f, p;
  for (d = a, u = a + s; d < u; ++d)
    p = t[d], f = {}, f[n.axis] = r || n.parse(i[d], d), l.push(fi(p, f, o, d));
  return l;
}
function is(e) {
...
function uc(e, t, a, s) {
  ...
  const { start: i, end: r, reverse: l, top: d, bottom: u } = dc(e);
  n === "middle" && a && (e.enableBorderRadius = !0, (a._top || 0) === s ? n = d : (a._bottom || 0) === s ? n = u : (o[In(u, i, r, l)] = !0, n = d)), o[In(n, i, r, l)] = !0, e.borderSkipped = o;
}
function In(e, t, a, s) {
...
class gc extends Ka {
  ...
  parseObjectData(t, a, s, n) {
    const { iScale: o, vScale: i } = t, { xAxisKey: r = "x", yAxisKey: l = "y" } = this._parsing, d = o.axis === "x" ? r : l, u = i.axis === "x" ? r : l, f = [];
    let p, v, h, m;
    for (p = s, v = s + n; p < v; ++p)
  ...
  updateElements(t, a, s, n) {
    const o = n === "reset", { index: i, _cachedMeta: { vScale: r } } = this, l = r.getBasePixel(), d = r.isHorizontal(), u = this._getRuler(), { sharedOptions: f, includeOptions: p } = this._getSharedOptions(a, n);
    for (let v = a; v < a + s; v++) {
      const h = this.getParsed(v), m = o || pt(h[r.axis]) ? {
        base: l,
        head: l
      } : this._calculateBarValuePixels(v), b = this._calculateBarIndexPixels(v, u), g = (h._stacks || {})[r.axis], _ = {
        horizontal: d,
        base: m.base,
        enableBorderRadius: !g || is(h._custom) || i === g._top || i === g._bottom,
        x: d ? m.head : b.center,
        y: d ? b.center : m.head,
        height: d ? b.size : Math.abs(m.size),
        width: d ? Math.abs(m.size) : b.size
      };
      p && (_.options = f || this.resolveDataElementOptions(v, t[v].active ? "active" : n));
      const k = _.options || t[v].options;
      uc(_, k, g, i), fc(_, k, u.ratio), this.updateElement(t[v], v, _, n);
    }
  }
  _getStacks(t, a) {
    const { iScale: s } = this._cachedMeta, n = s.getMatchingVisibleMetas(this._type).filter((u) => u.controller.options.grouped), o = s.options.stacked, i = [], r = this._cachedMeta.controller.getParsed(a), l = r && r[s.axis], d = (u) => {
      const f = u._parsed.find((v) => v[s.axis] === l), p = f && f[u.vScale.axis];
      if (pt(p) || isNaN(p))
        return !0;
    };
    for (const u of n)
  ...
  _calculateBarValuePixels(t) {
    const { _cachedMeta: { vScale: a, _stacked: s, index: n }, options: { base: o, minBarLength: i } } = this, r = o || 0, l = this.getParsed(t), d = l._custom, u = is(d);
    let f = l[a.axis], p = 0, v = s ? this.applyStack(a, l, s) : f, h, m;
    ...
    if (this.chart.getDataVisibility(t) ? h = a.getPixelForValue(p + v) : h = g, m = h - g, Math.abs(m) < i) {
      ...
      const _ = a.getPixelForDecimal(0), k = a.getPixelForDecimal(1), w = Math.min(_, k), M = Math.max(_, k);
      g = Math.max(Math.min(g, M), w), h = g + m, s && !u && (l._stacks[a.axis]._visualValues[n] = a.getValueForPixel(h) - a.getValueForPixel(g));
    }
    if (g === a.getPixelForValue(r)) {
      const _ = Jt(m) * a.getLineWidthForValue(r) / 2;
      g += _, m -= _;
    }
    return {
      size: m,
...
function pc(e, t, a) {
  let s = 1, n = 1, o = 0, i = 0;
  if (t < _t) {
    const r = e, l = r + t, d = Math.cos(r), u = Math.sin(r), f = Math.cos(l), p = Math.sin(l), v = (k, w, M) => ga(k, r, l, !0) ? 1 : Math.max(w, w * a, M, M * a), h = (k, w, M) => ga(k, r, l, !0) ? -1 : Math.min(w, w * a, M, M * a), m = v(0, d, f), b = v(St, u, p), g = h(mt, d, f), _ = h(mt + St, u, p);
    s = (m - g) / 2, n = (b - _) / 2, o = -(m + g) / 2, i = -(b + _) / 2;
  }
  return {
    ratioX: s,
    ratioY: n,
...
class vc extends Ka {
  ...
  update(t) {
    const a = this.chart, { chartArea: s } = a, n = this._cachedMeta, o = n.data, i = this.getMaxBorderWidth() + this.getMaxOffset(o) + this.options.spacing, r = Math.max((Math.min(s.width, s.height) - i) / 2, 0), l = Math.min(kr(this.options.cutout, r), 1), d = this._getRingWeight(this.index), { circumference: u, rotation: f } = this._getRotationExtents(), { ratioX: p, ratioY: v, offsetX: h, offsetY: m } = pc(f, u, l), b = (s.width - i) / p, g = (s.height - i) / v, _ = Math.max(Math.min(b, g) / 2, 0), k = Ho(this.options.radius, _), w = Math.max(k * l, 0), M = (k - w) / this._getVisibleDatasetWeightTotal();
  ...
  updateElements(t, a, s, n) {
    const o = n === "reset", i = this.chart, r = i.chartArea, d = i.options.animation, u = (r.left + r.right) / 2, f = (r.top + r.bottom) / 2, p = o && d.animateScale, v = p ? 0 : this.innerRadius, h = p ? 0 : this.outerRadius, { sharedOptions: m, includeOptions: b } = this._getSharedOptions(a, n);
    let g = this._getRotation(), _;
    for (_ = 0; _ < a; ++_)
      g += this._circumference(_, o);
    for (_ = a; _ < a + s; ++_) {
      const k = this._circumference(_, o), w = t[_], M = {
        x: u + this.offsetX,
        y: f + this.offsetY,
        startAngle: g,
        endAngle: g + k,
      ...
      b && (M.options = m || this.resolveDataElementOptions(_, w.active ? "active" : n)), g += k, this.updateElement(w, _, M, n);
    }
  }
  calculateTotal() {
...
class bc extends Ka {
  ...
  update(t) {
    ...
    let { start: r, count: l } = Wr(a, n, i);
    this._drawStart = r, this._drawCount = l, Hr(a) && (r = 0, l = n.length), s._chart = this.chart, s._datasetIndex = this.index, s._decimated = !!o._decimated, s.points = n;
  ...
  updateElements(t, a, s, n) {
    const o = n === "reset", { iScale: i, vScale: r, _stacked: l, _dataset: d } = this._cachedMeta, { sharedOptions: u, includeOptions: f } = this._getSharedOptions(a, n), p = i.axis, v = r.axis, { spanGaps: h, segment: m } = this.options, b = fa(h) ? h : Number.POSITIVE_INFINITY, g = this.chart._animationsDisabled || o || n === "none", _ = a + s, k = t.length;
    ...
    for (let M = 0; M < k; ++M) {
      ...
      const A = this.getParsed(M), B = pt(A[v]), F = D[p] = i.getPixelForValue(A[p], M), P = D[v] = o || B ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, A, l) : A[v], M);
      D.skip = isNaN(F) || isNaN(P) || B, D.stop = M > 0 && Math.abs(A[p] - w[p]) > b, m && (D.parsed = A, D.raw = d.data[M]), f && (D.options = u || this.resolveDataElementOptions(M, S.active ? "active" : n)), g || this.updateElement(S, M, D, n), w = A;
    }
  }
  getMaxOverflow() {
...
var $c = {
  modes: {
    index(e, t, a, s) {
      const n = Ce(t, e), o = a.axis || "x", i = a.includeInvisible || !1, r = a.intersect ? rs(e, n, o, s, i) : ls(e, n, o, !1, s, i), l = [];
...
function Dc(e) {
  const t = Mc(e), a = Ge(t.filter((d) => d.box.fullSize), !0), s = Ge(Xe(t, "left"), !0), n = Ge(Xe(t, "right")), o = Ge(Xe(t, "top"), !0), i = Ge(Xe(t, "bottom")), r = On(t, "x"), l = On(t, "y");
  return {
    fullSize: a,
...
function Ac(e, t, a, s) {
  ...
  const r = Math.max(0, t.outerWidth - Vn(i, e, "left", "right")), l = Math.max(0, t.outerHeight - Vn(i, e, "top", "bottom")), d = r !== e.w, u = l !== e.h;
...
function aa(e, t, a, s) {
  ...
  for (o = 0, i = e.length, d = 0; o < i; ++o) {
    r = e[o], l = r.box, l.update(r.width || t.w, r.height || t.h, Bc(r.horizontal, t));
...
function zn(e, t, a, s) {
  ...
  for (const r of e) {
    ...
    if (r.horizontal) {
      ...
      ha(d.start) && (i = d.start), l.fullSize ? Sa(l, n.left, i, a.outerWidth - n.right - n.left, p) : Sa(l, t.left + d.placed, i, f, p), d.start = i, d.placed += f, i = l.bottom;
    } else {
      const f = t.h * u, p = d.size || l.width;
      ha(d.start) && (o = d.start), l.fullSize ? Sa(l, o, n.top, p, a.outerHeight - n.bottom - n.top) : Sa(l, o, t.top + d.placed, p, f), d.start = o, d.placed += f, o = l.right;
    }
  }
  t.x = o, t.y = i;
}
var jt = {
  ...
  update(e, t, a, s) {
    if (!e)
      return;
    const n = Yt(e.options.layout.padding), o = Math.max(t - n.width, 0), i = Math.max(a - n.height, 0), r = Dc(e.boxes), l = r.vertical, d = r.horizontal;
    vt(e.boxes, (m) => {
      typeof m.beforeLayout == "function" && m.beforeLayout();
    });
    const u = l.reduce((m, b) => b.box.options && b.box.options.display === !1 ? m : m + 1, 0) || 1, f = Object.freeze({
      outerWidth: t,
      outerHeight: a,
      padding: n,
      availableWidth: o,
    ...
    aa(r.fullSize, v, f, h), aa(l, v, f, h), aa(d, v, f, h) && aa(l, v, f, h), Tc(v), zn(r.leftAndTop, v, f, h), v.x += v.w, v.y += v.h, zn(r.rightAndBottom, v, f, h), e.chartArea = {
      left: v.left,
      top: v.top,
      right: v.left + v.w,
      bottom: v.top + v.h,
...
function Uc(e, t) {
  const a = e.options.ticks, s = Kc(e), n = Math.min(a.maxTicksLimit || s, s), o = a.major.enabled ? Xc(t) : [], i = o.length, r = o[0], l = o[i - 1], d = [];
  if (i > n)
  ...
  if (i > 0) {
    ...
    for (Da(t, d, u, pt(v) ? 0 : r - v, r), f = 0, p = i - 1; f < p; f++)
      Da(t, d, u, o[f], o[f + 1]);
    return Da(t, d, u, l, pt(v) ? t.length : l + v), d;
  }
  return Da(t, d, u), d;
}
function Kc(e) {
...
function nd(e, t, a, s) {
  ...
  if (e.isHorizontal()) {
    if (v = At(s, o, r), ht(a)) {
      const g = Object.keys(a)[0], _ = a[g];
      h = u[g].getPixelForValue(_) + m - t;
    } else a === "center" ? h = (d.bottom + d.top) / 2 + m - t : h = Hn(e, a, t);
    p = r - o;
  } else {
    if (ht(a)) {
      const g = Object.keys(a)[0], _ = a[g];
      v = u[g].getPixelForValue(_) - b + t;
...
class je extends ce {
  ...
  update(t, a, s) {
    ...
    this._convertTicksToLabels(l ? Yn(this.ticks, r) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), i.display && (i.autoSkip || i.source === "auto") && (this.ticks = Uc(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), l && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate();
  }
  configure() {
  ...
  calculateLabelRotation() {
    ...
    r = t.offset ? this.maxWidth / s : v / (s - 1), f + 6 > r && (r = v / (s - (t.offset ? 0.5 : 1)), l = this.maxHeight - Ze(t.grid) - a.padding - Un(t.title, this.chart.options.font), d = Math.sqrt(f * f + p * p), i = Pr(Math.min(Math.asin(Tt((u.highest.height + 6) / r, -1, 1)), Math.asin(Tt(l / d, -1, 1)) - Math.asin(Tt(p / d, -1, 1)))), i = Math.max(n, Math.min(o, i))), this.labelRotation = i;
  }
  ...
  fit() {
    ...
    if (i) {
      const l = Un(n, a.options.font);
      if (r ? (t.width = this.maxWidth, t.height = Ze(o) + l) : (t.height = this.maxHeight, t.width = Ze(o) + l), s.display && this.ticks.length) {
        const { first: d, last: u, widest: f, highest: p } = this._getLabelSizes(), v = s.padding * 2, h = oe(this.labelRotation), m = Math.cos(h), b = Math.sin(h);
        if (r) {
          const g = s.mirror ? 0 : b * f.width + m * p.height;
          t.height = Math.min(this.maxHeight, t.height + g + v);
        } else {
          const g = s.mirror ? 0 : m * f.width + b * p.height;
          t.width = Math.min(this.maxWidth, t.width + g + v);
        }
        this._calculatePadding(d, u, b, m);
      }
    }
  ...
  _calculatePadding(t, a, s, n) {
    ...
    if (this.isHorizontal()) {
      ...
      let p = 0, v = 0;
      l ? d ? (p = n * t.width, v = s * a.height) : (p = s * t.height, v = n * a.width) : o === "start" ? v = a.width : o === "end" ? p = t.width : o !== "inner" && (p = t.width / 2, v = a.width / 2), this.paddingLeft = Math.max((p - u + i) * this.width / (this.width - u), 0), this.paddingRight = Math.max((v - f + i) * this.width / (this.width - f), 0);
    } else {
  ...
  _computeLabelSizes(t, a, s) {
    const { ctx: n, _longestTextCache: o } = this, i = [], r = [], l = Math.floor(a / jn(a, s));
    let d = 0, u = 0, f, p, v, h, m, b, g, _, k, w, M;
    for (f = 0; f < a; f += l) {
      if (h = t[f].label, m = this._resolveTickFontOptions(f), n.font = b = m.string, g = o[b] = o[b] || {
        data: {},
        gc: []
      }, _ = m.lineHeight, k = w = 0, !pt(h) && !Mt(h))
        k = yn(n, g.data, g.gc, k, h), w = _;
      else if (Mt(h))
        for (p = 0, v = h.length; p < v; ++p)
          M = h[p], !pt(M) && !Mt(M) && (k = yn(n, g.data, g.gc, k, M), w += _);
  ...
  _tickSize() {
    const t = this.options.ticks, a = oe(this.labelRotation), s = Math.abs(Math.cos(a)), n = Math.abs(Math.sin(a)), o = this._getLabelSizes(), i = t.autoSkipPadding || 0, r = o ? o.widest.width + i : 0, l = o ? o.highest.height + i : 0;
  ...
  _computeGridLineItems(t) {
    const a = this.axis, s = this.chart, n = this.options, { grid: o, position: i, border: r } = n, l = o.offset, d = this.isHorizontal(), f = this.ticks.length + (l ? 1 : 0), p = Ze(o), v = [], h = r.setContext(this.getContext()), m = h.display ? h.width : 0, b = m / 2, g = function(O) {
      return we(s, O, m);
    };
    let _, k, w, M, S, D, A, B, F, P, E, N;
    if (i === "top")
      _ = g(this.bottom), D = this.bottom - p, B = _ - b, P = g(t.top) + b, N = t.bottom;
    else if (i === "bottom")
      _ = g(this.top), P = t.top, N = g(t.bottom) - b, D = _ + b, B = this.top + p;
    else if (i === "left")
      _ = g(this.right), S = this.right - p, A = _ - b, F = g(t.left) + b, E = t.right;
    else if (i === "right")
      _ = g(this.left), F = t.left, E = g(t.right) - b, S = _ + b, A = this.left + p;
    else if (a === "x") {
      if (i === "center")
        _ = g((t.top + t.bottom) / 2 + 0.5);
      else if (ht(i)) {
        const O = Object.keys(i)[0], j = i[O];
        _ = g(this.chart.scales[O].getPixelForValue(j));
      }
      P = t.top, N = t.bottom, D = _ + b, B = D + p;
    } else if (a === "y") {
      if (i === "center")
        _ = g((t.left + t.right) / 2);
      else if (ht(i)) {
        const O = Object.keys(i)[0], j = i[O];
        _ = g(this.chart.scales[O].getPixelForValue(j));
      }
      S = _ - b, A = S - p, F = t.left, E = t.right;
    }
    const Y = it(n.ticks.maxTicksLimit, f), L = Math.max(1, Math.ceil(f / Y));
    for (k = 0; k < f; k += L) {
      const O = this.getContext(k), j = o.setContext(O), V = r.setContext(O), z = j.lineWidth, H = j.color, et = V.dash || [], G = V.dashOffset, K = j.tickWidth, ot = j.tickColor, wt = j.tickBorderDash || [], gt = j.tickBorderDashOffset;
      w = Jc(this, k, l), w !== void 0 && (M = we(s, w, z), d ? S = A = F = E = M : D = B = P = N = M, v.push({
        tx1: S,
        ty1: D,
        tx2: A,
        ty2: B,
    ...
    return this._ticksLength = f, this._borderValue = _, v;
  }
  _computeLabelItems(t) {
    const a = this.axis, s = this.options, { position: n, ticks: o } = s, i = this.isHorizontal(), r = this.ticks, { align: l, crossAlign: d, padding: u, mirror: f } = o, p = Ze(s.grid), v = p + u, h = f ? -u : v, m = -oe(this.labelRotation), b = [];
    let g, _, k, w, M, S, D, A, B, F, P, E, N = "middle";
    if (n === "top")
    ...
    a === "y" && (l === "start" ? N = "top" : l === "end" && (N = "bottom"));
    const Y = this._getLabelSizes();
    for (g = 0, _ = r.length; g < _; ++g) {
      k = r[g], w = k.label;
      ...
      let H = D;
      i ? (M = A, D === "inner" && (g === _ - 1 ? H = this.options.reverse ? "left" : "right" : g === 0 ? H = this.options.reverse ? "right" : "left" : H = "center"), n === "top" ? d === "near" || m !== 0 ? E = -P * F + F / 2 : d === "center" ? E = -Y.highest.height / 2 - O * F + F : E = -Y.highest.height + F / 2 : d === "near" || m !== 0 ? E = F / 2 : d === "center" ? E = Y.highest.height / 2 - O * F : E = Y.highest.height - P * F, f && (E *= -1), m !== 0 && !L.showLabelBackdrop && (M += F / 2 * Math.sin(m))) : (S = A, E = (1 - P) * F / 2);
      let et;
      if (L.showLabelBackdrop) {
        const G = Yt(L.backdropPadding), K = Y.heights[g], ot = Y.widths[g];
        let wt = E - G.top, gt = 0 - G.left;
        switch (N) {
          case "middle":
            wt -= K / 2;
            break;
  ...
  drawBorder() {
    ...
    let d, u, f, p;
    this.isHorizontal() ? (d = we(t, this.left, i) - i / 2, u = we(t, this.right, r) + r / 2, f = p = l) : (f = we(t, this.top, i) - i / 2, p = we(t, this.bottom, r) + r / 2, d = u = l), a.save(), a.lineWidth = o.width, a.strokeStyle = o.color, a.beginPath(), a.moveTo(d, f), a.lineTo(u, p), a.stroke(), a.restore();
  }
  drawLabels(t) {
  ...
  drawTitle() {
    ...
    const { titleX: d, titleY: u, maxWidth: f, rotation: p } = nd(this, l, a, r);
    va(t, s.text, 0, 0, o, {
      color: s.color,
      maxWidth: f,
      rotation: p,
...
class ld {
  constructor() {
    this.controllers = new Aa(Ka, "datasets", !0), this.elements = new Aa(ce, "elements"), this.plugins = new Aa(Object, "plugins"), this.scales = new Aa(je, "scales"), this._typedRegistries = [
      this.controllers,
      this.scales,
      this.elements
    ];
...
function Ls(e, ...t) {
  if (Kn(e))
    return e;
  for (const a of t) {
    const s = a.axis || vd(a.position) || e.length > 1 && Kn(e[0].toLowerCase());
    if (s)
      return s;
  }
...
function md(e, t) {
  ...
  return Object.keys(s).forEach((i) => {
    ...
    const l = Ls(i, r, bd(i, e), $t.scales[r.type]), d = pd(l, n), u = a.scales || {};
    ...
    const r = i.type || e.type, l = i.indexAxis || Bs(r, t), u = (Be[r] || {}).scales || {};
    Object.keys(u).forEach((f) => {
      const p = gd(f, l), v = i[p + "AxisID"] || p;
...
class _d {
  ...
  getOptionScopes(t, a, s) {
    ...
    a.forEach((u) => {
      t && (l.add(t), u.forEach((f) => Qe(l, t, f))), u.forEach((f) => Qe(l, n, f)), u.forEach((f) => Qe(l, Be[o] || {}, f)), u.forEach((f) => Qe(l, $t, f)), u.forEach((f) => Qe(l, As, f));
    });
...
let Ye = class {
  ...
  constructor(t, a) {
    ...
    if (this.id = xr(), this.ctx = r, this.canvas = l, this.width = u, this.height = d, this._options = i, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new cd(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = zr((f) => this.update(f), i.resizeDelay || 0), this._dataChanges = [], Pa[this.id] = this, !r || !l) {
  ...
  buildOrUpdateScales() {
    ...
    a && (o = o.concat(Object.keys(a).map((i) => {
      const r = a[i], l = Ls(i, r), d = l === "r", u = l === "x";
      return {
        options: r,
      ...
      const r = i.options, l = r.id, d = Ls(l, r), u = it(r.type, i.dtype);
      (r.position === void 0 || Zn(r.position, d) !== Zn(i.dposition)) && (r.position = i.dposition), n[l] = !0;
      let f = null;
  ...
  _updateHoverStyles(t, a, s) {
    const n = this.options.hover, o = (l, d) => l.filter((u) => !d.some((f) => u.datasetIndex === f.datasetIndex && u.index === f.index)), i = o(a, t), r = s ? t : o(t, a);
...
function Dd(e, t, a) {
  const { startAngle: s, x: n, y: o, outerRadius: i, innerRadius: r, options: l } = t, { borderWidth: d, borderJoinStyle: u } = l, f = Math.min(d / i, Wt(s - a));
  if (e.beginPath(), e.arc(n, o, i - d / 2, s + f / 2, a - f / 2), r > 0) {
    ...
    if (u === "round")
      ...
      const v = 2 * p * p, h = -v * Math.cos(a + mt / 2) + n, m = -v * Math.sin(a + mt / 2) + o, b = v * Math.cos(s + mt / 2) + n, g = v * Math.sin(s + mt / 2) + o;
      e.lineTo(h, m), e.lineTo(b, g);
    }
  }
...
function Bd(e, t, a, s) {
  const n = Td(e.options.borderRadius), o = (a - t) / 2, i = Math.min(o, s * t / 2), r = (l) => {
...
function Ha(e, t, a, s, n, o) {
  const { x: i, y: r, startAngle: l, pixelMargin: d, innerRadius: u } = t, f = Math.max(t.outerRadius + s + a - d, 0), p = u > 0 ? u + s + a + d : 0;
  let v = 0;
  const h = n - l;
  if (s) {
  ...
  const m = Math.max(1e-3, h * f - a / mt) / f, b = (h - m) / 2, g = l + b + v, _ = n - b - v, { outerStart: k, outerEnd: w, innerStart: M, innerEnd: S } = Bd(t, p, f, _ - g), D = f - k, A = f - w, B = g + k / D, F = _ - w / A, P = p + M, E = p + S, N = g + M / P, Y = _ - S / E;
  if (e.beginPath(), o) {
    const L = (B + F) / 2;
    if (e.arc(i, r, f, B, L), e.arc(i, r, f, L, F), w > 0) {
      const z = Ie(A, F, i, r);
      e.arc(z.x, z.y, w, F, _ + St);
    }
    const O = Ie(E, _, i, r);
    if (e.lineTo(O.x, O.y), S > 0) {
      const z = Ie(E, Y, i, r);
      e.arc(z.x, z.y, S, _ + St, Y + Math.PI);
    }
    const j = (_ - S / p + (g + M / p)) / 2;
    if (e.arc(i, r, p, _ - S / p, j, !0), e.arc(i, r, p, j, g + M / p, !0), M > 0) {
      const z = Ie(P, N, i, r);
...
function Ld(e, t, a, s, n) {
  ...
  return Ha(e, t, a, s, l, n), e.fill(), l;
}
function Fd(e, t, a, s, n) {
  const { fullCircles: o, startAngle: i, circumference: r, options: l } = t, { borderWidth: d, borderJoinStyle: u, borderDash: f, borderDashOffset: p, borderRadius: v } = l, h = l.borderAlign === "inner";
  if (!d)
    return;
  ...
  h && Ad(e, t, m), l.selfJoin && m - i >= mt && v === 0 && u !== "miter" && Dd(e, t, m), o || (Ha(e, t, a, s, m, n), e.stroke());
}
class Pd extends ce {
  static id = "arc";
  static defaults = {
  ...
  inRange(t, a, s) {
    const n = this.getProps([
      ...
      "outerRadius",
      "circumference"
    ], s), p = (this.options.spacing + this.options.borderWidth) / 2, v = it(f, l - r), h = ga(o, r, l) && r !== l, m = v >= _t || h, b = ie(i, d + p, u + p);
    return m && b;
  }
  getCenterPoint(t) {
    const { x: a, y: s, startAngle: n, endAngle: o, innerRadius: i, outerRadius: r } = this.getProps([
      ...
      "innerRadius",
      "outerRadius"
    ], t), { offset: l, spacing: d } = this.options, u = (n + o) / 2, f = (i + r + d + l) / 2;
    return {
      x: a + Math.cos(u) * f,
      y: s + Math.sin(u) * f
    };
  ...
  draw(t) {
    ...
    const l = 1 - Math.sin(Math.min(mt, s || 0)), d = n * l;
...
function Ed(e, t, a, s) {
  const { points: n, options: o } = t, { count: i, start: r, loop: l, ilen: d } = $i(n, a, s), u = Rd(o);
  let { move: f = !0, reverse: p } = s || {}, v, h, m;
  for (v = 0; v <= d; ++v)
    h = n[(r + (p ? d - v : v)) % i], !h.skip && (f ? (e.moveTo(h.x, h.y), f = !1) : u(e, m, h, p, o.stepped), m = h);
  return l && (h = n[(r + (p ? d : 0)) % i], u(e, m, h, p, o.stepped)), !!l;
}
function Od(e, t, a, s) {
  const n = t.points, { count: o, start: i, ilen: r } = $i(n, a, s), { move: l = !0, reverse: d } = s || {};
  let u = 0, f = 0, p, v, h, m, b, g;
  const _ = (w) => (i + (d ? r - w : w)) % o, k = () => {
    m !== b && (e.lineTo(u, b), e.lineTo(u, m), e.lineTo(u, g));
  };
  for (l && (v = n[_(0)], e.moveTo(v.x, v.y)), p = 0; p <= r; ++p) {
    if (v = n[_(p)], v.skip)
      continue;
    const w = v.x, M = v.y, S = w | 0;
    S === h ? (M < m ? m = M : M > b && (b = M), u = (f * u + w) / ++f) : (k(), e.lineTo(w, M), h = S, f = 0, m = b = M), g = M;
  }
  k();
}
function Fs(e) {
...
class Xa extends ce {
  ...
  interpolate(t, a) {
    ...
    for (d = 0, u = i.length; d < u; ++d) {
      ...
      const m = Math.abs((n - v[a]) / (h[a] - v[a])), b = l(v, h, m, s.stepped);
      b[a] = t[a], r.push(b);
    }
...
function Mi(e, t) {
  ...
  let r, l, d, u, f;
  return e.horizontal ? (f = i / 2, r = Math.min(a, n), l = Math.max(a, n), d = s - f, u = s + f) : (f = o / 2, r = a - f, l = a + f, d = Math.min(s, n), u = Math.max(s, n)), {
    left: r,
    top: d,
    right: l,
    bottom: u
...
function Ud(e, t, a) {
  const { enableBorderRadius: s } = e.getProps([
    "enableBorderRadius"
  ]), n = e.options.borderRadius, o = Ve(n), i = Math.min(t, a), r = e.borderSkipped, l = s || ht(n);
  return {
    topLeft: ve(!l || r.top || r.left, o.topLeft, 0, i),
    topRight: ve(!l || r.top || r.right, o.topRight, 0, i),
    bottomLeft: ve(!l || r.bottom || r.left, o.bottomLeft, 0, i),
    bottomRight: ve(!l || r.bottom || r.right, o.bottomRight, 0, i)
  };
}
function Kd(e) {
  const t = Mi(e), a = t.right - t.left, s = t.bottom - t.top, n = Yd(e, a / 2, s / 2), o = Ud(e, a / 2, s / 2);
  return {
    outer: {
      x: t.left,
      y: t.top,
...
class Gd extends ce {
  ...
  draw(t) {
    const { inflateAmount: a, options: { borderColor: s, backgroundColor: n } } = this, { inner: o, outer: i } = Kd(this), r = qd(i.radius) ? za : Xd;
...
function ru(e, t, a) {
  ...
  for (let n = 0; n < a.length; n++) {
    const o = a[n], { first: i, last: r, point: l } = lu(o, t, "x");
    if (!(!l || i && r)) {
      if (i)
        s.unshift(l);
      else if (e.push(l), !r)
...
function hs(e, t, a) {
  const s = cu(t), { chart: n, index: o, line: i, scale: r, axis: l } = t, d = i.options, u = d.fill, f = d.backgroundColor, { above: p = f, below: v = f } = u || {}, h = n.getDatasetMeta(o), m = di(n, h);
...
function oo(e, t, a) {
  ...
  e.beginPath();
  for (const r of s) {
    const { start: l, end: d } = r, u = n[l], f = n[Ga(l, d, n)];
...
function fs(e, t) {
  const { line: a, target: s, property: n, color: o, scale: i, clip: r } = t, l = Zd(a, s, n);
...
function pu(e, t, a, s) {
  ...
  if (o === "x" || o === "y") {
    let l, d, u, f;
    o === "x" ? (l = i, d = n.top, u = r, f = n.bottom) : (l = n.left, d = i, u = n.right, f = r), e.beginPath(), a && (l = Math.max(l, a.left), u = Math.min(u, a.right), d = Math.max(d, a.top), f = Math.min(f, a.bottom)), e.rect(l, d, u - l, f - d), e.clip();
  }
}
function ro(e, t, a, s) {
...
var vu = {
  ...
  afterDatasetsUpdate(e, t, a) {
    ...
    let o, i, r, l;
    for (i = 0; i < s; ++i)
      o = e.getDatasetMeta(i), r = o.dataset, l = null, r && r.options && r instanceof Xa && (l = {
    ...
    for (i = 0; i < s; ++i)
      l = n[i], !(!l || l.fill === !1) && (l.fill = Jd(n, i, a.propagate));
  },
  beforeDraw(e, t, a) {
...
class co extends ce {
  ...
  fit() {
    ...
    const s = t.labels, n = Bt(s.font), o = n.size, i = this._computeTitleHeight(), { boxWidth: r, itemHeight: l } = lo(s, o);
    let d, u;
  ...
  _fitRows(t, a, s, n) {
    ...
    return this.legendItems.forEach((h, m) => {
      const b = s + a / 2 + o.measureText(h.text).width;
      (m === 0 || d[d.length - 1] + b + 2 * r > i) && (f += u, d[d.length - (m > 0 ? 0 : 1)] = 0, v += u, p++), l[m] = {
        left: 0,
        top: v,
        row: p,
        width: b,
  ...
  _fitCols(t, a, s, n) {
    ...
    return this.legendItems.forEach((b, g) => {
      const { itemWidth: _, itemHeight: k } = mu(s, a, o, b, n);
  ...
  _draw() {
    const { options: t, columnSizes: a, lineWidths: s, ctx: n } = this, { align: o, labels: i } = t, r = $t.color, l = ze(t.rtl, this.left, this.width), d = Bt(i.font), { padding: u } = i, f = d.size, p = f / 2;
    let v;
    this.drawTitle(), n.textAlign = l.textAlign("left"), n.textBaseline = "middle", n.lineWidth = 0.5, n.font = d.string;
    const { boxWidth: h, boxHeight: m, itemHeight: b } = lo(i, f), g = function(S, D, A) {
      ...
      if (n.fillStyle = it(A.fillStyle, r), n.lineCap = it(A.lineCap, "butt"), n.lineDashOffset = it(A.lineDashOffset, 0), n.lineJoin = it(A.lineJoin, "miter"), n.lineWidth = B, n.strokeStyle = it(A.strokeStyle, r), n.setLineDash(it(A.lineDash, [])), i.usePointStyle) {
        const F = {
          ...
          rotation: A.rotation,
          borderWidth: B
        }, P = l.xPlus(S, h / 2), E = D + p;
        Qo(n, F, P, E, i.pointStyleWidth && h);
      } else {
        const F = D + Math.max((f - m) / 2, 0), P = l.leftForLtr(S, h), E = Ve(A.borderRadius);
        n.beginPath(), Object.values(E).some((N) => N !== 0) ? za(n, {
          x: P,
          y: F,
          w: h,
          h: m,
    ...
    this.legendItems.forEach((S, D) => {
      ...
      const A = n.measureText(S.text).width, B = l.textAlign(S.textAlign || (S.textAlign = i.textAlign)), F = h + p + A;
      let P = v.x, E = v.y;
      l.setWidth(this.width), k ? D > 0 && P + F + u > this.right && (E = v.y += M, v.line++, P = v.x = At(o, this.left + u, this.right - s[v.line])) : D > 0 && E + M > this.bottom && (P = v.x = P + a[v.line].width + u, v.line++, E = v.y = At(o, this.top + w + u, this.bottom - a[v.line].height));
      const N = l.x(P);
      if (g(N, E, S), P = Nr(B, P + h + p, k ? P + F : this.right, t.rtl), _(l.x(P), E, S), k)
        v.x += F + u;
  ...
  drawTitle() {
    ...
    if (!a.display)
      return;
    const o = ze(t.rtl, this.left, this.width), i = this.ctx, r = a.position, l = s.size / 2, d = n.top + l;
    let u, f = this.left, p = this.width;
    if (this.isHorizontal())
      p = Math.max(...this.lineWidths), u = this.top + d, f = At(t.align, f, this.right - p);
    else {
      const h = this.columnSizes.reduce((m, b) => Math.max(m, b.height), 0);
...
class Ai extends ce {
  ...
  _drawArgs(t) {
    ...
    let l = 0, d, u, f;
    return this.isHorizontal() ? (u = At(r, s, o), f = a + t, d = o - s) : (i.position === "left" ? (u = s + t, f = At(r, n, a), l = mt * -0.5) : (u = o - t, f = At(r, a, n), l = mt * 0.5), d = n - a), {
      titleX: u,
      titleY: f,
      maxWidth: d,
      rotation: l
...
const sa = {
  ...
  nearest(e, t) {
    ...
    for (o = 0, i = e.length; o < i; ++o) {
      const l = e[o].element;
      if (l && l.hasValue()) {
        const d = l.getCenterPoint(), u = Ds(t, d);
        u < n && (n = u, r = l);
      }
    }
    if (r) {
...
function uo(e, t) {
  const a = e.chart.ctx, { body: s, footer: n, title: o } = e, { boxWidth: i, boxHeight: r } = t, l = Bt(t.bodyFont), d = Bt(t.titleFont), u = Bt(t.footerFont), f = o.length, p = n.length, v = s.length, h = Yt(t.padding);
  let m = h.height, b = 0, g = s.reduce((w, M) => w + M.before.length + M.lines.length + M.after.length, 0);
  if (g += e.beforeBody.length + e.afterBody.length, f && (m += f * d.lineHeight + (f - 1) * t.titleSpacing + t.titleMarginBottom), g) {
    ...
    m += v * w + (g - v) * l.lineHeight + (g - 1) * t.bodySpacing;
  }
  p && (m += t.footerMarginTop + p * u.lineHeight + (p - 1) * t.footerSpacing);
  let _ = 0;
  const k = function(w) {
    b = Math.max(b, a.measureText(w).width + _);
  };
  return a.save(), a.font = d.string, vt(e.title, k), a.font = l.string, vt(e.beforeBody.concat(e.afterBody), k), _ = t.displayColors ? i + 2 + t.boxPadding : 0, vt(s, (w) => {
    vt(w.before, k), vt(w.lines, k), vt(w.after, k);
  }), _ = 0, a.font = u.string, vt(e.footer, k), a.restore(), b += h.width, {
    width: b,
    height: m
  };
}
...
function Cu(e, t, a, s) {
  ...
  let d = "center";
  return s === "center" ? d = n <= (r + l) / 2 ? "left" : "right" : n <= o / 2 ? d = "left" : n >= i - o / 2 && (d = "right"), Mu(d, e, t, a) && (d = "center"), d;
}
function ho(e, t, a) {
...
function fo(e, t, a, s) {
  const { caretSize: n, caretPadding: o, cornerRadius: i } = e, { xAlign: r, yAlign: l } = a, d = n + o, { topLeft: u, topRight: f, bottomLeft: p, bottomRight: v } = Ve(i);
  let h = Su(t, r);
  const m = Du(t, l, d);
  return l === "center" ? r === "left" ? h += d : r === "right" && (h -= d) : r === "left" ? h -= Math.max(u, p) + n : r === "right" && (h += Math.max(f, v) + n), {
...
class vo extends ce {
  ...
  getBody(t, a) {
    ...
    return vt(t, (o) => {
      ...
      Gt(i.before, se(Et(r, "beforeLabel", this, o))), Gt(i.lines, Et(r, "label", this, o)), Gt(i.after, se(Et(r, "afterLabel", this, o))), n.push(i);
    }), n;
  }
  getAfterBody(t, a) {
  ...
  _createItems(t) {
    ...
    return t.filter && (r = r.filter((u, f, p) => t.filter(u, f, p, s))), t.itemSort && (r = r.sort((u, f) => t.itemSort(u, f, s))), vt(r, (u) => {
      ...
      n.push(Et(f, "labelColor", this, u)), o.push(Et(f, "labelPointStyle", this, u)), i.push(Et(f, "labelTextColor", this, u));
  ...
  update(t, a) {
    ...
    if (!n.length)
      ...
      const l = this._size = uo(this, s), d = Object.assign({}, r, l), u = ho(this.chart, s, d), f = fo(s, d, u, this.chart);
  ...
  getCaretPosition(t, a, s) {
    const { xAlign: n, yAlign: o } = this, { caretSize: i, cornerRadius: r } = s, { topLeft: l, topRight: d, bottomLeft: u, bottomRight: f } = Ve(r), { x: p, y: v } = t, { width: h, height: m } = a;
    let b, g, _, k, w, M;
    return o === "center" ? (w = v + m / 2, n === "left" ? (b = p, g = b - i, k = w + i, M = w - i) : (b = p + h, g = b + i, k = w - i, M = w + i), _ = b) : (n === "left" ? g = p + Math.max(l, u) + i : n === "right" ? g = p + h - Math.max(d, f) - i : g = this.caretX, o === "top" ? (k = v, w = k - i, b = g - i, _ = g + i) : (k = v + m, w = k + i, b = g + i, _ = g - i), M = k), {
      x1: b,
      x2: g,
      x3: _,
      y1: k,
  ...
  drawTitle(t, a, s) {
    ...
    if (o) {
      ...
      for (t.x = Ba(this, s.titleAlign, s), a.textAlign = d.textAlign(s.titleAlign), a.textBaseline = "middle", i = Bt(s.titleFont), r = s.titleSpacing, a.fillStyle = s.titleColor, a.font = i.string, l = 0; l < o; ++l)
        a.fillText(n[l], d.x(t.x), t.y + i.lineHeight / 2), t.y += i.lineHeight + r, l + 1 === o && (t.y += s.titleMarginBottom - r);
    }
  }
  _drawColorBox(t, a, s, n, o) {
    const i = this.labelColors[s], r = this.labelPointStyles[s], { boxHeight: l, boxWidth: d } = o, u = Bt(o.bodyFont), f = Ba(this, "left", o), p = n.x(f), v = l < u.lineHeight ? (u.lineHeight - l) / 2 : 0, h = a.y + v;
    if (o.usePointStyle) {
      const m = {
        ...
        rotation: r.rotation,
        borderWidth: 1
      }, b = n.leftForLtr(p, d) + d / 2, g = h + l / 2;
      t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, Ts(t, m, b, g), t.strokeStyle = i.borderColor, t.fillStyle = i.backgroundColor, Ts(t, m, b, g);
    } else {
      ...
      const m = n.leftForLtr(p, d), b = n.leftForLtr(n.xPlus(p, 1), d - 2), g = Ve(i.borderRadius);
      Object.values(g).some((_) => _ !== 0) ? (t.beginPath(), t.fillStyle = o.multiKeyBackground, za(t, {
        x: m,
        y: h,
        w: d,
        h: l,
        ...
        h: l - 2,
        radius: g
      }), t.fill()) : (t.fillStyle = o.multiKeyBackground, t.fillRect(m, h, d, l), t.strokeRect(m, h, d, l), t.fillStyle = i.backgroundColor, t.fillRect(b, h + 1, d - 2, l - 2));
    }
    t.fillStyle = this.labelTextColors[s];
  }
  drawBody(t, a, s) {
    const { body: n } = this, { bodySpacing: o, bodyAlign: i, displayColors: r, boxHeight: l, boxWidth: d, boxPadding: u } = s, f = Bt(s.bodyFont);
    let p = f.lineHeight, v = 0;
    const h = ze(s.rtl, this.x, this.width), m = function(A) {
      a.fillText(A, h.x(t.x + v), t.y + p / 2), t.y += p + o;
    }, b = h.textAlign(i);
    let g, _, k, w, M, S, D;
    for (a.textAlign = i, a.textBaseline = "middle", a.font = f.string, t.x = Ba(this, b, s), a.fillStyle = s.bodyColor, vt(this.beforeBody, m), v = r && b !== "right" ? i === "center" ? d / 2 + u : d + 2 + u : 0, w = 0, S = n.length; w < S; ++w) {
      for (g = n[w], _ = this.labelTextColors[w], a.fillStyle = _, vt(g.before, m), k = g.lines, r && k.length && (this._drawColorBox(a, t, w, h, s), p = Math.max(f.lineHeight, l)), M = 0, D = k.length; M < D; ++M)
  ...
  drawFooter(t, a, s) {
    ...
    let i, r;
    if (o) {
      const l = ze(s.rtl, this.x, this.width);
      for (t.x = Ba(this, s.footerAlign, s), t.y += s.footerMarginTop, a.textAlign = l.textAlign(s.footerAlign), a.textBaseline = "middle", i = Bt(s.footerFont), a.fillStyle = s.footerColor, a.font = i.string, r = 0; r < o; ++r)
        a.fillText(n[r], l.x(t.x), t.y + i.lineHeight / 2), t.y += i.lineHeight + s.footerSpacing;
    }
  }
  drawBackground(t, a, s, n) {
    const { xAlign: o, yAlign: i } = this, { x: r, y: l } = t, { width: d, height: u } = s, { topLeft: f, topRight: p, bottomLeft: v, bottomRight: h } = Ve(n.cornerRadius);
    a.fillStyle = n.backgroundColor, a.strokeStyle = n.borderColor, a.lineWidth = n.borderWidth, a.beginPath(), a.moveTo(r + f, l), i === "top" && this.drawCaret(t, a, s, n), a.lineTo(r + d - p, l), a.quadraticCurveTo(r + d, l, r + d, l + p), i === "center" && o === "right" && this.drawCaret(t, a, s, n), a.lineTo(r + d, l + u - h), a.quadraticCurveTo(r + d, l + u, r + d - h, l + u), i === "bottom" && this.drawCaret(t, a, s, n), a.lineTo(r + v, l + u), a.quadraticCurveTo(r, l + u, r, l + u - v), i === "center" && o === "left" && this.drawCaret(t, a, s, n), a.lineTo(r, l + f), a.quadraticCurveTo(r, l, r + f, l), a.closePath(), a.fill(), n.borderWidth > 0 && a.stroke();
  }
  _updateAnimationTarget(t) {
    ...
    if (n || o) {
      ...
      if (!i)
        return;
      const r = this._size = uo(this, t), l = Object.assign({}, i, this._size), d = ho(a, t, l), u = fo(t, l, d, a);
...
function Fu(e, t) {
  const a = [], { bounds: n, step: o, min: i, max: r, precision: l, count: d, maxTicks: u, maxDigits: f, includeBounds: p } = e, v = o || 1, h = u - 1, { min: m, max: b } = t, g = !pt(i), _ = !pt(r), k = !pt(d), w = (b - m) / (f + 1);
  let M = hn((b - m) / h / v) * v, S, D, A, B;
  if (M < 1e-14 && !g && !_)
    return [
      {
        value: m
  ...
  B = Math.ceil(b / M) - Math.floor(m / M), B > h && (M = hn(B * M / h / v) * v), pt(l) || (S = Math.pow(10, l), M = Math.ceil(M * S) / S), n === "ticks" ? (D = Math.floor(m / M) * M, A = Math.ceil(b / M) * M) : (D = m, A = b), g && _ && o && Lr((r - i) / o, M / 1e3) ? (B = Math.round(Math.min((r - i) / M, u)), M = (r - i) / B, D = i, A = r) : k ? (D = g ? i : D, A = _ ? r : A, B = d - 1, M = (A - D) / B) : (B = (A - D) / M, oa(B, Math.round(B), M / 1e3) ? B = Math.round(B) : B = Math.ceil(B));
  const F = Math.max(fn(M), fn(D));
  S = Math.pow(10, pt(l) ? F : l), D = Math.round(D * S) / S, A = Math.round(A * S) / S;
  let P = 0;
  for (g && (p && D !== i ? (a.push({
    value: i
  }), D < i && P++, oa(Math.round((D + P * M) * S) / S, i, mo(i, w, e)) && P++) : D < i && P++); P < B; ++P) {
    const E = Math.round((D + P * M) * S) / S;
    if (_ && E > r)
      break;
    a.push({
      value: E
  ...
  return _ && p && A !== r ? a.length && oa(a[a.length - 1].value, r, mo(r, w, e)) ? a[a.length - 1].value = r : a.push({
    value: r
  }) : (!_ || A === r) && a.push({
    value: A
  }), a;
...
class $o extends je {
  ...
  _generate() {
    const t = this._adapter, a = this.min, s = this.max, n = this.options, o = n.time, i = o.unit || xo(o.minUnit, a, s, this._getLabelCapacity(a)), r = it(n.ticks.stepSize, 1), l = i === "week" ? o.isoWeekday : !1, d = fa(l) || l === !0, u = {};
    let f = a, p, v;
    if (d && (f = +t.startOf(f, "isoWeek", l)), f = +t.startOf(f, d ? "day" : i), t.diff(s, a, i) > 1e5 * r)
  ...
  _tickFormatFunction(t, a, s, n) {
    ...
    const r = o.time.displayFormats, l = this._unit, d = this._majorUnit, u = l && r[l], f = d && r[d], p = s[a], v = d && f && p && p.major;
...
function La(e, t, a) {
  ...
  a ? (t >= e[s].pos && t <= e[n].pos && ({ lo: s, hi: n } = De(e, "pos", t)), { pos: o, time: r } = e[s], { pos: i, time: l } = e[n]) : (t >= e[s].time && t <= e[n].time && ({ lo: s, hi: n } = De(e, "time", t)), { time: o, pos: r } = e[s], { time: i, pos: l } = e[n]);
  const d = i - o;
...
const ju = tt({
  ...
  setup(e, t) {
    ...
    return le(i), He(r), Rt([
      ...
      if (p) {
        const g = Re(p.labels), _ = Re(h.labels), k = Re(p.datasets), w = Re(h.datasets);
        g !== _ && (Ii(m.config.data, g), b = !0), k && k !== w && (Ri(m.config.data, k, e.datasetIdKey), b = !0);
      }
      b && Ct(() => {
        l(m);
      });
...
const Yu = /* @__PURE__ */ tn("bar", gc), Uu = /* @__PURE__ */ tn("line", bc), Ku = /* @__PURE__ */ tn("pie", mc), Mo = {
  // Backgrounds
  bgPrimary: "#f8f9fa",
  bgSecondary: "#ffffff",
  bgCard: "#ffffff",
...
const Xu = { class: "chart-container" }, Gu = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t }) {
    ...
    const { isDark: s, colors: n } = ct(lt(a, "theme")), o = a.data, i = (l) => typeof l == "string" ? l.charAt(0).toUpperCase() + l.slice(1).toLowerCase() : l, r = C(() => a.options ? a.options : {
      responsive: !0,
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: s }), (l, d) => (y(), x("div", Zu, [
      Q(T(Uu), {
        data: T(o),
        options: r.value
      }, null, 8, ["data", "options"])
  ...
  setup(e, { expose: t }) {
      ...
      plugins: {
          ...
          labels: {
            ...
            generateLabels: function(l) {
              ...
              return d.labels.length && d.datasets.length ? d.labels.map((u, f) => {
                const p = l.getDatasetMeta(0), v = d.datasets[0], h = v.data[f], m = Array.isArray(v.backgroundColor) ? v.backgroundColor[f] : v.backgroundColor;
                return {
                  text: `${i(u)}: ${h}`,
                  fillStyle: m,
        ...
        tooltip: {
          ...
          callbacks: {
            ...
            label: function(l) {
              const d = l.label || "", u = l.parsed || 0, f = l.dataset.data.reduce((v, h) => v + h, 0), p = (u / f * 100).toFixed(1);
              return `${i(d)}: ${u} (${p}%)`;
            }
          }
        }
    ...
    return t({ isDark: s }), (l, d) => (y(), x("div", Ju, [
      Q(T(Ku), {
        data: T(o),
        options: r.value
      }, null, 8, ["data", "options"])
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s } = ct(lt(a, "theme")), n = C(() => ({
      ...
      if (!h) return;
      const m = h.getBoundingClientRect(), b = h.createSVGPoint();
      b.x = p.clientX - m.left, b.y = p.clientY - m.top, o.value = {
        visible: !0,
        x: b.x,
        y: b.y - 20,
        text: v
      ...
      for (let m = 1; m <= 10; m++) {
        const b = m, g = (b - 1) / 9, _ = a.chartMargin + h - g * h;
        p.push({ value: b, y: _ });
      }
      return p;
    });
    return t({ isDark: s }), (p, v) => (y(), x("div", eh, [
      (y(), x("svg", {
        ...
        (y(!0), x(q, null, J(f.value, (h, m) => (y(), x(q, { key: m }, [
          c("line", {
            x1: e.chartMargin - 6,
            y1: h.y,
            x2: e.chartMargin,
        ...
        (y(!0), x(q, null, J(e.boxplotData, (h, m) => (y(), x(q, { key: m }, [
          c("g", {
            ...
            c("circle", {
              ...
              "stroke-width": "2",
              class: "hover-circle",
              onMouseenter: (b) => r(b, `Min: ${h.min.toFixed(1)}`),
              onMouseleave: u,
            ...
            c("circle", {
              ...
              "stroke-width": "2",
              class: "hover-circle",
              onMouseenter: (b) => r(b, `Q1: ${h.q1.toFixed(1)}`),
              onMouseleave: u,
              style: { cursor: "pointer" }
            }, null, 40, $h),
            c("circle", {
              ...
              "stroke-width": "2",
              class: "hover-circle",
              onMouseenter: (b) => r(b, `Q3: ${h.q3.toFixed(1)}`),
              onMouseleave: u,
              style: { cursor: "pointer" }
            }, null, 40, Mh),
            c("circle", {
              ...
              "stroke-width": "2",
              class: "hover-circle",
              onMouseenter: (b) => r(b, `Max: ${h.max.toFixed(1)}`),
              onMouseleave: u,
              style: { cursor: "pointer" }
            }, null, 40, Ch),
            c("line", {
              ...
              "stroke-width": "3.5",
              class: "hover-line",
              onMouseenter: (b) => r(b, `Median: ${h.median.toFixed(1)}`),
              onMouseleave: u,
              style: { cursor: "pointer" }
            }, null, 40, Sh),
            h.averageY ? (y(), x("line", {
              ...
              class: "hover-line",
              onMouseenter: (b) => r(b, `Avg: ${h.average.toFixed(1)}`),
              onMouseleave: u,
              style: { cursor: "pointer" }
            }, null, 40, Dh)) : R("", !0)
          ], 8, hh),
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s } = ct(lt(a, "theme")), n = C(() => ({
      ...
      if (!m) return;
      const b = m.getBoundingClientRect(), g = m.createSVGPoint();
    ...
    return t({ isDark: s }), (p, v) => (y(), x("div", Gh, [
      (y(), x("svg", {
        ...
        (y(!0), x(q, null, J(f.value, (h, m) => (y(), x("line", {
          key: `grid-${m}`,
          x1: e.chartMargin,
          y1: h.y,
          x2: e.chartWidth - e.chartMargin,
        ...
        (y(!0), x(q, null, J(e.candlestickData, (h, m) => (y(), x(q, { key: m }, [
          c("g", {
            transform: `translate(${h.centerX}, 0)`
          }, [
            c("line", {
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s } = ct(lt(a, "theme")), n = C(() => ({
      ...
      const ot = G / K, wt = [];
      for (let gt = 0; gt <= H; gt++) {
        const Pt = 1 + 9 * (gt / H), zt = f(Pt, V, z) * ot, Ut = h(Pt);
        if (Ut !== null) {
          const rt = a.chartHeight - a.chartBottomMargin - zt;
          wt.push(`${gt === 0 ? "M" : "L"} ${Ut} ${rt}`);
        }
      }
      return wt.join(" ");
    }), v = C(() => {
      ...
      return a.histogram.map((z, H) => {
        const et = a.chartMargin + (H + 0.5) * V, G = z.count > 0 ? z.count / d.value * r.value : 0, K = a.chartHeight - a.chartBottomMargin - G;
        return {
          score: z.score,
          count: z.count,
          x: et,
    ...
    }, m = C(() => h(a.minScore)), b = C(() => h(a.maxScore)), g = C(() => h(a.q1Score)), _ = C(() => h(a.medianScore)), k = C(() => h(a.q3Score)), w = C(() => h(a.averageScore)), M = C(() => a.minScore), S = C(() => a.maxScore), D = C(() => a.q1Score), A = C(() => a.medianScore), B = C(() => a.q3Score), F = C(() => a.averageScore), P = C(() => {
      ...
      V.forEach((K) => {
        ...
        for (let wt = 0; wt < et.length; wt++) {
          ...
          for (const Pt of et[wt]) {
            ...
            const zt = Math.abs(K.x - Pt.x), Ut = (K.width + Pt.width) / 2 + 10;
            if (zt < Ut) {
              gt = !0;
              break;
            }
        ...
        ot === -1 && (ot = et.length - 1), K.y = z - ot * H, et[ot].push(K);
      });
      const G = 15;
      return V.forEach((K) => {
        K.y < G && (K.y = G);
      }), V;
    }), E = (V) => P.value.find((H) => H.id === V)?.y || a.chartMargin - 10, N = C(() => {
      const V = [];
      for (let H = 0; H <= 5; H++) {
      ...
      const K = `Score: ${z.score}`, ot = `Count: ${z.count}`, wt = 120, gt = 48;
      o.value = {
        visible: !0,
        x: G.x,
        y: G.y - 20,
    ...
    return t({ isDark: s }), (V, z) => (y(), x("div", Rf, [
      (y(), x("svg", {
        viewBox: `0 0 ${e.chartWidth} ${e.chartHeight}`,
        ...
        (y(!0), x(q, null, J(N.value, (H, et) => (y(), x("line", {
          key: `grid-${et}`,
          x1: e.chartMargin,
          y1: H.y,
          x2: e.chartWidth - e.chartMargin,
        ...
        (y(!0), x(q, null, J(N.value, (H, et) => (y(), x(q, {
          key: `y-tick-${et}`
        }, [
          c("line", {
            x1: e.chartMargin - 6,
        ...
        (y(!0), x(q, null, J(v.value, (H, et) => (y(), x(q, {
          key: `tick-${et}`
        }, [
          c("line", {
            x1: H.x,
        ...
        (y(!0), x(q, null, J(v.value, (H, et) => (y(), x("rect", {
          key: `bar-${et}`,
          x: H.x - l.value / 2,
          y: H.y,
          width: l.value,
        ...
        w.value ? (y(), x("text", {
          ...
          "font-weight": "700",
          "font-family": "'DM Sans', sans-serif"
        }, " Avg: " + $(F.value.toFixed(1)), 9, lg)) : R("", !0),
        k.value ? (y(), x("line", {
          key: 10,
          x1: k.value,
          y1: e.chartMargin,
  ...
  setup(e, { expose: t }) {
    ...
    const d = {
      ...
      if (M) {
        const E = k.filter((L) => L.target === w.name), N = k.filter((L) => L.source === w.name), Y = E.length > 0 ? E.reduce((L, O) => L + (O.originalValue || O.value), 0) : N.reduce((L, O) => L + (O.originalValue || O.value), 0);
      ...
      if (o.value)
        try {
          l = sn.init(o.value), h(), window.addEventListener("resize", g);
        } catch (k) {
    ...
    return le(() => o.value && b()), Eo(_), Rt(() => a.data, h, { deep: !0 }), Rt(s, h), t({ isDark: s }), (k, w) => (y(), x("div", Ag, [
      r.value ? (y(), x("div", {
        key: 0,
        class: "error-state",
...
const Hg = { class: "chart-footer" }, jg = { class: "export-actions" }, Yg = { class: "export-buttons" }, Ug = ["disabled"], Kg = {
  key: 0,
  class: "spinner",
  width: "14",
  height: "14",
  ...
  setup(e, { expose: t, emit: a }) {
    const s = {
      ...
      o("export", p);
    }, { isDark: r, colors: l } = ct(lt(n, "theme")), d = (p) => {
      ...
      for (const k of Object.values(p))
        for (const w of Object.keys(k))
          m.add(w);
      const b = Array.from(m), g = (k) => k, _ = b.map((k) => ({
        label: k,
  ...
  setup(e, { emit: t }) {
    ...
    ) : []), r = C(() => o.value ? i.value : i.value.slice(0, gs)), l = C(() => i.value.length > gs), d = C(() => a.data?.total_payment_success_value || []), u = (g) => g.payment_success_value || [], f = (g) => typeof g.payment_success_count == "number" ? g.payment_success_count : (g.payment_success_value || []).reduce((_, k) => _ + (k.count || 0), 0), p = (g) => bt(g), v = (g) => g == null ? "0" : Qt(g);
    C(() => (a.data?.total_payment_success_value || []).reduce((g, _) => g + (_.total_value || 0), 0));
    const h = C(() => {
      const g = a.data, _ = g.total_booking_initiated || 0, k = g.total_booking_started || 0, w = g.total_payment_initiated || 0, M = g.total_not_found || 0, S = g.total_cancelled || 0, D = g.total_no_pending_balance || 0, A = g.total_errors || 0, B = typeof g.total_payment_success == "number" ? g.total_payment_success : (g.total_payment_success_value || []).reduce((O, j) => O + (j.count || 0), 0), F = g.total_payment_failed || 0, P = Math.max(0, _ - k), E = Math.max(0, k - w - M - S - D - A), N = (O, j) => {
        const V = j > 0 ? Math.round(O / j * 100) : 0;
        return `${O.toLocaleString()} (${V}%)`;
      }, Y = [
        { name: "Initiated" },
        { name: "Started" },
    ...
    }, b = (g, _) => !_ || _ === 0 ? "0%" : `${Math.round(g / _ * 100)}%`;
    return (g, _) => (y(), x("article", lp, [
      c("header", cp, [
        c("div", dp, [
          _[2] || (_[2] = c("div", { class: "title-section" }, [
            c("h3", { class: "card-title" }, "Booking Manager Metrics"),
            c("p", { class: "card-subtitle" }, "Booking manager workflow tracking and analysis")
          ], -1)),
          a.loading ? R("", !0) : (y(), x("div", up, [
            _[1] || (_[1] = c("p", { class: "badge-label" }, "Payment Success Value", -1)),
            d.value.length > 0 ? (y(), x("div", hp, [
              (y(!0), x(q, null, J(d.value, (k) => (y(), x("p", {
                key: k.currency,
      ...
      a.loading ? (y(), x("div", gp, [..._[3] || (_[3] = [
        st('<div class="loading-container" data-v-2c001af1><div class="chart-flow-loader" data-v-2c001af1><div class="flow-line flow-1" data-v-2c001af1></div><div class="flow-line flow-2" data-v-2c001af1></div><div class="flow-line flow-3" data-v-2c001af1></div><div class="flow-line flow-4" data-v-2c001af1></div><div class="flow-line flow-5" data-v-2c001af1></div></div><p class="loading-text" data-v-2c001af1>Loading booking data...</p></div>', 1)
      ])])) : a.error ? (y(), x("div", pp, [
        c("div", vp, [
          _[4] || (_[4] = c("div", { class: "error-icon-wrapper" }, [
            c("svg", {
              class: "error-icon",
              fill: "none",
              viewBox: "0 0 24 24",
          ...
          _[5] || (_[5] = c("p", { class: "error-title" }, "Error loading data", -1)),
          c("p", bp, $(a.error), 1)
        ])
      ])) : (y(), x("div", mp, [
        c("section", yp, [
        ...
        i.value.length > 0 ? (y(), x("section", xp, [
          _[8] || (_[8] = c("div", { class: "section-header" }, [
            c("h4", { class: "section-title" }, "Daily Overview")
          ], -1)),
          c("div", kp, [
            c("table", wp, [
              _[6] || (_[6] = c("thead", null, [
              ...
              c("tbody", $p, [
                (y(!0), x(q, null, J(r.value, (k) => (y(), x("tr", {
                  key: k.date,
                  class: "table-row"
                }, [
                  c("td", Mp, $(T(Dt)(k.date).format("DD/MM/YYYY")), 1),
                  c("td", Cp, $(T(X)(k.booking_initiated_count)), 1),
                  c("td", Sp, [
                    kt($(T(X)(k.booking_started_count)) + " ", 1),
                    c("span", Dp, " (" + $(b(k.booking_started_count, k.booking_initiated_count)) + ") ", 1)
                  ]),
                  c("td", Ap, $(T(X)(k.payment_initiated_count)), 1),
                  c("td", Tp, [
                    c("div", Bp, [
                      c("span", Lp, " Success: " + $(T(X)(f(k))), 1),
                      c("span", Fp, " Failed: " + $(T(X)(k.payment_failed_count || 0)), 1)
                    ])
                  ]),
                  c("td", Pp, [
                    u(k).length > 0 ? (y(), x("div", Ip, [
                      (y(!0), x(q, null, J(u(k), (w) => (y(), x("span", {
                  ...
                  c("td", Ep, [
                    c("div", Op, [
                      c("span", Vp, " Not Found: " + $(k.not_found_count ? T(X)(k.not_found_count) : "N/A"), 1),
                      c("span", zp, " Cancelled: " + $(k.cancelled_count ? T(X)(k.cancelled_count) : "N/A"), 1),
                      c("span", Np, " No Balance: " + $(k.no_pending_balance_count ? T(X)(k.no_pending_balance_count) : "N/A"), 1),
                      c("span", Wp, " Errors: " + $(k.error_count ? T(X)(k.error_count) : "N/A"), 1)
                    ])
                  ])
                ]))), 128))
              ])
          ...
          l.value ? (y(), x("button", {
            key: 0,
            class: "view-more-btn",
            onClick: _[0] || (_[0] = (k) => o.value = !o.value)
          }, [
        ...
        ])) : (y(), x("section", Hp, [..._[9] || (_[9] = [
          st('<div class="empty-state-content" data-v-2c001af1><div class="empty-icon-wrapper" data-v-2c001af1><svg class="empty-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-2c001af1><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-v-2c001af1></path></svg></div><p class="empty-title" data-v-2c001af1>No booking manager data available</p><p class="empty-description" data-v-2c001af1>No booking manager data found for the selected period. Try adjusting the date range.</p></div>', 1)
        ])]))
      ]))
    ]));
  }
}), Yp = /* @__PURE__ */ nt(jp, [["__scopeId", "data-v-2c001af1"]]), Up = { class: "checkin-metrics-card" }, Kp = {
  key: 0,
  class: "loading-state"
}, qp = {
  key: 1,
  ...
  setup(e, { emit: t }) {
    const a = t, s = (b) => {
      ...
      return (d.value.unrecovered_by_step || []).forEach((_) => {
        const w = _.step_name.replace(/_/g, " ").split(" ").map((S) => S.charAt(0).toUpperCase() + S.slice(1)).join(" "), M = {
          "Get Seatmap": "#DC2626",
    ...
    }), f = (b, g) => !g || g === 0 ? "0%" : `${Math.round(b / g * 100)}%`, p = (b, g) => {
      const _ = X(b), k = f(b, g);
      return `${_} (${k})`;
    }, v = (b) => b.reduce((g, _) => g + _.failed_count, 0), h = C(() => {
      const b = [], g = [];
      ...
      const _ = l.value.total_checkin_initiated, k = l.value.total_checkin_init, w = l.value.total_checkin_init_abandoned, M = k - w, S = l.value.total_checkin_started, D = l.value.total_checkin_completed, A = l.value.total_checkin_closed, B = d.value.unrecovered_by_step || [], F = B.reduce((Y, L) => Y + L.count, 0);
      if (k > 0) {
        const Y = Math.round(k / _ * 100);
        g.push({
          source: "Checkin Init",
        ...
        r.value && r.value.length > 0 ? (y(), x("section", Zp, [
          c("div", Qp, [
            c("table", Jp, [
              ...
              c("tbody", t0, [
                (y(!0), x(q, null, J(r.value, (_) => (y(), x("tr", {
                  key: _.date,
                  class: "table-row"
                }, [
                  c("td", e0, $(T(Dt)(_.date).format("DD/MM/YYYY")), 1),
                  c("td", a0, $(T(X)(_.checkin_initiated_count)), 1),
                  c("td", s0, $(p(_.checkin_init_count, _.checkin_initiated_count)), 1),
                  c("td", n0, $(T(X)(_.checkin_started_count)), 1),
                  c("td", o0, $(p(_.checkin_completed_count, _.checkin_started_count)), 1),
                  c("td", i0, $(p(_.checkin_closed_count, _.checkin_started_count)), 1),
                  c("td", r0, $(p(v(_.failed_steps), _.checkin_started_count)), 1),
                  c("td", l0, [
                    _.failed_steps && _.failed_steps.length > 0 ? (y(), x("div", c0, [
                      (y(!0), x(q, null, J(_.failed_steps, (k) => (y(), x("div", {
                        key: k.step_name,
                        class: "failed-step-item"
                      }, [
                        c("span", d0, $(k.step_name.replace(/_/g, " ")) + ":", 1),
                        c("span", u0, $(k.failed_count), 1)
                      ]))), 128))
                    ])) : (y(), x("div", h0, "-"))
                  ])
                ]))), 128))
  ...
  key: 2,
  class: "empty-state"
}, E0 = { class: "empty-state-content" }, O0 = { class: "empty-icon-wrapper" }, ps = 3, V0 = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (k) => {
      n("export", k);
    }, { isDark: i } = ct(lt(s, "theme")), r = (k) => k == null ? "0" : k.toLocaleString(), l = (k) => {
    ...
    }), b = C(() => h.value ? m.value : m.value.slice(0, ps)), g = C(() => m.value.length > ps), _ = C(() => {
      ...
      const D = s.checkinData.total_checkin_initiated || 0, A = s.checkinData.total_checkin_init || 0, B = s.checkinData.total_checkin_init_abandoned || 0, F = s.checkinData.total_checkin_pre_init_abandoned_error, P = s.checkinData.total_checkin_pre_init_abandoned_voluntary, E = F != null || P != null, N = E ? Math.max(Number(F) || 0, 0) : 0, Y = E ? Math.max(Number(P) || 0, 0) : 0, L = s.checkinData.total_checkin_init_abandoned_error, O = s.checkinData.total_checkin_init_abandoned_voluntary, j = L != null || O != null, V = j ? Math.max(Number(L) || 0, 0) : 0, z = j ? Math.max(Number(O) || 0, 0) : 0, H = j ? Math.max(B - V - z, 0) : B, et = A - B, G = s.checkinData.total_checkin_started || 0, K = s.checkinData.total_checkin_completed || 0, ot = s.checkinData.total_checkin_closed || 0, wt = s.failedData?.unrecovered_by_step || [], gt = wt.reduce((rt, ue) => rt + ue.count, 0);
      if (A > 0) {
      ...
      if (K > 0) {
        const rt = Math.round(K / G * 100);
        w.push({
          source: "Number of Passengers",
          target: "Completed",
          value: K,
          label: `${K.toLocaleString()} (${rt}%)`
        });
      }
      if (wt.length > 0 && gt > 0) {
        S("Unrecovered");
        ...
        w.push({
          ...
          const Ue = ue.step_name.replace(/_/g, " ").split(" ").map((Ke) => Ke.charAt(0).toUpperCase() + Ke.slice(1)).join(" "), ya = Math.round(ue.count / G * 100);
          S(Ue), w.push({
            source: "Unrecovered",
            target: Ue,
            value: ue.count,
      ...
      const Ut = K - ot;
      if (Ut > 0) {
        const rt = Math.round(Ut / G * 100);
        S("BP Error"), w.push({
          source: "Completed",
          target: "BP Error",
          value: Ut,
          label: `${Ut.toLocaleString()} (${rt}%)`
        });
      }
      if (ot > 0) {
    ...
    return t({ isDark: i }), (k, w) => (y(), x("article", v0, [
      ...
      e.loading ? (y(), x("div", b0, [...w[1] || (w[1] = [
        ...
        _.value.nodes.length > 0 ? (y(), x("div", y0, [
          Q(_e, {
            data: _.value,
            height: "500px",
            "node-colors": v.value,
        ...
        m.value && m.value.length > 0 ? (y(), x("div", _0, [
          c("div", x0, [
            c("table", k0, [
              ...
              c("tbody", w0, [
                (y(!0), x(q, null, J(b.value, (M) => (y(), x("tr", {
                  key: M.date,
                  class: "table-row"
                }, [
                  c("td", $0, $(l(M.date)), 1),
                  c("td", M0, $(r(M.checkin_initiated_count)), 1),
                  c("td", C0, $(f(M.checkin_init_count, M.checkin_initiated_count)), 1),
                  c("td", S0, $(r(M.checkin_started_count)), 1),
                  c("td", D0, $(f(M.checkin_completed_count, M.checkin_started_count)), 1),
                  c("td", A0, $(f(M.checkin_closed_count, M.checkin_started_count)), 1),
                  c("td", T0, $(f(p(M.failed_steps), M.checkin_started_count)), 1),
                  c("td", B0, [
                    M.failed_steps && M.failed_steps.length > 0 ? (y(), x("div", L0, [
                      (y(!0), x(q, null, J(M.failed_steps, (S) => (y(), x("div", {
                        key: S.step_name,
                        class: "reason-item"
                      }, [
                        c("span", F0, $(d(S.step_name)) + ":", 1),
                        c("span", P0, $(S.failed_count), 1)
                      ]))), 128))
                    ])) : (y(), x("div", I0, "-"))
                  ])
                ]))), 128))
          ...
          g.value ? (y(), x("button", {
            ...
            kt($(h.value ? "View less" : `View more (${m.value.length - ps} more rows)`) + " ", 1),
            (y(), x("svg", {
              class: U(["view-more-icon", { "view-more-icon-rotated": h.value }]),
              fill: "none",
              viewBox: "0 0 24 24",
              stroke: "currentColor"
            }, [...w[3] || (w[3] = [
  ...
  key: 0,
  class: "table-section"
}, Y0 = { class: "table-wrapper" }, U0 = { class: "data-table" }, K0 = { class: "table-body" }, q0 = { class: "table-cell font-medium text-center" }, X0 = { class: "airport-badge" }, G0 = { class: "table-cell text-center" }, Z0 = {
  key: 0,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (v) => {
      n("export", v);
    }, { isDark: i } = ct(lt(s, "theme")), r = at(!1), l = C(() => r.value ? s.data : s.data.slice(0, vs)), d = C(() => s.data.length > vs), u = (v, h) => !h || h === 0 || !v ? "0%" : `${Math.round(v / h * 100)}%`, f = (v) => !v || v === "None" ? "-" : String(v).trim().replace(/_[0-9]+$/i, ""), p = (v) => {
      const h = f(v?.departure_airport), m = f(v?.arrival_airport);
      return h === "-" || m === "-" ? !1 : h === m;
    };
    return t({ isDark: i }), (v, h) => (y(), x("article", N0, [
      h[7] || (h[7] = c("header", { class: "card-header" }, [
        c("div", { class: "header-content" }, [
        ...
        s.data.length > 0 ? (y(), x("section", j0, [
          c("div", Y0, [
            c("table", U0, [
              ...
              c("tbody", K0, [
                (y(!0), x(q, null, J(l.value, (m, b) => (y(), x("tr", {
                  key: b,
                  class: "table-row"
                }, [
                  c("td", q0, [
                    c("span", X0, $(f(m.departure_airport)), 1)
                  ]),
                  c("td", G0, [
                    f(m.conexion_airport) !== "-" ? (y(), x("span", Z0, $(f(m.conexion_airport)), 1)) : (y(), x("span", Q0, "-"))
                  ]),
                  c("td", J0, [
                    c("span", tv, $(f(m.arrival_airport)), 1)
                  ]),
                  c("td", ev, [
                  ...
                  c("td", nv, $(T(X)(m.segment_init_count)), 1),
                  c("td", ov, [
                    c("span", iv, $(u(m.segment_started_count, m.segment_init_count)), 1)
                  ]),
                  c("td", rv, [
                    c("span", lv, $(u(m.segment_completed_count, m.segment_init_count)), 1)
                  ]),
                  c("td", cv, [
                    c("span", dv, $(u(m.segment_closed_count, m.segment_init_count)), 1)
                  ])
                ]))), 128))
              ])
            ])
  ...
  key: 0,
  class: "table-section"
}, Cv = { class: "table-wrapper" }, Sv = { class: "data-table" }, Dv = { class: "table-body" }, Av = { class: "table-cell font-medium text-center" }, Tv = { class: "table-cell text-center" }, Bv = { class: "table-cell text-center" }, Lv = { class: "percentage-text" }, Fv = { class: "table-cell text-center" }, Pv = { class: "abandoned-value" }, Iv = { class: "table-cell" }, Rv = { class: "badges-container badges-wrap" }, Ev = { class: "badge badge-vol" }, Ov = { class: "badge badge-confirm" }, Vv = { class: "badge badge-not-confirm" }, zv = { class: "badge badge-reject" }, Nv = { class: "badge badge-not-paid" }, Wv = { class: "badge badge-success" }, Hv = { class: "table-cell" }, jv = { class: "badges-container badges-wrap" }, Yv = { class: "badge badge-inv" }, Uv = { class: "badge badge-human" }, Kv = { class: "badge badge-accept" }, qv = {
  key: 1,
  class: "empty-state"
}, bs = 3, Xv = /* @__PURE__ */ tt({
  __name: "Disruption",
  ...
  setup(e, { emit: t }) {
    ...
    ) : []), r = C(() => o.value ? i.value : i.value.slice(0, bs)), l = C(() => i.value.length > bs), d = C(() => a.data?.total_payment_success || []), u = (b, g) => !g || g === 0 ? "0%" : `${Math.round(b / g * 100)}%`, f = (b) => bt(b), p = (b) => (b ?? []).reduce((g, _) => g + (_.count ?? 0), 0), v = (b) => typeof b.sell_success_count == "number" ? b.sell_success_count : p(b.payment_success_total), h = C(() => {
      const b = a.data, g = b.total_disruption_conversations || 0, _ = b.total_disruption_initiated || 0, k = b.total_voluntary || 0, w = b.total_involuntary || 0, M = b.total_accepted || 0, S = b.total_confirmed || 0, D = typeof b.total_sell_success == "number" ? b.total_sell_success : p(b.total_payment_success), A = b.total_sell_failed || 0, B = Math.max(0, g - _), F = Math.max(0, _ - k - w), P = Math.max(0, w - M), E = Math.max(0, k - S), N = A, Y = Math.max(0, S - D - N), L = (V, z) => {
    ...
    return (b, g) => (y(), x("article", gv, [
      c("header", pv, [
        c("div", vv, [
          ...
          a.loading ? R("", !0) : (y(), x("div", bv, [
            g[1] || (g[1] = c("p", { class: "badge-label" }, "Payment Success Value", -1)),
            d.value.length > 0 ? (y(), x("div", mv, [
              (y(!0), x(q, null, J(d.value, (_) => (y(), x("p", {
                key: _.currency,
                class: "currency-breakdown-item"
              }, $(_.currency) + " " + $(f(_.total_value)), 1))), 128))
            ])) : (y(), x("p", yv, $(f(0)), 1))
          ]))
        ])
      ]),
      a.loading ? (y(), x("div", _v, [...g[3] || (g[3] = [
        ...
        i.value && i.value.length > 0 ? (y(), x("section", Mv, [
            ...
            c("table", Sv, [
              ...
              c("tbody", Dv, [
                (y(!0), x(q, null, J(r.value, (_) => (y(), x("tr", {
                  ...
                  c("td", Av, $(T(Dt)(_.date).format("DD/MM")), 1),
                  c("td", Tv, $(T(X)(_.disruption_conversations)), 1),
                  c("td", Bv, [
                    kt($(T(X)(_.disruption_initiated_count)) + " ", 1),
                    c("span", Lv, " (" + $(u(_.disruption_initiated_count, _.disruption_conversations)) + ") ", 1)
                  ]),
                  c("td", Fv, [
                    c("span", Pv, $(T(X)(_.disruption_initiated_count - _.voluntary_count - _.involuntary_count)) + " (" + $(u(_.disruption_initiated_count - _.voluntary_count - _.involuntary_count, _.disruption_conversations)) + ") ", 1)
                  ]),
                  c("td", Iv, [
                    c("div", Rv, [
                      c("span", Ev, " VOL " + $(T(X)(_.voluntary_count)) + " (" + $(u(_.voluntary_count, _.disruption_conversations)) + ") ", 1),
                      c("span", Ov, " Confirm " + $(T(X)(_.confirmed_count)) + " (" + $(u(_.confirmed_count, _.disruption_conversations)) + ") ", 1),
                      c("span", Vv, " Not Confirm " + $(T(X)(_.voluntary_count - _.confirmed_count)) + " (" + $(u(_.voluntary_count - _.confirmed_count, _.disruption_conversations)) + ") ", 1),
                      c("span", zv, " Reject " + $(T(X)(_.sell_failed_count)) + " (" + $(u(_.sell_failed_count, _.disruption_conversations)) + ") ", 1),
                      c("span", Nv, " Not Paid " + $(T(X)(Math.max(0, _.confirmed_count - v(_) - _.sell_failed_count))) + " (" + $(u(Math.max(0, _.confirmed_count - v(_) - _.sell_failed_count), _.disruption_conversations)) + ") ", 1),
                      c("span", Wv, " Finish " + $(T(X)(v(_))) + " (" + $(u(v(_), _.disruption_conversations)) + ") ", 1),
                      (y(!0), x(q, null, J(_.payment_success_total || [], (k) => (y(), x("span", {
                  ...
                  c("td", Hv, [
                    c("div", jv, [
                      c("span", Yv, " INV " + $(T(X)(_.involuntary_count)) + " (" + $(u(_.involuntary_count, _.disruption_conversations)) + ") ", 1),
                      c("span", Uv, " Human " + $(T(X)(_.involuntary_count - _.accepted_count)) + " (" + $(u(_.involuntary_count - _.accepted_count, _.disruption_conversations)) + ") ", 1),
                      c("span", Kv, " Accept " + $(T(X)(_.accepted_count)) + " (" + $(u(_.accepted_count, _.disruption_conversations)) + ") ", 1)
                    ])
                  ])
                ]))), 128))
              ])
          ...
          l.value ? (y(), x("button", {
            key: 0,
            class: "view-more-btn",
            onClick: g[0] || (g[0] = (_) => o.value = !o.value)
          }, [
  ...
  key: 0,
  class: "kpi-grid"
}, tb = { class: "kpi-label-row" }, eb = { class: "kpi-label" }, ab = { class: "kpi-value" }, sb = { class: "kpi-secondary" }, nb = {
  key: 1,
  class: "chart-section"
}, ob = {
  key: 2,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (h) => {
      n("export", h);
    }, { isDark: i, colors: r } = ct(lt(s, "theme")), l = {
      ...
      ], m = h.reduce((b, g) => b + g.total, 0);
      return m === 0 ? [] : h.map((b) => ({
        ...b,
        percentage: (b.total / m * 100).toFixed(1),
        color: l[b.name] || "#9ca3af"
      }));
    }), p = C(() => ({
      responsive: !0,
      maintainAspectRatio: !1,
      ...
      if (m.length > 0) {
        const b = m.map((w) => Dt(w.date).format("MMM DD")), g = m.map((w) => w.airline_information_retrieved_count || 0), _ = m.map((w) => w.flight_status_retrieved_count || 0), k = m.map((w) => w.booking_info_retrieved_count || 0);
        d.value = {
          labels: b,
          datasets: [
            {
    ...
    return Rt(
      ...
      m[2] || (m[2] = c("header", { class: "card-header" }, [
        c("div", { class: "header-content" }, [
          c("h3", { class: "card-title" }, "FAQ Metrics"),
          c("p", { class: "card-subtitle" }, "FAQ volume by category")
        ])
      ], -1)),
      s.loading ? (y(), x("div", ib, [...m[1] || (m[1] = [
        st('<div class="loading-container" data-v-b274cf63><div class="chart-bars-loader" data-v-b274cf63><div class="bar bar-1" data-v-b274cf63></div><div class="bar bar-2" data-v-b274cf63></div><div class="bar bar-3" data-v-b274cf63></div><div class="bar bar-4" data-v-b274cf63></div><div class="bar bar-5" data-v-b274cf63></div></div><p class="loading-text" data-v-b274cf63>Loading FAQ metrics...</p></div>', 1)
      ])])) : (y(), x("div", Qv, [
        f.value.length ? (y(), x("div", Jv, [
          (y(!0), x(q, null, J(f.value, (b) => (y(), x("div", {
            class: "kpi-card",
            key: b.name
          }, [
            c("div", tb, [
              c("span", {
                class: "kpi-color-dot",
                style: ft({ backgroundColor: b.color }),
                "aria-hidden": "true"
              }, null, 4),
              c("span", eb, $(b.label), 1)
            ]),
            c("span", ab, $(T(X)(b.total)), 1),
            c("span", sb, $(b.percentage) + "%", 1)
          ]))), 128))
        ])) : R("", !0),
        d.value.labels && d.value.labels.length ? (y(), x("section", nb, [
          Q(ye, {
            data: d.value,
            options: p.value
          }, null, 8, ["data", "options"]),
          ...
          st('<div class="empty-state-content" data-v-b274cf63><div class="empty-icon-wrapper" data-v-b274cf63><svg class="empty-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b274cf63><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-b274cf63></path></svg></div><p class="empty-title" data-v-b274cf63>No FAQ data available</p><p class="empty-description" data-v-b274cf63>No FAQ consultation data found for the selected period. Try adjusting the date range.</p></div>', 1)
        ])]))
      ]))
    ]));
  }
}), lb = /* @__PURE__ */ nt(rb, [["__scopeId", "data-v-b274cf63"]]), cb = { class: "messages-per-agent-card" }, db = {
  key: 0,
  class: "card-body"
}, ub = {
  key: 0,
  class: "kpi-grid"
}, hb = { class: "kpi-label-row" }, fb = { class: "kpi-label" }, gb = { class: "kpi-value" }, pb = { class: "kpi-secondary" }, vb = {
  key: 1,
  class: "chart-section"
}, bb = {
  key: 2,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = {
      ...
      o("export", p);
    }, { isDark: r, colors: l } = ct(lt(n, "theme")), d = C(() => {
      const p = n.data?.agents_by_day || {}, v = Object.keys(p).sort();
      if (v.length === 0)
        return { labels: [], datasets: [] };
      ...
      for (const m of Object.values(p))
        for (const [b, g] of Object.entries(m))
          v[b] = (v[b] || 0) + g;
      const h = Object.values(v).reduce((m, b) => m + b, 0);
      return h === 0 ? [] : Object.entries(v).sort(([, m], [, b]) => b - m).map(([m, b]) => ({
        name: m,
        label: m.charAt(0).toUpperCase() + m.slice(1).replace(/_/g, " "),
        total: b,
        percentage: (b / h * 100).toFixed(1),
        color: s[m] || "#94a3b8"
      }));
    }), f = C(() => n.options ? n.options : {
      responsive: !0,
    ...
    return t({ isDark: r }), (p, v) => (y(), x("article", cb, [
      v[3] || (v[3] = c("header", { class: "card-header" }, [
        c("div", { class: "header-content" }, [
          c("h3", { class: "card-title" }, "Interactions by Agent"),
          c("p", { class: "card-subtitle" }, "Responses sent by AI agents")
        ])
      ], -1)),
      e.loading ? (y(), x("div", _b, [...v[2] || (v[2] = [
        st('<div class="loading-container" data-v-d9be0ffa><div class="chart-lines-loader" data-v-d9be0ffa><div class="line line-1" data-v-d9be0ffa></div><div class="line line-2" data-v-d9be0ffa></div><div class="line line-3" data-v-d9be0ffa></div><div class="line line-4" data-v-d9be0ffa></div><div class="line line-5" data-v-d9be0ffa></div></div><p class="loading-text" data-v-d9be0ffa>Loading chart data...</p></div>', 1)
      ])])) : (y(), x("div", db, [
        u.value.length ? (y(), x("div", ub, [
          (y(!0), x(q, null, J(u.value, (h) => (y(), x("div", {
            class: "kpi-card",
            key: h.name
          }, [
            c("div", hb, [
            ...
            c("span", gb, $(h.percentage) + "%", 1),
            c("span", pb, $(T(X)(h.total)) + " msgs", 1)
          ]))), 128))
        ])) : R("", !0),
        d.value.labels && d.value.labels.length ? (y(), x("section", vb, [
          ...
          c("div", mb, [
            ...
            v[0] || (v[0] = c("p", { class: "empty-title" }, "No agent interactions data", -1)),
            v[1] || (v[1] = c("p", { class: "empty-description" }, "Try adjusting the date range or check your filters to see agent interaction trends.", -1))
          ])
        ]))
      ]))
    ]));
  }
}), kb = /* @__PURE__ */ nt(xb, [["__scopeId", "data-v-d9be0ffa"]]), wb = { class: "record-locator-card" }, $b = {
  key: 0,
  class: "loading-state"
}, Mb = {
  key: 1,
  ...
  key: 1,
  class: "table-header"
}, Pb = { class: "table-body" }, Ib = { class: "table-cell font-medium" }, Rb = { class: "table-cell text-center" }, Eb = { class: "table-cell text-center" }, Ob = { class: "table-cell text-center" }, Vb = { class: "table-cell text-center" }, zb = { class: "table-cell text-center success-value" }, Nb = { class: "table-cell text-center failed-value" }, Wb = { class: "table-cell text-center warning-value" }, Hb = {
  key: 0,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (b) => {
      n("export", b);
    }, { isDark: i } = ct(lt(s, "theme")), r = at(!1), l = C(() => s.data?.record_locator_by_day ? [...s.data.record_locator_by_day].sort(
      (b, g) => new Date(b.date).getTime() - new Date(g.date).getTime()
    ) : []), d = C(() => r.value ? l.value : l.value.slice(0, ms)), u = C(() => l.value.length > ms), f = C(() => s.data), p = C(() => ({
    ...
    })), v = (b, g) => !g || g === 0 ? "0%" : `${Math.round(b / g * 100)}%`, h = (b, g) => {
      const _ = X(b), k = v(b, g);
      return `${_} (${k})`;
    }, m = C(() => {
      const b = [], g = [], _ = /* @__PURE__ */ new Set(), k = (K) => {
        _.has(K) || (b.push({ name: K }), _.add(K));
      };
      ...
      if (Y) {
        ...
        if (L > 0) {
          const K = Math.round(L / w * 100);
          k("Booking not retreived"), g.push({
            source: "Checkin Init",
            target: "Booking not retreived",
            value: L,
            label: `${L.toLocaleString()} (${K}%)`
          });
        }
      } else if (G > 0) {
        const K = Math.round(G / w * 100);
        k("Abandoned (Init)"), g.push({
          source: "Checkin Init",
          target: "Abandoned (Init)",
          value: G,
      ...
      if (D > 0) {
        const K = Math.round(D / S * 100);
        g.push({
          source: "Checkin Started",
          target: "Checkin Completed",
          value: D,
          label: `${D.toLocaleString()} (${K}%)`
        });
      }
      if (A > 0) {
      ...
      s.loading ? (y(), x("div", $b, [...g[1] || (g[1] = [
        ...
        l.value && l.value.length > 0 ? (y(), x("section", Db, [
            ...
            c("table", Tb, [
              c("thead", null, [
                c("tr", Bb, [
                  ...
                  s.isAvianca ? (y(), x("th", Lb, "Create Payment")) : R("", !0),
                  s.isAvianca ? (y(), x("th", Fb, "Failed Payment")) : R("", !0)
                ])
              ]),
              c("tbody", Pb, [
                (y(!0), x(q, null, J(d.value, (_) => (y(), x("tr", {
                  key: _.date,
                  class: "table-row"
                }, [
                  c("td", Ib, $(T(Dt)(_.date).format("DD/MM/YYYY")), 1),
                  c("td", Rb, $(T(X)(_.checkin_initiated)), 1),
                  c("td", Eb, $(h(_.record_locator_init_count, _.checkin_initiated)), 1),
                  c("td", Ob, $(T(X)(_.record_locator_started_count)), 1),
                  c("td", Vb, $(h(_.record_locator_completed_count, _.record_locator_started_count)), 1),
                  c("td", zb, $(h(_.record_locator_closed_count, _.record_locator_started_count)), 1),
                  c("td", Nb, $(h(_.record_locator_failed_count, _.record_locator_started_count)), 1),
                  c("td", Wb, $(h(_.record_locator_abandoned_count, _.record_locator_started_count)), 1),
                  s.isAvianca ? (y(), x("td", Hb, $(T(X)(_.record_locator_create_payment_count)), 1)) : R("", !0),
                  s.isAvianca ? (y(), x("td", jb, $(T(X)(_.record_locator_create_payment_failed_count)), 1)) : R("", !0)
                ]))), 128))
              ])
            ])
          ]),
          u.value ? (y(), x("button", {
            ...
            kt($(r.value ? "View less" : `View more (${l.value.length - ms} more rows)`) + " ", 1),
            (y(), x("svg", {
              class: U(["view-more-icon", { "view-more-icon-rotated": r.value }]),
              fill: "none",
              viewBox: "0 0 24 24",
...
}), Kb = /* @__PURE__ */ nt(Ub, [["__scopeId", "data-v-e48cea55"]]), qb = { class: "sales-channel-card" }, Xb = {
  key: 0,
  class: "loading-state"
}, Gb = {
  key: 1,
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    const d = C(() => {
      ...
      const v = p.map((m) => Dt(m.date).format("MMM-DD")), h = d.value.map((m, b) => ({
        label: m,
        data: p.map((g) => g.channels[m] ?? 0),
        backgroundColor: u(m, b),
        borderRadius: 4
      }));
    ...
    return t({ isDark: l }), (p, v) => (y(), x("article", qb, [
      ...
      o.loading ? (y(), x("div", Xb, [...v[0] || (v[0] = [
        ...
        e.channelComparison.length > 0 ? (y(), x("section", tm, [
          c("div", em, [
            (y(!0), x(q, null, J(e.channelComparison, (h) => (y(), x("div", {
              key: h.channel,
              ...
              c("div", am, [
                c("span", sm, $(h.channel), 1),
                c("span", nm, $(T(X)(h.current)), 1),
                h.delta !== null ? (y(), x("div", om, [
                  c("span", {
                    class: U(["delta-badge", h.delta > 0 ? "delta-up" : h.delta < 0 ? "delta-down" : "delta-neutral"])
                  }, [
                    ...
                    kt(" " + $(Math.abs(h.delta).toFixed(1)) + "% ", 1)
                  ], 2),
                  c("span", lm, "vs prev. period (" + $(T(X)(h.previous)) + ")", 1)
                ])) : (y(), x("div", cm, [...v[4] || (v[4] = [
  ...
  key: 2,
  class: "table-section"
}, Am = { class: "table-wrapper" }, Tm = { class: "data-table" }, Bm = { class: "table-body" }, Lm = { class: "table-cell font-medium" }, Fm = { class: "table-cell text-center" }, Pm = { class: "table-cell text-center" }, Im = { class: "table-cell text-center" }, Rm = { class: "table-cell text-center" }, Em = { class: "table-cell text-center" }, Om = { class: "table-cell text-center warning-value" }, Vm = {
  key: 0,
  ...
  key: 1,
  class: "empty-cell"
}, Ym = { class: "table-cell text-center" }, Um = { class: "table-cell text-center success-value" }, Km = {
  key: 0,
  class: "currency-cell-list"
}, qm = { key: 1 }, Xm = { class: "table-cell text-left" }, Gm = {
  key: 0,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (D) => {
      n("export", D);
    }, { isDark: i } = ct(lt(s, "theme")), r = at(!1), l = C(() => {
    ...
    }), d = C(() => r.value ? l.value : l.value.slice(0, ys)), u = C(() => l.value.length > ys), f = C(() => s.sellerData), p = C(() => s.failedData), v = C(
      ...
      const j = N.reduce((H, et) => (et.reasons && Array.isArray(et.reasons) && et.reasons.forEach((G) => {
        const K = G.reason, ot = G.failed_count;
        H[K] = (H[K] || 0) + ot;
      }), H), {});
      if (B > 0) {
      ...
      if (E > 0) {
        ...
        Y.push({ name: "Cash Option", value: E }), L.push({
          source: "Booking Created",
          target: "Cash Option",
          value: E,
      ...
      if (Object.keys(j).length > 0) {
        const H = Object.values(j).reduce((G, K) => G + K, 0), et = z - H;
        if (Object.entries(j).filter(([, G]) => G > 0).sort(([, G], [, K]) => K - G).forEach(([G, K]) => {
          const ot = Math.round(K / D * 100);
          Y.push({ name: `Failed: ${G}`, value: K }), L.push({
    ...
    }, _ = C(() => g), k = (D, A) => !A || A === 0 ? "0%" : `${Math.round(D / A * 100)}%`, w = (D, A) => {
      const B = X(D), F = k(D, A);
      return `${B} (${F})`;
    ...
    return t({ isDark: i }), (D, A) => (y(), x("article", hm, [
      c("header", fm, [
        c("div", gm, [
          A[4] || (A[4] = c("div", { class: "title-section" }, [
            c("h3", { class: "card-title" }, "Seller Metrics"),
            c("p", { class: "card-subtitle" }, "Sales performance and failure analysis")
          ], -1)),
          c("div", pm, [
            s.loading ? R("", !0) : (y(), x("div", vm, [
              A[1] || (A[1] = c("p", { class: "badge-label" }, "Total Sales Value", -1)),
              v.value.length > 0 ? (y(), x("div", bm, [
                (y(!0), x(q, null, J(v.value, (B) => (y(), x("p", {
                  key: B.currency,
                  class: "currency-breakdown-item"
            ...
            !s.loading && h.value.length > 0 ? (y(), x("div", ym, [
              A[2] || (A[2] = c("p", { class: "badge-label-warning" }, "Bank Transfer Value", -1)),
              c("div", _m, [
                (y(!0), x(q, null, J(h.value, (B) => (y(), x("p", {
                  key: "bt-" + B.currency,
            ...
            !s.loading && m.value.length > 0 ? (y(), x("div", xm, [
              A[3] || (A[3] = c("p", { class: "badge-label-warning" }, "Cash Option Value", -1)),
              c("div", km, [
                (y(!0), x(q, null, J(m.value, (B) => (y(), x("p", {
                  key: "co-" + B.currency,
                  class: "currency-breakdown-item-warning"
                }, $(B.currency) + " " + $(T(Qt)(B.total_value)), 1))), 128))
              ])
      ...
      s.loading ? (y(), x("div", wm, [...A[5] || (A[5] = [
        ...
        b.value.nodes.length > 0 ? (y(), x("section", Mm, [
          c("div", Cm, [
            Q(_e, {
              data: b.value,
              "node-colors": _.value,
        ...
        l.value && l.value.length > 0 ? (y(), x("section", Dm, [
          c("div", Am, [
            c("table", Tm, [
              A[7] || (A[7] = c("thead", null, [
                c("tr", { class: "table-header-row" }, [
                  c("th", { class: "table-header" }, "Date"),
                  ...
                  c("th", { class: "table-header" }, "Bank Transfer"),
                  c("th", { class: "table-header" }, "BT Value"),
                  c("th", { class: "table-header" }, "Cash Option"),
                  c("th", { class: "table-header" }, "CO Value"),
              ...
              c("tbody", Bm, [
                (y(!0), x(q, null, J(d.value, (B) => (y(), x("tr", {
                  ...
                  c("td", Lm, $(T(Dt)(B.date).format("DD/MM/YYYY")), 1),
                  c("td", Fm, $(T(X)(B.seller_conversations || 0)), 1),
                  c("td", Pm, $(w(B.sell_started_count, B.seller_conversations || B.sell_started_count)), 1),
                  c("td", Im, $(w(B.sell_get_quote_count, B.seller_conversations || B.sell_started_count)), 1),
                  c("td", Rm, $(w(B.sell_booking_created_count, B.seller_conversations || B.sell_started_count)), 1),
                  c("td", Em, $(T(X)(B.sell_bank_transfer_count || 0)), 1),
                  c("td", Om, [
                    Array.isArray(B.daily_value_sell_bank_transfer) && B.daily_value_sell_bank_transfer.length > 0 ? (y(), x("div", Vm, [
                      (y(!0), x(q, null, J(B.daily_value_sell_bank_transfer, (F) => (y(), x("span", {
                        key: `${B.date}-bt-${F.currency}`
                      }, $(F.currency) + " " + $(T(Qt)(F.total_value)), 1))), 128))
                    ])) : (y(), x("span", zm, "-"))
                  ]),
                  c("td", Nm, $(T(X)(B.sell_cash_option_count || 0)), 1),
                  c("td", Wm, [
                    Array.isArray(B.daily_value_sell_cash_option) && B.daily_value_sell_cash_option.length > 0 ? (y(), x("div", Hm, [
                      (y(!0), x(q, null, J(B.daily_value_sell_cash_option, (F) => (y(), x("span", {
                        key: `${B.date}-co-${F.currency}`
                      }, $(F.currency) + " " + $(T(Qt)(F.total_value)), 1))), 128))
                    ])) : (y(), x("span", jm, "-"))
                  ]),
                  c("td", Ym, $(w(B.sell_success_count, B.seller_conversations || B.sell_started_count)), 1),
                  c("td", Um, [
                    Array.isArray(B.daily_value_sell_success) && B.daily_value_sell_success.length > 0 ? (y(), x("div", Km, [
                      (y(!0), x(q, null, J(B.daily_value_sell_success, (F) => (y(), x("span", {
                        key: `${B.date}-${F.currency}`
                      }, $(F.currency) + " " + $(T(Qt)(F.total_value)), 1))), 128))
                    ])) : (y(), x("span", qm, $(S(B.daily_value_sell_success)), 1))
                  ]),
                  c("td", Xm, [
                    B.reasons && B.reasons.length > 0 ? (y(), x("div", Gm, [
                      (y(!0), x(q, null, J(B.reasons, (F) => (y(), x("div", {
                        key: F.reason,
                        class: "failed-reason-item"
                      }, [
                        c("span", Zm, $(F.reason) + ":", 1),
                        c("span", Qm, $(F.failed_count), 1)
                      ]))), 128))
                    ])) : (y(), x("div", Jm, "-"))
                  ])
                ]))), 128))
          ...
          u.value ? (y(), x("button", {
            ...
            kt($(r.value ? "View less" : `View more (${l.value.length - ys} more rows)`) + " ", 1),
            (y(), x("svg", {
              class: U(["view-more-icon", { "view-more-icon-rotated": r.value }]),
              fill: "none",
              viewBox: "0 0 24 24",
  ...
  setup(e, { expose: t, emit: a }) {
    const s = {
      ...
      return {
        labels: p.map((b) => {
          const g = Number(b.conversations) || 0, _ = v ? g / v * 100 : 0;
          return `${b.agent_type} - ${g.toLocaleString()} (${_.toFixed(1)}%)`;
        }),
        datasets: [
          {
  ...
  key: 0,
  class: "currency-cell-list"
}, L1 = { key: 1 }, F1 = { class: "table-cell" }, P1 = { class: "payment-tags" }, I1 = { class: "tag-name" }, R1 = {
  key: 0,
  class: "tag-amount"
}, E1 = {
  key: 1,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, { isDark: o } = ct(lt(s, "theme")), i = at(!1), r = at({
      ...
      const O = b[L % b.length];
      return {
        background: O.bg,
        borderColor: O.border
      };
    }, _ = (L) => ({ color: b[L % b.length].text }), k = (L) => ({ color: b[L % b.length].value }), w = (L) => ({ color: b[L % b.length].icon }), M = (L) => ({ color: b[L % b.length].badge }), S = (L) => {
      const j = B(L).length;
    ...
    }, A = (L) => !L || L.toLowerCase() === "unknown" ? z1 : L.replace(/_/g, " "), B = (L) => L == null ? "$0.00" : bt(L), F = (L) => L == null ? "0" : Qt(L), P = (L) => L ? Dt(L).format("DD/MM/YYYY") : "-", E = (L) => L == null || Number.isNaN(Number(L)) ? 0 : Number(L), N = (L) => {
      n("export", L);
    };
    function Y() {
      const L = s.data;
    ...
    return le(() => {
      ...
      i.value ? (y(), x("div", h1, [...O[1] || (O[1] = [
        ...
        l.value ? (y(), x("section", g1, [
          O[2] || (O[2] = c("p", { class: "section-label" }, "Sales by Payment Method", -1)),
          c("div", p1, [
            (y(!0), x(q, null, J(r.value.payment_method_breakdown, (j, V) => (y(), x("div", {
              ...
              c("div", v1, [
                ...
                j.total_amount_by_currency && j.total_amount_by_currency.length > 0 ? (y(), x("div", m1, [
                  (y(!0), x(q, null, J(j.total_amount_by_currency, (z) => (y(), x("p", {
                    key: `${j.payment_method}-${z.currency}`,
                    class: "currency-card-item",
                    style: ft(k(V))
                  }, [
                    c("span", y1, $(z.currency), 1),
                    c("span", {
          ...
          c("div", k1, [
            ...
            O[3] || (O[3] = c("p", { class: "empty-title" }, "No payment data available", -1)),
            O[4] || (O[4] = c("p", { class: "empty-description" }, "No payment method data found for the selected period. Try adjusting the date range.", -1))
          ])
        ])),
        d.value ? (y(), x("section", $1, [
          O[8] || (O[8] = c("p", { class: "section-label" }, "Daily Breakdown", -1)),
          c("div", M1, [
            c("table", C1, [
              O[6] || (O[6] = c("thead", null, [
                c("tr", { class: "table-header-row" }, [
              ...
              c("tbody", S1, [
                (y(!0), x(q, null, J(p.value, (j) => (y(), x("tr", {
                  key: j.date,
                  class: "table-row"
                }, [
                  c("td", D1, $(P(j.date)), 1),
                  c("td", A1, $(T(X)(j.total_count ?? 0)), 1),
                  c("td", T1, [
                    j.total_amount_by_currency && j.total_amount_by_currency.length > 0 ? (y(), x("div", B1, [
                      (y(!0), x(q, null, J(j.total_amount_by_currency, (V) => (y(), x("span", {
                  ...
                  c("td", F1, [
                    c("div", P1, [
                      (y(!0), x(q, null, J(j.payment_methods || [], (V) => (y(), x("div", {
                        key: V.payment_method,
                        class: "payment-tag"
                      }, [
                        c("span", I1, $(A(V.payment_method)), 1),
                        O[5] || (O[5] = c("span", { class: "tag-separator" }, "•", -1)),
                        !V.total_amount_by_currency || V.total_amount_by_currency.length === 0 ? (y(), x("span", R1, $(B(V.total_amount)), 1)) : (y(), x("span", E1, $(V.total_amount_by_currency.map((z) => `${z.currency} ${B(z.total_value)}`).join(" / ")), 1)),
                        c("span", O1, "(" + $(E(V.count)) + ")", 1)
                      ]))), 128))
                    ])
                  ])
                ]))), 128))
          ...
          v.value ? (y(), x("button", {
            ...
            kt($(u.value ? "View less" : `View more (${f.value.length - _s} more rows)`) + " ", 1),
            (y(), x("svg", {
  ...
  key: 1,
  class: "card-body"
}, U1 = { class: "summary-cards" }, K1 = { class: "summary-card assigned-card" }, q1 = { class: "summary-card-content" }, X1 = { class: "card-content" }, G1 = { class: "card-value assigned-value" }, Z1 = { class: "card-content" }, Q1 = { class: "card-value assigned-value" }, J1 = { class: "summary-card closed-card" }, ty = { class: "summary-card-content" }, ey = { class: "card-content" }, ay = { class: "card-value closed-value" }, sy = { class: "card-content" }, ny = { class: "card-value closed-value" }, oy = {
  key: 0,
  class: "agents-section"
}, iy = { class: "date-header" }, ry = { class: "date-title" }, ly = { class: "date-stats" }, cy = { class: "stat-item assigned-stat" }, dy = { class: "stat-value" }, uy = { class: "stat-value" }, hy = { class: "stat-item closed-stat" }, fy = { class: "stat-value" }, gy = { class: "stat-value" }, py = { class: "table-wrapper" }, vy = { class: "data-table" }, by = { class: "table-body" }, my = { class: "table-cell name-cell" }, yy = { class: "table-cell email-cell" }, _y = { class: "table-cell text-center" }, xy = { class: "metric-cell-content" }, ky = { class: "badge assigned-badge" }, wy = { class: "metric-cell-avg" }, $y = { class: "table-cell text-center" }, My = { class: "metric-cell-content" }, Cy = { class: "badge closed-badge" }, Sy = { class: "metric-cell-avg" }, Dy = {
  key: 1,
  class: "empty-state"
}, Ay = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (b) => {
      n("export", b);
    }, { isDark: i } = ct(lt(s, "theme")), r = C(() => s.data?.agents_by_day && s.data.agents_by_day.length > 0), l = C(() => {
      if (!r.value) return {};
      const b = {};
      for (const k of s.data.agents_by_day)
        b[k.date] || (b[k.date] = []), b[k.date].push(k);
      const g = Object.keys(b).sort((k, w) => new Date(k).getTime() - new Date(w).getTime()), _ = {};
      for (const k of g)
        _[k] = b[k];
      return _;
      ...
      const g = Math.round(b), _ = Math.floor(g / 60), k = g % 60;
      if (_ < 60)
        return `${_}m ${k}s`;
      const w = Math.floor(_ / 60), M = _ % 60;
      return `${w}h ${M}m`;
    }, f = (b) => {
      const g = new Date(b), _ = {
        year: "numeric",
        month: "long",
        day: "numeric"
      };
      return g.toLocaleDateString("en-US", _);
    }, p = (b) => b[0]?.day_total_assigned ?? 0, v = (b) => b[0]?.day_total_closed ?? 0, h = (b) => b[0]?.day_avg_time_to_assign_seconds ?? null, m = (b) => b[0]?.day_avg_conversation_duration_seconds ?? null;
    return t({ isDark: i }), (b, g) => (y(), x("article", H1, [
          ...
          c("div", K1, [
            ...
            c("div", q1, [
              c("div", X1, [
                ...
                c("p", G1, $(d(e.data.total_assigned)), 1)
              ]),
              c("div", Z1, [
                g[2] || (g[2] = c("p", { class: "card-label" }, "AVG time to assign", -1)),
                c("p", Q1, $(u(e.data.avg_time_to_assign_seconds)), 1)
              ])
            ])
          ]),
          c("div", J1, [
            ...
            c("div", ty, [
              c("div", ey, [
                ...
                c("p", ay, $(d(e.data.total_closed)), 1)
              ]),
              c("div", sy, [
                g[5] || (g[5] = c("p", { class: "card-label" }, "AVG time to close", -1)),
                c("p", ny, $(u(e.data.avg_conversation_duration_seconds)), 1)
              ])
            ])
          ])
        ]),
        r.value ? (y(), x("div", oy, [
          (y(!0), x(q, null, J(l.value, (_, k) => (y(), x("div", {
            key: k,
            class: "date-group"
          }, [
            c("div", iy, [
            ...
            c("div", py, [
              c("table", vy, [
                ...
                c("tbody", by, [
                  (y(!0), x(q, null, J(_, (w) => (y(), x("tr", {
                    key: `${k}-${w.agent_email}`,
                    class: "table-row"
                  }, [
                    c("td", my, $(w.agent_name || "-"), 1),
                    c("td", yy, $(w.agent_email), 1),
                    c("td", _y, [
                      c("div", xy, [
                        c("span", ky, $(d(w.assigned_count)), 1),
                        c("span", wy, $(u(w.avg_time_to_assign_seconds)), 1)
                      ])
                    ]),
                    c("td", $y, [
                      c("div", My, [
                        c("span", Cy, $(d(w.closed_count)), 1),
                        c("span", Sy, $(u(w.avg_conversation_duration_seconds)), 1)
                      ])
                    ])
                  ]))), 128))
                ])
...
}), Ty = /* @__PURE__ */ nt(Ay, [["__scopeId", "data-v-6cfba83b"]]), By = { class: "channel-metrics-card" }, Ly = {
  key: 0,
  class: "card-body"
}, Fy = {
  key: 0,
  class: "kpi-grid"
}, Py = { class: "kpi-label-row" }, Iy = { class: "kpi-label" }, Ry = { class: "kpi-value" }, Ey = { class: "kpi-secondary" }, Oy = {
  key: 1,
  class: "chart-section"
}, Vy = {
  key: 2,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (h) => {
      ...
      const h = u.value.total_by_channel || {}, m = Object.values(h).reduce((b, g) => b + g, 0);
      return m === 0 ? [] : Object.entries(h).sort(([, b], [, g]) => g - b).map(([b, g]) => ({
        name: b,
        label: b.toUpperCase(),
        total: g,
      ...
      const m = h.channels_by_day, b = Object.keys(m).sort();
      if (b.length === 0) {
        d.value = { labels: [], datasets: [] };
        return;
      }
      ...
      const k = Array.from(g).map((w) => {
        const M = w.toLowerCase(), S = l[M] || "#9ca3af";
        return {
          label: w.toUpperCase(),
          data: b.map((D) => m[D]?.[w] || 0),
          borderColor: S,
      ...
      d.value = {
        labels: b.map((w) => Dt(w).format("MMM DD")),
        datasets: k
      };
    };
    return Rt(
      ...
      { deep: !0, immediate: !0 }
    ), t({ isDark: i }), (h, m) => (y(), x("article", By, [
      m[2] || (m[2] = c("header", { class: "card-header" }, [
        c("div", { class: "header-content" }, [
          c("h3", { class: "card-title" }, "Interactions by Channel"),
          c("p", { class: "card-subtitle" }, "Responses sent by AI agents")
        ])
      ], -1)),
      s.loading ? (y(), x("div", zy, [...m[1] || (m[1] = [
        st('<div class="loading-container" data-v-36697962><div class="chart-bars-loader" data-v-36697962><div class="bar bar-1" data-v-36697962></div><div class="bar bar-2" data-v-36697962></div><div class="bar bar-3" data-v-36697962></div><div class="bar bar-4" data-v-36697962></div><div class="bar bar-5" data-v-36697962></div></div><p class="loading-text" data-v-36697962>Loading channel metrics...</p></div>', 1)
      ])])) : (y(), x("div", Ly, [
        f.value.length ? (y(), x("div", Fy, [
          (y(!0), x(q, null, J(f.value, (b) => (y(), x("div", {
            class: "kpi-card",
            key: b.name
          }, [
            ...
            c("span", Ry, $(b.percentage) + "%", 1),
            c("span", Ey, $(T(X)(b.total)) + " msgs", 1)
          ]))), 128))
        ])) : R("", !0),
        d.value.labels && d.value.labels.length ? (y(), x("section", Oy, [
          Q(ye, {
            data: d.value,
            options: p.value
          }, null, 8, ["data", "options"]),
        ...
        ])) : (y(), x("section", Vy, [...m[0] || (m[0] = [
          st('<div class="empty-state-content" data-v-36697962><div class="empty-icon-wrapper" data-v-36697962><svg class="empty-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-36697962><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" data-v-36697962></path></svg></div><p class="empty-title" data-v-36697962>No channel metrics data available</p><p class="empty-description" data-v-36697962>No channel data found for the selected period. Try adjusting the date range.</p></div>', 1)
        ])]))
      ]))
    ]));
  }
}), Wy = /* @__PURE__ */ nt(Ny, [["__scopeId", "data-v-36697962"]]), Hy = { class: "triage-combinations-card" }, jy = { class: "card-header" }, Yy = { class: "total-badge" }, Uy = {
  key: 0,
  class: "card-body"
}, Ky = { class: "chart-container" }, qy = { class: "table-container" }, Xy = { class: "table-row" }, Gy = { class: "table-row" }, Zy = { class: "table-cell text-center count-cell" }, Qy = { class: "table-cell text-center count-cell" }, Jy = { class: "table-cell text-center count-cell" }, t_ = { class: "table-cell text-center count-cell" }, e_ = { class: "table-cell text-center count-cell" }, a_ = {
  key: 1,
  class: "empty-state"
}, s_ = { class: "empty-state-content" }, n_ = { class: "empty-icon-wrapper" }, o_ = {
  key: 1,
  class: "loading-state"
}, i_ = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (g) => {
      n("export", g);
    }, { isDark: i, colors: r } = ct(lt(s, "theme")), l = C(() => {
      const g = s.data?.combinations || {}, _ = { 0: 0, 1: 0, 2: 0, 3: 0, "4p": 0 };
      for (const [k, w] of Object.entries(g)) {
        ...
        S >= 4 ? _["4p"] += Number(w) || 0 : _[S] += Number(w) || 0;
      }
      return _;
    }), d = C(() => {
      const g = l.value;
    ...
    return t({ isDark: i }), (g, _) => (y(), x("article", Hy, [
      c("header", jy, [
        ...
        c("span", Yy, " Total: " + $(d.value), 1)
      ]),
      e.loading ? (y(), x("div", o_, [..._[6] || (_[6] = [
        ...
        u.value ? (y(), x(q, { key: 0 }, [
          ...
          c("div", qy, [
            _[3] || (_[3] = st('<div class="table-header" data-v-cb93cda2><div class="table-cell header-cell" data-v-cb93cda2>Number of intentions</div><div class="table-cell header-cell text-center" data-v-cb93cda2>0</div><div class="table-cell header-cell text-center" data-v-cb93cda2>1</div><div class="table-cell header-cell text-center" data-v-cb93cda2>2</div><div class="table-cell header-cell text-center" data-v-cb93cda2>3</div><div class="table-cell header-cell text-center" data-v-cb93cda2>4 or more</div></div>', 1)),
            c("div", Xy, [
            ...
            c("div", Gy, [
              ...
              c("div", Zy, $(T(X)(l.value[0])), 1),
              c("div", Qy, $(T(X)(l.value[1])), 1),
              c("div", Jy, $(T(X)(l.value[2])), 1),
              c("div", t_, $(T(X)(l.value[3])), 1),
              c("div", e_, $(T(X)(l.value["4p"])), 1)
            ])
          ]),
          e.enableExport ? (y(), dt(T(xt), {
            key: 0,
...
}), r_ = /* @__PURE__ */ nt(i_, [["__scopeId", "data-v-cb93cda2"]]), l_ = { class: "select-language-card" }, c_ = { class: "card-header" }, d_ = { class: "header-content" }, u_ = {
  key: 0,
  class: "total-badge"
  ...
  setup(e, { expose: t }) {
    ...
    return t({ isDark: s }), (v, h) => (y(), x("article", l_, [
      c("header", c_, [
        c("div", d_, [
          ...
          a.loading ? R("", !0) : (y(), x("div", u_, [
            h[0] || (h[0] = c("p", { class: "badge-label" }, "Total", -1)),
            c("p", h_, $(T(X)(d.value)), 1)
          ]))
        ])
      ]),
      a.loading ? (y(), x("div", f_, [...h[2] || (h[2] = [
...
}), m_ = /* @__PURE__ */ nt(b_, [["__scopeId", "data-v-216eadc2"]]), y_ = { class: "guardrails-card" }, __ = { class: "card-header" }, x_ = { class: "header-content" }, k_ = {
  key: 0,
  class: "total-badge"
}, w_ = { class: "badge-value" }, $_ = {
  key: 0,
  class: "loading-state"
}, M_ = {
  key: 1,
  class: "card-body"
}, C_ = { class: "summary-card" }, S_ = { class: "summary-items" }, D_ = { class: "summary-item" }, A_ = { class: "summary-value" }, T_ = { class: "summary-pct" }, B_ = { class: "summary-item" }, L_ = { class: "summary-pct" }, F_ = { class: "summary-item" }, P_ = { class: "summary-value" }, I_ = { class: "summary-pct" }, R_ = {
  key: 0,
  class: "table-section"
}, E_ = { class: "table-wrapper" }, O_ = { class: "data-table" }, V_ = { class: "table-body" }, z_ = { class: "table-cell font-medium text-center" }, N_ = { class: "table-cell text-center font-semibold" }, W_ = { class: "table-cell" }, H_ = { class: "type-badges-row" }, j_ = {
  key: 1,
  class: "empty-state"
}, xs = 3, Y_ = /* @__PURE__ */ tt({
  __name: "Guardrails",
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (g) => {
      ...
      () => (s.data?.items || []).reduce((g, _) => g + _.count, 0)
    ), d = (g) => {
      const _ = {};
      for (const M of s.data?.items || [])
        _[M[g]] = (_[M[g]] || 0) + M.count;
      const k = Object.entries(_).sort((M, S) => S[1] - M[1]);
      ...
      const g = {};
      for (const _ of s.data?.items || [])
        g[_.date] || (g[_.date] = {}), g[_.date][_.guardrail_type] = (g[_.date][_.guardrail_type] || 0) + _.count;
      return Object.entries(g).map(([_, k]) => ({
        date: _,
    ...
    }), h = at(!1), m = C(() => h.value ? v.value : v.value.slice(0, xs)), b = C(() => v.value.length > xs);
    return t({ isDark: i }), (g, _) => (y(), x("article", y_, [
      c("header", __, [
        c("div", x_, [
          _[2] || (_[2] = c("div", { class: "title-section" }, [
          ...
          s.loading ? R("", !0) : (y(), x("div", k_, [
            _[1] || (_[1] = c("p", { class: "badge-label" }, "Total Events", -1)),
            c("p", w_, $(T(X)(l.value)), 1)
          ]))
        ])
      ]),
      s.loading ? (y(), x("div", $_, [..._[3] || (_[3] = [
        ...
        r.value ? (y(), x(q, { key: 0 }, [
          c("div", C_, [
            c("div", S_, [
              c("div", D_, [
                _[4] || (_[4] = c("span", { class: "summary-label" }, "Top type:", -1)),
                c("span", A_, $(u.value.name), 1),
                c("span", T_, "(" + $(u.value.pct) + "%)", 1)
              ]),
              _[7] || (_[7] = c("span", { class: "summary-dot" }, "·", -1)),
              c("div", B_, [
                _[5] || (_[5] = c("span", { class: "summary-label" }, "Top action:", -1)),
                c("span", {
                  class: U(["summary-value", `summary-action-${f.value.name.toLowerCase()}`])
                }, $(f.value.name), 3),
                c("span", L_, "(" + $(f.value.pct) + "%)", 1)
              ]),
              _[8] || (_[8] = c("span", { class: "summary-dot" }, "·", -1)),
              c("div", F_, [
                _[6] || (_[6] = c("span", { class: "summary-label" }, "Top source:", -1)),
                c("span", P_, $(p.value.name), 1),
                c("span", I_, "(" + $(p.value.pct) + "%)", 1)
              ])
            ])
          ]),
          v.value.length > 0 ? (y(), x("section", R_, [
            _[11] || (_[11] = c("div", { class: "section-header" }, [
              c("h4", { class: "section-title" }, "Daily Overview")
            ], -1)),
            c("div", E_, [
              c("table", O_, [
                _[9] || (_[9] = c("thead", null, [
                  c("tr", { class: "table-header-row" }, [
                    c("th", { class: "table-header" }, "Date"),
                ...
                c("tbody", V_, [
                  (y(!0), x(q, null, J(m.value, (k) => (y(), x("tr", {
                    key: k.date,
                    class: "table-row"
                  }, [
                    c("td", z_, $(T(Dt)(k.date).format("DD/MM")), 1),
                    c("td", N_, $(T(X)(k.total)), 1),
                    c("td", W_, [
                      c("div", H_, [
                        (y(!0), x(q, null, J(k.types, (w) => (y(), x("span", {
                          key: w.type,
            ...
            b.value ? (y(), x("button", {
              key: 0,
              class: "view-more-btn",
              onClick: _[0] || (_[0] = (k) => h.value = !h.value)
            }, [
              kt($(h.value ? "View less" : `View more (${v.value.length - xs} more rows)`) + " ", 1),
              (y(), x("svg", {
                class: U(["view-more-icon", { "view-more-icon-rotated": h.value }]),
                fill: "none",
                viewBox: "0 0 24 24",
...
}), U_ = /* @__PURE__ */ nt(Y_, [["__scopeId", "data-v-02a2e95e"]]), K_ = { class: "dn-metrics-card" }, q_ = { class: "card-header" }, X_ = { class: "header-content" }, G_ = {
  key: 0,
  ...
  key: 1,
  class: "card-body"
}, t2 = { class: "kpi-grid" }, e2 = { class: "kpi-card kpi-neutral" }, a2 = { class: "kpi-value" }, s2 = { class: "kpi-card kpi-success" }, n2 = { class: "kpi-value kpi-value-success" }, o2 = { class: "kpi-pct" }, i2 = { class: "kpi-card kpi-danger" }, r2 = { class: "kpi-value kpi-value-error" }, l2 = { class: "kpi-pct" }, c2 = { class: "kpi-card kpi-warning" }, d2 = { class: "kpi-value kpi-value-reason" }, u2 = { class: "kpi-pct" }, h2 = { class: "chart-section" }, f2 = { class: "chart-wrapper" }, g2 = {
  key: 1,
  class: "empty-chart"
}, p2 = {
  key: 0,
  class: "table-section"
}, v2 = { class: "table-wrapper" }, b2 = { class: "data-table" }, m2 = { class: "table-body" }, y2 = { class: "table-cell text-left font-medium" }, _2 = { class: "table-cell text-center font-semibold" }, x2 = { class: "table-cell text-center" }, k2 = { class: "impact-bar-container" }, w2 = { class: "impact-label" }, $2 = {
  key: 1,
  class: "chart-section"
}, M2 = { class: "chart-wrapper" }, C2 = { class: "system-health" }, S2 = { class: "system-health-content" }, D2 = { class: "sys-kpi-grid" }, A2 = { class: "sys-kpi" }, T2 = { class: "sys-value" }, B2 = { class: "sys-kpi" }, L2 = { class: "sys-value" }, F2 = { class: "sys-kpi" }, P2 = { class: "sys-value sys-error" }, I2 = { class: "sys-kpi" }, R2 = { class: "sys-value" }, E2 = { class: "sys-kpi" }, O2 = { class: "sys-value" }, V2 = { class: "sys-kpi" }, z2 = { class: "sys-value sys-error" }, N2 = {
  key: 1,
  class: "empty-state"
}, W2 = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (w) => {
      ...
      const D = [.../* @__PURE__ */ new Set([...w.map((P) => P.date), ...M.map((P) => P.date)])].sort(), A = D.map((P) => Dt(P).format("MMM DD")), B = D.map((P) => {
        const E = w.find((L) => L.date === P), N = E?.notification_sent || 0, Y = S[P] || E?.processing_started || 0;
    ...
    return t({ isDark: i }), (w, M) => (y(), x("article", K_, [
      c("header", q_, [
        c("div", X_, [
          ...
          s.loading ? R("", !0) : (y(), x("div", G_, [
            M[0] || (M[0] = c("p", { class: "badge-label" }, "Total Records", -1)),
            c("p", Z_, $(T(X)(d.value.row_count_total)), 1)
          ]))
        ])
      ]),
      s.loading ? (y(), x("div", Q_, [...M[2] || (M[2] = [
        ...
        l.value ? (y(), x(q, { key: 0 }, [
          c("div", t2, [
            c("div", e2, [
              ...
              c("span", a2, $(T(X)(f.value)), 1)
            ]),
            c("div", s2, [
              M[4] || (M[4] = c("span", { class: "kpi-label" }, "Successfully Notified", -1)),
              c("span", n2, $(T(X)(u.value.notification_sent)), 1),
              c("span", o2, $(v(u.value.notification_sent, f.value)), 1)
            ]),
            c("div", i2, [
              M[5] || (M[5] = c("span", { class: "kpi-label" }, "Not Notified", -1)),
              c("span", r2, $(T(X)(p.value)), 1),
              c("span", l2, $(v(p.value, f.value)), 1)
            ]),
            c("div", c2, [
              M[6] || (M[6] = c("span", { class: "kpi-label" }, "Main Failure Reason", -1)),
              c("span", d2, $(h.value.reason), 1),
              c("span", u2, $(T(X)(h.value.count)) + " cases", 1)
            ])
          ]),
          c("section", h2, [
            ...
            c("div", f2, [
              b.value.nodes.length > 0 && b.value.links.length > 0 ? (y(), dt(_e, {
                key: 0,
                data: b.value,
                "node-colors": g,
                height: "350px"
              }, null, 8, ["data"])) : (y(), x("div", g2, [...M[7] || (M[7] = [
                c("p", { class: "empty-chart-text" }, "No processing data available for visualization", -1)
              ])]))
            ])
          ]),
          m.value.length > 0 ? (y(), x("section", p2, [
            ...
            c("div", v2, [
              c("table", b2, [
                ...
                c("tbody", m2, [
                  (y(!0), x(q, null, J(m.value, (S) => (y(), x("tr", {
                    key: S.reason,
                    class: "table-row"
                  }, [
                    c("td", y2, $(S.reason), 1),
                    c("td", _2, $(T(X)(S.count)), 1),
                    c("td", x2, [
                      c("div", k2, [
                        c("div", {
                          class: "impact-bar",
          ...
          _.value.labels.length > 0 ? (y(), x("section", $2, [
...
}), H2 = /* @__PURE__ */ nt(W2, [["__scopeId", "data-v-d8baf32c"]]), j2 = { class: "card-header" }, Y2 = {
  key: 0,
  class: "loading-state"
}, U2 = {
  key: 1,
  class: "card-body"
}, K2 = { class: "metric-value" }, q2 = /* @__PURE__ */ tt({
...
}), X2 = /* @__PURE__ */ nt(q2, [["__scopeId", "data-v-cd9dd1ba"]]), G2 = { class: "card-header" }, Z2 = {
  key: 0,
  class: "loading-state"
}, Q2 = {
  key: 1,
...
}), ex = /* @__PURE__ */ nt(tx, [["__scopeId", "data-v-e36f6025"]]), ax = { class: "card-header" }, sx = {
  key: 0,
  class: "loading-state"
}, nx = {
  key: 1,
...
}), rx = /* @__PURE__ */ nt(ix, [["__scopeId", "data-v-a642a31c"]]), lx = { class: "nps-daily-card" }, cx = { class: "card-header" }, dx = { class: "header-content" }, ux = {
  key: 0,
  class: "stats-badge"
  ...
  key: 1,
  class: "card-body"
}, px = { class: "tooltip-content" }, vx = { class: "tooltip-title" }, bx = { class: "tooltip-stats" }, mx = { class: "tooltip-stat-row" }, yx = { class: "tooltip-value" }, _x = { class: "tooltip-stat-row" }, xx = { class: "tooltip-value" }, kx = { class: "tooltip-stat-row" }, wx = { class: "tooltip-value" }, $x = { class: "tooltip-stat-row" }, Mx = { class: "tooltip-value" }, Cx = { class: "tooltip-stat-row" }, Sx = { class: "tooltip-value" }, Dx = { class: "tooltip-stat-row" }, Ax = { class: "tooltip-value" }, Tx = {
  key: 2,
  class: "empty-state"
}, Do = 400, Je = 60, Ao = 90, To = 120, Bx = {
  ...
  setup(e, { expose: t, emit: a }) {
    const s = a, n = (b) => {
      s("export", b);
    }, o = e, { isDark: i } = ct(lt(o, "theme")), r = C(() => o.data), l = at(null), d = at({
      visible: !1,
      x: 0,
      y: 0,
      date: "",
      ...
      const k = (b - 1) / 9;
      return Je + g - k * g;
    }, p = (b) => b ? Dt(b).format("DD-MM-YYYY") : "", v = C(() => {
      if (!r.value || !r.value.nps_by_day || r.value.nps_by_day.length === 0)
        return [];
      const b = [], g = Do - Je - Ao;
      return r.value.nps_by_day.forEach((_, k) => {
        const w = _.min_score || 0, M = _.q1_score || 0, S = _.median_score || 0, D = _.q3_score || 0, A = _.max_score || 0, B = _.average_score || 0;
        b.push({
          label: p(_.date),
      ...
      const _ = l.value.getBoundingClientRect(), k = b.clientX, w = b.clientY, M = 140, S = 160, D = 10, A = 15;
      let B = k - _.left - M / 2, F = w - _.top - S - A;
      B = Math.max(D, Math.min(B, _.width - M - D)), F < D && (F = w - _.top + A), F = Math.max(D, Math.min(F, _.height - S - D)), d.value = {
        visible: !0,
        x: B,
        y: F,
        date: g.label || "",
    ...
    return t({ isDark: i }), (b, g) => (y(), x("article", lx, [
      c("header", cx, [
        c("div", dx, [
          ...
          r.value && r.value.nps_by_day && r.value.nps_by_day.length > 0 ? (y(), x("div", ux, [
            g[0] || (g[0] = c("p", { class: "badge-label" }, "Days", -1)),
            c("p", hx, $(r.value.nps_by_day.length), 1)
          ])) : R("", !0)
        ])
      ]),
      o.loading ? (y(), x("div", fx, [...g[2] || (g[2] = [
      ...
      ])])) : r.value && r.value.nps_by_day && r.value.nps_by_day.length > 0 ? (y(), x("div", gx, [
        c("div", {
          class: "chart-wrapper",
          ref_key: "chartContainerRef",
          ref: l
        }, [
          v.value && v.value.length > 0 ? (y(), dt(Ei, {
            key: 0,
...
}, Wi = /* @__PURE__ */ nt(Bx, [["__scopeId", "data-v-b20112a7"]]), Lx = { class: "nps-overview-card" }, Fx = { class: "card-header" }, Px = { class: "header-content" }, Ix = { class: "header-badges" }, Rx = {
  key: 0,
  class: "stats-badge"
}, Ex = { class: "badge-value" }, Ox = {
  key: 1,
  class: "stats-badge"
}, Vx = { class: "badge-value" }, zx = {
  key: 0,
  class: "loading-state"
}, Nx = {
  key: 1,
  class: "card-body"
}, Wx = { class: "chart-wrapper" }, Hx = {
  key: 2,
  class: "empty-state"
}, jx = 500, Yx = 60, Ux = 80, Kx = {
  ...
  setup(e, { expose: t, emit: a }) {
    const s = a, n = (d) => {
      s("export", d);
    }, o = e, { isDark: i } = ct(lt(o, "theme")), r = C(() => o.data), l = C(() => Math.max(600, window.innerWidth * 0.85));
    return t({ isDark: i }), (d, u) => (y(), x("article", Lx, [
      c("header", Fx, [
        c("div", Px, [
          ...
          c("div", Ix, [
            r.value && r.value.total_nps_responses > 0 ? (y(), x("div", Rx, [
              ...
              c("p", Ex, $(r.value.total_nps_responses), 1)
            ])) : R("", !0),
            r.value && r.value.p95_score > 0 ? (y(), x("div", Ox, [
              u[1] || (u[1] = c("p", { class: "badge-label" }, "Percentile 95", -1)),
              c("p", Vx, $(r.value.p95_score || 0), 1)
            ])) : R("", !0)
          ])
        ])
      ]),
      o.loading ? (y(), x("div", zx, [...u[3] || (u[3] = [
      ...
      ])])) : r.value && r.value.total_nps_responses > 0 ? (y(), x("div", Nx, [
        c("div", Wx, [
          Q(Oi, {
...
}, Hi = /* @__PURE__ */ nt(Kx, [["__scopeId", "data-v-30fe5f88"]]), qx = { class: "nps-metrics-container" }, Xx = {
  __name: "npsMetrics",
  props: {
    data: {
      type: Object,
...
}, Gx = /* @__PURE__ */ nt(Xx, [["__scopeId", "data-v-25fe3b80"]]), Zx = { class: "aws-cost-card" }, Qx = { class: "card-header" }, Jx = { class: "header-main" }, tk = { class: "header-content" }, ek = { class: "card-title" }, ak = { class: "header-stats" }, sk = { class: "stat-badge primary" }, nk = { class: "stat-value" }, ok = { class: "stat-badge secondary" }, ik = { class: "stat-value" }, rk = { class: "card-body" }, lk = {
  key: 0,
  class: "loading-state"
}, ck = {
  key: 1,
  ...
  setup(e) {
    ...
    return (r, l) => (y(), x("article", Zx, [
      c("header", Qx, [
        c("div", Jx, [
          c("div", tk, [
            c("h3", ek, $(n.value.airline_name || "AWS Cost"), 1),
            l[0] || (l[0] = c("p", { class: "card-subtitle" }, "AWS vs Allocated costs over time", -1))
          ]),
          c("div", ak, [
            c("div", sk, [
              l[1] || (l[1] = c("span", { class: "stat-label" }, "Total Allocated", -1)),
              c("span", nk, $(T(bt)(n.value.total_allocated_cost)), 1)
            ]),
            c("div", ok, [
              l[2] || (l[2] = c("span", { class: "stat-label" }, "Total AWS", -1)),
              c("span", ik, $(T(bt)(n.value.total_cost)), 1)
            ])
          ])
        ])
      ]),
      c("div", rk, [
        e.loading ? (y(), x("div", lk, [...l[3] || (l[3] = [
        ...
        ])])) : n.value.daily.length > 0 ? (y(), x("div", ck, [
          c("div", dk, [
            Q(ye, {
              data: o.value,
              options: i.value
...
}, pk = /* @__PURE__ */ nt(gk, [["__scopeId", "data-v-c023bd59"]]), vk = { class: "cost-usage-card" }, bk = {
  key: 0,
  class: "card-body"
}, mk = {
  key: 0,
  class: "chart-section"
}, yk = { class: "chart-container" }, _k = { class: "kpi-grid" }, xk = { class: "kpi-card" }, kk = { class: "kpi-value" }, wk = { class: "kpi-card" }, $k = { class: "kpi-value" }, Mk = { class: "kpi-card" }, Ck = { class: "kpi-value" }, Sk = { class: "kpi-card" }, Dk = { class: "kpi-value" }, Ak = { class: "kpi-card" }, Tk = { class: "kpi-value" }, Bk = { class: "kpi-card highlighted" }, Lk = { class: "kpi-value gradient-text" }, Fk = {
  key: 1,
  class: "empty-state"
}, Pk = { class: "empty-state-content" }, Ik = { class: "empty-icon-wrapper" }, Rk = {
  key: 1,
  class: "loading-state"
}, Ek = /* @__PURE__ */ tt({
  __name: "CostUsage",
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, { isDark: n, colors: o } = ct(lt(s, "theme")), i = (h) => {
      const m = new Date(h), b = String(m.getDate()).padStart(2, "0"), g = String(m.getMonth() + 1).padStart(2, "0");
      return `${b}-${g}`;
    }, r = {
      input: "#a78bfa",
      output: "#f59e0b",
      ...
      return Object.values(h).reduce((m, b) => m + (b.input_cost || 0), 0);
    }), d = C(() => {
      const h = s.data?.costs_by_day || {};
      return Object.values(h).reduce((m, b) => m + (b.output_cost || 0), 0);
    }), u = C(() => {
      const h = s.data?.costs_by_day || {};
      return Object.values(h).reduce((m, b) => m + (b.cache_read_cost || 0), 0);
    }), f = C(() => {
      const h = s.data?.costs_by_day || {};
      return Object.values(h).reduce((m, b) => m + (b.cache_write_cost || 0), 0);
    }), p = C(() => {
      const h = s.data?.costs_by_day || {}, m = Object.keys(h).sort();
      if (m.length === 0)
        return { labels: [], datasets: [] };
      const b = m.map((_) => i(_)), g = [
        {
          label: "Input Cost",
          data: m.map((_) => h[_]?.input_cost || 0),
        ...
        {
          label: "Output Cost",
          data: m.map((_) => h[_]?.output_cost || 0),
        ...
        },
        {
          ...
          data: m.map((_) => h[_]?.cache_read_cost || 0),
        ...
        },
        {
          ...
          data: m.map((_) => h[_]?.cache_write_cost || 0),
    ...
    return t({ isDark: n }), (h, m) => (y(), x("article", vk, [
      ...
      e.loading ? (y(), x("div", Rk, [...m[8] || (m[8] = [
        ...
        p.value.labels && p.value.labels.length ? (y(), x("section", mk, [
          c("div", yk, [
            Q(re, {
              data: p.value,
              options: v.value,
...
}), Ok = /* @__PURE__ */ nt(Ek, [["__scopeId", "data-v-62f96954"]]), Vk = { class: "token-usage-card" }, zk = {
  key: 0,
  class: "card-body"
}, Nk = {
  key: 0,
  class: "chart-section"
}, Wk = { class: "chart-container" }, Hk = { class: "kpi-grid" }, jk = { class: "kpi-card" }, Yk = { class: "kpi-value" }, Uk = { class: "kpi-card" }, Kk = { class: "kpi-value" }, qk = { class: "kpi-card" }, Xk = { class: "kpi-value" }, Gk = { class: "kpi-card" }, Zk = { class: "kpi-value" }, Qk = { class: "kpi-card" }, Jk = { class: "kpi-value" }, t5 = {
  key: 1,
  class: "empty-state"
}, e5 = { class: "empty-state-content" }, a5 = { class: "empty-icon-wrapper" }, s5 = {
  key: 1,
  class: "loading-state"
}, n5 = /* @__PURE__ */ tt({
  __name: "TokenUsage",
  ...
  setup(e, { expose: t, emit: a }) {
    ...
    return t({ isDark: n }), (u, f) => (y(), x("article", Vk, [
      ...
      e.loading ? (y(), x("div", s5, [...f[7] || (f[7] = [
        ...
        l.value.labels && l.value.labels.length ? (y(), x("section", Nk, [
          c("div", Wk, [
            Q(re, {
              data: l.value,
              options: d.value,
          ...
          c("footer", Hk, [
            c("div", jk, [
              ...
              c("span", Yk, $(T(X)(e.data.total_tokens)), 1)
            ]),
            c("div", Uk, [
              f[1] || (f[1] = c("span", { class: "kpi-label" }, "Input", -1)),
              c("span", Kk, $(T(X)(e.data.total_input_tokens)), 1)
            ]),
            c("div", qk, [
              f[2] || (f[2] = c("span", { class: "kpi-label" }, "Output", -1)),
              c("span", Xk, $(T(X)(e.data.total_output_tokens)), 1)
            ]),
            c("div", Gk, [
              f[3] || (f[3] = c("span", { class: "kpi-label" }, "Cache Read", -1)),
              c("span", Zk, $(T(X)(e.data.total_cache_read_tokens)), 1)
            ]),
            c("div", Qk, [
              f[4] || (f[4] = c("span", { class: "kpi-label" }, "Cache Write", -1)),
              c("span", Jk, $(T(X)(e.data.total_cache_write_tokens)), 1)
            ])
          ])
        ])) : (y(), x("section", t5, [
          c("div", e5, [
...
}), o5 = /* @__PURE__ */ nt(n5, [["__scopeId", "data-v-e9e355be"]]), i5 = { class: "conversation-count-card" }, r5 = { class: "card-header" }, l5 = { class: "header-right" }, c5 = { class: "stat-badge" }, d5 = { class: "stat-value" }, u5 = {
  key: 0,
  class: "card-body"
}, h5 = {
  key: 0,
  class: "chart-section"
}, f5 = { class: "chart-container" }, g5 = {
  key: 1,
  class: "empty-state"
}, p5 = { class: "empty-state-content" }, v5 = { class: "empty-icon-wrapper" }, b5 = {
  key: 1,
  class: "loading-state"
}, m5 = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s, colors: n } = ct(lt(a, "theme")), o = (l) => {
    ...
    return t({ isDark: s }), (l, d) => (y(), x("article", i5, [
      c("header", r5, [
        ...
        c("div", l5, [
          c("div", c5, [
            ...
            c("span", d5, $(e.data.total_conversations || 0), 1)
          ])
        ])
      ]),
      e.loading ? (y(), x("div", b5, [...d[4] || (d[4] = [
        ...
        i.value.labels && i.value.labels.length ? (y(), x("section", h5, [
          c("div", f5, [
            Q(ye, {
              data: i.value,
              options: r.value
...
}), y5 = /* @__PURE__ */ nt(m5, [["__scopeId", "data-v-846f24b1"]]), _5 = { class: "top-agents-card" }, x5 = {
  key: 0,
  class: "card-body"
}, k5 = {
  key: 0,
  class: "charts-grid"
}, w5 = { class: "chart-section" }, $5 = { class: "chart-container" }, M5 = { class: "chart-section" }, C5 = { class: "chart-container" }, S5 = {
  key: 1,
  class: "empty-state"
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s, colors: n } = ct(lt(a, "theme")), o = C(() => a.data?.top_agents && a.data.top_agents.length > 0), i = C(() => a.data?.top_agents ? [...a.data.top_agents].sort((p, v) => (v.total_cost || 0) - (p.total_cost || 0)) : []), r = C(() => a.data?.top_agents ? [...a.data.top_agents].sort((p, v) => (v.total_tokens || 0) - (p.total_tokens || 0)) : []), l = C(() => {
      const p = i.value;
    ...
    return t({ isDark: s }), (p, v) => (y(), x("article", _5, [
...
}), L5 = /* @__PURE__ */ nt(B5, [["__scopeId", "data-v-78efa6dc"]]), F5 = { class: "top-agents-card" }, P5 = {
  key: 0,
  class: "card-body"
}, I5 = {
  key: 0,
  class: "chart-section"
}, R5 = { class: "chart-container" }, E5 = {
  key: 1,
  class: "empty-state"
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s, colors: n } = ct(lt(a, "theme")), o = {
    ...
    ) : []), r = C(() => i.value.length > 0), l = C(() => i.value.reduce((f, p) => f + (p.conversations || 0), 0)), d = C(() => {
      const f = i.value;
      if (f.length === 0)
        return { labels: [], datasets: [] };
      const p = f.map((m) => {
      ...
      return {
        labels: f.map((m) => {
          const b = m.conversations || 0, g = l.value ? b / l.value * 100 : 0;
          return `${m.agent_type} - ${b.toLocaleString()} (${g.toFixed(1)}%)`;
        }),
        datasets: [
          {
      ...
      plugins: {
        ...
        tooltip: {
          ...
          callbacks: {
            label: (f) => {
              const p = (f.label || "").toString(), v = Number(f.parsed) || 0, h = (f.dataset.data || []).reduce((b, g) => b + (Number(g) || 0), 0), m = h ? v / h * 100 : 0;
              return `${p}: ${v.toLocaleString()} (${m.toFixed(1)}%)`;
            }
          }
        }
    ...
    return t({ isDark: s }), (f, p) => (y(), x("article", F5, [
      p[3] || (p[3] = c("header", { class: "card-header" }, [
        c("div", { class: "header-content" }, [
          c("h3", { class: "card-title" }, "Top Agents"),
          c("p", { class: "card-subtitle" }, "Interactions by agent (excluding triage)")
...
}), W5 = /* @__PURE__ */ nt(N5, [["__scopeId", "data-v-05e3e74d"]]), H5 = { class: "daily-cost-trends-card" }, j5 = {
  key: 0,
  class: "card-body"
}, Y5 = {
  key: 0,
  class: "chart-section"
}, U5 = { class: "chart-container" }, K5 = {
  key: 1,
  class: "empty-state"
}, q5 = { class: "empty-state-content" }, X5 = { class: "empty-icon-wrapper" }, G5 = {
  key: 1,
  class: "loading-state"
}, Z5 = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t }) {
    const a = e, { isDark: s, colors: n } = ct(lt(a, "theme")), o = (d) => {
      ...
      const d = a.costData?.daily_mean_cost_per_conversation || [];
      if (d.length > 0) {
        const b = [...d].sort((g, _) => g.date.localeCompare(_.date));
        return {
      ...
      const u = a.costData?.costs_by_day || {}, f = a.conversationData?.conversations_by_day || {}, v = Object.keys(u).filter((b) => f[b]).sort();
      if (v.length === 0)
        return { labels: [], datasets: [] };
      const h = v.map((b) => o(b)), m = v.map((b) => {
        const g = u[b]?.total_cost || 0, _ = f[b] || 0;
        return _ > 0 ? g / _ : 0;
      });
      return {
        labels: h,
    ...
    return t({ isDark: s }), (d, u) => (y(), x("article", H5, [
...
}), Q5 = /* @__PURE__ */ nt(Z5, [["__scopeId", "data-v-e5bac1c5"]]), J5 = { class: "model-usage-card" }, tw = {
  key: 0,
  class: "loading-state"
}, ew = {
  key: 1,
  class: "card-body"
}, aw = { class: "tabs-container" }, sw = {
  class: "tabs-nav",
  "aria-label": "Model Usage Tabs"
}, nw = ["aria-selected"], ow = ["aria-selected"], iw = {
  key: 0,
  class: "table-section"
}, rw = { class: "table-wrapper" }, lw = { class: "data-table" }, cw = { class: "table-header-row" }, dw = { class: "table-header" }, uw = { class: "table-body" }, hw = { class: "table-cell name-cell" }, fw = { class: "table-cell text-center" }, gw = { class: "table-cell text-center" }, pw = { class: "table-cell text-center" }, vw = { class: "table-cell text-center cost-cell" }, bw = { class: "table-cell text-center" }, mw = {
  key: 1,
  class: "empty-state"
}, yw = { class: "empty-state-content" }, _w = { class: "empty-icon-wrapper" }, xw = /* @__PURE__ */ tt({
  __name: "ModelUsage",
  props: {
    data: { default: () => ({
      total_by_provider: {},
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (f) => {
      n("export", f);
    }, { isDark: i } = ct(lt(s, "theme")), r = at("by_model"), l = C(() => r.value === "by_model" ? s.data?.total_by_model || {} : s.data?.total_by_provider || {}), d = (f) => f == null ? "0" : X(f), u = (f) => f == null ? "$0.00" : bt(f);
    return t({ isDark: i }), (f, p) => (y(), x("article", J5, [
      ...
      e.loading ? (y(), x("div", tw, [...p[2] || (p[2] = [
        ...
        l.value && Object.keys(l.value).length > 0 ? (y(), x("div", iw, [
          c("div", rw, [
            c("table", lw, [
              c("thead", null, [
                c("tr", cw, [
                  c("th", dw, $(r.value === "by_model" ? "Model" : "Provider"), 1),
              ...
              c("tbody", uw, [
                (y(!0), x(q, null, J(l.value, (v, h) => (y(), x("tr", {
                  key: h,
                  class: "table-row"
                }, [
                  c("td", hw, $(h), 1),
                  c("td", fw, $(u(v.avg_cost_per_message)), 1),
                  c("td", gw, $(d(v.avg_tokens_per_message)), 1),
                  c("td", pw, $(d(v.message_count)), 1),
                  c("td", vw, $(u(v.total_cost)), 1),
                  c("td", bw, $(d(v.total_tokens)), 1)
                ]))), 128))
              ])
            ])
          ]),
...
}), kw = /* @__PURE__ */ nt(xw, [["__scopeId", "data-v-a7bf2d7b"]]), ww = { class: "message-roles-card" }, $w = {
  key: 0,
  class: "loading-state"
}, Mw = {
  key: 1,
  ...
  key: 0,
  class: "table-section"
}, Sw = { class: "table-wrapper" }, Dw = { class: "data-table" }, Aw = { class: "table-body" }, Tw = { class: "table-cell name-cell" }, Bw = { class: "table-cell text-center" }, Lw = { class: "table-cell text-center" }, Fw = { class: "table-cell text-center" }, Pw = { class: "table-cell text-center cost-cell" }, Iw = { class: "table-cell text-center" }, Rw = {
  key: 1,
  class: "empty-state"
}, Ew = { class: "empty-state-content" }, Ow = { class: "empty-icon-wrapper" }, Vw = /* @__PURE__ */ tt({
  __name: "MessageRoles",
  props: {
    data: { default: () => ({
      total_by_role: {}
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (v) => {
      n("export", v);
    }, { isDark: i } = ct(lt(s, "theme")), r = ["assistant", "system", "user"], l = C(() => s.data?.total_by_role || {}), d = C(() => Object.keys(l.value).length > 0), u = (v) => v == null ? "0" : X(v), f = (v) => v == null ? "$0.00" : bt(v), p = (v) => v.charAt(0).toUpperCase() + v.slice(1);
    return t({ isDark: i }), (v, h) => (y(), x("article", ww, [
        ...
        d.value ? (y(), x("div", Cw, [
          c("div", Sw, [
            c("table", Dw, [
              ...
              c("tbody", Aw, [
                (y(), x(q, null, J(r, (m) => c("tr", {
                  key: m,
                  class: "table-row"
                }, [
                  c("td", Tw, $(p(m)), 1),
                  c("td", Bw, $(f(l.value[m]?.avg_cost_per_message)), 1),
                  c("td", Lw, $(u(l.value[m]?.avg_tokens_per_message)), 1),
                  c("td", Fw, $(u(l.value[m]?.message_count)), 1),
                  c("td", Pw, $(f(l.value[m]?.total_cost)), 1),
                  c("td", Iw, $(u(l.value[m]?.total_tokens)), 1)
                ])), 64))
              ])
            ])
          ]),
...
}), zw = /* @__PURE__ */ nt(Vw, [["__scopeId", "data-v-6a953cfc"]]), Nw = { class: "cost-per-conversation-card" }, Ww = {
  key: 0,
  class: "card-body"
}, Hw = {
  key: 0,
  class: "chart-section"
}, jw = { class: "chart-container" }, Yw = { class: "kpi-grid" }, Uw = { class: "kpi-card" }, Kw = { class: "kpi-value" }, qw = { class: "kpi-card" }, Xw = { class: "kpi-value" }, Gw = { class: "kpi-card" }, Zw = { class: "kpi-value" }, Qw = { class: "kpi-card highlighted" }, Jw = { class: "kpi-value gradient-text" }, t$ = {
  key: 1,
  class: "empty-state"
}, e$ = { class: "empty-state-content" }, a$ = { class: "empty-icon-wrapper" }, s$ = {
  key: 1,
  class: "loading-state"
}, n$ = /* @__PURE__ */ tt({
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, n = a, o = (_) => {
      ...
      flight_info: "#f59e0b",
      support: "#10b981"
    }, d = (_) => _.agent_type || _.agent_id || _.agent_name || "", u = (_) => _.agent_name ? _.agent_name : d(_).split("_").map((w) => w.charAt(0).toUpperCase() + w.slice(1)).join(" ").replace(/V\d+$/, "").trim(), f = (_) => {
      const k = d(_).toLowerCase();
      for (const [w, M] of Object.entries(l))
        if (k.includes(w))
          return M;
      return "#9ca3af";
    }, p = C(() => [...s.data?.top_agents || []].sort((k, w) => w.avg_cost_per_conversation - k.avg_cost_per_conversation)), v = C(() => s.data?.total_conversations !== void 0 ? Number(s.data.total_conversations) || 0 : p.value.reduce((_, k) => _ + k.conversations, 0)), h = C(() => s.data?.total_cost !== void 0 ? Number(s.data.total_cost) || 0 : p.value.reduce((_, k) => _ + k.total_cost, 0)), m = C(() => s.data?.overall_avg_cost_per_conversation !== void 0 ? Number(s.data.overall_avg_cost_per_conversation) || 0 : v.value === 0 ? 0 : h.value / v.value), b = C(() => {
      const _ = p.value;
      if (_.length === 0)
        return { labels: [], datasets: [] };
      const k = _.map((S) => u(S)), w = _.map((S) => S.avg_cost_per_conversation), M = _.map((S) => f(S));
      return {
        labels: k,
        datasets: [
          {
    ...
    return t({ isDark: i }), (_, k) => (y(), x("article", Nw, [
      ...
      e.loading ? (y(), x("div", s$, [...k[6] || (k[6] = [
        ...
        b.value.labels && b.value.labels.length ? (y(), x("section", Hw, [
          c("div", jw, [
            Q(re, {
              data: b.value,
              options: g.value
...
}), o$ = /* @__PURE__ */ nt(n$, [["__scopeId", "data-v-17f6615c"]]);
function Ft() {
  const e = new Uint8Array(8);
  return globalThis.crypto.getRandomValues(e), Array.from(e, (t) => t.toString(16).padStart(2, "0")).join("");
}
const i$ = { class: "tabs text-sm" }, r$ = ["aria-label"], l$ = ["id", "aria-selected", "aria-disabled", "tabindex", "onClick", "onKeydown"], c$ = { class: "truncate whitespace-nowrap font-medium tracking-tight" }, d$ = /* @__PURE__ */ tt({
  name: "Tabs",
  __name: "Tabs",
  props: {
    items: {},
  ...
  setup(e, { emit: t }) {
    ...
    function p(h, m) {
      ...
      let g = h;
      for (let _ = 0; _ < b; _++)
        if (g = (g + m + b) % b, !a.items[g]?.disabled) return g;
      return h;
    }
    async function v(h, m) {
      ...
      const _ = a.items[g];
      !_ || _.disabled || (u(_.value, a.modelValue), await Ct(), n.value[g]?.focus());
    }
    return (h, m) => (y(), x("div", i$, [
      c("div", {
        role: "tablist",
        "aria-label": e.ariaLabel,
        class: U([
        ...
        (y(!0), x(q, null, J(e.items, (b, g) => (y(), x("button", {
          ...
          c("span", {
            class: U(["flex h-full min-h-0 min-w-0 items-center justify-center gap-2 px-3", { "min-w-0 flex-1": e.fullWidth }])
          }, [
            b.icon ? (y(), dt(ca(b.icon), {
              key: 0,
...
}), u$ = /* @__PURE__ */ nt(d$, [["__scopeId", "data-v-0cc67b12"]]), h$ = { class: "kiut-table-wrap overflow-hidden rounded-xl border border-[#e5e7eb] bg-[color:var(--kiut-bg-secondary)] shadow-sm dark:border-[color:var(--kiut-border-light)]" }, f$ = { class: "overflow-x-auto" }, g$ = { class: "kiut-table w-full min-w-[640px] border-collapse text-left text-sm" }, p$ = { class: "h-12 border-b border-[#e5e7eb] bg-[#eaeaec80] dark:border-[color:var(--kiut-border-light)] dark:bg-[#23232f80]" }, v$ = {
  key: 0,
  scope: "col",
  class: "w-12 px-4 py-3 text-center align-middle"
}, b$ = ["checked", "aria-label"], m$ = {
  key: 0,
  class: "w-12 bg-transparent px-4 py-3 text-center align-middle"
}, y$ = ["checked", "aria-label", "onChange"], _$ = /* @__PURE__ */ tt({
  name: "Table",
  __name: "Table",
  props: {
    columns: {},
  ...
  setup(e, { emit: t }) {
    ...
    const f = C(() => a.rows.map((_, k) => r(_, k)));
    function p(_, k) {
      const w = r(_, k);
      return a.selectedKeys.includes(w);
    }
    const v = C(() => !a.selectable || a.rows.length === 0 ? !1 : f.value.every((_) => a.selectedKeys.includes(_))), h = C(() => {
      if (!a.selectable || a.rows.length === 0) return !1;
      const _ = f.value.filter((k) => a.selectedKeys.includes(k));
      return _.length > 0 && _.length < a.rows.length;
    });
    Rt(
      [h, v, () => a.selectable],
      async () => {
        await Ct();
        const _ = n.value;
        _ && (_.indeterminate = h.value && !v.value);
      },
      { immediate: !0 }
    );
    function m() {
      if (a.selectable)
        if (v.value) {
          const _ = a.selectedKeys.filter((k) => !f.value.includes(k));
          s("update:selectedKeys", _);
        } else {
          const _ = new Set(a.selectedKeys);
          f.value.forEach((k) => _.add(k)), s("update:selectedKeys", [..._]);
        }
    }
    function b(_, k) {
    ...
    return (_, k) => (y(), x("div", h$, [
      c("div", f$, [
        c("table", g$, [
          c("thead", null, [
            c("tr", p$, [
              e.selectable ? (y(), x("th", v$, [
                c("input", {
              ...
              (y(!0), x(q, null, J(e.columns, (w) => (y(), x("th", {
                key: w.key,
                scope: "col",
                class: U([
          ...
          c("tbody", null, [
            (y(!0), x(q, null, J(e.rows, (w, M) => (y(), x("tr", {
              key: u(w, M),
...
}), x$ = /* @__PURE__ */ nt(_$, [["__scopeId", "data-v-1928de95"]]);
function k$(e, t) {
  return y(), x("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
const $$ = ["aria-label"], M$ = { class: "flex flex-wrap items-center gap-x-2 gap-y-1.5" }, C$ = { class: "shrink-0 font-medium text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, S$ = { class: "flex min-w-0 flex-1 flex-wrap items-center gap-1.5" }, D$ = ["aria-label", "aria-expanded", "aria-controls", "onClick"], A$ = { class: "truncate" }, T$ = {
  key: 0,
  class: "ml-0.5 inline-flex min-h-[1.125rem] min-w-[1.125rem] shrink-0 items-center justify-center rounded-full bg-[color:var(--kiut-primary)]/20 px-1 text-[10px] font-semibold tabular-nums text-[color:var(--kiut-primary-default)] dark:bg-[color:var(--kiut-primary)]/25 dark:text-[color:var(--kiut-primary-light)]"
}, B$ = {
  key: 0,
  class: "mt-2 flex flex-wrap items-center gap-x-3 gap-y-1.5"
}, L$ = { class: "flex min-w-0 flex-wrap items-center gap-1.5" }, F$ = ["aria-label", "onClick"], P$ = ["aria-label", "onClick"], I$ = ["aria-label"], R$ = ["aria-label"], E$ = {
  key: 1,
  class: "space-y-2"
}, O$ = ["for"], V$ = ["id", "placeholder", "onKeydown"], z$ = { class: "text-xs font-medium leading-tight text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, N$ = ["aria-label"], W$ = { class: "flex cursor-pointer items-center gap-2.5 rounded-md px-2 py-1.5 text-xs text-[color:var(--kiut-text-primary)] transition hover:bg-black/[0.04] dark:text-slate-100 dark:hover:bg-white/[0.06]" }, H$ = ["checked", "onChange"], j$ = { class: "min-w-0 flex-1" }, Y$ = { class: "text-xs font-medium leading-tight text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, U$ = { class: "flex flex-wrap items-end gap-2" }, K$ = { class: "min-w-[120px] flex-1" }, q$ = ["for"], X$ = ["id"], G$ = { class: "min-w-[120px] flex-1" }, Z$ = ["for"], Q$ = ["id"], J$ = /* @__PURE__ */ tt({
  name: "Filters",
  __name: "Filters",
  props: {
    filterDefinitions: {},
  ...
  setup(e, { emit: t }) {
    const a = e, s = t, n = Oo(), i = `${`kiut-filters-${Ft()}`}-panel`, r = at(null), l = /* @__PURE__ */ new Map(), d = at(null), u = at(!1), f = at({}), p = at(null), v = at(""), h = at([]), m = at(""), b = at(""), g = C(() => d.value ? a.filterDefinitions.find((I) => I.id === d.value) ?? null : null), _ = C(() => {
      const I = g.value;
      if (I)
        return I.type === "text" ? v.value : I.type === "select" ? h.value : { start: m.value, end: b.value };
    });
    function k(I, W) {
      W && W instanceof HTMLElement ? l.set(I, W) : l.delete(I);
    }
    function w(I) {
    ...
    function F(I) {
      ...
      if (I.type === "select") {
        const Ui = M(W).map((an) => I.options.find((Ki) => Ki.value === an)?.label ?? an);
        return `${Z}: ${Ui.join(", ")}`;
      }
      const ut = W, Nt = E(ut.start), he = E(ut.end);
      return `${Z}: ${Nt} – ${he}`;
    }
    function P(I) {
    ...
    function L(I) {
      ...
      const Z = W;
      m.value = Z?.start?.trim() ?? "", b.value = Z?.end?.trim() ?? "";
    }
    function O() {
      const I = g.value;
    ...
    function H(I, W) {
      ...
      u.value && d.value !== I.id && ot(), d.value = I.id, u.value = !0, L(I), Ct().then(async () => {
        const Z = l.get(I.id) ?? W.currentTarget;
        V(Z), await Ct(), et();
      });
    }
    function et() {
    ...
    function ot() {
      ...
      const W = m.value.trim(), Z = b.value.trim(), ut = { ...a.modelValue };
    ...
    return le(() => {
      document.addEventListener("mousedown", Ue, !0), window.addEventListener("keydown", ya, !0), window.addEventListener("resize", Ke);
    }), Eo(() => {
      document.removeEventListener("mousedown", Ue, !0), window.removeEventListener("keydown", ya, !0), window.removeEventListener("resize", Ke);
    }), Rt(
      () => a.modelValue,
      () => {
        const I = g.value;
      ...
      c("div", M$, [
        c("span", C$, $(e.label), 1),
        c("div", S$, [
          (y(!0), x(q, null, J(e.filterDefinitions, (Z) => (y(), x("button", {
            key: `pill-${Z.id}`,
            ref_for: !0,
            ref: (ut) => k(Z.id, ut),
            type: "button",
            class: U(["inline-flex h-[26px] max-w-full shrink-0 items-center gap-0.5 rounded-full px-2 font-medium transition-colors", N(Z)]),
            "aria-label": Y(Z),
            ...
            c("span", A$, $(Z.label), 1),
            Z.type === "select" && B(Z) > 0 ? (y(), x("span", T$, $(B(Z)), 1)) : R("", !0)
          ], 10, D$))), 128))
        ])
      ]),
      D.value ? (y(), x("div", B$, [
        c("div", L$, [
          (y(!0), x(q, null, J(A.value, (Z) => (y(), x("div", {
            key: Z.key,
            ...
            I.$slots.panel ? It(I.$slots, "panel", {
              ...
              g.value.type === "text" ? (y(), x(q, { key: 0 }, [
                ...
                c("ul", {
                  ...
                  (y(!0), x(q, null, J(g.value.options, (Z) => (y(), x("li", {
                    key: Z.value
                  }, [
                    c("label", W$, [
                      c("input", {
...
}), t4 = /* @__PURE__ */ nt(J$, [["__scopeId", "data-v-4403df66"]]), qt = "mb-1.5 block text-sm font-medium text-[color:var(--kiut-text-primary)] dark:text-slate-100", de = "min-h-[2.75rem] w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm font-sans text-[color:var(--kiut-text-primary)] shadow-sm outline-none transition placeholder:text-[color:var(--kiut-text-muted)] focus:border-[color:var(--kiut-primary)] focus:ring-2 focus:ring-[color:var(--kiut-primary)]/25 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:border-[color:var(--kiut-border-light)] dark:bg-[color:var(--kiut-bg-secondary)] dark:text-slate-100 dark:placeholder:text-slate-500", Fe = "border-red-500 focus:border-red-500 focus:ring-red-500/25 dark:border-red-400", xe = "mt-1 text-xs font-medium text-red-600 dark:text-red-400", e4 = { class: "font-sans" }, a4 = ["for"], s4 = ["id", "placeholder", "disabled", "aria-invalid", "aria-describedby"], n4 = ["id"], o4 = /* @__PURE__ */ tt({
  name: "InputText",
  __name: "InputText",
  props: {
    modelValue: {},
  ...
  setup(e, { emit: t }) {
    ...
    return (l, d) => (y(), x("div", e4, [
      ...
      e.errorText ? (y(), x("p", {
        ...
        class: U(T(xe)),
        role: "alert"
      }, $(e.errorText), 11, n4)) : R("", !0)
    ]));
  }
}), i4 = { class: "font-sans" }, r4 = ["for"], l4 = ["id", "name", "accept", "disabled", "aria-invalid", "aria-describedby"], c4 = ["for"], d4 = ["title"], u4 = ["aria-label"], h4 = ["id"], f4 = /* @__PURE__ */ tt({
  name: "InputFile",
  __name: "InputFile",
  props: {
    modelValue: {},
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, s = t, n = `kiut-input-file-${Ft()}`, o = C(() => a.id ?? n), i = C(() => `${o.value}-err`), r = at(null), l = C(() => a.modelValue?.name ?? a.placeholder);
    function d(f) {
    ...
    return (f, p) => (y(), x("div", i4, [
      ...
      e.errorText ? (y(), x("p", {
        ...
        class: U(T(xe)),
        role: "alert"
      }, $(e.errorText), 11, h4)) : R("", !0)
    ]));
  }
}), g4 = { class: "font-sans" }, p4 = ["for"], v4 = { class: "relative" }, b4 = ["id", "value", "name", "disabled", "min", "max", "step", "aria-invalid", "aria-describedby"], m4 = ["id"], y4 = /* @__PURE__ */ tt({
  name: "InputDateTime",
  ...
  setup(e, { emit: t }) {
    ...
    return (f, p) => (y(), x("div", _4, [
      ...
      e.errorText ? (y(), x("p", {
        ...
        class: U(T(xe)),
        role: "alert"
      }, $(e.errorText), 11, $4)) : R("", !0)
    ]));
  }
}), C4 = { class: "font-sans" }, S4 = ["for"], D4 = {
  key: 0,
  class: "order-1 text-center text-sm text-[color:var(--kiut-text-muted)] dark:text-slate-400"
}, A4 = ["id", "value", "min", "max", "step", "disabled", "aria-orientation", "aria-invalid", "aria-describedby"], T4 = {
  key: 1,
  class: "text-center text-sm text-[color:var(--kiut-text-muted)] dark:text-slate-400"
}, B4 = {
  key: 2,
  class: "grid w-full max-w-full grid-cols-[1fr_auto_1fr] items-start gap-x-3 text-sm text-[color:var(--kiut-text-muted)] dark:text-slate-400"
}, L4 = { class: "min-w-0 text-left leading-snug" }, F4 = { class: "max-w-[min(100%,12rem)] shrink px-1 text-center leading-snug" }, P4 = { class: "min-w-0 text-right leading-snug" }, I4 = {
  key: 3,
  class: "order-3 text-center text-sm text-[color:var(--kiut-text-muted)] dark:text-slate-400"
}, R4 = {
  key: 4,
  class: "order-4 text-center text-sm text-[color:var(--kiut-text-muted)] dark:text-slate-400"
}, E4 = ["id"], O4 = /* @__PURE__ */ tt({
  name: "InputRange",
  __name: "InputRange",
  props: {
    modelValue: {},
  ...
  setup(e, { emit: t }) {
    ...
    return (v, h) => (y(), x("div", C4, [
      ...
      c("div", {
        ...
        e.orientation === "vertical" && e.captionMax ? (y(), x("p", D4, $(e.captionMax), 1)) : R("", !0),
        c("div", {
        ...
        e.orientation === "horizontal" && l.value ? (y(), x("p", T4, $(e.caption), 1)) : e.orientation === "horizontal" && d.value ? (y(), x("div", B4, [
          c("span", L4, $(e.captionMin), 1),
          c("span", F4, $(e.caption), 1),
          c("span", P4, $(e.captionMax), 1)
        ])) : R("", !0),
        e.orientation === "vertical" && e.captionMin ? (y(), x("p", I4, $(e.captionMin), 1)) : R("", !0),
        e.orientation === "vertical" && e.caption ? (y(), x("p", R4, $(e.caption), 1)) : R("", !0)
      ], 2),
      e.errorText ? (y(), x("p", {
        key: 1,
        id: i.value,
        class: U(T(xe)),
        role: "alert"
      }, $(e.errorText), 11, E4)) : R("", !0)
    ]));
  }
}), V4 = /* @__PURE__ */ nt(O4, [["__scopeId", "data-v-a1343418"]]), z4 = { class: "font-sans" }, N4 = ["for"], W4 = ["id", "value", "placeholder", "disabled", "min", "max", "step", "aria-invalid", "aria-describedby"], H4 = ["id"], j4 = /* @__PURE__ */ tt({
  name: "InputNumber",
  __name: "InputNumber",
  props: {
    modelValue: {},
...
}), Y4 = { class: "font-sans" }, U4 = ["for"], K4 = ["id", "value", "disabled", "aria-invalid", "aria-describedby"], q4 = ["disabled"], X4 = ["id"], G4 = "#3b82f6", Z4 = "#aabbcc", Q4 = "flex min-h-[2.75rem] w-full items-center gap-3 rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm font-sans shadow-sm outline-none transition focus-within:border-[color:var(--kiut-primary)] focus-within:ring-2 focus-within:ring-[color:var(--kiut-primary)]/25 focus-within:ring-offset-0 dark:border-[color:var(--kiut-border-light)] dark:bg-[color:var(--kiut-bg-secondary)]", J4 = /* @__PURE__ */ tt({
  ...
  setup(e, { emit: t }) {
    function a(h) {
      const m = h.trim(), b = /^#?([0-9a-fA-F]{6})$/.exec(m);
      if (b) return `#${b[1].toLowerCase()}`;
      const g = /^#?([0-9a-fA-F]{3})$/.exec(m);
      if (g) {
        const [_, k, w] = g[1].split("");
    ...
    const n = e, o = t, i = `kiut-input-color-${Ft()}`, r = C(() => n.id ?? i), l = C(() => `${r.value}-err`), d = C(() => s(n.modelValue)), u = at(d.value), f = at(!1);
    Rt(d, (h) => {
      f.value || (u.value = h);
    });
    function p(h) {
      const m = h.target, b = a(m.value);
...
const tM = ["disabled", "aria-expanded", "aria-labelledby", "aria-label"], eM = ["aria-selected", "onClick", "onMouseenter"], aM = {
  key: 0,
  class: "flex w-5 shrink-0 justify-center",
  "aria-hidden": "true"
}, sM = { class: "min-w-0 flex-1" }, Yi = /* @__PURE__ */ tt({
  name: "Select",
  __name: "Select",
  props: {
    modelValue: {},
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, s = t, n = `kiut-select-${Ft()}`, o = `${n}-label`, i = `${n}-btn`, r = `${n}-listbox`, l = at(null), d = at(null), u = at(null), f = at(!1), p = at(0), v = at({});
    function h() {
      const P = d.value;
      if (!P) return;
    ...
    const m = C(() => a.options.filter((P) => !P.disabled)), b = C(
    ...
    function A(P) {
      if (!f.value) return;
      const E = P.target, N = l.value, Y = u.value;
      N && !N.contains(E) && (!Y || !Y.contains(E)) && (f.value = !1);
    }
    function B(P) {
    ...
    function F(P) {
      ...
      if (E.length !== 0) {
        ...
        if (P.key === "ArrowDown") {
          P.preventDefault(), p.value = Math.min(p.value + 1, E.length - 1);
          return;
        }
        if (P.key === "ArrowUp") {
    ...
    return le(() => {
      ...
      (y(), dt(Rs, { to: "body" }, [
        Kt(c("ul", {
          ...
          (y(!0), x(q, null, J(m.value, (N, Y) => (y(), x("li", {
            key: _(N),
            role: "option",
            "aria-selected": k(N),
            class: U(w(N, Y)),
...
}), nM = ["disabled", "aria-expanded", "aria-labelledby", "aria-label"], oM = { class: "min-h-[1.25rem] min-w-0 flex-1 max-h-32 overflow-y-auto py-0.5" }, iM = {
  key: 0,
  class: "block truncate text-[color:var(--kiut-text-muted)] dark:text-slate-500"
}, rM = {
  key: 1,
  class: "flex flex-wrap gap-1"
}, lM = { class: "truncate" }, cM = ["aria-selected", "onClick", "onMouseenter"], dM = {
  class: "flex w-5 shrink-0 justify-center",
  "aria-hidden": "true"
}, uM = { class: "min-w-0 flex-1" }, hM = /* @__PURE__ */ tt({
  name: "MultiSelect",
  __name: "MultiSelect",
  props: {
    modelValue: {},
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, s = t, n = `kiut-multiselect-${Ft()}`, o = `${n}-label`, i = `${n}-btn`, r = `${n}-listbox`, l = at(null), d = at(null), u = at(!1), f = at(0), p = C(() => a.options.filter((F) => !F.disabled)), v = C(() => new Set(a.modelValue ?? [])), h = C(
    ...
    function k(F) {
      const P = [...a.modelValue ?? []], E = P.indexOf(F.value);
      E >= 0 ? P.splice(E, 1) : P.push(F.value), s("update:modelValue", P);
    }
    function w() {
      const F = p.value;
      if (F.length === 0) {
      ...
      const P = v.value, E = F.findIndex((N) => P.has(N.value));
      f.value = E >= 0 ? E : 0;
    }
    function M() {
    ...
    return le(() => {
      ...
      c("button", {
        ...
        c("div", oM, [
          h.value.length === 0 ? (y(), x("span", iM, $(e.placeholder), 1)) : (y(), x("div", rM, [
            (y(!0), x(q, null, J(h.value, (E) => (y(), x("span", {
              key: b(E),
      ...
      Kt(c("ul", {
        ...
        (y(!0), x(q, null, J(p.value, (E, N) => (y(), x("li", {
          key: b(E),
          role: "option",
          "aria-selected": g(E),
          class: U(_(E, N)),
...
}), fM = ["id", "aria-checked", "aria-disabled", "disabled", "onKeydown"], gM = { class: "sr-only" }, pM = /* @__PURE__ */ tt({
  name: "Toggle",
  __name: "Toggle",
  props: {
  ...
  setup(e, { emit: t }) {
    ...
    return (o, i) => (y(), x("button", {
      ...
      c("span", gM, $(e.ariaLabel), 1)
    ], 42, fM));
  }
}), vM = { class: "font-sans" }, bM = ["for"], mM = { class: "flex gap-2" }, yM = { class: "w-[7.5rem] shrink-0" }, _M = { class: "min-w-0 flex-1" }, xM = ["id", "placeholder", "disabled", "aria-invalid", "aria-describedby"], kM = ["id"], wM = /* @__PURE__ */ tt({
  name: "InputPhone",
  __name: "InputPhone",
  props: {
    modelValue: {},
  ...
  setup(e, { emit: t }) {
    ...
    return (d, u) => (y(), x("div", vM, [
      ...
      e.errorText ? (y(), x("p", {
        ...
        class: U(T(xe)),
        role: "alert"
      }, $(e.errorText), 11, kM)) : R("", !0)
    ]));
  }
}), $M = ["role", "aria-label"], MM = { class: "flex flex-wrap gap-2" }, CM = ["aria-checked", "role", "onClick"], SM = { class: "flex h-4 w-4 shrink-0 items-center justify-center rounded-full border-2 border-[color:var(--kiut-primary)] bg-white transition dark:bg-[color:var(--kiut-bg-secondary)]" }, DM = {
  key: 0,
  class: "h-2 w-2 rounded-full bg-[color:var(--kiut-primary)]"
}, AM = { class: "text-sm font-medium text-[color:var(--kiut-text-primary)] dark:text-slate-100" }, TM = /* @__PURE__ */ tt({
...
}), BM = ["aria-label"], LM = ["id", "aria-selected", "aria-disabled", "tabindex", "onClick", "onKeydown"], FM = { class: "truncate px-3 py-2 text-sm font-medium" }, PM = /* @__PURE__ */ tt({
  ...
  setup(e, { emit: t }) {
    ...
    function r(m, b) {
      m instanceof HTMLButtonElement ? i.value[b] = m : i.value[b] = null;
    }
    function l(m) {
      return m.value === a.modelValue;
    }
    function d(m) {
      const b = l(m), g = "flex min-w-0 flex-1 cursor-pointer items-center justify-center rounded-md outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[color:var(--kiut-bg-secondary)]";
      return m.disabled ? `${g} cursor-not-allowed opacity-40` : b ? `${g} bg-[color:var(--kiut-primary)] text-white shadow-sm` : `${g} text-[color:var(--kiut-text-primary)] hover:bg-black/[0.03] dark:text-slate-100 dark:hover:bg-white/[0.06]`;
    }
    function u(m) {
      m.disabled || m.value !== a.modelValue && s("update:modelValue", m.value);
    }
    function f(m, b, g) {
      u(m), Ct(() => i.value[b]?.focus());
    }
    const p = C(
    ...
    function v(m, b) {
      ...
      let _ = m;
      for (let k = 0; k < g; k++)
        if (_ = (_ + b + g) % g, !a.items[_]?.disabled) return _;
      return m;
    }
    function h(m, b) {
      if (m.key === "ArrowRight" || m.key === "ArrowDown") {
        m.preventDefault();
        const g = v(b, 1), _ = a.items[g];
        _ && u(_), Ct(() => i.value[g]?.focus());
    ...
    return (m, b) => (y(), x("div", {
      ...
      (y(!0), x(q, null, J(e.items, (g, _) => (y(), x("button", {
        id: o(g.value),
        key: g.value,
        ref_for: !0,
        ref: (k) => r(k, _),
...
function Fo(e) {
  return `${OM[e.getMonth()]} ${String(e.getDate()).padStart(2, "0")}`;
}
function Po(e) {
  return `${VM[e.getMonth()]} ${e.getFullYear()}`;
}
const zM = ["aria-expanded", "aria-labelledby", "aria-label"], NM = ["onKeydown"], WM = { class: "mb-4 flex items-center justify-between gap-2" }, HM = { class: "flex min-w-0 flex-1 justify-center gap-8 text-center text-sm font-semibold text-[color:var(--kiut-text-primary)] dark:text-slate-100" }, jM = { class: "min-w-0 truncate" }, YM = { class: "min-w-0 truncate" }, UM = { class: "flex flex-col gap-6 sm:flex-row sm:gap-8" }, KM = { class: "mb-2 grid grid-cols-7 gap-1 text-center text-[11px] font-medium uppercase tracking-wide text-[color:var(--kiut-text-secondary)] dark:text-slate-400" }, qM = { class: "grid grid-cols-7 gap-y-1" }, XM = ["disabled", "onClick"], GM = /* @__PURE__ */ tt({
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const a = e, s = t, o = `${`kiut-drp-${Ft()}`}-lbl`, i = at(null), r = at(null), l = at(!1), d = at(null), u = at(ks(/* @__PURE__ */ new Date())), f = C(() => {
      const D = ks(u.value);
      return [D, Bo(D, 1)];
    ...
    function g(D, A) {
      const B = m(A, D), F = a.modelValue.start ? fe(Me(a.modelValue.start)) : null, P = a.modelValue.end ? fe(Me(a.modelValue.end)) : null, E = fe(A), N = B ? "text-[color:var(--kiut-text-primary)] dark:text-slate-100" : "text-slate-400 dark:text-slate-500";
      if (!F || !P)
        return `${N} hover:bg-black/[0.04] dark:hover:bg-white/[0.06]`;
      const Y = IM(E, F) && RM(E, P), L = Lo(E, F), O = Lo(E, P);
    ...
    function _(D) {
      ...
      ws(P, F) && ([F, P] = [P, F]), s("update:modelValue", { start: ta(F), end: ta(P) }), d.value = null, l.value = !1;
    }
    function k(D) {
    ...
    return Rt(l, (D) => {
      ...
      c("button", {
        type: "button",
        class: U([T(de), "flex w-full items-center gap-2 text-left"]),
      ...
      Kt(c("div", {
        ...
        c("div", WM, [
          ...
          c("div", HM, [
            c("span", jM, $(T(Po)(f.value[0])), 1),
            c("span", YM, $(T(Po)(f.value[1])), 1)
          ]),
          c("button", {
            type: "button",
            class: "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-gray-300 text-gray-600 transition hover:bg-black/[0.04] focus-visible:outline focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/30 dark:border-[color:var(--kiut-border-light)] dark:text-slate-300 dark:hover:bg-white/[0.06]",
        ...
        c("div", UM, [
          (y(!0), x(q, null, J(f.value, (B) => (y(), x("div", {
            ...
            c("div", KM, [
              (y(), x(q, null, J(v, (F) => c("span", { key: F }, $(F), 1)), 64))
            ]),
            c("div", qM, [
              (y(!0), x(q, null, J(T(EM)(B), (F) => (y(), x("button", {
                key: T(ta)(F),
                type: "button",
                disabled: b(F),
                class: U(["relative flex h-9 items-center justify-center rounded-lg text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/40", g(B, F)]),
                onClick: (P) => _(F)
              }, $(F.getDate()), 11, XM))), 128))
            ])
          ]))), 128))
  ...
  setup(e) {
    ...
    return (r, l) => a.value ? (y(), x("span", {
      ...
      e.statusLive === !0 ? (y(), x("span", ZM, [...l[0] || (l[0] = [
...
}, tC = ["type", "disabled", "aria-label"], eC = {
  key: 1,
...
}, sC = ["type", "disabled", "aria-label"], nC = {
  key: 1,
  class: "min-w-0 truncate"
}, Ia = /* @__PURE__ */ tt({
  name: "Button",
  ...
  setup(e) {
    ...
    return (u, f) => s.value ? (y(), x("span", JM, [
      c("button", Cs({
        type: r.value,
...
}, lC = { class: "min-h-0 flex-1 overflow-y-auto px-6 py-6" }, cC = { class: "flex shrink-0 justify-end gap-3 px-6 pb-6 pt-2" }, dC = /* @__PURE__ */ tt({
  name: "Modal",
  __name: "Modal",
  props: {
    modelValue: { type: Boolean },
            ...
            c("div", {
              ...
              c("header", {
                ...
                c("div", iC, [
                  ...
                  e.subtitle ? (y(), x("p", rC, $(e.subtitle), 1)) : R("", !0)
                ]),
                Q(Ia, {
                  variant: "action",
                  type: "button",
...
}), uC = /* @__PURE__ */ nt(dC, [["__scopeId", "data-v-4ed7bb14"]]), hC = { class: "flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between" }, fC = { class: "flex min-w-0 flex-1 flex-col gap-1.5" }, gC = { class: "flex min-w-0 items-center gap-2.5" }, pC = {
  key: 0,
      ...
      c("header", hC, [
        c("div", fC, [
          c("div", gC, [
            o.value ? (y(), x("span", pC, [
              It(i.$slots, "icon", {}, () => [
                e.icon ? (y(), dt(ca(e.icon), { key: 0 })) : R("", !0)
              ])
            ])) : R("", !0),
            c("h2", {
              id: n,
          ...
          e.subtitle ? (y(), x("p", vC, $(e.subtitle), 1)) : R("", !0)
        ]),
        i.$slots.actions ? (y(), x("div", bC, [
          It(i.$slots, "actions")
        ])) : R("", !0)
      ]),
      i.$slots.default ? (y(), x("div", mC, [
        It(i.$slots, "default")
      ])) : R("", !0)
    ]));
  }
}), _C = { class: "flex flex-1 min-h-0" }, xC = {
  key: 0,
  class: "flex justify-center items-center mt-3 shrink-0"
}, kC = {
  class: "flex-1 overflow-y-auto p-1.5 flex flex-col gap-1",
  "aria-label": "Sections"
}, wC = ["aria-current", "title", "onClick"], $C = {
  key: 1,
  class: "shrink-0 border-t border-[color:var(--kiut-border-light)] bg-[color:var(--kiut-bg-secondary)]"
}, MC = { class: "px-4 pt-4 pb-2 shrink-0" }, CC = { class: "text-[12px] font-bold uppercase tracking-widest text-[color:var(--kiut-text-muted)]" }, SC = {
  class: "flex-1 overflow-y-auto px-2 pb-3 flex flex-col gap-1",
  "aria-label": "Section items"
}, DC = ["data-nav-id", "aria-current", "onClick"], AC = /* @__PURE__ */ tt({
  ...
  setup(e, { emit: t }) {
    const a = at(!1), s = e, n = t, o = Vo(), { class: i, ...r } = o, l = C(() => {
      const m = s.sections.find((b) => b.id === s.selectedSectionId);
    ...
    function f(m) {
      ...
      const b = s.selectedSectionId === m.id ? null : m.id;
      n("update:selectedSectionId", b);
    }
    function p(m, b) {
      n("navigate", { section: m, item: b });
    }
    function v(m) {
        ...
        c("div", {
          ...
          c("nav", kC, [
            (y(!0), x(q, null, J(e.sections, (g) => (y(), x("button", {
              ...
              title: g.label,
              class: U(["group relative flex flex-row items-center justify-start gap-1 px-2 py-2 rounded-xl transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/20", v(g)]),
              onClick: (_) => f(g)
            }, [
            ...
            l.value ? (y(), x("div", {
              ...
              c("nav", SC, [
                (y(!0), x(q, null, J(l.value.items, (g) => (y(), x("button", {
                  ...
                  class: U(["group flex items-center gap-2.5 w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--kiut-primary)]/20", h(g)]),
                  onClick: (_) => p(l.value, g)
                }, [
                  g.icon ? (y(), dt(ca(g.icon), {
                    key: 0,
...
}), TC = /* @__PURE__ */ nt(AC, [["__scopeId", "data-v-b510acff"]]), NC = {
  install(e) {
    e.component("KiutChartBar", re), e.component("KiutChartLine", ye), e.component("KiutPieChart", Qa), e.component("KiutBoxplotChart", Xh), e.component("KiutCandlestickChart", Ei), e.component("KiutHistogramChart", Oi), e.component("KiutSankeyChart", _e), e.component("KiutAgentsPerDay", rp), e.component("KiutBookingManager", Yp), e.component("KiutCheckin", p0), e.component("KiutCheckinMetrics", z0), e.component("KiutCheckinSegments", fv), e.component("KiutDisruption", Gv), e.component("KiutFAQ", lb), e.component("KiutMessagesPerAgent", kb), e.component("KiutRecordLocator", Kb), e.component("KiutSalesByChannel", um), e.component("KiutSeller", e1), e.component("KiutTopAgents", d1), e.component("KiutPaymentMethod", W1), e.component("KiutAgentHumanConversations", Ty), e.component("KiutChannelMetrics", Wy), e.component("KiutTriageCombinations", r_), e.component("KiutSelectLanguage", m_), e.component("KiutGuardrails", U_), e.component("KiutDisruptionNotifier", H2), e.component("KiutTotalConversationsCard", X2), e.component("KiutCsatP95Card", ex), e.component("KiutAiGeneratedRevenueCard", rx), e.component("KiutNpsDailyMetrics", Wi), e.component("KiutNpsMetrics", Gx), e.component("KiutNpsOverviewMetrics", Hi), e.component("KiutAWSCost", pk), e.component("KiutCostUsage", Ok), e.component("KiutTokenUsage", o5), e.component("KiutConversationCount", y5), e.component("KiutTopAgentsAnalysis", L5), e.component("KiutTopAgentsPie", W5), e.component("KiutDailyCostTrends", Q5), e.component("KiutModelUsage", kw), e.component("KiutMessageRoles", zw), e.component("KiutCostPerConversations", o$), e.component("Tabs", u$), e.component("Table", x$), e.component("Filters", t4), e.component("InputText", o4), e.component("InputFile", f4), e.component("InputDateTime", y4), e.component("InputTime", M4), e.component("InputRange", V4), e.component("InputNumber", j4), e.component("InputColorPicker", J4), e.component("Select", Yi), e.component("MultiSelect", hM), e.component("Toggle", pM), e.component("InputPhone", wM), e.component("SelectablePills", TM), e.component("SegmentedControl", PM), e.component("DateRangePicker", GM), e.component("Tag", QM), e.component("Button", Ia), e.component("Modal", uC), e.component("Section", yC), e.component("KiutAppShellNavigation", TC);
  }
};
export {
  pk as AWSCost,
  ...
  y5 as ConversationCount,
  o$ as CostPerConversations,
  Ok as CostUsage,
  ex as CsatP95Card,
  Q5 as DailyCostTrends,
  GM as DateRangePicker,
  Gv as Disruption,
  H2 as DisruptionNotifier,
  lb as FAQ,
  t4 as Filters,
  U_ as Guardrails,
  ...
  o5 as TokenUsage,
  d1 as TopAgents,
  L5 as TopAgentsAnalysis,
  W5 as TopAgentsPie,
  X2 as TotalConversationsCard,
