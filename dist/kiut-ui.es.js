import { defineComponent as Z, shallowRef as Va, h as Is, ref as xt, onMounted as us, onUnmounted as ja, watch as Xt, toRaw as zs, nextTick as Ya, version as Ki, isProxy as Ua, computed as T, toRef as J, createElementBlock as k, openBlock as _, createVNode as j, unref as F, normalizeStyle as bt, createCommentVNode as z, createElementVNode as d, toDisplayString as S, Fragment as X, renderList as ot, onBeforeUnmount as Gi, createStaticVNode as V, withDirectives as pn, vShow as bn, normalizeClass as as, createBlock as ht, createTextVNode as pe, resolveDynamicComponent as Zi } from "vue";
  ...
  if (!(isNaN(v) || v <= 0)) {
    switch (e.beginPath(), g) {
      ...
      case "triangle":
        ...
        break;
      case "rectRounded":
        c = v * 0.516, l = v - c, o = Math.cos(m + Zt) * l, u = Math.cos(m + Zt) * (a ? a / 2 - c : l), r = Math.sin(m + Zt) * l, f = Math.sin(m + Zt) * (a ? a / 2 - c : l), e.arc(s - u, n - r, c, m - it, m - pt), e.arc(s + f, n - o, c, m - pt, m), e.arc(s + u, n + r, c, m, m + pt), e.arc(s - f, n + o, c, m + pt, m + it), e.closePath();
        break;
      case "rect":
        if (!p) {
...
function yl(e, t, s) {
  let n = 1, a = 1, i = 0, o = 0;
  if (t < dt) {
    const r = e, l = r + t, c = Math.cos(r), h = Math.sin(r), u = Math.cos(l), f = Math.sin(l), g = (x, M, w) => Ie(x, r, l, !0) ? 1 : Math.max(M, M * s, w, w * s), p = (x, M, w) => Ie(x, r, l, !0) ? -1 : Math.min(M, M * s, w, w * s), v = g(0, c, u), m = g(pt, h, f), b = p(it, c, u), y = p(it + pt, h, f);
...
class xl extends bs {
  ...
  updateElements(t, s, n, a) {
    ...
    for (let w = 0; w < x; ++w) {
      ...
      $.skip = isNaN(D) || isNaN(B) || L, $.stop = w > 0 && Math.abs(A[f] - M[f]) > m, v && ($.parsed = A, $.raw = c.data[w]), u && ($.options = h || this.resolveDataElementOptions(w, C.active ? "active" : a)), b || this.updateElement(C, w, $, a), M = A;
    }
  }
  getMaxOverflow() {
...
class ve extends Vt {
  ...
  _computeGridLineItems(t) {
    ...
    if (o === "top")
      y = b(this.bottom), $ = this.bottom - f, L = y - m, B = b(t.top) + m, R = t.bottom;
    else if (o === "bottom")
      y = b(this.top), B = t.top, R = b(t.bottom) - m, $ = y + m, L = this.top + f;
    else if (o === "left")
  ...
  _computeLabelItems(t) {
    ...
    let b, y, x, M, w, C, $, A, L, D, B, P, R = "middle";
    if (a === "top")
    ...
    for (b = 0, y = r.length; b < y; ++b) {
      ...
      A = this.getPixelForTick(b) + i.labelOffset, L = this._resolveTickFontOptions(b), D = L.lineHeight, B = ft(M) ? M.length : 1;
...
function hs(e, t, s, n, a, i) {
  ...
  const v = Math.max(1e-3, p * u - s / it) / u, m = (p - v) / 2, b = l + m + g, y = a - m - g, { outerStart: x, outerEnd: M, innerStart: w, innerEnd: C } = Oc(t, f, u, y - b), $ = u - x, A = u - M, L = b + x / $, D = y - M / A, B = f + w, P = f + C, R = b + w / B, O = y - C / P;
  if (e.beginPath(), i) {
    const I = (L + D) / 2;
    ...
    if (e.arc(o, r, f, y - C / f, st, !0), e.arc(o, r, f, st, b + w / f, !0), w > 0) {
      const E = he(B, R, o, r);
      e.arc(E.x, E.y, w, R + Math.PI, b - pt);
    }
    const H = he($, b, o, r);
    if (e.lineTo(H.x, H.y), x > 0) {
      const E = he($, L, o, r);
      e.arc(E.x, E.y, x, b - pt, L);
    }
  } else {
    e.moveTo(o, r);
...
class ka extends Vt {
  ...
  _draw() {
    ...
    this.legendItems.forEach((C, $) => {
      ...
      const R = l.x(B);
      if (b(R, P, C), B = Yo(L, B + p + f, x ? B + D : this.right, t.rtl), y(l.x(B), P, C), x)
        g.x += D + h;
...
function Rd(e, t) {
  ...
  L = Math.ceil(m / w) - Math.floor(v / w), L > p && (w = wn(L * w / p / g) * g), et(l) || (C = Math.pow(10, l), w = Math.ceil(w * C) / C), a === "ticks" ? ($ = Math.floor(v / w) * w, A = Math.ceil(m / w) * w) : ($ = v, A = m), b && y && i && Eo((r - o) / i, w / 1e3) ? (L = Math.round(Math.min((r - o) / w, h)), w = (r - o) / L, $ = o, A = r) : x ? ($ = b ? o : $, A = y ? r : A, L = c - 1, w = (A - $) / L) : (L = (A - $) / w, Fe(L, Math.round(L), w / 1e3) ? L = Math.round(L) : L = Math.ceil(L));
...
const Jd = { class: "chart-container" }, th = /* @__PURE__ */ Z({
  ...
  setup(e, { expose: t }) {
    ...
    }, v = T(() => p(s.minScore)), m = T(() => p(s.maxScore)), b = T(() => p(s.q1Score)), y = T(() => p(s.medianScore)), x = T(() => p(s.q3Score)), M = T(() => p(s.averageScore)), w = T(() => s.minScore), C = T(() => s.maxScore), $ = T(() => s.q1Score), A = T(() => s.medianScore), L = T(() => s.q3Score), D = T(() => s.averageScore), B = T(() => {
...
const Vf = { class: "chart-footer" }, jf = { class: "export-actions" }, Yf = { class: "export-buttons" }, Uf = ["disabled"], qf = {
      ...
      n.loading ? (_(), k("div", rb, [...g[6] || (g[6] = [
        ...
        d("div", X0, [
          ...
          d("div", J0, [
            ...
            d("span", tb, S(F(W)(c.value.total_airline_information_retrieved)), 1)
          ]),
          d("div", eb, [
            g[3] || (g[3] = d("span", { class: "kpi-label" }, "Booking Info", -1)),
            d("span", sb, S(F(W)(c.value.total_booking_info_retrieved)), 1)
          ]),
          d("div", nb, [
            g[4] || (g[4] = d("span", { class: "kpi-label" }, "Flight Status", -1)),
            d("span", ab, S(F(W)(c.value.total_flight_status_retrieved)), 1)
          ])
        ]),
            ...
            d("table", Cb, [
              ...
              d("tbody", Tb, [
                (_(!0), k(X, null, ot(r.value, (v) => (_(), k("tr", {
                  ...
                  d("td", Fb, S(F(Tt)(v.date).format("DD/MM/YYYY")), 1),
                  d("td", Bb, S(F(W)(v.checkin_initiated)), 1),
                  d("td", Pb, S(u(v.record_locator_init_count, v.checkin_initiated)), 1),
                  d("td", Lb, S(F(W)(v.record_locator_started_count)), 1),
                  ...
                  n.isAvianca ? (_(), k("td", zb, S(F(W)(v.record_locator_create_payment_count)), 1)) : z("", !0),
                  n.isAvianca ? (_(), k("td", Wb, S(F(W)(v.record_locator_create_payment_failed_count)), 1)) : z("", !0)
                ]))), 128))
              ])
            ])
          ]),
  ...
  setup(e, { expose: t, emit: s }) {
    const n = e, a = s, i = (b) => {
      ...
      const x = W(b), M = g(b, y);
      return `${x} (${M})`;
    }, v = (b) => b == null ? 0 : typeof b == "number" ? b : Array.isArray(b) ? b.reduce((y, x) => y + (x.total_value || 0), 0) : 0, m = (b) => at(v(b));
            ...
            d("table", sm, [
              ...
              d("tbody", nm, [
                (_(!0), k(X, null, ot(r.value, (x) => (_(), k("tr", {
                  ...
                  d("td", am, S(F(Tt)(x.date).format("DD/MM/YYYY")), 1),
                  d("td", im, S(F(W)(x.seller_conversations || 0)), 1),
            ...
            d("table", jm, [
              ...
              d("tbody", Ym, [
                (_(!0), k(X, null, ot(h.value, (P) => (_(), k("tr", {
                  ...
                  d("td", Um, S($(P.date)), 1),
                  d("td", qm, S(F(W)(P.total_count ?? 0)), 1),
        ...
        d("div", J1, [
          ...
          d("div", sy, [
            d("div", ny, [
              ...
              d("span", ay, S(F(at)(e.data.total_allocated_cost)), 1)
            ]),
            d("div", iy, [
              r[2] || (r[2] = d("span", { class: "stat-label" }, "Total AWS", -1)),
              d("span", oy, S(F(at)(e.data.total_cost)), 1)
            ])
          ])
        ])
      ]),
        ...
        e.loading ? (_(), k("div", ly, [...r[3] || (r[3] = [
          ...
          d("footer", hy, [
            d("div", uy, [
              ...
              d("span", fy, S(F(W)(e.data.total_conversations)), 1)
            ]),
            d("div", gy, [
              r[5] || (r[5] = d("span", { class: "kpi-label" }, "Airline Conv.", -1)),
              d("span", py, S(F(W)(e.data.total_airline_conversations)), 1)
            ]),
            d("div", by, [
              r[6] || (r[6] = d("span", { class: "kpi-label" }, "Avg. Cost / Conv.", -1)),
              d("span", my, S(F(at)(e.data.total_allocated_cost / (e.data.total_conversations || 1))), 1)
            ]),
            d("div", vy, [
        ...
        l.value.labels && l.value.labels.length ? (_(), k("section", Gy, [
          ...
          d("footer", Qy, [
            d("div", Jy, [
              ...
              d("span", t_, S(F(W)(e.data.total_tokens)), 1)
            ]),
            d("div", e_, [
              u[1] || (u[1] = d("span", { class: "kpi-label" }, "Input", -1)),
              d("span", s_, S(F(W)(e.data.total_input_tokens)), 1)
            ]),
            d("div", n_, [
              u[2] || (u[2] = d("span", { class: "kpi-label" }, "Output", -1)),
              d("span", a_, S(F(W)(e.data.total_output_tokens)), 1)
            ]),
            d("div", i_, [
              u[3] || (u[3] = d("span", { class: "kpi-label" }, "Cache Read", -1)),
              d("span", o_, S(F(W)(e.data.total_cache_read_tokens)), 1)
            ]),
            d("div", r_, [
              u[4] || (u[4] = d("span", { class: "kpi-label" }, "Cache Write", -1)),
              d("span", l_, S(F(W)(e.data.total_cache_write_tokens)), 1)
            ])
          ])
        ])) : (_(), k("section", c_, [
          d("div", d_, [
...
}), g_ = /* @__PURE__ */ G(f_, [["__scopeId", "data-v-e9e355be"]]), p_ = { class: "conversation-count-card" }, b_ = { class: "card-header" }, m_ = { class: "header-right" }, v_ = { class: "stat-badge" }, y_ = { class: "stat-value" }, __ = {
  key: 0,
  class: "card-body"
}, x_ = {
  key: 0,
  ...
  setup(e, { expose: t, emit: s }) {
    ...
    return t({ isDark: o }), (y, x) => (_(), k("article", G2, [
      ...
      e.loading ? (_(), k("div", ux, [...x[6] || (x[6] = [
        ...
        m.value.labels && m.value.labels.length ? (_(), k("section", Q2, [
          d("div", J2, [
            j(Gt, {
              data: m.value,
              options: b.value
