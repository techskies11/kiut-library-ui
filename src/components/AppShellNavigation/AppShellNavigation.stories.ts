...
export const Default: Story = {
  render: () => ({
    ...
    template: `
      <div class="ku:flex ku:h-screen ku:bg-[color:var(--kiut-bg-primary)]">
        <AppShellNavigation
          :sections="demoSections"
          v-model:selectedSectionId="selectedSectionId"
          :activePath="activePath"
          @navigate="onNavigate"
          class="ku:h-full ku:rounded-xl ku:m-3"
          style="box-shadow: var(--kiut-shadow-card)"
          expandedPrimaryWidth= "13rem"
        >
          <template #logo>
            <div class="ku:w-9 ku:h-9 ku:rounded-xl ku:bg-[color:var(--kiut-primary)] ku:flex ku:items-center ku:justify-center">
              <svg class="ku:w-5 ku:h-5 ku:text-white" viewBox="0 0 24 24" fill="currentColor">
          ...
          <template #footer="{ expanded }">
            ...
            <div v-if="expanded" class="ku:flex ku:items-center ku:justify-between ku:px-3 ku:py-2.5 ku:gap-2 ku:text-[color:var(--kiut-text-muted)]">
              <button class="ku:flex ku:flex-col ku:items-center ku:gap-0.5 ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors">
                <span class="ku:text-[9px] ku:font-semibold ku:uppercase ku:tracking-wider">EN</span>
              </button>
              <button class="ku:flex ku:flex-col ku:items-center ku:gap-0.5 ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors">
                <svg class="ku:w-3.5 ku:h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>
                <span class="ku:text-[8px] ku:font-medium">GMT-5</span>
              </button>
              <button class="ku:flex ku:flex-col ku:items-center ku:gap-0.5 ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors">
                <svg class="ku:w-3.5 ku:h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg>
              </button>
            </div>
            <!-- Collapsed: single centered icon -->
            <div v-else class="ku:flex ku:items-center ku:justify-center ku:py-2.5 ku:text-[color:var(--kiut-text-muted)]">
              <button class="ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors">
                <svg class="ku:w-3.5 ku:h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg>
              </button>
            </div>
          </template>
        ...
        <main class="ku:flex-1 ku:p-6">
          <p class="ku:text-sm ku:text-[color:var(--kiut-text-secondary)]">
            Selected section: <strong>{{ selectedSectionId }}</strong><br />
            Active path: <strong>{{ activePath }}</strong>
          </p>
          <p class="ku:mt-4 ku:text-xs ku:text-[color:var(--kiut-text-muted)]">
...
export const DarkMode: Story = {
  render: () => ({
    ...
    template: `
      <div class="dark ku:flex ku:h-screen ku:bg-[#000]">
        <AppShellNavigation
          :sections="demoSections"
          v-model:selectedSectionId="selectedSectionId"
          :activePath="activePath"
        ...
        <main class="ku:flex-1 ku:p-6">
          <p class="ku:text-sm ku:text-[color:var(--kiut-text-secondary)]">Dark mode preview</p>
        </main>
      </div>
    `,
  }),
    ...
    template: `
      <div class="ku:flex ku:h-screen ku:bg-[color:var(--kiut-bg-primary)]">
        ...
        <main class="ku:flex-1 ku:p-6">
          ...
          <ul class="ku:mt-2 ku:space-y-1 ku:text-xs ku:text-[color:var(--kiut-text-muted)] ku:list-disc ku:list-inside">
...
export const Mobile: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "On viewports narrower than `mobileBreakpoint` (default 768px) the navigation switches to a ku:fixed ku:bottom tab bar. Tapping a section with sub-items reveals a ku:bottom sheet. Tapping outside the sheet or a close button dismisses it.",
      },
    },
  ...
  render: () => ({
    ...
    template: `
      <div class="ku:relative ku:h-screen ku:bg-[color:var(--kiut-bg-primary)] ku:overflow-hidden" style="max-width:390px">
        <main class="ku:flex-1 ku:p-5 ku:pb-[7rem]">
          <h2 class="ku:text-base ku:font-semibold ku:text-[color:var(--kiut-text-primary)] ku:mb-1">Mobile Navigation</h2>
          <p class="ku:text-sm ku:text-[color:var(--kiut-text-secondary)] ku:mb-4">
            Tap a section in the bottom bar to open its items in a sheet.
          </p>
          <p class="ku:text-xs ku:text-[color:var(--kiut-text-muted)]">
            Selected section: <strong>{{ selectedSectionId ?? '—' }}</strong><br />
            Active path: <strong>{{ activePath }}</strong>
          </p>
        </main>
        ...
        >
          <template #footer>
            <div class="ku:flex ku:items-center ku:justify-between ku:px-1 ku:py-2.5 ku:gap-0.5 ku:text-[color:var(--kiut-text-muted)] ku:w-full">
              <button class="ku:flex ku:flex-col ku:items-center ku:gap-0.5 ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors ku:w-1/3">
                <strong class="ku:text-[8px] ku:font-semibold ku:uppercase ku:tracking-wider">Lang</strong>
                <span class="ku:text-[8px] ku:font-medium">EN</span>
              </button>
              <button class="ku:flex ku:flex-col ku:items-center ku:gap-0.5 ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors ku:w-1/3">
                <strong class="ku:text-[8px] ku:font-semibold ku:uppercase ku:tracking-wider">Zone</strong>
                <svg class="ku:w-3.5 ku:h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>
                <span class="ku:text-[8px] ku:font-medium">GMT-5</span>
              </button>
              <button class="ku:flex ku:flex-col ku:items-center ku:gap-0.5 ku:hover:text-[color:var(--kiut-primary)] ku:transition-colors ku:w-1/3">
                <strong class="ku:text-[8px] ku:font-semibold ku:uppercase ku:tracking-wider">Theme</strong>
                <svg class="ku:w-3.5 ku:h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg>
              </button>
            </div>
          </template>
...
export const MobileDark: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div class="dark ku:relative ku:h-screen ku:bg-[#000] ku:overflow-hidden" style="max-width:390px">
        <main class="ku:flex-1 ku:p-5 ku:pb-[7rem]">
          <h2 class="ku:text-base ku:font-semibold ku:text-[color:var(--kiut-text-primary)] ku:mb-1">Dark Mobile</h2>
          <p class="ku:text-sm ku:text-[color:var(--kiut-text-secondary)]">
            Active path: <strong>{{ activePath }}</strong>
          </p>
        </main>
