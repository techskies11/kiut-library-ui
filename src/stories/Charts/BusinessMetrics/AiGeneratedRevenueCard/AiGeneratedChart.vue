...
const DEFAULT_TITLES: Record<string, string> = {
  all: "AI Generated Revenue",
  payment_method: "AI Generated Revenue by Payment Method",
  agent_type: "AI Generated Revenue by Agent",
  channel: "AI Generated Revenue by Channel",
  channel_and_agent: "AI Generated Revenue by Channel & Agent",
  agent_and_product: "AI Generated Revenue by Agent & Product",
};
...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    data: null,
    breakdownBy: "all",
    breakdownOptions: undefined,
    titles: undefined,
    subtitle: "Revenue generated by AI agents",
    emptyTitle: "No revenue data available",
    emptyDescription: "No AI revenue found for the selected period. Try adjusting the date range.",
    theme: undefined,
  },
);
...
const resolvedBreakdownOptions = computed(
  () =>
    props.breakdownOptions && props.breakdownOptions.length > 0
      ? props.breakdownOptions
      : DEFAULT_BREAKDOWN_OPTIONS,
);

const resolvedTitles = computed(() => props.titles ?? DEFAULT_TITLES);

const chartTitle = computed(
  () =>
    resolvedTitles.value[selectedBreakdown.value] ?? resolvedTitles.value.all,
);
