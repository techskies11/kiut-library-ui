...
const baseAgentRows = [
  {
    ...
    transferred_count: 4,
    abandoned_count: 2,
    day_total_abandoned: 3,
    connected_at: null,
    disconnected_at: null,
    online_time_seconds: null,
...
const meta = {
  ...
  argTypes: {
    ...
    previousTotalTransferred: {
      control: 'number',
      description: 'Previous period total transferred for trend badge',
    },
    previousTotalAbandoned: {
      control: 'number',
      description: 'Previous period total abandoned for trend badge',
    },
...
export const WithTrendBadges: Story = {
  args: {
    ...
    previousTotalTransferred: 14,
    previousTotalAbandoned: 4,
